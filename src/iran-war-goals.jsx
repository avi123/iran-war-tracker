...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      { id:"mis-fixed", name:"Destroy fixed missile launch sites", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Day 8: 80+ coalition jets struck 230+ munitions/supply targets. 16 IRGC Quds Force aircraft destroyed at Isfahan air base. Underground missile factory in western Iran hit with bunker-busters. IDF: 300+ launchers destroyed. UAE BM data: D1:137, D2:28, D3:9, D4:12, D5:3, D6:7, D7:9. B-2s dropping 2,000lb penetrators on underground launchers. Parchin military-industrial complex struck. 90%+ Gulf interception rates holding.", sources:[{t:"IDF-Hebrew",u:"https://x.com/idfonline/status/2029563609353703542"},{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/04/why-irans-ballistic-missile-launches-are-declining/"},{t:"UAE-MOD-D7",u:"https://x.com/modgovae/status/2029918244094759323"},{t:"Vahid-Parchin",u:"https://x.com/Vahid/status/2029600023650963459"},{t:"CENTCOM-D8",u:"https://www.centcom.mil/MEDIA/PRESS-RELEASES/"}] },
      ...
      { id:"mis-prod", name:"Destroy missile production facilities", party:"both", type:"achieve", importance:5, achievability:3, status:"in progress", outcomeNote:"Hegseth Objective #2. Some facilities struck but Iran has dispersed production across dozens of sites.", sources:[{t:"Army.mil",u:"https://www.army.mil/article/290823/hegseth_says_epic_fury_goals_in_iran_are_laser_focused"},{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/03/us-israeli-strikes-hit-irans-missile-nuclear-political-and-repression-sites/"}] },
      ...
      { id:"mis-c2", name:"Destroy missile command & control", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Iranian missile fire on Israel significantly decreased. Israel says Iran may be rationing munitions for long war. C2 degradation evident — sporadic fire patterns. But missiles still launching at Gulf states.", sources:[{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/04/why-irans-ballistic-missile-launches-are-declining/"},{t:"ToI",u:"https://www.timesofisrael.com/us-israel-say-iran-missile-fire-down-most-launchers-taken-out-as-offensive-ramps-up/"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", outcomeNote:"FAILED + FORMALIZING: Assembly of Experts elected Mojtaba Khamenei as Supreme Leader DESPITE Israel destroying their Qom building. Day 8: Assembly of Experts reportedly preparing to meet again within 24 hours to formalize Mojtaba's investiture. Regime reconstituting constitutional succession under active bombing. Israel declared Mojtaba 'an unequivocal target for elimination.' Trump: 'everybody that wants to be a leader, they end up dead.' Succession proceeding despite threats.", sources:[{t:"FDD-AoE",u:"https://www.fdd.org/analysis/2026/03/03/israel-strikes-tehran-regimes-assembly-of-experts-underlining-efforts-to-disrupt-succession-process/"},{t:"IranIntl",u:"https://www.iranintl.com/en/liveblog/202602288143"},{t:"AJZ-Mojtaba",u:"https://www.aljazeera.com/features/2026/3/4/who-is-mojtaba-khamenei-a-contender-for-irans-leadership-amid-war"},{t:"IranIntl-D8",u:"https://www.iranintl.com/en/liveblog/20260307"}] },
      ...
      { id:"reg-repress", name:"Degrade regime's internal repression capability", party:"israel", type:"achieve", importance:3, achievability:4, status:"in progress", outcomeNote:"Day 8: REPRESSION INTENSIFYING DESPITE DEGRADATION. Shoot-to-kill orders issued against protesters. IRGC warning about 'fifth column' — framing internal dissent as enemy action. Police chief ordered officers to shoot thieves on sight. Sistan-Baluchistan insurgency continuing — Mobarizoun Popular Front active. IDF + US systematically hitting internal security — police HQs, Basij bases, IRGC facilities. 120hr+ internet blackout. Regime compensating for infrastructure degradation with escalated violence against own population.", sources:[{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/03/us-israeli-strikes-hit-irans-missile-nuclear-political-and-repression-sites/"},{t:"CTP-ISW",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-5-2026"},{t:"IranIntl-D8",u:"https://www.iranintl.com/en/liveblog/20260307"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"hor-open", name:"Keep Hormuz open during operations", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"WARLIKE OPS AREA + FIRST IRANIAN TRANSIT: UKMTO: tugboat Mussafah 2 hit — all ~8 crew believed killed. IRGC hit US tanker. Kuwait tanker explosion. Oman storage hit. P&I removed. 150+ ships stalled. BUT: 2 Iranian cargo ships departed for Malaysia via Hormuz (first transit since war — CTP-ISW). 4 tankers loading 8M barrels at Kharg Island (satellite). Iran testing whether it can keep its OWN shipping moving while blocking everyone else. Qatar partially reopened airspace. Macron building European naval coalition. China in talks for safe passage.", sources:[{t:"CTP-ISW",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-5-2026"},{t:"Euronews",u:"https://www.euronews.com/2026/03/05/iran-claims-it-hit-us-tanker-as-israel-launches-fresh-strikes-on-tehran"}] },
      ...
      { id:"hor-energy", name:"Prevent global energy crisis", party:"us", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Brent $82+. US gas biggest 1-day spike since 2005. EU gas +42%. QatarEnergy offline. Iraq shutting Rumaila (3M bpd). Crisis materializing.", sources:[{t:"CNBC",u:"https://www.cnbc.com/2026/03/05/crude-oil-prices-today-iran-war.html"},{t:"Euronews",u:"https://www.euronews.com/business/2026/03/02/european-gas-prices-jump-by-as-much-as-45-as-qatar-stops-lng-production"}] },
    ]
  },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 8: 2 Givati Brigade soldiers wounded by Hezbollah ATGM. IDF commando raid on Nabi Chit cemetery (Baalbek district, Lebanon) searching for Ron Arad remains — 41 killed including 3 Lebanese soldiers. Growing Lebanese anger at IDF operations. Beirut evacuation warnings expanding. Lebanon: 217+ dead, ~800 wounded, 110,162 displaced (UNHCR). IDF ordered evacuation of ALL southern Beirut — 500,000+ people. Smotrich: 'Dahieh = Khan Younis.' 116+ Hezbollah attack waves. Radwan deployed. Gaza template now applied to Lebanon.", sources:[{t:"CNN",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-05-26"},{t:"AJZ-Mar7",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"},{t:"Euronews-Arad",u:"https://www.euronews.com/2026/03/07/idf-raids-lebanese-cemetery-in-search-for-missing-pilot-ron-arad"},{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 8: 24,000 evacuated from Lebanon (UNHCR). IDF commando raid on Nabi Chit cemetery (Baalbek, Lebanon) searching for Ron Arad remains — 41 killed including 3 Lebanese soldiers (Euronews/ToI). 110,162 displaced in Lebanon (UNHCR). Iran: 1,332+ dead, 181 children (UNICEF). Second school hit (Tehran Niloufar Square). IDF evacuation orders inside Qom. 500,000+ Beirut evacuation. Day 7 most intense bombing yet. Toll documented by UNICEF, OHCHR, WHO — permanent accountability record.", sources:[{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/6/tehran-hit-by-heavy-bombing-on-day-seven-of-us-israel-war-on-iran"},{t:"AJZ-Mar7",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"},{t:"Euronews-Arad",u:"https://www.euronews.com/2026/03/07/idf-raids-lebanese-cemetery-in-search-for-missing-pilot-ron-arad"},{t:"UNHCR",u:"https://www.unhcr.org/"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"all-base", name:"Maintain basing rights across region", party:"us", type:"achieve", importance:5, achievability:3, status:"in progress", outcomeNote:"Day 8: UK deployed B-1 bombers to RAF Fairford. UK sending Typhoon fighters to protect Qatar. US approved $151M arms sale (Gulf ally). BUT: Iran threatened European countries hosting US forces as 'legitimate targets' — direct warning to basing nations. 20,000 Americans evacuated. CIA station Riyadh hit. France authorized US base access. Basing architecture expanding through NATO but Iran now explicitly threatening host nations, which could test political will to keep bases open.", sources:[{t:"AJZ-D7",u:"https://www.aljazeera.com/news/2026/3/6/iran-war-what-is-happening-on-day-seven-of-us-israel-attacks"},{t:"WaPo",u:"https://www.washingtonpost.com/national-security/2026/03/03/cia-saudi-arabia-drone-attack-iran/"},{t:"CTP-ISW",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-5-2026"},{t:"Reuters-D8",u:"https://www.reuters.com/world/middle-east/"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"gp-russia", name:"Prevent Russian military support to Iran", party:"both", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"DE FACTO CO-BELLIGERENCE CONFIRMED: Day 8 reporting confirms WaPo/CBS intel sharing story. Russia providing Iran real-time intelligence on US warship and aircraft positions — 'pretty comprehensive effort' (multiple officials). Iran has few military satellites; Russian data filling critical ISR gap. May explain accuracy of strikes on Riyadh embassy, early warning radars. Moscow publicly calls strikes 'unprovoked aggression' while covertly enabling targeting. Peskov: Iran has NOT requested weapons — yet. Key threshold: weapons resupply when missile stocks (down 90%) deplete. Achievability downgraded: intel sharing now confirmed, not speculated.", sources:[{t:"WaPo",u:"https://www.washingtonpost.com/national-security/2026/03/06/russia-iran-intelligence-us-targets/"},{t:"CBS",u:"https://www.cbsnews.com/live-updates/us-iran-war-israel-strikes-regime-targets/"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"sco-theater", name:"Limit conflict to Iran bilateral", party:"us", type:"achieve", importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 8 EXPANDING FURTHER: Iran threatened European countries hosting US forces as 'legitimate targets' — war expanding to European theater politically. Trump threatened 'complete destruction' of new target areas. Iraqi Islamic Resistance claimed 27 operations (up from 23+). Dubai airport struck by drone. 10+ theaters active: Azerbaijan, Oman, Lebanon, Iraq, Gulf states, Red Sea, Mediterranean. Unknown forces in Anbar Province (CTP-ISW). Iran attacked 12 countries (Cooper). War touching sovereignty of 10+ nations and now explicitly threatening European basing nations.", sources:[{t:"CTP-ISW",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-5-2026"},{t:"Euronews",u:"https://www.euronews.com/2026/03/05/iran-claims-it-hit-us-tanker-as-israel-launches-fresh-strikes-on-tehran"},{t:"AJZ-D8",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"RECORD WEEKLY SURGE: Brent $92.69, WTI $90.90 (Mar 7). WTI +35.63% weekly — largest weekly gain in history. Kuwait cutting oil production due to storage overflow + Hormuz closure. QatarEnergy LNG halt continues. Supertanker rates $423K/day (record). KOSPI -12%. Gold $5,100+. 10+ tankers burning at Hormuz. Iran loading 8M bbl at Kharg + 2 cargo ships transited Hormuz — testing selective export while blocking others. $100/bbl threshold approaching rapidly at current trajectory.", sources:[{t:"CNBC",u:"https://www.cnbc.com/2026/03/07/crude-oil-prices-today-iran-war.html"},{t:"KoreaHerald",u:"https://www.koreaherald.com/article/10686893"},{t:"Reuters-D8",u:"https://www.reuters.com/business/energy/"}] },
      { id:"en-gas", name:"Prevent European gas crisis", party:"us", type:"avoid", importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"EU gas +42%. QatarEnergy offline (world's #2 LNG). European Stoxx 600 -2.7% Tue (extending -1.6% Mon). Banks -3.8%, insurance -4.2%. Even defense stocks fell -2.5%. If Qatar offline for weeks, 2022 crisis comparison becomes real.", sources:[{t:"Euronews",u:"https://www.euronews.com/my-europe/2026/03/04/iran-war-revives-spectre-of-energy-crisis-in-europe-fuelling-economic-anxiety"},{t:"TheNational",u:"https://www.thenationalnews.com/business/energy/2026/03/04/qatarenergy-declares-force-majeure-after-iran-attacks-halt-supply/"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"gulf-ad", name:"Maintain Gulf air defense effectiveness", party:"us", type:"achieve", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"UAE D8 (Mar 7): 121 UAVs detected, 119 intercepted (98.3%). Saudi intercepted 16 Iranian drones targeting Shaybah oil facility. Qatar intercepted 9/10 BMs. Cumulative UAE: ~205 BMs, ~1,300 drones. Bahrain: BAPCO refinery hit Day 7, Manama hotel/residential buildings struck. UAE casualties: 3 dead (Pakistani, Nepali, Bangladeshi), 94+ wounded across 18 nationalities. Interception rates holding 90%+ but interceptor stock depletion = Week 2 critical question.", sources:[{t:"UAE-MOD-D7",u:"https://x.com/modgovae/status/2029918244094759323"},{t:"UAE-MOD-D6",u:"https://x.com/modgovae/status/2029520996974407745"},{t:"Zelenskyy",u:"https://x.com/ZelenskyyUa/status/2029470937695781108"},{t:"AJZ-D8",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"}] },
      { id:"gulf-infra", name:"Protect Gulf energy infrastructure", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 8 EXPANDING: Dubai airport struck by Iranian drone — flights diverted. Saudi Shaybah oil facility hit by 16 drones (Saudi intercepted all). Bahrain: Manama hotel + 2 residential buildings fire from Day 7 strikes. Al Dhafra air base (UAE) targeted. BAPCO refinery (Bahrain) struck by 2 BMs Day 7. 10+ tankers burning at Hormuz. Saudi Aramco Ras Tanura offline. AWS data centers UAE/Bahrain still affected. Iran systematically targeting Gulf civilian and energy infrastructure with drones as missile stocks decline.", sources:[{t:"CTP-ISW",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-5-2026"},{t:"TheNational",u:"https://www.thenationalnews.com/business/2026/03/02/saudi-aramco-shuts-down-ras-tanura-refinery-following-drone-attack/"},{t:"CNBC",u:"https://www.cnbc.com/2026/03/03/iran-war-uae-drone-strikes-aws-data-centers.html"},{t:"AJZ-D8",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"}] },
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:mobile?8:12 }}>
          <div>
            ...
            <div style={{ fontSize:mobile?10:11, color:C.textDim, marginTop:4 }}>
              ...
              <span style={{color:C.oppose}}>■</span> Opposing {!mobile && <>&nbsp;|&nbsp; Day 7 — Hour 180+ — March 6, 2026 — Evening Update</>}
            </div>
            {mobile && <div style={{ fontSize:9, color:C.textDim, marginTop:2 }}>Day 7 — March 6, 2026 — Evening Update</div>}
          </div>
