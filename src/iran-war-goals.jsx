...
const HIGHLIGHTS = {
  updatedAt: "2026-03-10T06:36Z",
  keyDevelopments: [
    { text: "Oil price CORRECTION — WTI settled $101.97 (+12.2%), not $109. Brent $103.47. Still above $100 but pulled back from $119 panic spike. WTI posted biggest weekly gain in history (+35.6%).", why: "$102 settle vs $119 intraday = markets correcting panic overshoot. Still structurally above $100, but the gap between intraday fear and settlement reality matters for policy.", category: "economic", goalIds: ["en-oil", "en-pump"], sources: [{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/09/oil-prices-iran-war-middle-east-us-israel-strait-of-hormuz.html"}] },
    { text: "IRGC Air Force HQ + Space/Satellite Command destroyed. 50 ammunition bunkers. 10/17 Artesh airbases struck. IDF claims 1,900+ Iranian military killed.", why: "Campaign systematically eliminating Iran's command infrastructure — air force, space, satellite, internal security all degraded. 1,900 KIA claim (if accurate) is devastating attrition in 10 days.", category: "military", goalIds: ["mis-fixed", "mis-c2"], sources: [{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Haaretz-D10",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-09/ty-article-live/u-s-servicemember-dies-of-wounds-bringing-total-killed-to-7-centcom-says/0000019c-cf7a-d8f8-a9de-fffbff0b0000"}] },
    { text: "Iran's Kharazi (CNN): prepared for 'long war,' only ends through 'economic pain.' IRGC declared 'energy war' — threatened 'not one liter of oil' from Gulf.", why: "Iran explicitly positioning energy prices as its primary weapon. Combined with ceasefire rejection, Iran's strategy is attrition through global economic pain, not military victory.", category: "political", goalIds: ["sco-exit", "en-oil"], sources: [{t:"CNN-Kharazi",u:"https://www.cnn.com/2026/03/09/middleeast/iran-long-war-kamal-kharazi-interview-intl"}] },
    { text: "Pentagon: $5.6B munitions in first 2 days, $6B total first week. Supplemental budget request expected this week — potentially tens of billions.", why: "Cost transparency = political vulnerability. $6B/week is $312B annualized. No supplemental authorized. Congress hasn't voted on funding. Money is the structural constraint, not military capability.", category: "political", goalIds: ["sco-time"], sources: [{t:"WaPo-Cost",u:"https://www.washingtonpost.com/national-security/2026/03/09/iran-war-cost/"},{t:"DefOne",u:"https://www.defenseone.com/threats/2026/03/the-d-brief-march-09-2026/411979/"}] },
    { text: "Lebanon proposed direct peace talks with Israel at ministerial level in Cyprus — both US and Israel rejected. 486-500+ killed, 1.15M displaced in Lebanon.", why: "Lebanon genuinely desperate but powerless. Israel rejecting even an ally's peace overture signals maximalist posture. Lebanon cannot stop Hezbollah and the world cannot stop Israel.", category: "political", goalIds: ["hez-leb", "hez"], sources: [{t:"Axios-Lebanon",u:"https://www.axios.com/2026/03/09/lebanon-israel-hezbollah-peace-talks"}] },
    { text: "Hezbollah hitting 135-160 km deep into Israel — Rehavam Camp (Ramla) + satellite station (Elah Valley). 16 injured. 223 total attack waves since Mar 2.", why: "Range expansion means Hezbollah can now reach most of Israel's populated center. 223 waves in 7 days = 30+/day pace, sustained and intensifying, not weakening.", category: "military", goalIds: ["hez-rocket", "hez"], sources: [{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Alma-D10",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-9-2026-1800/"}] },
  ],
  watchNext: [
    { text: "G7 oil reserves release — Tuesday meeting. US wants 300-400M bbl joint release. France: 'not there yet'", why: "If released, could push oil below $100 temporarily. If not, $4 gas locks in. The G7 decision is the single biggest near-term variable for US domestic politics.", category: "economic", timeframe: "24-48h", sources: [{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/09/iran-war-g7-energy-minister-oil-reserves.html"}] },
    { text: "Pentagon supplemental budget request — tens of billions to Congress. Congressional reaction = first real funding vote on war", why: "Congress hasn't authorized or funded this war. A supplemental forces every member to vote yes or no on sustaining operations. War Powers failed, but money is different.", category: "political", timeframe: "this week", sources: [{t:"WaPo-Cost",u:"https://www.washingtonpost.com/national-security/2026/03/09/iran-war-cost/"}] },
    { text: "Houthi silence Day 10+ — endorsed Mojtaba, pledged attacks, but still no confirmed strikes. Each day = strategic win", why: "Houthi entry with oil at $102 would close Red Sea + double shipping crisis. Their rhetoric is escalating but actions remain restrained. Watch for gap between words and launches.", category: "military", timeframe: "this week", sources: [{t:"ToI-Houthi",u:"https://www.timesofisrael.com/liveblog_entry/yemens-houthis-hail-new-iran-supreme-leader-choice-as-resounding-blow-for-enemies/"}] },
    { text: "'Death to Mojtaba' chants geolocated in Tehran (LiveUAMap) — still unverified by major wire. IRGC dismantled armed group in Kurdistan", why: "If anti-Mojtaba protests confirmed AND armed resistance emerging simultaneously, regime consolidation narrative collapses. Two data points now, not one.", category: "regime", timeframe: "24-48h", sources: [{t:"LiveUAMap",u:"https://iran.liveuamap.com/en/2026/9-march-07-death-to-mojtaba-khamenei-heard-in-tehran-overnight"},{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"}] },
    { text: "Turkey Article 5 — second BM intercepted, debris in Gaziantep (93 mi from Incirlik). US ordered departure from SE Turkey", why: "Debris landing near Incirlik (where US nukes widely believed stored) raises the stakes exponentially. If Turkey invokes Article 5, this becomes a formal NATO war.", category: "political", timeframe: "this week", sources: [{t:"Bloomberg-Turkey",u:"https://www.bloomberg.com/news/articles/2026-03-09/nato-intercepts-second-ballistic-missile-fired-toward-turkey"}] },
    { text: "Ground troops debate — Trump 'nowhere near' deciding, but CNN: 7 officials say HEU seizure needs 'significant' ground forces", why: "The gap between 'special forces raid' framing and actual requirement for 'significant ground forces' is the next political tripwire. If troops go in, the war fundamentally changes.", category: "military", timeframe: "this week", sources: [{t:"NPR-Trump",u:"https://www.npr.org/2026/03/09/nx-s1-5742591/trump-press-conference-as-u-s-israel-led-iran-war-enters-second-week"},{t:"Axios-SF",u:"https://www.axios.com/2026/03/08/iran-ground-troops-special-forces-nuclear"}] },
  ],
  watchResolved: [
    { text: "Oil settle price", resolved: "CORRECTED: WTI settled $101.97, Brent $103.47. Initial $109 report was intraday, not settlement. Still above $100 structurally.", status: "confirmed" },
    { text: "8th US death", resolved: "CLARIFIED: CENTCOM confirmed 7 combat KIA (Sgt. Pennington latest). 8th death was National Guard medical emergency in Kuwait — not combat. Count depends on definition.", status: "partial" },
    { text: "Iran ceasefire response", resolved: "REJECTED: Araghchi + Kharazi both confirmed — Iran prepared for 'long war,' only ends through 'economic pain.'", status: "confirmed" },
    { text: "Oil sustaining above $100?", resolved: "YES: WTI $101.97 settle. Pulled back from $119 panic but structurally above $100. G7 reserves decision Tuesday is the next test.", status: "confirmed" },
    { text: "Macron Cyprus coalition", resolved: "PROGRESSING: Macron visited. France deploying 8 warships + carrier. Building European Strait escort framework.", status: "ongoing" },
    { text: "Houthi decision point", resolved: "Day 10+ without entry. Endorsed Mojtaba, pledged attacks, but no confirmed strikes. Restraint continues.", status: "ongoing" },
    { text: "SF uranium seizure", resolved: "STALLED: Trump 'nowhere near' deciding. CNN: 7 officials say needs 'significant' ground forces, not just special ops.", status: "ongoing" },
    { text: "Lebanon peace overture", resolved: "REJECTED: Lebanon proposed direct talks via Tom Barrack. Israel rejected. US skeptical.", status: "confirmed" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 10 evening: IDF claims 1,900+ Iranian soldiers/commanders killed since Feb 28 (Brig. Gen. Defrin: 'we have many more targets'). IRGC Air Force HQ + Space/Satellite Command destroyed. 50 ammunition bunkers destroyed. 10/17 Artesh airbases struck. 30+ Iranian ships sunk. 75% of missile launchers destroyed (CTP-ISW assessment). Shahed Aviation Industries Production Facility (Isfahan) struck. Hegseth: 'accelerating, not decelerating' — previewed gravity bombs with 'nearly unlimited stockpile.' Pentagon: $5.6B munitions in first 2 days, $6B first week. Campaign succeeding against missiles, struggling against drones.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Haaretz-D10",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-09/ty-article-live/u-s-servicemember-dies-of-wounds-bringing-total-killed-to-7-centcom-says/0000019c-cf7a-d8f8-a9de-fffbff0b0000"},{t:"WaPo-Cost",u:"https://www.washingtonpost.com/national-security/2026/03/09/iran-war-cost/"}],
    subgoals:[
      { id:"mis-fixed", name:"Destroy fixed missile launch sites", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Day 10 evening: IRGC AIR FORCE HQ DESTROYED + IRGC Space and Satellite Command destroyed + 50 ammunition bunkers destroyed. 10 of 17 Artesh Air Force tactical airbases struck since Feb 28 + 3 of 6 Ground Forces Aviation bases. 12+ munitions dropped on 8th Tactical Airbase (Isfahan). Badr Base (Isfahan) confirmed damaged: runway + SAM site. Vehicle inspection center in Zanjan struck — contained hidden missile launcher. 75% of launchers destroyed (CTP-ISW). Abolghasem Babaeian (SL military chief) + Haj Ali Hashem (senior IRGC, Isfahan) eliminated.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Haaretz-D10",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-09/ty-article-live/u-s-servicemember-dies-of-wounds-bringing-total-killed-to-7-centcom-says/0000019c-cf7a-d8f8-a9de-fffbff0b0000"},{t:"ToI-D10",u:"https://www.timesofisrael.com/liveblog-march-9-2026/"}] },
      ...
      { id:"mis-drone", name:"Destroy drone production & launch sites", party:"both", type:"achieve", importance:4, achievability:3, status:"in progress", outcomeNote:"Day 10: SHAHED PRODUCTION FACILITY STRUCK — Shahed Aviation Industries (Isfahan) hit, produces Shahed-136/129/171 drones. Ali Akbar Drone Base (Ahvaz) runway cratered. IRGC Drone Command HQ targeted. UAE cumulative: 1,440 drones launched, 1,359 intercepted (94.4%). Cluster munition warheads now confirmed — 1 Israeli civilian killed, multiple injured. 174 total Iranian attack waves on Israel since Feb 28. CENTCOM civilian warning — Iran using populated areas as launch sites. Drone factories distributed but key production node (Shahed Industries) now hit.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"GulfNews-D10",u:"https://gulfnews.com/world/mena/usisrael-war-on-iran-day-10-mojtaba-khamenei-named-supreme-leader-gulf-states-face-new-attacks-1.500467987"},{t:"Alma-D10",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-9-2026-1800/"}] },
      { id:"mis-c2", name:"Destroy missile command & control", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Day 10: IRGC AIR FORCE HQ DESTROYED + IRGC Space and Satellite Command destroyed. 12+ Basij regional bases struck in Tehran. Greater Tehran Law Enforcement Command Relief Unit struck. Sahab Pardaz Company (censorship/surveillance tools) struck — new target category. 9 BM barrages launched at Israel Mar 8-9 = staggered strategy continues but C2 capacity diminishing. IDF: 1,900+ Iranian commanders/soldiers killed. C2 systematically degraded — internal security infrastructure now being dismantled alongside military.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Haaretz-D10",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-09/ty-article-live/u-s-servicemember-dies-of-wounds-bringing-total-killed-to-7-centcom-says/0000019c-cf7a-d8f8-a9de-fffbff0b0000"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"hor-energy", name:"Prevent global energy crisis", party:"us", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Day 10: CRISIS DEEPENING — WTI spiked ~$119 intraday Monday, settled ~$109.30. Kospi -8% (worst since 2020), Nikkei -7%. Bahrain Bapco force majeure = another Gulf producer offline. ~9M bbl/day off market. Qatar $150 warning increasingly credible. EU TTF gas still elevated. Gold record. Supertanker rates record. The question is no longer 'will there be a crisis' but 'how deep and how long.'", sources:[{t:"Reuters-Oil",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"},{t:"Bloomberg-Markets",u:"https://www.bloomberg.com/news/articles/2026-03-09/global-markets-crash-iran-war-oil-spike"},{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"}] },
    ]
  },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 10 evening: HEZBOLLAH STRIKING 135-160 KM DEEP — 'high-quality missiles' hit IDF Rehavam Camp (Ramla, ~135km) + satellite station (Elah Valley, ~160km). 16 injured in Ramla/Mateh Yehuda. Nasr Unit Commander Abu Hussein Ragheb killed. 223 total attack waves since Mar 2. 120+ Hezbollah targets struck in past day. Second helicopter raid into Bekaa — Hezbollah claims downed one (unconfirmed). LEBANON PROPOSED DIRECT PEACE TALKS with Israel via US — Israel rejected. 486-500+ killed in Lebanon, 1.15M displaced. Hezbollah pledged allegiance to Mojtaba.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Axios-Lebanon",u:"https://www.axios.com/2026/03/09/lebanon-israel-hezbollah-peace-talks"},{t:"Alma-D10",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-9-2026-1800/"},{t:"Haaretz-IDF-D10",u:"https://www.haaretz.com/israel-news/2026-03-09/ty-article/two-more-idf-soldiers-killed-in-lebanon"}],
    subgoals:[
      ...
      { id:"hez-leb", name:"Get Lebanon to act against Hezbollah", party:"israel", type:"achieve", importance:3, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Day 10: LEBANON PROPOSED DIRECT PEACE TALKS WITH ISRAEL — approached Tom Barrack (US amb. Turkey), proposed ministerial-level talks in Cyprus. Both US and Israel 'cool and deeply skeptical' — Israel rejected outreach. Lebanese leadership accused Hezbollah of trying to 'collapse' the state. Government declared Hezbollah military activity illegal, banned IRGC. But military court released detained Hezbollah members on minimal bail. Parliament extended own term by 2 years. Lebanon genuinely desperate but unable to control Hezbollah — 486-500+ dead, 1.15M displaced.", sources:[{t:"Axios-Lebanon",u:"https://www.axios.com/2026/03/09/lebanon-israel-hezbollah-peace-talks"},{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"PBS-Lebanon",u:"https://www.pbs.org/newshour/world/lebanese-parliament-extends-term-by-2-years-as-israel-intensifies-attacks-on-lebanon"}] },
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 10: HITTING 160 KM DEEP — 'high-quality missiles' at Rehavam Camp (Ramla, ~135km from border) + 'sophisticated missiles' at IDF satellite station (Elah Valley, ~160km). 16 injured in Ramla/Mateh Yehuda (Magen David Adom). 22 attacks claimed Mar 8-9. Targeted Zeev Air Defense Base (Haifa) + 146th Division HQ (Jaatoun). 223 total attack waves since Mar 2 entry. Mix: 59% rockets/missiles, 37% UAVs. Hezbollah range now covers majority of Israel.", sources:[{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"Alma-D10",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-9-2026-1800/"}] },
    ]
  },
  {
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10: 13 civilians dead — 1 more killed by cluster munition (13th total). 1,900+ injured. 4 IDF soldiers killed total (2 more in Lebanon — Staff Sgt. Or Demry, 20, bringing IDF ground KIA to 4 since fighting restarted). Cluster munitions now the primary lethal threat to Israeli civilians. TA-125 crashed -3.4% on Monday. Attack wave frequency declining but lethality sustained — quality over quantity pattern continues.", sources:[{t:"ToI-D10",u:"https://www.timesofisrael.com/liveblog-march-09-2026/"},{t:"Haaretz-IDF-D10",u:"https://www.haaretz.com/israel-news/2026-03-09/ty-article/two-more-idf-soldiers-killed-in-lebanon"},{t:"Bloomberg-Markets",u:"https://www.bloomberg.com/news/articles/2026-03-09/global-markets-crash-iran-war-oil-spike"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"sco-time", name:"Complete operations within 4-5 weeks", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 10: COST EXPLODING — Pentagon: $5.6B munitions in first 2 days, $6B total first week (~$4B munitions + interceptors). Supplemental budget request expected this week — potentially tens of billions. Trump Doral presser: 'ended soon' but 'haven't won enough.' Hegseth: 'accelerating, not decelerating.' Kharazi: Iran 'prepared for long war.' 82nd Airborne elements on alert. CNN: recovering HEU would require 'significant' ground forces per 7 current/former officials. CSIS: $891M/day. Every timeline signal points to months, not weeks.", sources:[{t:"WaPo-Cost",u:"https://www.washingtonpost.com/national-security/2026/03/09/iran-war-cost/"},{t:"DefOne",u:"https://www.defenseone.com/threats/2026/03/the-d-brief-march-09-2026/411979/"},{t:"CNN-Kharazi",u:"https://www.cnn.com/2026/03/09/middleeast/iran-long-war-kamal-kharazi-interview-intl"},{t:"NPR-Trump",u:"https://www.npr.org/2026/03/09/nx-s1-5742591/trump-press-conference-as-u-s-israel-led-iran-war-enters-second-week"}] },
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 10 evening: OIL CORRECTION — WTI spiked ~$119 intraday but SETTLED $101.97 (+12.2%). Brent settled $103.47 (+11.6%). Still above $100 but not the $109 initially reported. WTI posted biggest weekly gain in history (+35.6%). G7 energy ministers met but 'not there yet' on reserve release — Tuesday follow-up. IRGC declared 'energy war': threatened 'not one liter of oil' from Gulf. Bahrain Bapco force majeure. Kuwait force majeure. ~9M bbl/day off market. Iran's Kharazi on CNN: prepared for 'long war,' only ends through 'economic pain.'", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/09/oil-prices-iran-war-middle-east-us-israel-strait-of-hormuz.html"},{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/09/iran-war-g7-energy-minister-oil-reserves.html"},{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"CNN-Kharazi",u:"https://www.cnn.com/2026/03/09/middleeast/iran-long-war-kamal-kharazi-interview-intl"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 10 evening: PRICE CORRECTION — WTI spiked ~$119 intraday but SETTLED $101.97 (+12.2%). Brent settled $103.47 (+11.6%). Still above $100 but pulled back significantly from panic highs. WTI biggest weekly gain in history (+35.6%). G7 energy ministers met but France's Lescure: 'not there yet' on reserve release — US wants 300-400M bbl joint release (25-30% of 1.2B reserves). Tuesday follow-up meeting scheduled. IRGC declared 'energy war,' threatened 'not one liter of oil' from Gulf. Kharazi (CNN): Iran prepared for 'long war,' only ends through 'economic pain.' Kuwait declared force majeure citing 'almost total absence' of tankers.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/09/oil-prices-iran-war-middle-east-us-israel-strait-of-hormuz.html"},{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/09/iran-war-g7-energy-minister-oil-reserves.html"},{t:"CNN-Kharazi",u:"https://www.cnn.com/2026/03/09/middleeast/iran-long-war-kamal-kharazi-interview-intl"},{t:"Axios-Friction",u:"https://www.axios.com/2026/03/09/us-israel-friction-oil-depot-strikes"}] },
      ...
      { id:"en-pump", name:"Keep US gas prices manageable", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10 evening: OIL SETTLED LOWER THAN FEARED — WTI $101.97 (not $109 as initially reported), but still well above $100. $4 gas approaching: previous $3.41 at $90 oil. G7 'not there yet' on reserve release — Tuesday follow-up. Trump still won't tap SPR. CA already $5+. Summer blend switchover imminent. IRGC 'energy war' declaration + Kharazi 'long war' = Iran explicitly weaponizing energy prices. $4 gas historically the approval-rating cliff for US presidents.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/09/oil-prices-iran-war-middle-east-us-israel-strait-of-hormuz.html"},{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/09/iran-war-g7-energy-minister-oil-reserves.html"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/why-gas-prices-are-going-up-iran-war-chart/"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"gulf-ad", name:"Maintain Gulf air defense effectiveness", party:"us", type:"achieve", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 10: UAE CUMULATIVE — 253 BMs launched (233 intercepted, 92.1%) + 1,440 drones (1,359 intercepted, 94.4%). Qatar: 17 BMs + 6 drones on March 9 — ALL intercepted (100%). Cumulative Qatar: 60+ BMs intercepted. Kuwait: 406 drones + 219 missiles total. Gulf-wide intercept rate ~94%. 11 COUNTRIES now requesting Ukraine's Shahed countermeasures expertise (up from 1). Rates still holding but stocks critical — US 'stonewalling' replenishment. Pentagon: $4B of $6B first-week cost was interceptors + munitions.", sources:[{t:"GulfNews-D10",u:"https://gulfnews.com/world/mena/usisrael-war-on-iran-day-10-mojtaba-khamenei-named-supreme-leader-gulf-states-face-new-attacks-1.500467987"},{t:"ToI-Qatar",u:"https://www.timesofisrael.com/liveblog_entry/iran-fired-17-missiles-and-6-drones-at-qatar-today-all-of-them-intercepted-says-doha/"},{t:"CTP-ISW-D10E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-9-2026"},{t:"MEE-Stonewall",u:"https://www.middleeasteye.net/news/us-stonewalling-requests-gulf-states-replenish-interceptors-sources-say"}] },
      { id:"gulf-infra", name:"Protect Gulf energy infrastructure", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 10: BAHRAIN BAPCO FORCE MAJEURE — refinery operations halted indefinitely after Iranian strikes. 32 injured at Sitra including 2-month-old baby. Water + oil infrastructure now both targeted. US 'dismayed' Israel hit 30 oil depots (exceeding bilateral agreement). Previous: desalination plant, Kuwait airport fuel tanks, Saudi refineries all struck. Energy war fully bilateral. ~9M bbl/day off market.", sources:[{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"AJZ-Sitra",u:"https://www.aljazeera.com/news/2026/3/9/bahrain-sitra-drone-strikes-injure-dozens"},{t:"Axios-Friction",u:"https://www.axios.com/2026/03/09/us-israel-friction-oil-depot-strikes"},{t:"AJZ-Desal",u:"https://www.aljazeera.com/news/2026/3/8/bahrain-says-water-desalination-plant-damaged-in-iranian-drone-attack"}] },
      { id:"gulf-civ", name:"Protect Gulf civilian populations", party:"us", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10 evening: DEATHS MOUNTING — Bahrain Manama residential strike: 1 killed (29yo woman), 8 injured (separate from Sitra/Bapco). Saudi al-Kharj: 2 Bangladeshi nationals killed, 12 injured. UAE: 1 killed + 112+ injured cumulative. Kuwait: 2 border guards killed. Bahrain Sitra: 32 injured incl. 2-month-old. Qatar: 1 Pakistani killed. US ordered departure from Saudi Arabia + SE Turkey — 32,000+ Americans evacuated. Gulf casualties across 9+ countries with civilian infrastructure (water, oil, airports, residential) all targeted.", sources:[{t:"GulfNews-D10",u:"https://gulfnews.com/world/mena/usisrael-war-on-iran-day-10-mojtaba-khamenei-named-supreme-leader-gulf-states-face-new-attacks-1.500467987"},{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"},{t:"AJZ-Sitra",u:"https://www.aljazeera.com/news/2026/3/9/bahrain-sitra-drone-strikes-injure-dozens"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"ter-us", name:"Prevent attacks on US homeland", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10: US ORDERED DEPARTURE FROM SAUDI ARABIA + SE TURKEY — first 'ordered departure' since war started. 32,000+ Americans evacuated from region. US Embassy Riyadh hit by 2 drones. State Dept ordered non-emergency staff + families out. Previous: Oslo embassy explosion, NYC incendiary device, Texas shooting. DHS terrorism risk 'elevated.' Pattern: Oslo → embassy drones → ordered departures = threat materializing across multiple theaters. No mass-casualty event on US soil yet but every indicator escalating.", sources:[{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"},{t:"USEmb-Riyadh",u:"https://sa.usembassy.gov/security-alert-u-s-embassy-riyadh-saudi-arabia-march-9-2026-update-1/"},{t:"BNO-Oslo",u:"https://bnonews.com/index.php/2026/03/loud-bang-reported-near-u-s-embassy-in-oslo-norway/"}] },
