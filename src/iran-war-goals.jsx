...
const HIGHLIGHTS = {
  updatedAt: "2026-03-11T09:30Z",
  keyDevelopments: [
    { text: "IEA approved record 400 million barrel strategic reserve release — largest in IEA history. Brent pulled back from $119.50 peak to ~$90.77; WTI ~$86.01. G7 had deferred days earlier; IEA overrode. But 3 ships struck in Hormuz same day, Ruwais still offline, mines still in water.", why: "IEA release is the biggest economic intervention of the war — but it addresses the demand side (price) not the supply side (Hormuz closure). Oil is below $100 today; whether it holds depends on Hormuz, not reserves.", category: "economic", goalIds: ["en-oil", "en-pump"], sources: [{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"},{t:"AJZ-D12",u:"https://www.aljazeera.com/news/2026/3/11/iran-war-what-is-happening-on-day-12-of-us-israel-attacks"}] },
    { text: "Day 12: 7 named IRGC/LEC generals killed (Day 11). Ilam Province LEC/Basij 'most central assets' dismantled. Simultaneous Tehran + Tabriz IDF+Intel operation. CENTCOM issued formal civilian ports warning — potential Phase 2 signal.", why: "Targeting has shifted from military to internal security apparatus — the forces that suppress protests, not fight wars. LEC Intelligence head killed. If ports warning precedes Bandar Abbas strikes, Phase 2 will directly strangle Iran's import/export economy.", category: "military", goalIds: ["reg-repress", "mis-c2", "nav-mines"], sources: [{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"},{t:"CENTCOM-Ports",u:"https://www.centcom.mil/MEDIA/PRESS-RELEASES/Press-Release-View/Article/4430855/civilians-warned-to-avoid-ports-used-by-iranian-forces/"},{t:"IDF-Ilam",u:"https://x.com/IDF/status/2031417660974497819"}] },
    { text: "Hormuz: 3 commercial ships struck Day 12 — Thai Mayuree Naree (fire, crew evacuated), Japanese One Majesty (damaged), third bulk carrier. UKMTO 17 total incidents. Iran still mining. CENTCOM destroyed entire Soleimani-class — 60+ vessels total.", why: "Mines + ship strikes are compounding the blockade. Even with 16 minelayers sunk, Iran retains 80-90% of small-boat capacity. The 17 UKMTO incidents show Iran's maritime campaign is accelerating, not collapsing.", category: "military", goalIds: ["nav-mines", "nav-ships"], sources: [{t:"CNBC-Ships",u:"https://www.cnbc.com/2026/03/11/cargo-ship-struck-strait-of-hormuz-uk-iran-war.html"},{t:"MilTimes-Class",u:"https://www.militarytimes.com/news/your-military/2026/03/11/us-has-destroyed-entire-class-of-iranian-warships-centcom-commander-says/"}] },
    { text: "Hezbollah 29 attacks in 24 hours — highest of the war. Missile hit SES civilian satellite station near Beit Shemesh: no intercept, no warning siren (IDF: 'isolated failure'). ATGM stocks depleting, appointing 4 deputies per commander. IDF: Lebanon now launching more attacks than Iran.", why: "Hezbollah is adapting — rationing ATGMs (precision), maintaining volume with rockets (area). The satellite station failure (civilian infrastructure, no defense) is a new vulnerability pattern. Lebanon front expanding while Iran front degrades.", category: "military", goalIds: ["hez-rocket", "hez-leb"], sources: [{t:"Fabian-Satellite",u:"https://x.com/manniefabian/status/2031416252770533883"},{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"}] },
    { text: "Hungary, Slovakia, Serbia publicly sided with Tehran over Trump. Russia advising Iran on drone tactics (CNN, unconfirmed). Iranian ceasefire signals: contradictory — Deputy FM says possible; Parliament Speaker Ghalibaf: 'definitely not looking for a ceasefire.'", why: "Three NATO+ European states defecting to Tehran is a concrete coalition fracture. If Russia moves from intelligence to active tactical advising, the 'prevent great power support' goal crosses from expanding to failing. Iran's split ceasefire signals are a negotiation tactic, not a genuine opening.", category: "political", goalIds: ["dip-nato", "dip-russia"], sources: [{t:"FDD-Defect",u:"https://www.fdd.org/analysis/2026/03/11/hungary-slovakia-and-serbia-chose-tehran-over-trump/"},{t:"CNN-D12",u:"https://edition.cnn.com/world/live-news/iran-war-us-israel-trump-03-11-26"}] },
  ],
  watchNext: [
    { text: "CENTCOM ports warning → imminent strikes on Bandar Abbas or other Iranian commercial ports?", why: "A formal pre-strike warning to civilians is Phase 2's equivalent of an Adraee evacuation order. If Bandar Abbas is struck, Iran's ability to receive imports (including Chinese components) collapses — but international law exposure escalates sharply.", category: "military", timeframe: "24-48h", sources: [{t:"CENTCOM-Ports",u:"https://www.centcom.mil/MEDIA/PRESS-RELEASES/Press-Release-View/Article/4430855/civilians-warned-to-avoid-ports-used-by-iranian-forces/"}] },
    { text: "IEA 400M bbl release vs. Hormuz mines/strikes — does oil hold below $100 or do Day 12 ship strikes re-spike prices?", why: "IEA release addresses price but not supply. Three ships struck today. If mines close Hormuz to all transit, reserves release buys weeks, not months. $100 oil will be retested.", category: "economic", timeframe: "24-48h", sources: [{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"}] },
    { text: "Houthis pledged allegiance to Mojtaba as 'Imam' — does believing the regime survives mean permanent non-entry, or can Iran still call them in?", why: "Houthi non-entry remains the single biggest strategic win of the war. Their allegiance pledge suggests they're betting on regime survival — but if Iran explicitly requests their involvement as existential, the calculus changes.", category: "military", timeframe: "this week", sources: [{t:"FP-Houthi",u:"https://foreignpolicy.com/2026/03/11/why-houthis-havent-fired-iran/"}] },
    { text: "~$50B supplemental budget request + Congressional hearings demand", why: "Congress hasn't authorized or funded this war. $5B+ in 11 days. Democrats can't stop the war but can force every member to vote on cost/accountability before midterms.", category: "political", timeframe: "this week", sources: [{t:"CAP-Cost",u:"https://www.americanprogress.org/article/the-trump-administrations-reckless-war-in-iran-has-already-cost-more-than-5-billion/"}] },
    { text: "Hezbollah ATGM depletion rate — at 29 attacks/24hrs with rationing, how many precision strikes remain?", why: "Hezbollah precision strikes (Fateh-110, ATGMs) are the high-value threat; volume rockets are annoyances. When ATGM stocks run out, Hezbollah shifts from targeted to area fire — strategically less dangerous but harder to intercept.", category: "military", timeframe: "open question", sources: [{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"}] },
  ],
  watchResolved: [
    { text: "G7 oil reserves release", resolved: "RESOLVED: IEA approved 400M bbl release — largest in IEA history. G7 had deferred; IEA overrode. Brent from $119.50 peak to ~$90.77.", status: "confirmed" },
    { text: "Day 12 BDA — 'most intense day' aftermath", resolved: "CONFIRMED: Wave 37 fired — IRGC's own 'most intense attack of war.' US/IDF: 5,000+ targets, 11/17 airbases, 7 generals killed. BM launches down 86-90%.", status: "confirmed" },
    { text: "Pentagon supplemental", resolved: "IN PROGRESS: ~$50B request being prepared. $5B+ spent in 11 days. Dems demanding hearings.", status: "ongoing" },
    { text: "Houthi silence", resolved: "Day 12 without entry. Pledged allegiance to Mojtaba as 'Imam.' Stimson: weakened Iran makes entry 'detrimental.' Rhetoric ongoing, action restrained.", status: "ongoing" },
    ...
    { text: "Ruwais refinery restart", resolved: "HALTED: Ruwais still offline after repeated drone hits. Operations halted Day 12.", status: "ongoing" },
    { text: "Lebanon peace overture", resolved: "REJECTED: South Beirut evacuated 'until further notice.' IDF: Lebanon launching more attacks than Iran. 667K+ displaced.", status: "confirmed" },
    { text: "Ground troops debate", resolved: "STALLED: Trump 'nowhere near' deciding. No movement on Day 12.", status: "ongoing" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-repress", name:"Degrade regime's internal repression capability", party:"israel", type:"achieve", importance:3, achievability:4, status:"in progress", outcomeNote:"Day 12: ILAM PROVINCE DECAPITATION + SIMULTANEOUS TEHRAN/TABRIZ OPERATION. IDF struck 'most central assets' of Iran's internal security in Ilam Province: LEC HQ, Intelligence Ministry HQ, IRGC protest-suppression command, special forces HQ, multiple Basij HQs (IDF: 'forces conducting brutal repression during Dec-Jan protests'). Simultaneous IAF+Intel strike on Tehran LEC Special Forces HQ + Tabriz LEC HQ + ballistic missile/artillery HQ + Maraqeh intel police HQ. LEC Intelligence head BGen Rezaian killed. Previous: 12+ Basij bases in Tehran, Sahab Pardaz (censorship tools) struck, LEC HQs across 5+ provinces. Repression capability being systematically dismantled across geographic and functional lines.", sources:[{t:"IDF-Ilam",u:"https://x.com/IDF/status/2031417660974497819"},{t:"IDF-Tabriz",u:"https://x.com/idfonline/status/2031442397897306364"},{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"},{t:"manniefabian",u:"https://x.com/manniefabian/status/2031414691478540785"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"nav-mines", name:"Prevent/clear mine-laying in Hormuz", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"MINES OPERATIONAL + 3 SHIPS STRUCK: Day 12: Three commercial vessels hit near Strait — Thai-flagged Mayuree Naree (fire, crew evacuated), Japanese One Majesty (damaged), third bulk carrier. UKMTO: 17 incidents total since Feb 28. Iran still laying mines; CENTCOM destroyed 16 minelayers but Iran retains 80-90% of small boat/minelayer capacity. CENTCOM issued formal warning Mar 11: civilian ports used by Iranian military forces lose protected status — potential Phase 2 expansion. France announced 'purely defensive' escort mission once intense phase ends. Mine clearance would take weeks-months even after hostilities.", sources:[{t:"CNBC-Ships",u:"https://www.cnbc.com/2026/03/11/cargo-ship-struck-strait-of-hormuz-uk-iran-war.html"},{t:"CNBC-Mines",u:"https://www.cnbc.com/2026/03/11/us-strikes-iran-mine-ships-strait-of-hormuz-war-oil.html"},{t:"CENTCOM-Ports",u:"https://www.centcom.mil/MEDIA/PRESS-RELEASES/Press-Release-View/Article/4430855/civilians-warned-to-avoid-ports-used-by-iranian-forces/"},{t:"CNN-Mines",u:"https://www.cnn.com/2026/03/10/politics/iran-begins-laying-mines-in-strait-of-hormuz"}] },
    ]
  },
  {
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 12: 29 ATTACKS IN 24 HOURS — HIGHEST SINCE WAR START. Hezbollah missile hit civilian SES satellite station near Beit Shemesh — IDF called it 'isolated failure' (no intercept, no warning siren). ATGM stocks depleting — Hezbollah rationing anti-tank guided missiles. Appointing 4 deputies per commander (redundancy against decapitation). IDF firing on Rehavam Camp in Ramla. IDF: Lebanon has launched MORE attacks against Israel over past week than Iran itself. Hezbollah structural resilience adapting to strikes despite Quds Force Lebanon Corps decapitation.", sources:[{t:"Fabian-Satellite",u:"https://x.com/manniefabian/status/2031416252770533883"},{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"},{t:"Haaretz-D12",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-11/ty-article-live/iran-fires-four-barrages-at-israel-idf-launches-wide-scale-attacks-in-tehran/0000019c-daf7-d9b7-a5fd-dfff2a880000"}] },
    ]
  },
  {
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 12: IEA 400M BBL RELEASE — LARGEST IN IEA HISTORY. Brent ~$90.77, WTI ~$86.01 (partially stabilized after release, down from $119.50 Brent peak). IEA approved unanimously — overriding G7 deferral from Day 11. Previously: G7 asked IEA to 'study options'; now IEA acted. BUT: 3 ships struck in Hormuz on Day 12, Ruwais refinery still offline, mines in water. Below $100 for now but Hormuz fundamentals unchanged — 17 UKMTO incidents, ships still striking, Iran still mining. Iran military command threatened $200/barrel.", sources:[{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"},{t:"AJZ-D12",u:"https://www.aljazeera.com/news/2026/3/11/iran-war-what-is-happening-on-day-12-of-us-israel-attacks"},{t:"ToI-D12",u:"https://www.timesofisrael.com/liveblog-march-11-2026/"}] },
