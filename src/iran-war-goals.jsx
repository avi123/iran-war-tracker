...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      { id:"mis-fixed", name:"Destroy fixed missile launch sites", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"IDF: 300+ launchers destroyed (IDF Hebrew tweet, Mar 5). 113 IDF strike waves completed. ~200 targets hit in western/central Iran in single broad wave. UAE BM data: 137→28→9→12→3→7→(D7 TBD). Iran→Israel attack waves: 148 total (D1:25, D2:64, D3:25, D4:9, D5:11, D6:9, D7:5 through noon). Kish Island radars struck (Vahid OSINT — radar + maritime watchtower). Parchin military-industrial complex struck evening Mar 5. 90%+ Gulf interception rates holding.", sources:[{t:"IDF-Hebrew",u:"https://x.com/idfonline/status/2029563609353703542"},{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/04/why-irans-ballistic-missile-launches-are-declining/"},{t:"Vahid-Kish",u:"https://x.com/Vahid/status/2029584971933851890"},{t:"Vahid-Parchin",u:"https://x.com/Vahid/status/2029600023650963459"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-repress", name:"Degrade regime's internal repression capability", party:"israel", type:"achieve", importance:3, achievability:4, status:"in progress", outcomeNote:"IDF + US SYSTEMATICALLY HITTING INTERNAL SECURITY: Shahriar police command HQ struck (IranIntl video). Fardis Basij base in Alborz province destroyed (IranIntl). Robat Karim police station #11 struck (hey_itsmyturn OSINT). IDF broad waves targeting IRGC services and internal security force HQs in southeastern Tehran. Systematic degradation of regime's repression apparatus expanding to suburban police/basij infrastructure. But 120hr+ internet blackout also prevents organizing opposition. Degrading repression AND communication simultaneously." },
  ...
  },
  {
    ...
    subgoals:[
      { id:"nav-ships", name:"Sink Iranian warships", party:"us", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"30+ SHIPS DESTROYED: CENTCOM video (Mar 5) confirms Shahid Bagheri drone carrier (40,000-ton converted container ship, commissioned Feb 2025) sunk in opening hours. 11 naval vessels destroyed in initial phase including IRIS Jamaran, IRIS Dena (torpedoed off Sri Lanka — 100+ missing, 87 bodies recovered). Soleimani-class corvette IRIS Shahid Sayyad Shirazi struck at Bandar Abbas. IRIS Bushehr interned by Sri Lanka (first warship internment since WWII). Hegseth: 'quiet death' — first US torpedo kill since WWII. Cooper: 'Today they have ZERO.' Iran's conventional navy effectively annihilated.", sources:[{t:"NavalNews",u:"https://www.navalnews.com/naval-news/2026/03/centcom-releases-footage-showing-strike-on-irans-drone-carrier/"},{t:"NavyTimes",u:"https://www.navytimes.com/news/2026/03/05/us-has-destroyed-iranian-drone-carrier-centcom-commander-says/"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"gp-china", name:"Prevent Chinese military support to Iran", party:"both", type:"avoid", importance:5, achievability:4, status:"in progress", outcomeNote:"MOVING BEYOND RHETORICAL: HQ-9B destroyed = humiliation. 1 Chinese citizen killed = leverage. NEW: JPost reports China in talks with Iran for safe oil/gas passage through Hormuz — energy-focused, not military, but signals deepening economic alignment. US Treasury issued 30-day waiver for Indian refineries to buy Russian oil — pressure valve suggesting US aware of energy alliance risks. No Chinese weapons to Iran yet. Watch: arms resupply, intel sharing (Russia already providing), energy guarantees.", sources:[{t:"JPost",u:"https://www.jpost.com/middle-east/iran-news/article-889028"}] },
      { id:"gp-russia", name:"Prevent Russian military support to Iran", party:"both", type:"avoid", importance:4, achievability:4, status:"at risk", trend:"expanding", outcomeNote:"INTELLIGENCE SHARING CONFIRMED: WaPo (Mar 6): Russia providing Iran real-time intelligence on US warship and aircraft locations — 'pretty comprehensive effort' per US official. Not weapons yet, but targeting data. Iran has few military satellites; Russian data filling critical ISR gap. May explain accuracy of some Iranian strikes (Riyadh embassy, early warning radars). Moscow publicly calls strikes 'unprovoked aggression' while covertly enabling Iranian targeting. Peskov: Iran has NOT requested weapons. But intelligence cooperation = de facto co-belligerence. Key escalation threshold: weapons resupply request if missile stocks (down 90%) run dry.", sources:[{t:"WaPo",u:"https://www.washingtonpost.com/national-security/2026/03/06/russia-iran-intelligence-us-targets/"},{t:"Siasat",u:"https://www.siasat.com/live-us-israel-attack-iran-day-6-3424183/"}] },
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:12 }}>
          <div>
            ...
            <div style={{ fontSize:11, color:C.textDim, marginTop:4 }}>
              ...
              <span style={{color:C.oppose}}>■</span> Opposing &nbsp;|&nbsp; Day 7 — Hour 180+ — March 6, 2026 — Evening Update
            </div>
          </div>
