...
const HIGHLIGHTS = {
  updatedAt: "2026-04-11T15:54Z",
  keyDevelopments: [
    { text: "ISLAMABAD TALKS UNDERWAY — First direct US-Iran talks since 1979. VP Vance + Kushner leading US delegation; Ghalibaf (71-person team) + Araghchi for Iran. Pakistan PM Sharif mediating. Immediate impasse: Ghalibaf set preconditions (Lebanon ceasefire + frozen asset release) before substantive talks. Trump: 'they have no cards,' 'no nuclear weapon is 99% of the deal.' Iran claims US agreed to release frozen assets — unconfirmed by US side. FDD: US 'completely discarded' Iran's 10-point proposal. Arms Control Association: US negotiators 'ill-prepared for serious nuclear talks.'", why: "The highest-level US-Iran diplomatic engagement since 1979 is happening but deadlocked on preconditions before substance. Ghalibaf's demands may be performative (for domestic hardliner audience) or genuine. Vance personally attending signals serious US commitment. But structural gap remains: zero enrichment vs enrichment rights has no visible compromise formula. With 10 days until ceasefire expiry, process is consuming time that could be spent on substance.", category: "political", goalIds: ["nuke", "sco-exit", "all-oman"], sources: [{t:"CNN-Islamabad",u:"https://www.cnn.com/2026/04/09/asia/pakistan-islamabad-talks-us-iran-ceasefire-intl-hnk"},{t:"CNBC-Talks",u:"https://www.cnbc.com/2026/04/10/iran-war-vance-negotiations-trump-oil-hormuz-strait.html"},{t:"Haaretz-NoCards",u:"https://www.haaretz.com/middle-east-news/iran/2026-04-10/ty-article/iran-urges-lebanon-cease-fire-asset-release-as-trump-says-they-have-no-cards/0000019d-7852-d759-ab9d-79dbcd0f0000"},{t:"FDD-Discarded",u:"https://www.fdd.org/analysis/2026/04/09/ceasefire-with-tehran-doesnt-guarantee-peace/"}] },
    { text: "LEBANON DEATH TOLL ~1,950 — 'Operation Eternal Darkness' April 8: 50 jets, 160 bombs, 100 targets in 10 minutes, 357 killed (1,223 injured). Civilian/militant ratio disputed — IDF claimed 180 Hezbollah among dead, observers note strikes hit commercial zones during rush hour without warning. IDF killed 8 Lebanese security personnel April 10. IDF taking Bint Jbail (98th Division). Israel excluded France from Lebanon talks. Israel Hayom: 'Lebanon will determine the fate of the campaign.' Ghalibaf's Lebanon ceasefire precondition is the primary diplomatic friction point.", why: "Lebanon is the active war while Iran pauses, and now the primary threat to Islamabad talks. Cumulative toll (~1,950 killed, 6,300+ wounded) approaching Hezbollah 2006 levels. The Trump-Netanyahu scale-back tension is the first visible coalition fracture on theater management. If Iran walks out of Islamabad citing Lebanon, Israel's theater decoupling trades tactical Hezbollah gains for strategic failure on the nuclear deal.", category: "military", goalIds: ["hez", "hez-rocket", "hez-ground", "sco-theater"], sources: [{t:"Wikipedia-Apr8",u:"https://en.wikipedia.org/wiki/8_April_2026_Lebanon_attacks"},{t:"ToI-Apr10",u:"https://www.timesofisrael.com/liveblog-april-10-2026/"},{t:"IsraelHayom-Lebanon",u:"https://www.israelhayom.com/2026/04/10/lebanon-will-determine-the-fate-of-the-campaign/"}] },
    { text: "ENRICHMENT DEADLOCK TOTAL — Iran's nuclear chief Eslami publicly rejected ALL enrichment restrictions: 'demands to restrict Iran's enrichment programme are merely wishes that will be buried.' Trump: 'no nuclear weapon is 99% of the deal.' US proposal: hand over HEU + dismantle enrichment. Iran position: enrichment is sovereign right, non-negotiable. Positions have zero overlap. Fordow undamaged. 440 kg HEU unverifiable. IAEA: zero access since Day 1.", why: "The nuclear impasse went from 'difficult' to 'structurally incompatible' with Eslami's blanket rejection. This isn't a negotiating position — Eslami is IRGC-aligned, and his statement signals the hardliner faction will block any enrichment compromise. Even if Ghalibaf's team wants to negotiate, the IRGC controls the nuclear program. This is the most likely point of failure for Islamabad talks.", category: "political", goalIds: ["nuke", "nuke-fordow", "nuke-breakout"], sources: [{t:"Euronews-Eslami",u:"https://www.euronews.com/2026/04/09/iran-rules-out-any-restrictions-on-its-enrichment-programme-nuclear-chief-says"},{t:"AJZ-RedLine",u:"https://www.aljazeera.com/news/2026/4/8/white-house-says-trumps-red-line-against-iran-nuclear-enrichment-remains"},{t:"Townhall-99pct",u:"https://townhall.com/tipsheet/scott-mcclallen/2026/04/10/trump-no-nuclear-weapon-is-99-percent-of-iran-deal-talks-n2674277"}] },
    { text: "HORMUZ MINE CRISIS — NYT/Haaretz: Iran cannot find or remove its own mines in the Strait. Only 4 tanker transits/day vs 135 normal. 400+ tankers anchored outside Gulf. Iran's parliament legislating toll system in rials, banning 'hostile' shipping. EU warned of airport jet fuel crunch within 3 weeks. IRGC using ceasefire to tighten Hormuz grip. Even good-faith reopening faces physical obstacles — mines are uncontrolled.", why: "This is the most significant Hormuz revelation since the war began. The mine problem transforms Hormuz from a leverage question (Iran choosing to block) to a capability question (Iran unable to unblock even if willing). Ceasefire's centerpiece economic deliverable is now physically impossible to deliver on the ceasefire's timeline. EU fuel crunch adds a new pressure point.", category: "economic", goalIds: ["hor-open", "en-oil", "hor-insurance", "en-gas"], sources: [{t:"Haaretz-Mines",u:"https://www.haaretz.com/israel-news/israel-security/2026-04-10/ty-article-live/report-iranian-delegation-arrives-in-pakistan-for-talks-with-u-s-envoys/0000019d-751e-d759-ab9d-7d9f5c630000"},{t:"CNBC-4Ships",u:"https://www.cnbc.com/2026/04/09/tankers-return-to-hormuz-ceasefire-disruption-to-last-weeks.html"},{t:"CNBC-JetFuel",u:"https://www.cnbc.com/2026/04/10/jet-fuel-shortage-european-airports-strait-of-hormuz.html"}] },
    { text: "CENTCOM: 'GENERATIONAL MILITARY DEFEAT' — Admiral Cooper: 13,000+ strikes, 50,000+ US troops, '40-year military build-up crushed in under 40 days.' 70%+ BM launchers disabled. BUT: China preparing MANPADs (shoulder-fired anti-air missiles) shipment to Iran routed through third countries (CNN exclusive). Kuwait intercepted 7 hostile drones in 24 hours during ceasefire — proxy forces still active. Haaretz: 'Trump wants out and Netanyahu is extremely disappointed.'", why: "Two contradictory signals in one cycle. CENTCOM declares victory while China resupplies Iran and proxy forces continue operations during ceasefire. Cooper's assessment is info-war framing — impressive numbers but 'generational defeat' of conventional forces doesn't address Iran's asymmetric leverage (Hormuz mines, proxies, enrichment). China MANPADs represent the conflict's first direct state-to-state arms transfer TO Iran — a significant escalation threshold.", category: "military", goalIds: ["missile", "mis-supply", "mil-degrade"], sources: [{t:"Breitbart-Cooper",u:"https://www.breitbart.com/politics/2026/04/09/centcom-chief-iran-has-suffered-a-generational-military-defeat-40-year-military-build-up-crushed-in-under-40-days/"},{t:"CNN-ChinaMANPADs",u:"https://www.cnn.com/2026/04/11/politics/us-intelligence-iran-china-weapons"},{t:"KuwaitArmy-Drones",u:"https://x.com/KuwaitArmyGHQ/status/2042614875545899315"},{t:"Haaretz-WantsOut",u:"https://www.haaretz.com/israel-news/podcasts/2026-04-09/ty-article-podcast/amos-harel-on-iran-cease-fire-trump-wants-out-netanyahu-is-disappointed/0000019d-72f5-df41-adff-73f5d2100000"}] },
    { text: "REGIME FRACTURE NOW PHYSICAL — Basij members stoned FM Araghchi outside Foreign Ministry, protesting his Islamabad participation. Hardliner rally against Ghalibaf: 'Curse you if you trample on the blood of the Leader.' Pezeshkian: 'Iran will never abandon Lebanon.' OpIndia: IRGC described as 'de facto ruler' — Mojtaba absent 35+ days. Internet blackout 41+ days (960+ hours). Iranians celebrated ceasefire in streets. 857 schools, 32 universities, 338 hospitals damaged/destroyed (NPR). US CPI surged to 3.3% — war-driven inflation.", why: "The Araghchi stoning is extraordinary — Basij physically attacking a sitting FM signals the IRGC/hardliner faction will use intimidation against the diplomatic track. The regime is fractured into two camps with irreconcilable positions, and the faction that controls the military is opposing the faction doing the negotiating. This makes any Islamabad agreement structurally unreliable — even if Ghalibaf signs something, can IRGC compliance be ensured?", category: "regime", goalIds: ["regime", "reg-succession", "reg-irgc-cohesion"], sources: [{t:"Araghchi-Stoned",u:"https://x.com/MohamadAhwaze/status/2042391712715125050"},{t:"IranIntl-Rally",u:"https://x.com/IranIntl/status/2042146425849684395"},{t:"NPR-Infrastructure",u:"https://www.npr.org/2026/04/10/g-s1-117013/trump-iran-strait-of-hormuz"},{t:"CBS-CPI",u:"https://www.cbsnews.com/news/cpi-report-today-march-2026-inflation-iran-war-trump/"}] },
  ],
  watchNext: [
    { text: "ISLAMABAD TALKS OUTCOME — Preconditions deadlocked (Lebanon ceasefire + frozen assets). Can shuttle diplomacy break through to substance on enrichment? Iran's SNSC: talks could continue 15 days. No agreements as of Day 44.", why: "If talks produce even a process agreement to extend ceasefire, that's a win. If they collapse on preconditions without reaching nuclear substance, resumption at Day 54 with Iran partially recovered, War Powers at ~7 days, and no Plan B. Watch for: Ghalibaf dropping preconditions vs Iran walking out citing Lebanon.", category: "political", timeframe: "24-48h", sources: [{t:"CBS-NoAgreement",u:"https://www.cbsnews.com/live-updates/iran-war-trump-strait-of-hormuz-israel-ceasefire-talks/"},{t:"CNBC-Talks",u:"https://www.cnbc.com/2026/04/10/iran-war-vance-negotiations-trump-oil-hormuz-strait.html"}] },
    { text: "CHINA MANPADs DELIVERY TIMELINE — US intel: China routing shoulder-fired anti-air missiles to Iran through third countries, arriving 'within weeks.' China denied. First direct state-to-state arms transfer to Iran during the war.", why: "MANPADs threaten low-flying aircraft and helicopters — relevant if ground operations begin or if special forces attempt HEU seizure. More importantly, the transfer crosses a great-power escalation threshold. US response (sanctions? interception?) will signal whether China faces consequences for arming Iran during active conflict.", category: "military", timeframe: "this week", sources: [{t:"CNN-ChinaMANPADs",u:"https://www.cnn.com/2026/04/11/politics/us-intelligence-iran-china-weapons"},{t:"Militarnyi-MANPADs",u:"https://militarnyi.com/en/news/cnn-china-to-supply-iran-with-manpads/"}] },
    { text: "CEASEFIRE EXPIRY ~APRIL 21 + WAR POWERS ~APRIL 28 — 10 days to ceasefire deadline, 17 to War Powers. If Islamabad talks extend beyond ceasefire window, does the pause hold? Congress returns from recess next week. $200B supplemental still dead.", why: "The twin clocks are the binding constraint on everything. If talks succeed, both become moot. If talks fail: only 7 days of fighting before authorization required. The question is whether talks produce a ceasefire extension even without substantive agreement — process success vs substance failure.", category: "political", timeframe: "this week", sources: [{t:"Axios-WP",u:"https://www.axios.com/2026/03/26/iran-trump-war-powers-vote-house-democrats"},{t:"TheHill-50K",u:"https://thehill.com/policy/defense/5823895-iran-ceasefire-us-central-command-troops/"}] },
    { text: "HORMUZ MINE REMOVAL — Iran physically cannot locate/remove its own mines. Even with political will, Strait reopening faces weeks of minesweeping. EU airports face jet fuel crunch in ~3 weeks. Does US/allied minesweeping begin?", why: "This transforms Hormuz from a negotiation issue to an engineering problem. Iran's inability to clear mines means the ceasefire's economic deliverable cannot be met on the ceasefire's timeline regardless of political outcomes at Islamabad. If allied minesweeping begins unilaterally, it could trigger confrontation with IRGC naval forces.", category: "economic", timeframe: "this week", sources: [{t:"Haaretz-Mines",u:"https://www.haaretz.com/israel-news/israel-security/2026-04-10/ty-article-live/report-iranian-delegation-arrives-in-pakistan-for-talks-with-u-s-envoys/0000019d-751e-d759-ab9d-7d9f5c630000"},{t:"CNBC-JetFuel",u:"https://www.cnbc.com/2026/04/10/jet-fuel-shortage-european-airports-strait-of-hormuz.html"}] },
    { text: "REGIME INTERNAL — Can Ghalibaf's negotiating team deliver IRGC compliance? Basij stoned Araghchi. Hardliner rallies against diplomacy. Mojtaba absent 35+ days. If talks produce a deal, does the IRGC honor it?", why: "The regime fracture means any agreement is only as reliable as IRGC willingness to comply. The Araghchi stoning signals physical intimidation of the diplomatic track. If Ghalibaf signs something in Islamabad that the IRGC won't implement, the deal is worthless — and the US may not discover this until after the ceasefire expires.", category: "regime", timeframe: "open question", sources: [{t:"Araghchi-Stoned",u:"https://x.com/MohamadAhwaze/status/2042391712715125050"},{t:"OpIndia-IRGC",u:"https://www.opindia.com/news-updates/a-silent-coup-in-iran-irgc-takes-over-as-de-facto-ruler-as-rift-with-president-masoud-pezeshkian-deepens-his-authority-sidelined/"}] },
  ],
  watchResolved: [
    { text: "Islamabad talks April 10-11", resolved: "TALKS UNDERWAY BUT DEADLOCKED ON PRECONDITIONS: Vance + Ghalibaf in Islamabad. First US-Iran direct talks since 1979. But Ghalibaf set preconditions (Lebanon ceasefire + frozen assets) creating immediate impasse before substance. No agreements reached as of Day 44. Iran's nuclear chief rejected ALL enrichment restrictions.", status: "ongoing" },
    { text: "Lebanon as ceasefire-killer", resolved: "ESCALATING — NOT YET FATAL TO TALKS: 357 killed April 8 (Operation Eternal Darkness), death toll now ~1,950. Ghalibaf made Lebanon ceasefire a precondition. Iran has not walked out yet — talks still underway. But Lebanon is the primary friction point.", status: "ongoing" },
    { text: "Hormuz re-closure", resolved: "WORSE THAN EXPECTED: Only 4 transits/day. Iran cannot find/remove its own mines (NYT). Toll legislation advancing. EU fuel crunch in 3 weeks. Problem transformed from political (Iran choosing to block) to physical (unable to unblock).", status: "ongoing" },
    { text: "Iran using ceasefire to reconstitute", resolved: "CONFIRMED + CHINA RESUPPLY: China preparing MANPADs shipment routed through third countries (CNN exclusive). Iran hardening during pause. But MANPADs, not integrated air defense — less than feared.", status: "ongoing" },
    { text: "Pezeshkian vs IRGC", resolved: "FRACTURE NOW PHYSICAL: Basij stoned FM Araghchi outside Foreign Ministry. Hardliner rallies against Ghalibaf. IRGC described as 'de facto ruler.' Split is no longer rhetorical — physical intimidation of diplomatic track.", status: "ongoing" },
    { text: "$200B supplemental", resolved: "STILL DEAD: No votes, no timeline. War at $38B+ spent. House Democrats blocked on unanimous consent.", status: "ongoing" },
    { text: "Bab el-Mandeb threat", resolved: "PROXY CEASEFIRE FRAYING: Iraq's Islamic Resistance declared parallel halt but Kuwait intercepted 7 hostile drones in 24 hours during ceasefire. Houthis quiet on Red Sea.", status: "partial" },
    { text: "Ceasefire expiry + War Powers", resolved: "CLOCK TICKING: 10 days to ceasefire expiry (~April 21), 17 to War Powers (~April 28). Talks underway but preconditions consuming limited time.", status: "ongoing" },
  ],
};
...
const AXES = [
  {
    ...
    statusColor: "#F59E0B",
    keyMetric: "41 days",
    keyMetricLabel: "Ceasefire stabilizes regime",
    summary: "Regime fracture now physical: Basij stoned FM Araghchi outside Foreign Ministry for participating in Islamabad talks. Hardliner rallies against Ghalibaf's negotiating role. IRGC described as 'de facto ruler' — Mojtaba absent 35+ days. The regime split has two camps with irreconcilable positions: Ghalibaf/Araghchi (negotiate) vs IRGC/Vahidi (fight on). The faction controlling the military is physically intimidating the faction doing the negotiating. Pezeshkian declared 'Iran will never abandon Lebanon.' Internet blackout 41+ days (960+ hours). 857 schools, 32 universities, 338 hospitals damaged/destroyed. State media framing ceasefire as victory. Islamabad talks test whether diplomatic track can survive hardliner opposition.",
    keyIndicators: [
      { label: "5-man ruling council", value: "Consolidated", detail: "Ejei/Zolghadr/Ghalibaf/Mojtaba/Arafi. Khademi (#2) + Bagheri killed April 6 but replacements reconstituting. Ghalibaf leading diplomatic track. Ceasefire gives regime breathing room.", color: "#F59E0B" },
      { label: "Regime split", value: "Physical violence", detail: "Basij stoned Araghchi outside Foreign Ministry. Hardliner rally: 'Curse you if you trample on blood of the Leader.' Pezeshkian/Ghalibaf (negotiate) vs IRGC/Vahidi (fight on). IRGC controlling military while diplomatic track faces physical intimidation.", color: "#EF4444" },
      { label: "Mojtaba status", value: "Absent 35+ days", detail: "IRGC described as 'de facto ruler' — Mojtaba's absence creating power vacuum. No video/audio. Internet blackout 41+ days (960+ hours). Ceasefire removes immediate survival pressure but governance demands visibility.", color: "#EF4444" },
      { label: "IRGC paradox", value: "De facto ruler", detail: "OpIndia: IRGC has taken over as de facto ruler. IRGC commanders issued defiant warnings despite ceasefire. Nuclear chief (IRGC-aligned) rejected ALL enrichment restrictions. Any Islamabad agreement is only as reliable as IRGC willingness to comply.", color: "#EF4444" },
    ],
    watching: [
      { text: "Can Ghalibaf's team deliver IRGC compliance? Basij stoning Araghchi signals physical opposition to diplomatic track. Any deal is only as reliable as IRGC willingness to implement.", timeframe: "24-48h" },
      { text: "Mojtaba Khamenei absent 35+ days — no video/audio. IRGC filling the vacuum as 'de facto ruler.' Does Mojtaba resurface during talks?", timeframe: "open question" },
  ...
  },
  {
    ...
    summary: "Enrichment deadlock total. Iran's nuclear chief Eslami publicly rejected ALL enrichment restrictions: 'demands to restrict enrichment are wishes that will be buried.' Trump: 'no nuclear weapon is 99% of the deal.' US proposal: hand over HEU + dismantle enrichment. Iran: enrichment is sovereign right, non-negotiable. Positions have zero overlap. Islamabad talks underway but deadlocked on preconditions before reaching nuclear substance. Fordow undamaged and operational. 440 kg HEU unverifiable. IAEA: zero access since Day 1. Arms Control Association: US negotiators 'ill-prepared for serious nuclear talks.' Iran has 10 more days of ceasefire to harden, relocate, or advance program.",
    keyIndicators: [
      ...
      { label: "Enrichment impasse", value: "Total deadlock", detail: "Eslami rejected ALL restrictions. Trump: '99% of the deal.' US demands zero enrichment + HEU handover. Iran: sovereign right. Arms Control Association: US 'ill-prepared.' Positions have zero overlap — structurally incompatible.", color: "#EF4444" },
      { label: "IAEA access", value: "Zero since Day 1", detail: "No inspectors at any facility. Grossi: cannot certify peaceful. Eslami's blanket rejection signals IRGC-aligned faction will block any inspection concessions even if Ghalibaf wanted to offer them.", color: "#EF4444" },
    ],
    watching: [
      { text: "Enrichment at Islamabad — Eslami's blanket rejection signals IRGC blocking. Can Ghalibaf override the nuclear chief? Or is this a coordinated good-cop/bad-cop?", timeframe: "24-48h" },
      { text: "Iran hardening during ceasefire — 10 more days to move HEU, reinforce Fordow. China MANPADs arriving 'within weeks' could protect reconstituted sites from low-altitude attack.", timeframe: "this week" },
      { text: "IAEA access — still zero since Day 1. Any inspection during ceasefire would transform intelligence picture. Eslami's rejection makes voluntary access unlikely.", timeframe: "this week" },
    ],
    goalIds: ["nuke", "hormuz"],
  ...
  },
  {
    ...
    slug: "/attrition/",
    status: "diverging",
    statusLabel: "CEASEFIRE PAUSES CLOCK",
    statusColor: "#F59E0B",
    keyMetric: "14 days",
    keyMetricLabel: "Both sides racing to replenish",
    summary: "Ceasefire pauses Iran-US attrition but both sides racing to improve position. CENTCOM Chief Cooper: 'generational military defeat' — 13,000+ strikes, 70%+ BM launchers disabled. But China rushing MANPADs to Iran (CNN exclusive) and Kuwait intercepted 7 drones during ceasefire — proxy forces active. Iran cannot find/remove its own Hormuz mines — physical obstacle regardless of politics. Lebanon toll rising to ~1,950 killed, depleting Israeli interceptors on that front. Arrow 2/3 ~80% depleted. Oil back above $100 despite ceasefire. US CPI at 3.3%. Both sides racing: Iran to reconstitute with Chinese resupply, US to replenish interceptors. 10 days until ceasefire expiry.",
    keyIndicators: [
      { label: "Iran arsenal", value: "Degraded + resupplying", detail: "Cooper: 'generational defeat.' 70%+ BM launchers disabled. But China rushing MANPADs (CNN). Soufan: 'only partially depleted.' Kuwait 7 drones during ceasefire = proxy forces active. Iran reconstituting during pause.", color: "#F59E0B" },
      { label: "Israel interceptors", value: "~80% depleted", detail: "Arrow 2/3 ~80% expended. Ceasefire pauses Iran depletion but Lebanon front continuing — IDF launched 160 bombs April 8. Replacement 2-3 years. If war resumes, crisis returns immediately.", color: "#EF4444" },
      { label: "Casualties all fronts", value: "~5,900-6,200 killed", detail: "Iran: 3,636 (HRANA), ~6,620 military est. (Hengaw). Lebanon: ~1,950 (up from 1,784). Israel: 19-40. US: 13 KIA, 381 WIA. 857 schools, 338 hospitals damaged in Iran (NPR).", color: "#EF4444" },
      { label: "Oil/economic", value: "Above $100 + CPI 3.3%", detail: "Dated Brent >$120. WTI $94 on ceasefire but recovering. US CPI 3.3% (highest in ~2 years). EU jet fuel crunch in 3 weeks. IEA: 'largest oil supply shock in history.' Iran mines unrecoverable.", color: "#EF4444" },
      { label: "Ceasefire clock", value: "~10 days left", detail: "Expires ~April 21. War Powers ~April 28. Islamabad talks deadlocked on preconditions. Enrichment impasse total (Eslami rejected ALL restrictions). Process consuming time without substance.", color: "#F59E0B" },
    ],
    watching: [
      { text: "Islamabad outcome — talks underway but deadlocked on preconditions. Can substance be reached before ceasefire expires in 10 days?", timeframe: "24-48h" },
      { text: "China MANPADs arrival timeline — first direct state arms delivery to Iran during war. Changes ground ops calculus if special forces attempt HEU seizure.", timeframe: "this week" },
      { text: "Hormuz mine removal — Iran can't find its own mines. Does US/allied minesweeping begin unilaterally? EU fuel crunch in 3 weeks.", timeframe: "this week" },
    ],
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 44: ENRICHMENT DEADLOCK TOTAL — Iran's nuclear chief Eslami publicly rejected ALL enrichment restrictions: 'demands to restrict enrichment are wishes that will be buried.' Trump: 'no nuclear weapon is 99% of the deal.' US 15-point plan demands zero enrichment + HEU handover; Iran insists enrichment is sovereign right. Positions have zero overlap. Islamabad talks underway but deadlocked on preconditions before reaching nuclear substance. Arms Control Association: US negotiators 'ill-prepared for serious nuclear talks.' Fordow undamaged. ~440 kg 60% HEU unverifiable. IAEA: zero access since Day 1. Ceasefire gives Iran 10 more days to harden/relocate.", sources:[{t:"Euronews-Eslami",u:"https://www.euronews.com/2026/04/09/iran-rules-out-any-restrictions-on-its-enrichment-programme-nuclear-chief-says"},{t:"Townhall-99pct",u:"https://townhall.com/tipsheet/scott-mcclallen/2026/04/10/trump-no-nuclear-weapon-is-99-percent-of-iran-deal-talks-n2674277"},{t:"ACA-Unprepared",u:"https://www.armscontrol.org/act/2026-04/features/analysis-us-negotiators-were-ill-prepared-serious-nuclear-talks-iran"},{t:"CSIS-Nuclear",u:"https://www.csis.org/analysis/fragile-us-iran-ceasefire-issues-watch"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 44: 'GENERATIONAL MILITARY DEFEAT' — CENTCOM Chief Admiral Cooper: 13,000+ strikes, 50,000+ US troops, '40-year military build-up crushed in under 40 days.' 70%+ BM launchers disabled (Alma Center). Hegseth: Iran's missile program 'functionally destroyed.' IDF Chief Zamir: Iran 'much weaker,' Israel prepared to return to combat 'at any moment.' BUT: Kuwait intercepted 7 hostile drones in 24 hours during ceasefire — proxy forces still active. China preparing MANPADs (shoulder-fired anti-air missiles) shipment to Iran routed through third countries (CNN exclusive). Cooper's BDA is info-war framing — impressive numbers but independently unverified. Soufan: Iran's arsenal 'only partially depleted.'", sources:[{t:"Breitbart-Cooper",u:"https://www.breitbart.com/politics/2026/04/09/centcom-chief-iran-has-suffered-a-generational-military-defeat-40-year-military-build-up-crushed-in-under-40-days/"},{t:"CNN-ChinaMANPADs",u:"https://www.cnn.com/2026/04/11/politics/us-intelligence-iran-china-weapons"},{t:"KuwaitArmy-Drones",u:"https://x.com/KuwaitArmyGHQ/status/2042614875545899315"},{t:"Soufan-Arsenal",u:"https://thesoufancenter.org/intelbrief-2026-april-6/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 44: REGIME FRACTURE NOW PHYSICAL — Basij members stoned FM Araghchi outside Foreign Ministry, protesting his Islamabad participation. Hardliner rally against Ghalibaf: 'Curse you if you trample on the blood of the Leader.' Pezeshkian: 'Iran will never abandon Lebanon' — publicly linking fronts. IRGC described as 'de facto ruler' — Mojtaba Khamenei absent 35+ days, leaving power vacuum. IRGC commanders issued defiant warnings despite ceasefire. Internet blackout 41+ days (960+ hours). Iranians celebrated ceasefire in streets, framing as victory. 857 schools, 32 universities, 338 hospitals damaged/destroyed (NPR). Iranian hackers leaked ex-IDF chief's private photos. Ceasefire stabilizes regime — but the faction controlling the military is physically intimidating the faction doing the negotiating.", sources:[{t:"Araghchi-Stoned",u:"https://x.com/MohamadAhwaze/status/2042391712715125050"},{t:"IranIntl-Rally",u:"https://x.com/IranIntl/status/2042146425849684395"},{t:"OpIndia-IRGC",u:"https://www.opindia.com/news-updates/a-silent-coup-in-iran-irgc-takes-over-as-de-facto-ruler-as-rift-with-president-masoud-pezeshkian-deepens-his-authority-sidelined/"},{t:"NPR-Infrastructure",u:"https://www.npr.org/2026/04/10/g-s1-117013/trump-iran-strait-of-hormuz"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 42: HORMUZ RE-CLOSED — Iran shut Strait again citing Lebanon strikes, hours after initial tanker transit. 3-4 ships/day vs 135 normal. 800+ vessels trapped (426 crude/fuel tankers, 34 LPG, 19 LNG). Iran collecting $2M/vessel tolls in bitcoin/yuan — free transit for China, Russia, India, Iraq, Pakistan. Cap at 15 vessels/day. IMO: tolls 'dangerous and unacceptable precedent.' UK rejected scheme. IEA: 'largest supply disruption in history of global oil market.' Trump demands Strait open 'without limitation, including tolls.' Maersk/Hapag-Lloyd: normalization weeks to months. UNSC resolution failed (Russia/China vetoed). Macron: ~15 countries working on 'strictly defensive mission.' UKMTO assessment: 'critical.' White House claims Hormuz open — 'contradicted by marine tracking data.'", sources:[{t:"Bloomberg-Tolls",u:"https://www.bloomberg.com/news/articles/2026-04-09/iran-s-hormuz-tolls-would-set-a-dangerous-precedent-imo-says"},{t:"WaPo-Reclosed",u:"https://www.washingtonpost.com/national/2026/04/08/iran-israel-us-lebanon-latest-april-8-2026/5b988e08-3304-11f1-b85b-2cd751275c1d_story.html"},{t:"InsJournal-Ships",u:"https://www.insurancejournal.com/news/international/2026/04/09/865095.htm"}],
    subgoals:[
      { id:"hor-open", name:"Keep Hormuz open during operations", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 44: IRAN CANNOT REMOVE OWN MINES — NYT/Haaretz: Iran has failed to open Strait because it cannot find or remove mines it laid. Only 4 tanker transits/day vs 135 normal. 400+ tankers anchored outside Gulf. Iran's parliament legislating toll system in rials, banning 'hostile' shipping. IRGC using ceasefire to consolidate Hormuz control. EU airports face jet fuel crunch within 3 weeks. UK called for toll-free Hormuz. Analysts: normalization 'weeks, if not months.' Problem transformed from political leverage to physical impossibility on ceasefire timeline. IRGC has conducted 21 confirmed attacks on merchant ships since Feb 28.", sources:[{t:"Haaretz-Mines",u:"https://www.haaretz.com/israel-news/israel-security/2026-04-10/ty-article-live/report-iranian-delegation-arrives-in-pakistan-for-talks-with-u-s-envoys/0000019d-751e-d759-ab9d-7d9f5c630000"},{t:"CNBC-4Ships",u:"https://www.cnbc.com/2026/04/09/tankers-return-to-hormuz-ceasefire-disruption-to-last-weeks.html"},{t:"CNBC-JetFuel",u:"https://www.cnbc.com/2026/04/10/jet-fuel-shortage-european-airports-strait-of-hormuz.html"}] },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 44: LEBANON DEATH TOLL ~1,950 — Up from 1,784 at Day 42. April 8 'Operation Eternal Darkness': 50 jets, 160 bombs, 100 targets in 10 min, 357 killed, 1,223 injured. Civilian/militant ratio disputed — IDF claimed 180 Hezbollah among dead, observers note strikes hit commercial zones without warning. IDF killed Lebanese Resistance Brigade commander + Hezbollah chief's secretary + 8 Lebanese security personnel April 10. IDF gaining control of Bint Jbail (98th Division). Israel excluded France from Lebanon talks. Israel refuses truce before negotiations; Lebanon demands ceasefire first. Israel Hayom: 'Lebanon will determine the fate of the campaign.' Ghalibaf's Lebanon ceasefire precondition = primary Islamabad friction point.", sources:[{t:"Wikipedia-Apr8",u:"https://en.wikipedia.org/wiki/8_April_2026_Lebanon_attacks"},{t:"ToI-Apr10",u:"https://www.timesofisrael.com/liveblog-april-10-2026/"},{t:"JPost-BintJbail",u:"https://www.jpost.com/israel-news/defense-news/article-892493"},{t:"IsraelHayom-Lebanon",u:"https://www.israelhayom.com/2026/04/10/lebanon-will-determine-the-fate-of-the-campaign/"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"sco-exit", name:"Define clear exit criteria", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 44: ISLAMABAD TALKS DEADLOCKED ON PRECONDITIONS — First direct US-Iran talks since 1979 underway but Ghalibaf set preconditions (Lebanon ceasefire + frozen asset release) before substantive discussion. US 15-point plan: zero enrichment, HEU handover, missile limits, proxy rollback, Hormuz open unconditionally. Iran 10-point plan: Hormuz sovereignty including tolls, reparations, frozen assets, durable all-fronts ceasefire. FDD: US 'completely discarded' Iran's 10-point plan. Haaretz: 'Trump wants out and Netanyahu is extremely disappointed.' Iran claims US agreed to release frozen assets (unconfirmed). No agreements reached. War Powers ~17 days. $200B supplemental dead. Ceasefire expires ~April 21 — 10 days left.", sources:[{t:"CNBC-Talks",u:"https://www.cnbc.com/2026/04/10/iran-war-vance-negotiations-trump-oil-hormuz-strait.html"},{t:"FDD-Discarded",u:"https://www.fdd.org/analysis/2026/04/09/ceasefire-with-tehran-doesnt-guarantee-peace/"},{t:"Haaretz-WantsOut",u:"https://www.haaretz.com/israel-news/podcasts/2026-04-09/ty-article-podcast/amos-harel-on-iran-cease-fire-trump-wants-out-netanyahu-is-disappointed/0000019d-72f5-df41-adff-73f5d2100000"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 44: OIL ELEVATED DESPITE CEASEFIRE — WTI dropped 16% to $94.41 on ceasefire announcement but Dated Brent still >$120 (near-record). Markets re-pricing as Hormuz reopening fails — 4 ships/day, mines unrecoverable. US CPI surged to 3.3% annual rate (highest in ~2 years), driven by energy. IEA described this as 'largest oil supply shock in history' — up to 20M bbl/day cut. Brent expected to average $96/bbl for 2026 (Al-Monitor, up from $79 pre-war). Dow +1,300 on ceasefire but gains partially reversed. EU airports face jet fuel crunch within 3 weeks. Ceasefire euphoria evaporating as Hormuz physical obstacles and mine crisis become clear.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/04/09/oil-prices-today-wti-brent-iran-accuse-us-of-ceasefire-breach.html"},{t:"CBS-CPI",u:"https://www.cbsnews.com/news/cpi-report-today-march-2026-inflation-iran-war-trump/"},{t:"CNBC-JetFuel",u:"https://www.cnbc.com/2026/04/10/jet-fuel-shortage-european-airports-strait-of-hormuz.html"}] },
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 44</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Historic talks underway in Islamabad — first direct US-Iran diplomacy since 1979, with VP Vance personally leading.</span> CENTCOM Chief Admiral Cooper assessed a 'generational military defeat': 13,000+ strikes, 50,000+ troops, 70%+ ballistic missile launcher attrition, 73-86% reduction in Iranian launch rates. Iran's air defense gaps severe enough that China is rushing replacement MANPADs (CNN, April 11) — itself an indicator of degradation. Ceasefire validated by military pressure: Iran accepted a pause from a position of weakness. Market reaction positive (Dow +1,300, WTI -16% initially).
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>The US has demonstrated the ability to impose massive conventional costs while sustaining only 13 KIA</span> — a historically favorable exchange ratio across 13,000+ strikes. Iran sent a 71-person delegation to Islamabad, signaling serious engagement. The compellence theory is being tested: air campaign pressure → ceasefire → diplomatic engagement. CAUTION: Cooper's 'generational defeat' is info-war framing, not independently verified BDA. Kuwait intercepted 7 drones during ceasefire — proxy forces remain active. And talks are deadlocked on preconditions, not producing substance.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 44</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Scope expansion is accelerating, not decelerating, during the ceasefire.</span> Israel's 'Operation Eternal Darkness' killed 357 in Lebanon on April 8 — deadliest single day of the Lebanon front — explicitly exploiting the Iran pause to escalate against Hezbollah. Lebanon's cumulative toll has risen to ~1,950 killed. This front is now the primary threat to the ceasefire itself, with Ghalibaf making Lebanon ceasefire a precondition for Islamabad talks. <span style={{color:"#F59E0B",fontWeight:700}}>China preparing MANPADs shipment to Iran</span> (CNN exclusive, April 11) introduces a new great-power arms transfer dimension absent at war's start.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Iran converting the Hormuz blockade from temporary wartime measure into permanent toll system</span> — parliament legislating fees in rials, banning 'hostile' shipping. Iran cannot even find or remove its own mines (NYT/Haaretz), meaning the blockade has physical permanence beyond political will. EU airports face jet fuel disruptions within 3 weeks. US CPI surged to 3.3% (highest in ~2 years). The war's economic and geographic footprint is growing even as kinetic operations between US and Iran have paused. Hezbollah 2006 analogue rising to MEDIUM-HIGH fit for the Lebanon front specifically.
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 44</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are demonstrably failing.</span> (1) <span style={{color:C.red,fontWeight:700}}>Enrichment impasse is total.</span> Iran's nuclear chief Eslami publicly rejected 'ALL restrictions' on enrichment (Euronews, April 9). Trump called zero nuclear weapons '99% of the deal.' These positions have zero overlap — structurally incompatible. Fordow undamaged, 440 kg HEU unverifiable, IAEA has had zero access since Day 1. Arms Control Association: US negotiators 'ill-prepared for serious nuclear talks.' (2) <span style={{color:C.red,fontWeight:700}}>Hormuz physically cannot reopen on ceasefire timeline.</span> Iran cannot locate or remove its own mines (NYT/Haaretz). Only 4 tanker transits/day vs 135 normal. 400+ tankers anchored. Toll system being legislated. EU fuel crunch in 3 weeks.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              (3) <span style={{color:C.red,fontWeight:700}}>Basij physically attacked FM Araghchi</span> for participating in Islamabad talks — the IRGC/hardliner faction will use intimidation against the diplomatic track. Any agreement is only as reliable as IRGC willingness to comply. (4) Islamabad talks deadlocked on preconditions before reaching substance — Ghalibaf demanding Lebanon ceasefire + frozen assets before nuclear discussion. No written ceasefire document. (5) War Powers ~17 days, $200B supplemental dead. US CPI at 3.3% — war-driven inflation hitting consumers. Haaretz: 'Trump wants out and Netanyahu is extremely disappointed.' <span style={{color:C.red,fontWeight:700}}>If talks fail and war resumes at Day 54: Iran partially recovered with Chinese MANPADs, US War Powers at ~7 days, Hormuz mined and unrecoverable, Lebanon at ~1,950 dead. There is no Plan B.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
      ...
      <CollapsibleSection title="Historical Analogues" id="analogues" defaultOpen={false} mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"24px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))", gap:12 }}>
            {[
              { name:"Israel-Hezbollah 2006", fit:"HIGH (7.5)", fitColor:C.green, note:"UPGRADING TO TOP ANALOGUE. Lebanon is now the active war — 254 killed April 8 ('Operation Eternal Darkness'), 6 IDF divisions committed, Haaretz: Hezbollah maintains 'solid hold.' Trump asked Netanyahu to 'scale back' (echoes Bush 2006). IDF says disarmament 'unrealistic.' 1,784 killed, 1M+ displaced. 2006 outcome: Israel declared objectives met, Hezbollah claimed victory, UNSCR 1701 framework nobody enforced. Converging fast. If Lebanon continues to dominate while Iran talks stall, this becomes the primary lens." },
              { name:"Kosovo 1999", fit:"HIGH (7.0)", fitColor:C.green, note:"DOWNGRADING. Ceasefire at Day 40 is NOT 'ahead of Kosovo's Day 78' — these are different things. Kosovo Day 78 = capitulation + Serbian withdrawal. Iran Day 40 = negotiating pause with structurally irreconcilable positions. Kosovo's Day 40 equivalent = late April 1999, when back-channels began but fighting continued and Milosevic was nowhere near capitulating. If Islamabad produces a framework agreement, upgrade to 8.0+. Until then, the comparison overstates progress." },
              { name:"Desert Storm 1991", fit:"MEDIUM (6.5)", fitColor:C.amber, note:"38-day air campaign → ceasefire mirrors timeline. Hegseth's 'decisive victory' echoes Schwarzkopf's briefing structurally — declaring military success while political endgame undefined. Desert Storm's lesson: military success didn't produce political resolution (Saddam survived). Risk: Iran's regime survives ceasefire, reconstitutes key capabilities, nuclear objective unachieved — exactly Desert Storm's outcome with Iraqi WMD." },
              { name:"Osirak 1981", fit:"MEDIUM (5.5)", fitColor:C.amber, note:"UPGRADING. Nuclear dimension is now THE central issue. Fordow intact, 440 kg HEU unverifiable, enrichment is the deal-breaker at Islamabad. CSIS: facilities 'buried beneath tons of rubble' but issue 'fundamentally unresolved.' Iran may be 'redoubling efforts.' Osirak's core lesson — strikes delayed but didn't prevent the program — is directly and immediately relevant. If Islamabad fails to resolve enrichment, this lesson applies fully." },
              { name:"Libya 2011", fit:"MEDIUM (5.0)", fitColor:C.amber, note:"NATO air campaign → degrade without invading. Libya's failure = state collapse without political follow-through. Iran's institutions holding — Pezeshkian publicly challenging IRGC suggests political dynamics functioning, not fracturing. Ceasefire reduces this risk. Petrochemical destruction (85%) parallels Libya's infrastructure degradation but Iran has a diplomatic pathway Libya never had." },
              { name:"June 2025 12-Day War", fit:"LOW (3.5)", fitColor:C.red, note:"Scale divergence overwhelming. Only useful as counterfactual baseline for what 'limited' looked like." },
              { name:"Iraq 2003", fit:"LOW (2.5)", fitColor:C.red, note:"Further demotion. Ceasefire makes this even less relevant. No occupation, no governance burden, bilateral diplomatic track. 'Mission Accomplished' echo (Hegseth press conference) is the only remaining useful element. Structural conditions for Iraq-style failure have no pathway." },
              { name:"Panama 1989", fit:"LOW (2.0)", fitColor:C.red, note:"Terminal. No ground troops, no regime change, bilateral ceasefire. Quick-swap model completely inapplicable." },
            ].map(a => (
