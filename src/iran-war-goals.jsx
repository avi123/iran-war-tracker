...
const HIGHLIGHTS = {
  updatedAt: "2026-03-23T18:00Z",
  keyDevelopments: [
    { text: "TRUMP 5-DAY PAUSE ON POWER PLANT STRIKES — Extended 48-hour Hormuz ultimatum by 5 days (~March 28), citing '15 major points of agreement' and 'very good and productive conversations.' Iran FM Araghchi categorically denied any dialogue: 'no dialogue between Tehran and Washington.' Oman confirmed as mediator. Turkey, Egypt, Pakistan also passing messages. Oil crashed ~14% on pause news — Brent to ~$94/bbl.", why: "First diplomatic signal of the war. Both sides may be technically correct: no direct talks, but indirect channels via Oman/Turkey/Egypt/Pakistan. Markets responded immediately — 14% Brent drop signals traders pricing in resolution possibility. But if the 5-day clock expires without progress, the power plant strike threat returns with credibility eroded.", category: "political", goalIds: ["hormuz", "en-oil", "sco-exit", "all-oman"], sources: [{t:"CNN-Pause",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-23-26"},{t:"Axios-Talks",u:"https://www.axios.com/2026/03/23/trump-suspends-iran-strikes-hormuz-negotiations"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/23/oil-prices-trump-iran-strait-of-hormuz-wti-crude-middle-east-lng-gas.html"},{t:"IranIntl-Deny",u:"https://www.iranintl.com/en/202603234008"}] },
    { text: "'UNPRECEDENTED' IDF STRIKES ON TEHRAN — Wide-scale wave on eastern Tehran (Aghdasieh, Majidiyeh, Chizar), described as 'unprecedented' by AJ correspondent. Struck emergency command center for internal security + Intelligence Ministry HQ. Second round hours later. Continuing systematic decapitation: Intel Minister Khatib killed (March 18), Basij commander Mortazavi-Nasb, 15 senior Basij commanders eliminated.", why: "Strikes now targeting internal security apparatus command nodes, not just military infrastructure. Emergency command center = regime's ability to coordinate domestic control under bombardment. Intelligence Ministry HQ hit weeks after killing the minister. Pattern: destroy the leadership, then destroy the institution.", category: "military", goalIds: ["reg-repress", "reg-irgc-leaders", "mis-c2"], sources: [{t:"AJZ-Unprecedented",u:"https://www.aljazeera.com/news/2026/3/23/unprecedented-israel-us-carry-out-extensive-strikes-across-iran"},{t:"CTP-ISW-D22",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-22-2026"},{t:"JPost-D25",u:"https://www.jpost.com/middle-east/iran-news/article-890846"}] },
    { text: "CENTCOM: 8,000+ TARGETS, 130 VESSELS — Adm. Cooper Day 22 update: 'largest elimination of a navy over a three-week period since WWII.' 8,000+ combat flights. 80-85% of Iran's air defense architecture destroyed. A-10s and Apaches now deployed — strongest signal that CENTCOM assesses air defense threat as neutralized. IDF Chief Zamir: campaign 'approximately halfway through.'", why: "A-10 and Apache deployment is only viable in permissive air environments — their use confirms functional air superiority over Iran. The 130-vessel number represents the near-total destruction of Iran's conventional navy. Zamir's 'halfway' at Day 24 maps to Kosovo's timeline (Day 25 of 78 = 32%). Three more weeks minimum.", category: "military", goalIds: ["navy", "airsup", "mis-fixed", "sco-time"], sources: [{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-21/centcom-cooper-iran-update-day-22-21139708.html"},{t:"TheHill-8K",u:"https://thehill.com/policy/defense/5794604-centcom-brad-cooper-us-military-operation-iran-8k-targets/"},{t:"FDD-Gains",u:"https://www.fdd.org/analysis/2026/03/19/operational-gains-against-iran-continue-but-threats-to-us-forces-persist/"}] },
    { text: "GULF ATTACKS ESCALATING — Saudi intercepted 21 drones + 3 BMs (one targeting Riyadh). 7 drones at Kuwait (4 intercepted, 3 fell in open areas). IRGC claimed targeting US Fifth Fleet base in Manama. UK bulk carrier hit by explosion off Sharjah coast. Ghalibaf on X: Gulf energy infrastructure 'legitimate targets' if power plants hit. IRGC warns: 'If you hit electricity, we hit electricity.'", why: "Iran expanding Gulf attacks despite diplomatic pause. All six GCC states now directly targeted. IRGC framing Gulf infrastructure as reciprocal hostage to power grid targeting — setting up mutual assured destruction of energy infrastructure. 22-nation coalition response = rhetorical so far, no kinetic enforcement.", category: "military", goalIds: ["gulf-protect", "gulf-ad", "gulf-infra", "hor-open"], sources: [{t:"CTP-ISW-D22",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-22-2026"},{t:"AJZ-Live",u:"https://www.aljazeera.com/news/liveblog/2026/3/23/iran-war-live-tehran-vows-to-completely-close-hormuz-if-power-plants-hit"},{t:"TheWeek-Sharjah",u:"https://www.theweek.in/news/middle-east/2026/03/22/us-iran-war-uk-bulk-carrier-vessel-hit-by-explosion-off-uaes-sharjah-coast.html"}] },
    { text: "CASUALTY UPDATE — Iran: 1,330-1,500+ killed (200+ children), 18,000+ injured, 80,000+ buildings damaged. US: 13 KIA, 200+ wounded across 7 countries. Israel: 18 civilians killed, 4,564+ injured (180 in Dimona/Arad alone). Lebanon: 968 killed, 1M+ displaced. CENTCOM chief: Iran targeting civilians 'more than 300 times' out of 'desperation.'", why: "Multi-theater casualty toll continues climbing. The gap between official Iranian figures (1,500) and independent counts (HRANA: 3,220+, Hengaw: 5,300) remains an intelligence failure. US military casualties (13 KIA) now approaching political threshold where individual deaths become named stories. Civilian toll constraining diplomatic options on all sides.", category: "humanitarian", goalIds: ["cas-civ", "cas-us", "cas-isr", "civ-total"], sources: [{t:"CNN-D23",u:"https://www.cnn.com/2026/03/22/middleeast/us-israel-iran-middle-east-war-day-23-what-we-know-intl-hnk"},{t:"FDD-Threats",u:"https://www.fdd.org/analysis/2026/03/19/operational-gains-against-iran-continue-but-threats-to-us-forces-persist/"},{t:"AJZ-Unprecedented",u:"https://www.aljazeera.com/news/2026/3/23/unprecedented-israel-us-carry-out-extensive-strikes-across-iran"}] },
    { text: "HOUTHI ENTRY POSSIBLY IMMINENT — KAN citing regional security officials: Houthis may enter war 'as early as March 23' (post-Eid). Houthis preparing but not yet attacking — reinforcements toward Hodeidah, hospitals established. Houthi politburo member threatened naval blockade. Zero commercial shipping attacks in 25 days = biggest surprise of the war. If entry = simultaneous Hormuz + Bab el-Mandeb disruption.", why: "Houthi non-entry has been the war's biggest strategic wildcard. Their restraint has kept Bab el-Mandeb open while Hormuz closed — partial maritime continuity. Entry would close ~35% of global maritime trade simultaneously. But KAN report is from unnamed 'regional security officials' — speculative, not confirmed intelligence.", category: "military", goalIds: ["prx-houthi", "sco-theater", "hor-open"], sources: [{t:"Turkiye-Houthi",u:"https://www.turkiyetoday.com/region/houthis-may-enter-iran-war-as-early-as-march-23-israeli-media-claims-3216713"},{t:"AJZ-Houthi",u:"https://www.aljazeera.com/news/2026/3/22/will-the-houthis-join-the-iran-war"}] },
  ],
  watchNext: [
    { text: "5-DAY PAUSE CLOCK — Trump extended Hormuz ultimatum to ~March 28. Claims '15 points of agreement.' Iran categorically denies any talks. Oman confirmed mediating; Turkey/Egypt/Pakistan also passing messages. Will indirect channels produce a framework, or does clock expire with nothing?", why: "This is the first diplomatic opening of the war. If it collapses, power plant strikes return with credibility eroded by the delay. If it produces even partial framework, precedent shifts from 'no talks possible' to 'talks structure exists.' Markets already pricing in resolution — 14% oil drop means reversal if pause fails.", category: "political", timeframe: "24-48h", sources: [{t:"CNN-Pause",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-23-26"},{t:"Axios-Talks",u:"https://www.axios.com/2026/03/23/trump-suspends-iran-strikes-hormuz-negotiations"},{t:"IranIntl-Deny",u:"https://www.iranintl.com/en/202603234008"}] },
    { text: "Houthi entry — KAN citing regional officials: may enter 'as early as March 23' (post-Eid). Zero commercial shipping attacks in 25 days. Preparing but not attacking. Houthi politburo threatened naval blockade. Entry = simultaneous Hormuz + Bab el-Mandeb closure (~35% global maritime trade).", why: "If Houthis enter during the 5-day pause, it torpedoes diplomacy and creates a second maritime chokepoint. If they continue restraint, their non-entry remains the war's biggest strategic surprise. The diplomatic window may be the last chance before potential Houthi escalation.", category: "military", timeframe: "imminent", sources: [{t:"Turkiye-Houthi",u:"https://www.turkiyetoday.com/region/houthis-may-enter-iran-war-as-early-as-march-23-israeli-media-claims-3216713"},{t:"AJZ-Houthi",u:"https://www.aljazeera.com/news/2026/3/22/will-the-houthis-join-the-iran-war"}] },
    { text: "Interceptor depletion — Dimona/Arad failures confirmed. Arrow stocks 'critically low.' $826M emergency transfer approved but production rate is fixed. 70% of Iranian launches now cluster munitions. 29 attack waves over weekend.", why: "If Arrow depletes before campaign ends, Israeli population centers are exposed. Iran adapting strike packages specifically to exploit intercept gaps. The 5-day diplomatic pause may be partly motivated by interceptor sustainability — buying time for resupply. Each day of continued Iranian fire accelerates the depletion clock.", category: "military", timeframe: "this week", sources: [{t:"ToI-Dimona",u:"https://www.timesofisrael.com/over-100-injured-11-seriously-in-iranian-missile-strikes-on-southern-cities-of-arad-dimona/"},{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"}] },
    { text: "$200B supplemental — Still stalled. Murkowski won't fund without strategy. Reconciliation explored. Kent (NCTC) resigned saying 'no imminent threat,' FBI investigating him. At $1B+/day burn rate, war approaching $25B+ spent. 60-day War Powers clock expires ~April 29.", why: "War funding is the binding domestic constraint. The 5-day pause may create a window for White House to present strategy outline to Congress. If reconciliation fails, April 29 War Powers expiry becomes the hard deadline. GOP fracturing — Kent resignation is highest-level war dissent.", category: "political", timeframe: "this week", sources: [{t:"CNN-GOP",u:"https://www.cnn.com/2026/03/19/politics/iran-war-cost-republicans-congress"},{t:"CNN-Kent",u:"https://www.cnn.com/2026/03/21/politics/joe-kent-resignation-nctc"}] },
    { text: "Oil price whipsaw — Brent crashed ~14% to ~$94/bbl on pause news, but Goldman still forecasts $110 avg Mar-Apr. If 5-day pause collapses, oil rebounds sharply. UK PM Starmer called emergency meeting over economic fallout. IEA released record 400M barrels from reserves.", why: "14% single-day drop shows how much Hormuz risk premium is embedded in prices. If diplomacy produces Hormuz reopening framework, prices could fall to $80s. If pause expires with power plant strikes, $120+ is immediate. Markets are now a real-time referendum on diplomatic progress.", category: "economic", timeframe: "this week", sources: [{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/23/oil-prices-trump-iran-strait-of-hormuz-wti-crude-middle-east-lng-gas.html"},{t:"Bloomberg-14pct",u:"https://www.bloomberg.com/news/articles/2026-03-23/oil-futures-tumble-14-after-trump-s-iran-comments"}] },
    { text: "IRGC troika durability — Vahidi/Ghalibaf/Jafari filling Mojtaba's vacuum (absent 16+ days, confirmed injured). Ghalibaf issuing military threats on X. IRGC commander visiting Kurdish border. Can junta maintain coherence under sustained decapitation campaign?", why: "The regime's survival mechanism — military junta replacing civilian leadership — is being tested simultaneously by bombing and Kurdish mobilization. If troika fractures, question of 'what comes next' reopens. If it holds, Iraq 2003 parallel strengthens: institutions adapting faster than strikes can destroy them.", category: "regime", timeframe: "open question", sources: [{t:"JPost-IRGC",u:"https://www.jpost.com/israel-news/article-890716"},{t:"CTP-ISW-D22",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-22-2026"}] },
  ],
  watchResolved: [
    { text: "48-hour Hormuz ultimatum", resolved: "EXTENDED: Trump granted 5-day pause (~March 28) citing '15 points of agreement.' Iran denies any talks. Oman confirmed mediating. Power plant strikes deferred, not cancelled. Oil dropped 14%.", status: "confirmed" },
    { text: "Iran's negotiation refusal", resolved: "NUANCED: FM Araghchi publicly denies all dialogue. But indirect channels exist — Oman, Turkey, Egypt, Pakistan all passing messages. Ghalibaf in contact with US envoys (Axios). Public denial + private engagement = classic pre-negotiation behavior.", status: "confirmed" },
    { text: "General License U impact", resolved: "ONGOING: ~140M barrels authorized for sale. Market impact unclear — oil dropped 14% but on pause news, not GLU. FDD criticism of 'no guardrails' stands. Contradiction of bombing Iran while releasing its oil persists.", status: "ongoing" },
    { text: "Zamir 'halfway' timeline", resolved: "ONGOING: IDF Chief's statement stands — implies mid-April conclusion (~6 weeks). 5-day diplomatic pause doesn't contradict military timeline. A-10/Apache deployment confirms CENTCOM executing to plan. Three contradictory signals persist: military says 3+ weeks, Trump says winding down, ultimatum says escalation.", status: "ongoing" },
    { text: "Houthi Red Sea restraint", resolved: "HOLDING AT DAY 25: Zero commercial shipping attacks. KAN reports possible entry 'as early as March 23' — but speculative, unnamed sources. Still preparing, not attacking. If they enter during 5-day pause = torpedoes diplomacy.", status: "partial" },
    { text: "Russian weapons escalation", resolved: "ONGOING: Confirmed weapons supply continues. Russia reportedly sharing advanced drone tactics (CTP-ISW). CENTCOM struck Caspian supply route. De facto co-belligerence threshold crossed.", status: "ongoing" },
    { text: "F-35 investigation", resolved: "ONGOING: CENTCOM still hasn't confirmed Iranian fire hit F-35. No new reporting.", status: "ongoing" },
    { text: "IRGC troika consolidation", resolved: "CONFIRMED + DEEPENING: Vahidi/Ghalibaf/Jafari expanding control. Ghalibaf issuing military threats directly on X. IRGC commander visiting Kurdish border. Mojtaba absent 16+ days. Junta functioning as de facto government.", status: "confirmed" },
  ],
};
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 24: NUCLEAR TIT-FOR-TAT — Natanz struck 2nd time with bunker-busters (March 21). IAEA confirmed damage to entrance buildings, no radiation leak. Iran retaliated by targeting Dimona (~180 wounded, 0 killed). IAEA chief Grossi: war 'can't entirely eliminate' Iran's nuclear program. NEW: IDF struck Tehran university site used for nuclear weapons components. Isfahan underground facility remains uninspected. ~400 kg of highly enriched uranium persists. Mutual nuclear facility targeting is a new escalation phase with no precedent. Previous: IAEA zero access to 4 declared facilities since war started.", sources:[{t:"AJZ-Natanz",u:"https://www.aljazeera.com/news/2026/3/21/iran-says-us-and-israel-attacked-natanz-nuclear-facility"},{t:"WashExam-IAEA",u:"https://www.washingtonexaminer.com/news/world/4499578/iaea-no-radiation-leak-natanz-iran-strike/"},{t:"ToI-Dimona",u:"https://www.timesofisrael.com/over-100-injured-11-seriously-in-iranian-missile-strikes-on-southern-cities-of-arad-dimona/"},{t:"TheNatl-Isfahan",u:"https://www.thenationalnews.com/news/mena/2026/03/18/iran-has-new-underground-nuclear-site-iaea-reveals/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 24: 8,000+ TARGETS, 130+ VESSELS — ADM Cooper: 'largest elimination of a navy since WWII.' A-10s and Apaches deployed (= Iranian AD functionally neutralized). Israeli assessment: missile production reduced from ~100 BMs/month to ZERO. Diego Garcia IRBM: Iran launched 2 missiles at 4,000km range (1 failed, 1 intercepted) — first operational use beyond declared 2,000km limit. IDF Chief Zamir: 'Europe within range.' 70% of Iranian launches now cluster munitions. BG Agha Jani killed (IRGC drone chief, $10M bounty). Caspian Sea strikes on 5+ vessels disrupting Russian supply route. But Iran still sustaining BM barrages at Israel — Dimona/Arad penetrated.", sources:[{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-21/centcom-cooper-iran-update-day-22-21139708.html"},{t:"TheHill-8K",u:"https://thehill.com/policy/defense/5794604-centcom-brad-cooper-us-military-operation-iran-8k-targets/"},{t:"CNN-DiegoGarcia",u:"https://www.cnn.com/2026/03/21/politics/iran-missiles-diego-garcia"},{t:"CTP-ISW-D21",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-21-2026"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 24: IRGC JUNTA CONSOLIDATING — Mojtaba absent 14+ days, government confirmed injured. IRGC troika (Vahidi/Ghalibaf/Jafari) filling vacuum — Israeli officials: IRGC 'mainly filled the power vacuum.' BG Agha Jani killed (IRGC drone chief, $10M bounty). Missile production reduced to zero (Israeli assessment). 3 protesters publicly executed in Qom — first from January detainees, dozens more at imminent risk. Iran FM: 'no reason to negotiate now.' Saudi expelled Iranian diplomats. 200+ arrested, 100+ for sharing intel with foreign entities, 14 with Starlink devices. Decapitation producing structural effects — but replacement is hardline military junta, not regime collapse.", sources:[{t:"JPost-IRGC",u:"https://www.jpost.com/israel-news/article-890716"},{t:"CTP-ISW-D21",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-21-2026"},{t:"WaPo-Negotiate",u:"https://www.washingtonpost.com/world/2026/03/22/iran-refuses-negotiate"},{t:"AJZ-SaudiExpel",u:"https://www.aljazeera.com/news/2026/3/22/saudi-arabia-expels-iranian-diplomats"}],
    subgoals:[
      ...
      { id:"reg-endgame", name:"Define post-war governance plan", party:"opposing", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 24: ENDGAME INCOHERENT — Trump says 'winding down' while issuing 48-hour ultimatum to obliterate power plants. Iran FM: 'no reason to negotiate now.' IRGC troika consolidating — regime adapting, not collapsing. Turkey's Fidan and Egypt's Sisi mediating but no traction. US-Israel goal divergence deepening (WaPo). Trump signals US may leave allies to manage Iran fallout alone. No governance plan, no exit criteria, no interlocutor (Larijani killed, Mojtaba absent). Iraq 2003 parallel at its tightest: military success without political strategy.", sources:[{t:"WaPo-Diverge",u:"https://www.washingtonpost.com/world/2026/03/20/us-israel-iran-war-divergence"},{t:"WaPo-Negotiate",u:"https://www.washingtonpost.com/world/2026/03/22/iran-refuses-negotiate"},{t:"Bloomberg-48hr",u:"https://www.bloomberg.com/news/articles/2026-03-22/trump-gives-iran-48-hours-to-open-strait-threatens-power-plants"}] },
    ]
  },
  {
    id:"navy", name:"Destroy Iran's Navy & Maritime Threat", party:"us", type:"achieve",
    importance:5, achievability:5, status:"achieved", outcomeNote:"Day 25: 130 VESSELS DESTROYED — Adm. Cooper: 'largest elimination of a navy over a three-week period since WWII.' 8,000+ targets struck, 8,000+ combat flights. 80-85% of air defense architecture destroyed. A-10s and Apaches now deployed (= AD threat neutralized). Previous: 16 Iranian cargo vessels struck/burned. Caspian Sea strikes on 5+ vessels disrupting Russian supply route. 22-nation coalition condemning Iran's attacks on commercial shipping. Navy 'combat ineffective' but IRGC retains asymmetric capacity: Hormuz still at zero commercial traffic.", sources:[{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-21/centcom-cooper-iran-update-day-22-21139708.html"},{t:"TheHill-8K",u:"https://thehill.com/policy/defense/5794604-centcom-brad-cooper-us-military-operation-iran-8k-targets/"},{t:"FDD-Gains",u:"https://www.fdd.org/analysis/2026/03/19/operational-gains-against-iran-continue-but-threats-to-us-forces-persist/"}],
    subgoals:[
  ...
  // ═══ TIER 2: OPERATIONAL ═══
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"Day 24: A-10s AND APACHES DEPLOYED — strongest signal that CENTCOM assesses integrated air defense as functionally neutralized. These platforms are only viable in permissive environments. 8,000+ combat flights flown. 200+ targets struck over weekend in simultaneous waves on Iran + Lebanon. IDF struck Tehran overnight March 22: arms production, IRGC air force, intelligence ministry HQ, Khatam-al Anbiya military command. Caspian Sea strikes (new geographic front). Previous: 150+ AD systems destroyed, F-14 fleet eliminated, B-2/F-35/B-1B operating freely over entire country.", sources:[{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-21/centcom-cooper-iran-update-day-22-21139708.html"},{t:"TheHill-8K",u:"https://thehill.com/policy/defense/5794604-centcom-brad-cooper-us-military-operation-iran-8k-targets/"},{t:"NPR-Tehran",u:"https://www.npr.org/2026/03/22/iran-tehran-strikes-overnight"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"prx-iraq", name:"Prevent Iraqi militia activation", party:"us", type:"avoid", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 24: IRAQ BECOMING 6TH THEATER — INIS HQ in Baghdad hit by drone attack (intelligence officer killed). US/Israeli forces struck 52nd PMF Brigade base. Iraq declared force majeure on oil exports. NATO pulled all remaining personnel from Iraq (Mission Iraq ended). Kataib Hezbollah signaled possible temporary pause; Kataib Sayyid al-Shuhada vowed to continue. Multiple militia front groups claiming daily attacks on US bases. Previous: Embassy penetrated by drone March 17. 196+ drone/missile attacks on KRI since Feb 28. Militia tempo still escalating despite leadership kills.", sources:[{t:"CTP-ISW-D21",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-21-2026"},{t:"FDD-Iraq",u:"https://www.longwarjournal.org/archives/2026/03/iraq-militia-escalation-march-2026.php"},{t:"CNBC-ForceMajeure",u:"https://www.cnbc.com/2026/03/20/iraq-force-majeure-oil-exports.html"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 24: 13 KIA, 232 WIA (207 RTD) across 7+ countries. USS Boxer + thousands of Marines left California (3-week transit). F-35 investigation still open — CENTCOM hasn't confirmed Iranian fire hit. IRGC FLIR video unverified. Diego Garcia: 2 IRBMs launched at US-UK base (1 failed, 1 intercepted, no casualties). Iraq militia escalating: INIS HQ struck by drone, US Embassy Baghdad penetrated by drone March 17. Kent (NCTC) resigned. $200B supplemental stalled. Military presenting Trump daily 'escalate or exit' options — hasn't taken exit ramp.", sources:[{t:"Time-US",u:"https://time.com/article/2026/03/22/us-military-casualties-iran-war/"},{t:"CNN-DiegoGarcia",u:"https://www.cnn.com/2026/03/21/politics/iran-missiles-diego-garcia"},{t:"CNN-Kent",u:"https://www.cnn.com/2026/03/21/politics/joe-kent-resignation-nctc"},{t:"NBC-ExitRamp",u:"https://www.nbcnews.com/politics/national-security/trump-presented-daily-options-end-war-iran-hasnt-taken-far-rcna263399"}],
    subgoals:[
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 25</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>8,000+ targets struck, 130 naval vessels destroyed, 80-85% of air defense architecture eliminated. 'Unprecedented' IDF strikes continuing on eastern Tehran — Intelligence Ministry HQ hit, IRGC Basij commander killed. Military leadership 'in deep bunkers.'</span> CENTCOM chief says campaign 'ahead or on plan.' A-10/Apache deployment confirms permissive air environment. Iran's conventional deterrent effectively neutralized — missile production at zero, navy destroyed, BM launches down 90%.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Trump's 5-day pause produced the war's first diplomatic opening. Oman confirmed mediating. Oil crashed ~14% on pause news.</span> The pause itself is a success signal — it implies enough military leverage to negotiate from strength. Saudi expelled Iranian diplomats. 22-nation Hormuz coalition. Houthis still NOT attacking at Day 25 despite 'imminent' predictions. Kosovo parallel: Day 25 of 78 = 32% through, with air/naval dominance NATO didn't achieve until Week 6.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 25</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>{stats.expanding} goals growing beyond plan</span>. <span style={{color:"#F59E0B",fontWeight:700}}>The 5-day pause is analytically ambiguous — is it de-escalation or escalation leverage? Trump claims '15 points of agreement'; Iran says 'no dialogue.' Both may be technically correct (indirect channels via Oman/Turkey/Egypt/Pakistan). Gulf attacks CONTINUED during the pause — Saudi hit with 21 drones + 3 BMs, Kuwait with 7 drones, IRGC claimed Fifth Fleet Bahrain. Houthi entry 'imminent' per Israeli media — would open 7th theater.</span>
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Fiscal: $200B supplemental still stalled — GOP can't get own party votes. $11B in first week alone. Oil whipsawing: $126 peak → $94 on pause → Goldman forecasts $110 average. UK PM called emergency meeting on economic fallout. China/HK worst day in a year.</span> The pause creates a paradox: if it leads to talks, expansion may have been the pressure that worked. If talks collapse after 5 days, power plant strikes resume and expansion accelerates dramatically. IRGC threatening to 'mine Gulf waters' if invaded — Hormuz dimension has no historical parallel.
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 25</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are genuinely failing</span>. (1) <span style={{color:C.red,fontWeight:700}}>The 5-day pause may signal military strikes alone aren't producing capitulation. Trump claims 15 points of agreement; Iran FM says 'no dialogue'; IRGC says 'no direct or indirect contact.' Mehr News: Trump 'backed down.' The narrative gap is enormous — someone is fabricating.</span> (2) Gulf attacks continued DURING the pause — Iran hitting Saudi, Kuwait, Bahrain simultaneously. 300+ deliberate attacks on civilian targets per CENTCOM. Interceptor stocks depleting with no resupply timeline. (3) Humanitarian irreversible: 1,330+ dead including 200+ children, 18,000+ injured, 80,000+ civilian buildings hit.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              $200B supplemental stalled — can't pass even through reconciliation. 13 US KIA, 200+ wounded across 7 countries. <span style={{color:C.red,fontWeight:700}}>Houthi entry would open 7th theater while $200B unfunded. Oil whipsawing ($126→$94→Goldman says $110) = markets pricing in prolonged conflict, not resolution. IRGC troika consolidating — regime adapting around strikes, not collapsing. Iran threatening to mine Gulf waters. The pause itself is the strongest evidence the original theory of victory (air power → capitulation) isn't working at Day 25 — you don't pause a winning campaign.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
      ...
      <CollapsibleSection title="Historical Analogues" id="analogues" defaultOpen={false} mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"24px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))", gap:12 }}>
            {[
              { name:"Kosovo 1999", fit:"HIGH", fitColor:C.green, note:"Day 24 of 78 maps almost exactly. Air pressure continuing without ground invasion. IDF 'halfway' aligns with Kosovo timeline. 22-nation coalition parallels NATO unity under strain. Key difference growing: Hormuz/energy dimension has no Kosovo parallel — Kosovo didn't threaten global energy supply. Fit weakens on economic dimension but strengthens on military arc." },
              { name:"Panama 1989", fit:"LOW-MEDIUM", fitColor:C.amber, note:"Downgrading. 'Quick decapitation + transition' model clearly not operative. Mojtaba absent but no Endara-equivalent being installed. No governance plan at all. IRGC troika filling vacuum = institutional survival, not collapse. This analogue has aged out." },
              { name:"Desert Storm 1991", fit:"MEDIUM", fitColor:C.amber, note:"Limited objectives model — but are objectives limited? 48-hour ultimatum to destroy power grid suggests escalating aims. If 'Hormuz open + nukes gone' = limited, fit holds. If regime change becomes explicit goal, fit drops. $200B cost tracks. Energy damage echoes oil well fires." },
              { name:"Iraq 2003", fit:"MEDIUM-HIGH", fitColor:C.amber, note:"Upgrading. IRGC troika filling Mojtaba's vacuum parallels Baathist institutional survival. No post-conflict plan visible. Military success without political strategy. 'Winding down' rhetoric while escalating parallels 'Mission Accomplished.' Not a 1:1 match — no ground occupation — but the political-military disconnect is the tightest it's been. Stop treating 'military success' as evidence against this parallel — Iraq was never about military failure." },
              { name:"Libya 2011", fit:"MEDIUM", fitColor:C.amber, note:"IRGC junta emergence parallels militia fragmentation, but Iranian state institutions are HOLDING, unlike Libya's collapse. If IRGC troika fractures internally, fit rises sharply. Energy infrastructure damage echoes Libya's post-war oil disruption. CTP-ISW: 'disruption will not cause regime collapse without an indigenous force to exploit it.'" },
              { name:"June 2025 12-Day War", fit:"MEDIUM-HIGH", fitColor:C.amber, note:"Downgrading to MEDIUM-HIGH. Phase 2 confirmed and lasting degradation achieved. But the 12-Day War had defined objectives and stopped. This campaign has no visible stopping point — 48-hour ultimatums, Marines deploying, Litani bridge destruction. The analogy is aging out as duration extends well beyond 12 days." },
              { name:"Israel-Hezbollah 2006", fit:"MEDIUM", fitColor:C.amber, note:"Upgrading. Lebanon front now has 3 IDF divisions, Litani bridge destruction ordered (permanent security line), 570+ Hezbollah fighters killed, 1,000+ Lebanese dead, 1M+ displaced. First IED use. This is 2006 on steroids. The parallel is no longer distant — it's actively replaying alongside the Iran campaign." },
              { name:"Osirak 1981", fit:"LOW", fitColor:C.red, note:"Natanz struck twice + new Isfahan site = sustained campaign, not surgical strike. Grossi: war 'can't entirely eliminate' Iran's nuclear program. Osirak model is definitively inapplicable — this is counter-proliferation through sustained bombardment, not a single raid." },
            ].map(a => (
