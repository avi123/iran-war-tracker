...
const HIGHLIGHTS = {
  updatedAt: "2026-03-18T19:00Z",
  keyDevelopments: [
    { text: "3 SENIOR LEADERS KILLED IN 36 HOURS — Larijani (SNSC Secretary, de facto leader) confirmed killed by Iran. Intelligence Minister Khatib killed overnight March 17-18. Basij commander Soleimani + ~300 Basij commanders eliminated. IDF now authorized to kill senior Iranians without prior approval.", why: "Most concentrated decapitation of Iranian leadership since the revolution. Larijani was the only experienced diplomatic operator — his death leaves Mojtaba + IRGC hardliners with no negotiation capacity. Khatib ran internal repression apparatus. Basij field command decapitated systematically. IDF's blanket kill authorization signals acceleration.", category: "military", goalIds: ["reg-succession", "reg-irgc-leaders", "reg-repress"], sources: [{t:"NPR-Khatib",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"WaPo-Khatib",u:"https://www.washingtonpost.com/world/2026/03/18/iran-israel-war-us-esmail-khatib/"},{t:"IDF-Soleimani",u:"https://x.com/idfonline/status/2033826032667496787"},{t:"IranIntl-Basij",u:"https://x.com/IranIntl/status/2033955048175145156"}] },
    { text: "SOUTH PARS GAS FIELD STRUCK — first upstream energy target. IAF hit gas treatment plants (Phases 3-5-6) at Asaluyeh, Bushehr. ~1/5 of Iran's gas processing capacity damaged/offline. Iran threatens named Gulf targets in retaliation: Samref Refinery, Jubail Petrochemical, Al Hasan Gas Field.", why: "Crossing the energy infrastructure threshold fundamentally changes the war's economic dimension. Previous strikes hit military/dual-use — South Pars is pure civilian energy infrastructure. Iran's retaliatory threat naming specific Gulf facilities suggests escalation spiral in energy targeting. Brent spiked to $108.78 on the news.", category: "economic", goalIds: ["en-oil", "energy", "hormuz"], sources: [{t:"ToI-SouthPars",u:"https://www.timesofisrael.com/liveblog-march-18-2026/"},{t:"Haaretz-SouthPars",u:"https://www.haaretz.com/israel-news/2026-03-18/ty-article/.premium/south-pars-gas-field-struck/"},{t:"Bloomberg-Oil",u:"https://www.bloomberg.com/news/articles/2026-03-18/oil-surges-past-108-after-israel-strikes-iran-south-pars-gas-field"}] },
    { text: "LEBANON GROUND INVASION — 3-5 IDF divisions launched largest ground op since 2006 (March 16). Tyre evacuation ordered. IDF says troops will remain 'for months.' Beirut strikes: 6-20 killed in Bashoura. 922+ killed, 1M+ displaced in Lebanon. 5 NATO allies oppose.", why: "This is now a second full war running simultaneously with the Iran air campaign. IDF entering with 3-5 divisions for 'months' echoes 2006 — which ended inconclusively. Hezbollah still firing ~100 rockets/day. The 5-nation NATO statement opposing the operation signals growing international isolation on this front.", category: "military", goalIds: ["hez", "hez-ground", "sco-theater"], sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"NBC-Beirut",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-bunker-busters-israel-beirut-lebanon-hezbollah-rcna264012"},{t:"Axios-Ground",u:"https://www.axios.com/2026/03/16/israel-ground-invasion-lebanon-hezbollah"}] },
    { text: "KENT RESIGNS + TRUMP THREATENS NATO — NCTC Director Joe Kent quit (first senior Trump official): 'war due to pressure from Israel and its powerful American lobby.' Trump threatened NATO withdrawal after all allies refused Hormuz coalition. Near-universal rejection: EU, Germany, Japan, Australia declined.", why: "Kent's resignation breaks the unanimity that sustained the war politically. His framing — Israel lobby pressure — provides a narrative vehicle for opposition. Trump's NATO threat over Hormuz is a second diplomatic failure: the allies he needs for legitimacy are the ones he's alienating. Both developments erode the political foundations.", category: "political", goalIds: ["dom-support", "alliance", "sco-exit"], sources: [{t:"CNN-Kent",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-18-26"},{t:"NPR-Kent",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"Euronews-NATO",u:"https://www.euronews.com/2026/03/18/trump-threatens-nato-exit-allies-refuse-hormuz"}] },
    { text: "BRENT $106-109, GAS $3.84, DIESEL $5.04 — despite 400M bbl strategic release (largest ever). Fed expected to hold rates. Iran offering yuan-denominated Hormuz transit to 8 countries. First non-Iranian tanker (Karachi) transited with AIS March 15. 20,000 seafarers stranded.", why: "Strategic reserves are being burned at historic rates and prices keep rising — structural supply disruption overpowering reserves. Iran's yuan-transit scheme is building an alternative economic order. The Karachi transit shows negotiated passage is possible but doesn't resolve the 60% export reduction. Diesel at $5 hits trucking/logistics directly.", category: "economic", goalIds: ["en-oil", "en-pump", "hor-open"], sources: [{t:"Fortune-Oil",u:"https://fortune.com/article/price-of-oil-03-18-2026/"},{t:"CNBC-Gas",u:"https://www.cnbc.com/2026/03/18/iran-strikes-us-israeli-targets-gulf-larijani-death.html"},{t:"MarineTraffic-Karachi",u:"https://x.com/MarineTraffic/status/2033490585298915497"}] },
    { text: "MOJTABA 'WOUNDED AND DISFIGURED' — Hegseth assessment. Still no public appearance (20 days). Banking crisis (Melli/Sepah failures) ahead of Nowruz March 20. Internet blackout Day 18+, AS12880 network collapsed. 500 detained as alleged spies. Iran executes Swedish citizen.", why: "Nowruz is 2 days away — the hard deadline for regime functionality. If Mojtaba can't deliver the traditional supreme leader message, IRGC-by-committee governance is confirmed. Banking failures + internet collapse before Iran's biggest holiday = compounding civilian pressure. The execution of a foreign national signals regime desperation.", category: "regime", goalIds: ["reg-succession", "reg-repress", "reg-endgame"], sources: [{t:"CBS-Mojtaba",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"},{t:"LWJ-Banking",u:"https://www.longwarjournal.org/archives/2026/03/iran-banking-crisis-deepens-ahead-of-nowruz.php"},{t:"Netblocks",u:"https://x.com/netblocks/status/2033448212430758038"}] },
  ],
  watchNext: [
    { text: "Nowruz March 20 — will Mojtaba deliver traditional supreme leader message? 'Wounded and disfigured' per Hegseth. Banking system failing. Internet at 1-4%.", why: "Hard deadline for regime functionality in 2 days. If Mojtaba appears = regime reconstituted under hardline IRGC direction. If not = ruling by committee confirmed. Banking failures + internet collapse before biggest Iranian holiday = compounding civilian pressure on regime.", category: "regime", timeframe: "24-48h", sources: [{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"},{t:"CBS-Mojtaba",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"}] },
    { text: "School strike deadlines — Senate March 18 (TODAY), House March 20. No DOD response yet. AI targeting identified as cause (WaPo). Amnesty: 170+ killed including schoolgirls.", why: "If both deadlines pass without accountability, it becomes a midterm issue. The AI-targeting angle generates sustained media attention. $50B supplemental forces every member to take a recorded position on the war.", category: "political", timeframe: "imminent", sources: [{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"},{t:"WaPo-AI",u:"https://www.washingtonpost.com/national-security/2026/03/17/iran-school-strike-ai-targeting/"}] },
    { text: "Iran's Gulf energy retaliation — named Samref Refinery, Jubail Petrochemical, Al Hasan Gas Field, Qatar refinery as targets. Response to South Pars strike.", why: "If Iran hits named targets, energy war escalates to mutual infrastructure destruction. Saudi Aramco facilities = global supply shock. If Iran doesn't follow through = deterrence working but credibility eroded.", category: "economic", timeframe: "imminent", sources: [{t:"ToI-Threats",u:"https://www.timesofisrael.com/liveblog-march-18-2026/"}] },
    { text: "Lebanon ground ops Day 3+ — will IDF push north of Litani? 3-5 divisions deployed. Hezbollah still firing ~100 rockets/day. 2006 echoes.", why: "If IDF seizes all territory south of Litani, this becomes a sustained occupation requiring indefinite force commitment. Hezbollah's Radwan Force (~1,000 operatives) positioned to resist. Duration ('months') contradicts any short-war scenario.", category: "military", timeframe: "24-48h", sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"Axios-Ground",u:"https://www.axios.com/2026/03/16/israel-ground-invasion-lebanon-hezbollah"}] },
    { text: "Fed decision today (2pm ET) — expected hold at 3.5-3.75%. May signal zero 2026 rate cuts. Stagflationary pressure from oil spike.", why: "If Fed signals zero cuts while war drives inflation, the economic pain narrative intensifies. Markets pricing in extended conflict. First 2026 dot plot releasing today.", category: "economic", timeframe: "imminent", sources: [{t:"Kiplinger-Fed",u:"https://www.kiplinger.com/economic-forecasts/interest-rates"},{t:"Yahoo-Fed",u:"https://finance.yahoo.com/news/fed-decision-march-2026/"}] },
    { text: "Russian weapons escalation — confirmed Shahed components + satellite imagery + MANPADS. Will BM resupply follow as Iran's arsenal nears depletion?", why: "Russia has crossed from intelligence to weapons. If BM resupply follows, Iran's decline reverses and campaign timeline resets. WSJ confirmed satellite imagery + drone tech + targeting advice.", category: "military", timeframe: "this week", sources: [{t:"WSJ-Russia",u:"https://www.wsj.com/world/middle-east/russia-iran-weapons-support-war-2026"},{t:"United24-Russia",u:"https://united24media.com/latest-news/iran-officially-confirms-military-support-from-russia-and-china-in-war-against-the-us-16882"}] },
  ],
  watchResolved: [
    { text: "Larijani — will Iran confirm or deny?", resolved: "CONFIRMED KILLED: Iran's SNSC confirmed. Son Morteza and deputy Bayat also killed. Highest-value target since Khamenei.", status: "confirmed" },
    { text: "Houthi escalation", resolved: "STRATEGIC PAUSE: Zero Red Sea shipping attacks despite 3 weeks of war. Attacked USS Truman but not commercial vessels. Analysts cite strategic patience and self-preservation.", status: "partial" },
    { text: "Mojtaba physical appearance", resolved: "ONGOING: Hegseth says 'wounded and disfigured.' Still no appearance (20 days). Nowruz March 20 = 2 days.", status: "ongoing" },
    { text: "$50B supplemental", resolved: "ONGOING: Not submitted. No vote date. 250+ groups opposing. War costing ~$1B/day.", status: "ongoing" },
    { text: "Oil at $100", resolved: "CONFIRMED + WORSENING: Brent $106-109, spiked to $108.78 after South Pars. Strategic releases not holding. Diesel $5.04.", status: "confirmed" },
    { text: "All allies refuse Hormuz coalition", resolved: "CONFIRMED: EU, Germany, Japan, Australia all declined. Trump threatened NATO withdrawal. Near-universal rejection.", status: "confirmed" },
    { text: "Lebanon ground invasion", resolved: "CONFIRMED + EXPANDING: 3-5 divisions. Tyre evacuated. IDF says 'months.' 922+ killed. Beirut strikes ongoing. 5 NATO allies oppose.", status: "confirmed" },
    { text: "European sleeper cells", resolved: "EXPANDING: Oslo IED near US Embassy. Liège synagogue bomb (IMCR claimed). Encrypted activation signal intercepted. State Dept ordered worldwide embassy security reviews.", status: "confirmed" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 20: GBU-72 5,000-lb bunker busters hitting coastal anti-ship missile sites. First non-Iranian cargo (tanker Karachi) transited with AIS March 15. But Ghalibaf: 'Hormuz won't return to pre-war status.' 20,000 seafarers stranded. Ship traffic ~1/5 normal. Previous: All allies refused Hormuz coalition. Iran maintaining selective blockade: open to China, Turkey, India; closed to Western allies. Gulf exports still down ~60%. Iran offering yuan-denominated transit to 8 countries.", sources:[{t:"MarineTraffic",u:"https://x.com/MarineTraffic/status/2033490585298915497"},{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"ToI-D20",u:"https://www.timesofisrael.com/liveblog-march-18-2026/"},{t:"AJZ-Passage",u:"https://www.aljazeera.com/economy/2026/3/16/strait-of-hormuz-which-countriess-ships-has-iran-allowed-safe-passage-to"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 20: IDF ground invasion launched March 16 with 3-5 divisions — largest since 2006. Tyre evacuated. IDF says 'months.' 922+ killed, 1M+ displaced. Beirut strikes: 6-20 killed in Bashoura. 400+ Hezbollah operatives eliminated. Lebanon proposes direct talks. Previous: Hezbollah firing ~100 rockets/day. 5 NATO allies oppose ground ops.", sources:[{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"NBC-Beirut",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-bunker-busters-israel-beirut-lebanon-hezbollah-rcna264012"},{t:"Axios-Ground",u:"https://www.axios.com/2026/03/16/israel-ground-invasion-lebanon-hezbollah"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 20: 13 KIA, ~200 wounded across 7 countries (first comprehensive disclosure). USS Ford to Crete for 1+ week repairs after fire. Missile struck inside US Embassy Baghdad compound. FPV drones breached Embassy perimeter. Previous: France 1 KIA. ~50,000 troops deployed. Army banned uniform-wearing off-base. $50B supplemental pending. 4 manned aircraft lost.", sources:[{t:"WaPo-200WIA",u:"https://www.washingtonpost.com/national-security/2026/03/16/us-troops-wounded-iran/"},{t:"CNN-Embassy",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-18-26"},{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-16/centcom-update-operation-epic-fury-day-16-21086277.html"},{t:"CTP-ISW-D15",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-15-2026"}],
    subgoals:[
  ...
  // ═══ TIER 3: POLITICAL / DIPLOMATIC ═══
  {
    ...
    importance:5, achievability:2, status:"at risk", outcomeNote:"Day 20: Kent resignation provides narrative vehicle for opposition. 250+ groups opposing $50B supplemental. DNI Gabbard + FBI Patel testifying before Senate today. 53-56% oppose war. Previous: Republicans blocking hearings. Amnesty school strike report (170+ killed). FCC threatening broadcaster licenses. Gas $3.84. Senate school strike deadline TODAY.", sources:[{t:"CNN-Kent",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-18-26"},{t:"NPR-Kent",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"ACLU-250",u:"https://www.aclu.org/press-releases/more-than-250-groups-oppose-additional-spending-on-trumps-illegal-iran-war"},{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 20: Brent $106-109 (spiked $108.78 after South Pars). Gas $3.84 avg (+29%). Diesel $5.04. 400M bbl strategic release not holding. Iran offering yuan-denominated transit to 8 countries. Previous: 30+ countries coordinated largest reserve release in history. Structural disruption (60% export reduction) overpowering reserves. Oil up ~60% from pre-war ~$65-70.", sources:[{t:"Fortune-Oil",u:"https://fortune.com/article/price-of-oil-03-18-2026/"},{t:"CNBC-Gas",u:"https://www.cnbc.com/2026/03/18/iran-strikes-us-israeli-targets-gulf-larijani-death.html"},{t:"Bloomberg-Oil",u:"https://www.bloomberg.com/news/articles/2026-03-18/oil-surges-past-108-after-israel-strikes-iran-south-pars-gas-field"}] },
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 20</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>3 senior leaders killed in 36 hours: Larijani (SNSC), Soleimani (Basij), Khatib (Intelligence). ~300 Basij field commanders eliminated. IDF authorized to kill senior figures without prior approval. 7,000+ targets struck. 6,500+ sorties. 100+ naval vessels destroyed. ~70% missile launchers destroyed. Phase 2 commenced — defense industrial base targeting.</span> Air defense functionally suppressed — simultaneous strikes on Tehran, Shiraz, Tabriz. GBU-72 bunker busters hitting Hormuz coastal missile sites. First non-Iranian cargo transited Hormuz with AIS (March 15). CTP-ISW reports desertions and refusals to follow orders.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Gulf coalition holding under fire: Saudi, UAE, Qatar, Bahrain, Kuwait all actively intercepting. Bahrain: 129 missiles + 221 drones neutralized. Qatar withstood 14 BMs.</span> Mojtaba assessed 'wounded, disfigured' — non-functional. Fordow assessed 'inoperable' (US official). South Pars strike demonstrates willingness to escalate to energy infrastructure. Kosovo prior: Day 20 of 78 — NATO hadn't even started hitting infrastructure at this point. Military degradation pace is historically unprecedented.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 20</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>{stats.expanding} goals growing beyond plan</span>. <span style={{color:"#F59E0B",fontWeight:700}}>Lebanon ground invasion: 3-5 divisions, IDF says 'months.' South Pars energy strike crosses infrastructure threshold. Israel's 5 stated war objectives now explicitly include 'regime change conditions.' Baghdad Embassy struck by missile + drones. ~200 US wounded across 7 countries. Qatar receiving 14 BMs. European sleeper cells activating (Oslo, Liège). Brent $106-109.</span>
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              USS Ford out of action 1+ week. Iran threatening named Gulf energy targets (Samref, Jubail, Al Hasan). Trump threatening NATO withdrawal. Kent resignation = first admin break. <span style={{color:"#F59E0B",fontWeight:700}}>Both sides maximalist: Mojtaba 'not the right time for peace,' Trump 'terms aren't good enough.' No mediator, no off-ramp, no endgame. The war is militarily succeeding, economically worsening, geographically expanding into Lebanon + Iraq + Europe, and diplomatically frozen — simultaneously.</span>
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 20</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are genuinely failing</span>. (1) <span style={{color:C.red,fontWeight:700}}>Nuclear objective stuck: underground Natanz FEP survived initial strikes. 440.9 kg enriched uranium location unknown. IAEA has zero access.</span> (2) Force protection failing: missile struck inside US Embassy Baghdad. FPV drones flew through perimeter unchallenged. ~200 US wounded, 13 KIA. (3) Diplomatic isolation: Kent resignation, Trump NATO threat, 5 allies opposing Lebanon, 250+ groups opposing $50B supplemental. (4) Humanitarian legitimacy eroding: Amnesty school strike report (170+ killed), HRW 'unlawful strikes.' Senate deadline TODAY.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              Oil $106-109 despite 400M bbl strategic release. Gas $3.84, diesel $5.04. Iran offering yuan-denominated transit — building alternative order. Ghalibaf: 'Hormuz won't return to pre-war status.' <span style={{color:C.red,fontWeight:700}}>Iran's retaliatory capability persists at Day 20: cluster munitions hitting central Israel (2 killed Ramat Gan), 9 BM barrages daily, Gulf states under sustained attack. Everything failing is structurally unchanged or worsening. Strategic reserves depleting with no resolution timeline.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
