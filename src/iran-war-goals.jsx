...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"mis-prod", name:"Destroy missile production facilities", party:"both", type:"achieve", importance:5, achievability:3, status:"in progress", outcomeNote:"Day 8: Shahrud BM production facilities struck — IDF described as 'central' production sites. Shokouhiyeh Industrial Zone (Qom) drone production struck after IDF evacuation warning. 6 defense industrial sites hit D8 including DIO and Shiraz Electronics Industries (both US-sanctioned). Hegseth Objective #2. Cooper: mission to 'systematically dismantle Iran's missile production capability for the future.' Iran has dispersed production but key nodes being degraded.", sources:[{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"},{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"IranIntl-Qom",u:"https://x.com/IranIntl/status/2029927326813733048"}] },
      ...
      { id:"mis-supply", name:"Interdict missile component supply chains", party:"us", type:"achieve", importance:3, achievability:2, status:"tbd", outcomeNote:"Long-term objective. Chinese/North Korean supply networks not addressed by air campaign.", sources:[{t:"Alma",u:"https://israel-alma.org/iran-situation-assessment-february-2026-the-race-to-rebuild-the-nuclear-and-missile-array-casual-terror-and-the-crink/"},{t:"CSIS",u:"https://www.csis.org/analysis/crink-security-ties-growing-cooperation-anchored-china-and-russia"}] },
    ]
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", outcomeNote:"FORMALIZING BUT FRACTURED: Assembly of Experts elected Mojtaba but 8 of 88 members refused to attend — protesting IRGC pressure on the process. Formal public announcement delayed: concern that announcing would expose Mojtaba as direct strike target. Israel declared Mojtaba 'unequivocal target for elimination.' Trump: Mojtaba 'unacceptable' and 'a lightweight' — wants role choosing Iran's next leader. Day 8: Ali Asghar Hejazi (Khamenei's deputy CoS / most powerful intel official) targeted — systematic elimination of regime's inner circle continuing. Succession proceeding constitutionally but under unprecedented stress.", sources:[{t:"JPost-AoE",u:"https://www.jpost.com/middle-east/iran-news/article-888965"},{t:"IranIntl-AoE",u:"https://www.iranintl.com/en/202603052337"},{t:"CBS-Trump",u:"https://www.cbsnews.com/live-updates/us-iran-war-spreads-azerbaijan-israel-strikes-tehran-lebanon/"},{t:"IDF-Hejazi",u:"https://x.com/idfonline/status/2029922050576413074"}] },
      { id:"reg-irgc-cohesion", name:"Break IRGC institutional cohesion", party:"both", type:"achieve", importance:4, achievability:2, status:"at risk", outcomeNote:"IRGC CONSOLIDATING + CLAIMING ENDURANCE: IRGC claims '6-month readiness' (Bloomberg). Zero defections. IRGC pressure drove Mojtaba selection — 8/88 AoE members refused to attend but were overridden. IRGC commander: fatal consequences for sympathy with enemy. Internal security degrading (9/23 Basij bases hit, LEC in 4 provinces destroyed) but IRGC compensating with escalated repression. Ali Asghar Hejazi targeted — eliminating inner circle. BUT: institutional cohesion holding under unprecedented pressure. Quds Force officers fleeing Lebanon ≠ IRGC collapse in Iran.", sources:[{t:"Bloomberg-IRGC",u:"https://www.bloomberg.com/news/live-blog/2026-03-07/iran-latest"},{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"AJZ-5thCol",u:"https://www.aljazeera.com/news/2026/3/7/iranian-authorities-warn-against-fifth-column-as-no-signs-of-war-abating"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"nav-ships", name:"Sink Iranian warships", party:"us", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"43 SHIPS DESTROYED (CENTCOM Mar 6): Up from 30+. Shahid Bagheri drone carrier sunk in opening hours. 11 naval vessels in initial phase including IRIS Jamaran, IRIS Dena (torpedoed — 87 bodies recovered). IRIS Bushehr interned by Sri Lanka. Hegseth: 'quiet death' — first US torpedo kill since WWII. Cooper: 'Today they have ZERO.' Iran's conventional navy annihilated.", sources:[{t:"NavalNews",u:"https://www.navalnews.com/naval-news/2026/03/centcom-releases-footage-showing-strike-on-irans-drone-carrier/"},{t:"NavyTimes",u:"https://www.navytimes.com/news/2026/03/05/us-has-destroyed-iranian-drone-carrier-centcom-commander-says/"},{t:"CENTCOM-Mar6",u:"https://www.foxnews.com/live-news/us-iran-israel-war-latest-march-6"}] },
  ...
  // ═══ TIER 2: OPERATIONAL ═══
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"EXPANDING BEYOND TEHRAN: CTP-ISW assesses air superiority now extends over Tehran AND 'likely over parts of western Iran' — expanded from Tehran-only. IRGC Air Force central air defense command center struck in central Tehran (D8 evening). 2 Artesh airbases in Esfahan Province struck. IDF: ~3,400 strikes, ~7,500 munitions. Day 8 evening wave struck air defense systems, HQs, warehouses. B-1B Lancers arriving at RAF Fairford (UK) — Hegseth: firepower 'about to surge dramatically.' $151.8M emergency arms sale: 12,000 x 1,000-lb bombs. Air campaign deepening with expanded basing + resupply.", sources:[{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"France24-D8",u:"https://www.france24.com/en/middle-east/20260307-live-israel-launches-broader-attacks-on-tehran-as-war-goes-into-eighth-day"},{t:"MEE-B1B",u:"https://www.middleeasteye.net/news/us-bombers-land-britain-pentagon-prepares-surge-iran-strikes"},{t:"TRT-Arms",u:"https://www.trtworld.com/article/e87e62db3834"}],
    subgoals:[
      { id:"air-ad", name:"Destroy Iranian air defense network", party:"both", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"Day 8: IRGC Air Force CENTRAL air defense command center struck in central Tehran — the command node itself, not just individual batteries. Air superiority expanded to 'parts of western Iran' (CTP-ISW). 2 Artesh airbases in Esfahan Province suppressed. B-2s and F-35s operating freely. Phase 2 underground targeting proceeding uncontested. THAAD AN/TPY-2 radar damage confirmed at Al Dhafra (UAE) + Jordan — ~$500M each, degrades regional BMD architecture. Iran's remaining air defense: fragmented, leaderless.", sources:[{t:"France24-D8",u:"https://www.france24.com/en/middle-east/20260307-live-israel-launches-broader-attacks-on-tehran-as-war-goes-into-eighth-day"},{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"CNN-THAAD",u:"https://www.cnn.com/2026/03/05/middleeast/radar-bases-us-missile-defense-iran-war-intl-invs"}] },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 8 evening: Lebanon 294 dead, 1,023 wounded, 300,000+ displaced (NRC — up from 110K). Nabi Chit raid details: 4 Israeli helicopters from Syrian direction, Hezbollah Radwan Force engaged at cemetery, 41 killed (incl. 3 Lebanese soldiers + 1 general security). IDF's deepest incursion since Batroun Nov 2024. Fresh Dahiyeh strikes evening Mar 7. 116+ Hezbollah attack waves. Radwan deployed. Gaza template applied to Lebanon. 3 UNIFIL peacekeepers wounded in Qouzah missile strike.", sources:[{t:"AJZ-Bekaa",u:"https://www.aljazeera.com/news/2026/3/7/hezbollah-israeli-troops-clash-on-the-ground-in-eastern-lebanons-bekaa"},{t:"NRC",u:"https://www.nrc.no/news/2026/lebanon-300000-already-displaced-as-israel-issues-mass-evacuation-orders"},{t:"WaPo-Arad",u:"https://www.washingtonpost.com/world/2026/03/07/lebanon-israel-hezbollah-ron-arad-nabi-chit/c7cb1b32-1a2b-11f1-aef0-0aac8e8e94db_story.html"},{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"prx-houthi", name:"Suppress Houthi threats", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Houthis re-entered with missile/drone attacks on US/Israeli ships in Red Sea. Bab al-Mandab chokepoint back on map.", sources:[{t:"FreightWaves",u:"https://www.freightwaves.com/news/iran-backed-houthi-warn-of-new-red-sea-attacks"},{t:"ToI",u:"https://www.timesofisrael.com/liveblog_entry/iranian-backed-houthis-say-theyll-resume-attacks-on-israel-and-on-shipping-routes/"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 8: 12 BM salvos in 24 hours — Iran shifting to staggered strategy (every 1-2 hours) to strain interception + keep millions in shelters. Missile fragment hit home in Lod — structural damage, no injuries. 11-12 civilians dead, 1,600+ injured. IDF assessment: Iran may redirect resources from Gulf to concentrate strikes on Israel. Attack wave frequency declining but salvo strategy demonstrates continued capability. Defense systems holding but cumulative strain visible.", sources:[{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"},{t:"ToI-Salvos",u:"https://www.timesofisrael.com/smaller-volleys-more-alerts-attacking-israel-anew-iran-shifts-tack-on-missile-barrages/"},{t:"Haaretz-IDF",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-07/ty-article/.premium/idf-officials-israel-bracing-for-iran-to-ramp-up-missile-launches/0000019c-c8fb-d3fb-a1fe-dffb592b0000"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"all-base", name:"Maintain basing rights across region", party:"us", type:"achieve", importance:5, achievability:3, status:"in progress", outcomeNote:"Day 8: B-1B Lancers arriving at RAF Fairford (UK) — first arrived Friday, 3 more Saturday. UK PM Starmer authorized Fairford + Diego Garcia for US operations. Hegseth: firepower 'about to surge dramatically.' UK sending additional Typhoons to Qatar + helicopters to Cyprus. $151.8M emergency arms sale: 12,000 x 1,000-lb bombs (Rubio invoked emergency authority). BUT: Iran deputy FM warned European basing nations will be 'legitimate targets for retaliation.' Spain refused 2 joint bases. Basing architecture expanding while political costs rising for host nations.", sources:[{t:"MEE-B1B",u:"https://www.middleeasteye.net/news/us-bombers-land-britain-pentagon-prepares-surge-iran-strikes"},{t:"ITV-Fairford",u:"https://www.itv.com/news/westcountry/2026-03-07/us-bomber-lands-in-gloucestershire-as-iran-war-enters-eighth-day"},{t:"TRT-Arms",u:"https://www.trtworld.com/article/e87e62db3834"},{t:"France24-Threat",u:"https://www.france24.com/en/tv-shows/t%C3%AAte-%C3%A0-t%C3%AAte/20260306-europeans-will-be-legitimate-targets-if-they-join-war-iran-s-deputy-fm-warns"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"sco-theater", name:"Limit conflict to Iran bilateral", party:"us", type:"achieve", importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 8: FIRST OIL INFRASTRUCTURE STRIKES (3 Tehran depots) = new target category. Iran-Azerbaijan ultimatum: 'expel the Israelis' or face consequences. Iran threatened European basing nations as 'legitimate targets.' B-1B bombers deployed to UK = European theater now operationally involved. Pezeshkian conditional ceasefire to neighbors contradicted within 1 hour (Dubai airport drone). 10+ theaters active. Iran attacked 12 countries (Cooper). War scope expanding on every axis — target categories, geographic theaters, and participating nations all growing.", sources:[{t:"ToI-Oil",u:"https://www.timesofisrael.com/liveblog_entry/air-force-striking-iranian-oil-infrastructure-in-tehran-in-apparent-first/"},{t:"MEE-B1B",u:"https://www.middleeasteye.net/news/us-bombers-land-britain-pentagon-prepares-surge-iran-strikes"},{t:"France24-Threat",u:"https://www.france24.com/en/tv-shows/t%C3%AAte-%C3%A0-t%C3%AAte/20260306-europeans-will-be-legitimate-targets-if-they-join-war-iran-s-deputy-fm-warns"},{t:"Euronews-DXB",u:"https://www.euronews.com/2026/03/07/iranian-drone-attack-suspends-flights-at-dubai-international-airport"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"FIRST OIL INFRASTRUCTURE STRIKES + $100 THRESHOLD APPROACHING: IDF struck 3 oil depots in western Tehran (Kuhak, Shahran, Karaj) — ~30 storage tanks targeted. First civil/energy infrastructure hit of war. Refinery undamaged. Brent $92.69, WTI $90.90. WTI +35.63% weekly = largest weekly gain in history. Kuwait cutting 100K bbl/day (storage full ~12 days). Qatar Energy Minister: oil could hit $150 if Gulf exports halt. ~9M bbl/day off market. Goldman Sachs: $100/bbl if Hormuz disrupted 5 weeks. India granted 30-day Russian oil waiver. Russia reporting 'significant increase in demand.' $100 threshold = political crisis.", sources:[{t:"ToI-Oil",u:"https://www.timesofisrael.com/liveblog_entry/air-force-striking-iranian-oil-infrastructure-in-tehran-in-apparent-first/"},{t:"CNBC-Kuwait",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"},{t:"CNBC-India",u:"https://www.cnbc.com/2026/03/06/us-india-waiver-russian-oil-iran-war-energy-supply-worries-.html"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"gulf-ad", name:"Maintain Gulf air defense effectiveness", party:"us", type:"achieve", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 8: UAE 121 drones (119 intercepted, 98.3%). Saudi: 2 BMs (Prince Sultan AB) + 6 drones (Shaybah) + 1 drone (east Riyadh). Qatar: 10 drones (9 intercepted, 1 landed remote). Bahrain cumulative: 86 missiles + 148 drones (up from 75+123). THAAD AN/TPY-2 radar damage confirmed at Al Dhafra + Jordan — ~$500M each, degrades BMD architecture. CRITICAL: at least one Gulf ally running low on interceptor munitions by Day 4 (CBS/Fortune). Resupply task force created but 'not happening as fast as needed.' Interception rates 90%+ but sustainability is Week 2 question.", sources:[{t:"CBS-Intercept",u:"https://www.cbsnews.com/news/arab-states-running-low-interceptors-iranian-fired-missiles/"},{t:"Fortune-Supply",u:"https://fortune.com/2026/03/07/trump-munitions-iran-war-ukraine-interceptors-patriot-thaad-low-supply/"},{t:"CNN-THAAD",u:"https://www.cnn.com/2026/03/05/middleeast/radar-bases-us-missile-defense-iran-war-intl-invs"},{t:"AJZ-D8",u:"https://www.aljazeera.com/news/liveblog/2026/3/7/iran-war-live-trump-says-no-deal-with-iran-until-unconditional-surrender"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"ter-us", name:"Prevent attacks on US homeland", party:"us", type:"avoid", importance:5, achievability:3, status:"in progress", outcomeNote:"Day 8: Asif Merchant convicted — Iranian assassination plot targeting Trump before the war. Demonstrates pre-existing IRGC operational capability on US soil. DHS Noem: terrorism risk 'elevated at this time.' Texas shooting (man with Iran flag). No mass-casualty event on US soil yet but threat level highest since 9/11 era. Merchant conviction provides legal/intelligence backdrop for ongoing domestic threat assessment.", sources:[{t:"ABC",u:"https://abc17news.com/news/national-world/cnn-national/2026/03/02/authorities-probe-whether-austin-shooter-was-motivated-by-iran-strikes-sources-say/"},{t:"NPR",u:"https://www.npr.org/2026/03/02/nx-s1-5732326/u-s-states-take-steps-to-guard-against-any-potential-threat-from-iran"},{t:"DOJ-Merchant",u:"https://www.justice.gov/opa/pr/"}] },
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:mobile?8:12 }}>
          <div>
            ...
            <div style={{ fontSize:mobile?10:11, color:C.textDim, marginTop:4 }}>
              ...
              <span style={{color:C.oppose}}>■</span> Opposing {!mobile && <>&nbsp;|&nbsp; Day 8 — Hour 204+ — March 7, 2026 — Evening Update</>}
            </div>
