...
const HIGHLIGHTS = {
  updatedAt: "2026-03-11T00:52Z",
  keyDevelopments: [
    { text: "CENTCOM destroyed 16 Iranian minelayers near Strait of Hormuz. CNN: Iran has begun laying mines — 'a few dozen' in recent days. Trump on Truth Social denies mines exist. France announced escort mission once intense phase ends.", why: "Mine-laying is the most significant escalation since the war began — transforms Hormuz from a blockade (reversible) to a minefield (weeks-months to clear). Even after hostilities end, mines remain. Iran retains 80-90% of mine-laying capacity despite 16 vessels sunk.", category: "military", goalIds: ["nav-mines", "nav-ships"], sources: [{t:"CNN-Mines",u:"https://www.cnn.com/2026/03/10/politics/iran-begins-laying-mines-in-strait-of-hormuz"},{t:"CENTCOM",u:"https://x.com/CENTCOM/status/2031489675760640370"},{t:"AJZ-Macron",u:"https://www.aljazeera.com/news/2026/3/9/france-preparing-to-escort-ships-in-strait-of-hormuz-when-war-calms-macron"}] },
    { text: "Energy Sec Wright posted then DELETED false claim Navy escorted tanker through Hormuz. WH + Pentagon both contradicted him. Oil dropped 17% on the tweet before recovery. Brent settled $87.80 (-11.28%), WTI $83.45.", why: "A cabinet secretary's deleted tweet moved global oil markets more than any military operation. Demonstrates that oil price is now a credibility indicator — and the administration's credibility on Hormuz is crumbling.", category: "economic", goalIds: ["en-oil", "en-pump"], sources: [{t:"AJZ-Wright",u:"https://www.aljazeera.com/news/2026/3/10/energy-secretary-deletes-claim-us-military-escorted-tanker-through-hormuz"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/10/crude-oil-prices-today-iran-war.html"}] },
    { text: "IDF: 50% of ~300 Iranian ballistic missiles at Israel carried cluster munitions — 20-24 bomblets each, 8km dispersal radius. 2 killed, multiple wounded. Hezbollah Fateh-110 missiles (350km) hitting specific military targets in central Israel.", why: "Cluster munitions change the calculus — intercepting the missile doesn't stop the bomblets, which scatter over 8km. Combined with Hezbollah precision strikes at 350km range, Israeli population centers face a dual threat air defense wasn't designed for.", category: "military", goalIds: ["cas-isr", "hez-rocket"], sources: [{t:"ToI-Cluster",u:"https://www.timesofisrael.com/liveblog_entry/half-of-iranian-missiles-fired-at-israel-had-cluster-bomb-warheads-idf-assesses/"},{t:"Haaretz-Cluster",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-10/ty-article/.premium/about-half-of-irans-missiles-fired-at-israel-were-cluster-munitions-idf-says/0000019c-d89e-d3be-a7fd-ffde2a740000"}] },
    { text: "G7 energy ministers DEFERRED oil reserves release — asked IEA to study options. No coordinated SPR release yet. Trump floating sanctions relief on unnamed oil producers.", why: "The single biggest near-term economic variable punted to a study. Without reserves release, $4 gas nationally is likely within weeks. Trump's sanctions relief hint (Russia/Venezuela?) could substitute — but at enormous geopolitical cost.", category: "economic", goalIds: ["en-oil", "en-pump"], sources: [{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/10/iea-g7-oil-iran-war-strait-hormuz.html"},{t:"AJZ-Sanctions",u:"https://www.aljazeera.com/economy/2026/3/10/trump-says-some-sanctions-to-be-lifted-on-oil-producers-amid-iran-war"}] },
    { text: "Lebanon: 570 dead (up from 486), 700,000+ displaced (UN). 100K displaced in single day. Maronite priest killed by Israeli tank fire after refusing evacuation. Iran arrests 30 'spies' + 81 detained for sharing info.", why: "Lebanon toll accelerating — 84 killed since last update. Priest's death will resonate across Christian communities. Iran's spy crackdown signals regime paranoia under new leadership — arresting citizens for sharing information with 'hostile media' while under 10-day internet blackout.", category: "humanitarian", goalIds: ["hez-leb", "nar-iran"], sources: [{t:"UN-700K",u:"https://news.un.org/en/story/2026/03/1167098"},{t:"AlMonitor-Spies",u:"https://www.al-monitor.com/originals/2026/03/iran-arrests-dozens-including-foreign-national-tied-us-and-israel-state-media"}] },
    { text: "Shahed drone factory in Isfahan CONFIRMED DESTROYED by satellite imagery. 10 of 17 Iranian tactical air bases targeted. IDF struck IRGC drone command HQ. Internal security apparatus targeted: 12+ Basij bases, police HQs, censorship company.", why: "Targeting has expanded beyond military to internal security infrastructure — Basij (anti-riot), police, censorship tools. This is regime-collapse-oriented targeting, not just capability degradation. Combined with drone factory destruction, Iran's ability to both fight and suppress its population is being simultaneously degraded.", category: "military", goalIds: ["mis-drone", "mis-c2", "nar-iran"], sources: [{t:"Pixel-Shahed",u:"https://x.com/ayatsubzero/status/2031049810799681906"},{t:"Alma-10bases",u:"https://x.com/Israel_Alma_org/status/2030918654867513600"},{t:"Alma-D11",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-10-2026-1800/"}] },
  ],
  watchNext: [
    { text: "Hormuz mine clearance — how many mines are in the water? US destroyed 16 minelayers but Iran retains 80-90% of capacity. Mine detection/clearance hasn't begun.", why: "Mines persist after hostilities end. Even a few dozen in shipping lanes could keep Hormuz closed for months. If Iran lays hundreds more before minelayers are neutralized, the economic impact extends far beyond the war itself.", category: "military", timeframe: "this week", sources: [{t:"CNN-Mines",u:"https://www.cnn.com/2026/03/10/politics/iran-begins-laying-mines-in-strait-of-hormuz"}] },
    { text: "Day 12 BDA — 'most intense day' aftermath. Will Iran's missile launches continue declining below the 90% degradation threshold?", why: "If launches hit zero, validates air campaign timeline. If Iran finds workarounds (mobile launchers, cluster munitions), 90% figure was temporary not permanent. The answer determines whether this is a 4-week or 12-week war.", category: "military", timeframe: "24-48h", sources: [{t:"CBS-Pentagon",u:"https://www.cbsnews.com/news/pete-hegseth-dan-caine-news-briefing-pentagon-iran-war/"}] },
    { text: "Houthis Day 12+ — 'hands on trigger' but still no strikes. Two officials told media they've 'decided to restart' Red Sea attacks — but nothing confirmed.", why: "If Houthis enter, it compounds Hormuz closure with Red Sea/Bab el-Mandeb closure — two of three global chokepoints blocked simultaneously. Their absence is the single biggest strategic win for the US so far.", category: "military", timeframe: "this week", sources: [{t:"FDD-LWJ",u:"https://www.longwarjournal.org/archives/2026/03/houthis-express-solidarity-with-iran-but-do-not-launch-retaliatory-attacks-yet.php"},{t:"ITV-Houthis",u:"https://www.itv.com/news/2026-03-10/the-houthis-irans-allies-threaten-another-trade-route-to-europe"}] },
    { text: "~$50B supplemental budget request + Senate Democrats demanding public hearings on war timeline", why: "Congress hasn't authorized or funded this war. A supplemental forces yes/no votes on every member. Democrats can't stop the war but can make the political cost visible.", category: "political", timeframe: "this week", sources: [{t:"CAP-Cost",u:"https://www.americanprogress.org/article/the-trump-administrations-reckless-war-in-iran-has-already-cost-more-than-5-billion/"},{t:"NPR-Dems",u:"https://www.npr.org/2026/03/10/g-s1-113167/democrats-iran-trump"}] },
    { text: "Ruwais refinery — hit AGAIN March 10. Still offline (922K bbl/day). Iran demonstrating ability to re-strike repaired infrastructure.", why: "If Iran can repeatedly hit Ruwais, the refinery can't restart even after repairs. This is a new pattern — 'hit, wait for restart, hit again' — that could permanently disable Gulf refining capacity for the war's duration.", category: "economic", timeframe: "24-48h", sources: [{t:"Bloomberg-Ruwais",u:"https://www.bloomberg.com/news/articles/2026-03-10/uae-says-drone-attack-causes-fire-in-zone-that-houses-refinery"}] },
    { text: "Toronto consulate + synagogue shootings — RCMP: 'national security incident.' 2 suspects sought. Pattern: Oslo → NYC → Toronto across 3 continents.", why: "Attribution pending. If Iranian-linked, demonstrates global operational reach. If copycat, demonstrates the war's psychological contagion beyond the Middle East.", category: "political", timeframe: "24-48h", sources: [{t:"CBC-Toronto",u:"https://www.cbc.ca/news/canada/toronto/toronto-police-say-us-consulate-struck-by-gunfire-9.7121843"},{t:"WaTimes-Sleeper",u:"https://www.washingtontimes.com/news/2026/mar/10/shooting-us-consulate-toronto-sparks-concerns-iranian-sleeper-cells/"}] },
  ],
  watchResolved: [
    { text: "G7 oil reserves release", resolved: "DEFERRED: Energy ministers met Tuesday, stopped short of release — asked IEA to 'study options.' US wanted 300-400M bbl. France: 'not there yet.' No timeline for decision.", status: "partial" },
    { text: "Pentagon supplemental", resolved: "IN PROGRESS: ~$50B request being prepared. $5B+ spent in 11 days. Senate Democrats now demanding public hearings. Graham: 'there will be a supplemental.'", status: "ongoing" },
    { text: "Houthi silence", resolved: "Day 11 without entry. Two officials said 'decided to restart' Red Sea attacks — but NO confirmed new strikes. Rhetoric escalating, action restrained.", status: "ongoing" },
    { text: "Oil settle price", resolved: "CRASHED: Brent $87.80 (-11.28%), WTI $83.45 (-11.94%). Wright tanker escort debacle caused 17% flash crash. Trump rhetoric > supply fundamentals.", status: "confirmed" },
    { text: "Lebanon peace overture", resolved: "REJECTED by Israel & US. 570 dead, 700K+ displaced. FP: 'inching toward civil war.' Priest killed.", status: "confirmed" },
    { text: "Turkey Article 5", resolved: "RESOLVED: 2nd Iranian BM intercepted by NATO in Turkish airspace (Gaziantep). Additional Patriot deploying to east. Rutte ruled out Article 5.", status: "confirmed" },
    { text: "'Most intense day' BDA", resolved: "CONFIRMED: 5,000+ targets, 90% missile degradation. 50+ naval vessels destroyed. 10/17 airbases hit. Shahed factory destroyed. But Iran adapting — cluster munitions + mine-laying.", status: "confirmed" },
    { text: "Ground troops debate", resolved: "STALLED: Trump 'nowhere near' deciding. No movement.", status: "ongoing" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"ANNIHILATED: 50+ vessels damaged/destroyed (up from 43). 16 minelayers sunk near Hormuz on Mar 10. White House: Iranian navy 'combat ineffective.' Shahid Soleimani-class corvette struck off Bandar Lengeh. Drone carrier sunk. IRIS Bushehr interned by Sri Lanka (first warship internment since WWII). 87 bodies recovered from IRIS Dena. Conventional navy destroyed. But IRGC coastal asymmetric forces still operating — mine-laying underway, fast boats sustaining Hormuz blockade.", sources:[{t:"Wiki",u:"https://en.wikipedia.org/wiki/2026_Iran_war"},{t:"NavyTimes",u:"https://www.navytimes.com/news/2026/03/05/us-has-destroyed-iranian-drone-carrier-centcom-commander-says/"},{t:"CENTCOM-16",u:"https://x.com/CENTCOM/status/2031489675760640370"},{t:"Faytuks",u:"https://x.com/FaytuksNetwork/status/2031003449605624014"}],
    subgoals:[
      { id:"nav-ships", name:"Sink Iranian warships", party:"us", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"50+ VESSELS DESTROYED: Up from 43. 16 minelayers sunk near Hormuz Mar 10. Shahid Soleimani-class corvette struck off Bandar Lengeh (visual confirmation). IRIS Dena torpedoed off Sri Lanka — 87 killed. IRIS Bushehr interned by Sri Lanka. IRIS Lavan limped to India. Shahid Bagheri drone carrier sunk. Conventional navy annihilated; IRGC coastal asymmetric forces remain but being systematically targeted.", sources:[{t:"NavyTimes",u:"https://www.navytimes.com/news/2026/03/05/us-has-destroyed-iranian-drone-carrier-centcom-commander-says/"},{t:"CENTCOM-16",u:"https://x.com/CENTCOM/status/2031489675760640370"},{t:"Faytuks",u:"https://x.com/FaytuksNetwork/status/2031003449605624014"}] },
      ...
      { id:"nav-mines", name:"Prevent/clear mine-laying in Hormuz", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"MINES IN THE WATER: CNN/US intelligence confirms Iran began laying mines — 'a few dozen' in recent days. CENTCOM destroyed 16 minelaying vessels near Strait on Mar 10. But Iran retains 80-90% of small boats and mine layers — could lay hundreds more. Trump on Truth Social: 'no reports' of mines (contradicts intelligence). France announced 'purely defensive' escort mission to reopen Hormuz once intense phase ends. Mine clearance would take weeks-months even after hostilities.", sources:[{t:"CNN-Mines",u:"https://www.cnn.com/2026/03/10/politics/iran-begins-laying-mines-in-strait-of-hormuz"},{t:"CENTCOM-16",u:"https://x.com/CENTCOM/status/2031489675760640370"},{t:"AJZ-Macron",u:"https://www.aljazeera.com/news/2026/3/9/france-preparing-to-escort-ships-in-strait-of-hormuz-when-war-calms-macron"}] },
    ]
  },
  {
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"hez-leb", name:"Get Lebanon to act against Hezbollah", party:"israel", type:"achieve", importance:3, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Day 11: 570 KILLED, 700,000+ DISPLACED (UN). 100,000 displaced in single day. FP: Lebanon 'inching toward civil war.' Aoun's 4-point plan rejected by Israel & US. Government declared Hezbollah military activity illegal, banned IRGC ops, but military court released detained members on bail. Maronite priest Pierre al-Rahi killed by Israeli tank fire in Qlayaa after refusing evacuation. Lebanon genuinely desperate — caught between Hezbollah and Israel with no leverage over either.", sources:[{t:"FP-CivilWar",u:"https://foreignpolicy.com/2026/03/09/lebanon-hezbollah-civil-war-israel-iran/"},{t:"UN-700K",u:"https://news.un.org/en/story/2026/03/1167098"},{t:"AJZ-D11",u:"https://www.aljazeera.com/news/2026/3/10/iran-war-what-is-happening-on-day-11-of-us-israel-attacks"}] },
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 11: HEZBOLLAH LONG-RANGE PRECISION STRIKES — Fateh-110 missiles (350km range) hitting specific military targets: Emek Ha'ela SES satellite station damaged (confirmed via satellite imagery), kindergarten in Ramla hit, 16 wounded in central Israel salvo. 269 total attack waves since Mar 2 (31 on Mar 9 alone). IDF investigating failure to intercept one missile. Nasr Unit Commander Abu Hussein Ragheb killed. IDF struck 120+ targets. Hezbollah range covers majority of Israel's populated center.", sources:[{t:"Fabian-16",u:"https://x.com/manniefabian/status/2031057168250843602"},{t:"Evergreen-Satellite",u:"https://x.com/vcdgf555/status/2031035259081687356"},{t:"Alma-D11",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-10-2026-1800/"}] },
    ]
  },
  {
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 11: Iran gov (Foundation of Martyrs): 1,230-1,255 killed. HRANA: 912 verified civilian deaths + 183 children under 10. Hengaw: 4,000+ military killed (first military-specific estimate). ~10,000 wounded. 'Most intense day' of strikes declared — civilian toll expected to rise. Lebanon: 570 killed, 700,000+ displaced. Bahrain: 1 woman killed in residential drone strike. 12+ Basij bases in Tehran targeted + police HQs + censorship company (Sahab Pardaz). Internal security apparatus now explicitly targeted.", sources:[{t:"AJZ-1255",u:"https://www.aljazeera.com/news/2026/3/9/iran-says-1255-killed-in-us-israeli-attacks-mostly-civilians"},{t:"DefPost-1900",u:"https://thedefensepost.com/2026/03/10/israel-killed-iran-warfighters/"},{t:"Alma-D11",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-10-2026-1800/"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 11 close: Brent $87.80 (-11.28%), WTI $83.45 (-11.94%). Oil briefly below $100 on Trump rhetoric — but fundamentals unchanged. Energy Sec Wright's deleted tanker escort claim caused 17% flash crash. G7 energy ministers deferred SPR release to IEA study. Trump floating sanctions relief on oil producers. Ruwais refinery hit AGAIN Mar 10 — still offline. ~1,000 ships can't transit Hormuz (97% collapse). Iraqi production down 60%. Below $100 for now but entirely dependent on Trump's words, not supply reality.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/10/crude-oil-prices-today-iran-war.html"},{t:"AJZ-Wright",u:"https://www.aljazeera.com/news/2026/3/10/energy-secretary-deletes-claim-us-military-escorted-tanker-through-hormuz"},{t:"CNBC-G7",u:"https://www.cnbc.com/2026/03/10/iea-g7-oil-iran-war-strait-hormuz.html"}] },
