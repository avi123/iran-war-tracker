...
const HIGHLIGHTS = {
  updatedAt: "2026-03-12T00:35Z",
  keyDevelopments: [
    { text: "Pentagon preliminary investigation confirms US Tomahawk killed 175 children at Shajarah Tayyebeh girls school in Minab, Iran on Feb 28 — outdated DIA coordinates (school partitioned from IRGC base by 2016). Trump publicly blamed Iran. Own government's finding contradicts the president.", why: "The school strike is now Iran's most powerful information weapon — confirmed by the US government itself. Trump's public misattribution to Iran is a documented presidential misstatement on a war crime investigation. This is the Kosovo Chinese embassy moment, arriving at Day 12 instead of Day 72.", category: "humanitarian", goalIds: ["civ-hospital", "dom-justify", "cas-civ"], sources: [{t:"NPR-School",u:"https://www.npr.org/2026/03/11/nx-s1-5744981/pentagon-iran-missile-school-hegseth"},{t:"Newsweek-School",u:"https://www.newsweek.com/iran-school-strike-us-tomahawk-targeting-error-report-11660925"},{t:"TheIntercept",u:"https://theintercept.com/2026/03/11/iran-school-missile-investigation/"}] },
    { text: "CENTCOM: 5,500+ targets struck, 60+ ships sunk, all Soleimani-class corvettes eliminated. Bandar Abbas struck (Day 10-11): 6 precision strikes, 11 warships sunk, Makran base ablaze. Hegseth declared Day 12 'most intense day of strikes on Iran.'", why: "Bandar Abbas was the CENTCOM ports warning realized — Phase 2 is targeting Iran's import/export infrastructure, not just military capability. All four Soleimani-class corvettes destroyed = Iran's blue-water capability is gone. Asymmetric IRGC fast-boat force remains.", category: "military", goalIds: ["navy", "nav-ships", "reg-repress"], sources: [{t:"MilTimes-Class",u:"https://www.militarytimes.com/news/your-military/2026/03/11/us-has-destroyed-entire-class-of-iranian-warships-centcom-commander-says/"},{t:"JFeed-Bandar",u:"https://www.jfeed.com/news-world/us-strikes-iran-bandar-abbas-port"},{t:"CTP-ISW-D12M",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-11-2026"}] },
    { text: "IRGC + Hezbollah declared first 'joint and integrated operation' — 150 rockets at northern Israel in 24 hours (war record). IDF advancing into Bint Jbeil District (south Lebanon). Senior Israeli security official: 'eve of a fateful campaign in Lebanon that will determine the future of both countries.'", why: "The joint operation declaration is strategically significant — Iran is now publicly coordinating with Hezbollah as a combined force, not separate fronts. The 'fateful campaign' signal and ground advance into Bint Jbeil suggest Lebanon escalation is imminent, not hypothetical.", category: "military", goalIds: ["hez-rocket", "hez-ground", "hez-leb"], sources: [{t:"ToI-D12",u:"https://www.timesofisrael.com/liveblog-march-11-2026/"},{t:"CTP-ISW-D12M",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-11-2026"}] },
    { text: "Oil rebounded to ~$88 after IEA 400M bbl release — IRGC threatens $200/bbl, 15M bbl/day stranded in Persian Gulf. Dubai airport struck (2 drones, 4 injured). Oman fuel silos burning. Bahrain evacuating aircraft. Ruwais still offline.", why: "IEA release temporarily suppressed price but didn't fix the supply problem. 15M bbl/day stranded = de facto closure is real, not declaratory. Iran attacking every bypass route simultaneously (Dubai, Oman, Bahrain) while threatening $200 oil. IEA buys weeks, not months, if Hormuz stays closed.", category: "economic", goalIds: ["en-oil", "hor-bypass", "hor-energy"], sources: [{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"},{t:"TheNational-Dubai",u:"https://www.thenationalnews.com/news/uae/2026/03/11/four-injured-after-iranian-drone-strike-near-dubai-airport/"},{t:"Bloomberg-Bahrain",u:"https://www.bloomberg.com/news/articles/2026-03-11/bahrain-takes-aircraft-out-of-country-as-iran-threat-persists"}] },
    { text: "Pentagon briefed Senate: $11.3 billion spent in first 6 days. UN Security Council passed 13-2 resolution demanding Iran halt Gulf state attacks. Pezeshkian set ceasefire conditions: recognition + reparations + no future attack guarantees — non-starter in Washington.", why: "$11.3B in 6 days (vs earlier CSIS $891M/day = $5.3B in 6 days — both estimates suggest $1.5-2B/day run rate). At this pace, 100 days = $150-200B. Congress hasn't authorized or appropriated any of it. The 13-2 UN vote gives Iran's opponents a legal framing; Pezeshkian's conditions give Iran a face-saving off-ramp that neither the US nor Israel will take.", category: "political", goalIds: ["dom-warpow", "dip-nato", "reg-endgame"], sources: [{t:"NBC-D12",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-israel-us-lebanon-tehran-oil-prices-hormuz-rcna262889"},{t:"ToI-D12",u:"https://www.timesofisrael.com/liveblog-march-11-2026/"}] },
  ],
  watchNext: [
    { text: "IDF 'fateful campaign' signal — ground advance into Bint Jbeil District. Is Lebanon escalation days away?", why: "Senior Israeli security official language ('fateful campaign, determines the future of both countries') is the strongest escalation signal of the war. IDF already advancing into Kanouq, Aitaroun. If Bint Jbeil falls, Lebanon becomes a second major ground theater.", category: "military", timeframe: "imminent", sources: [{t:"ToI-D12",u:"https://www.timesofisrael.com/liveblog-march-11-2026/"}] },
    { text: "Oil at $88 and climbing — will IRGC $200/bbl threat + continued ship strikes push back above $100 despite IEA release?", why: "IEA release addresses price but not supply. Oil rebounded from $86 to $88 same day as release. If mines spread or Hormuz ships stop entirely, the reserve release buys weeks not months. $100 will be retested.", category: "economic", timeframe: "24-48h", sources: [{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"},{t:"AJZ-IRGC200",u:"https://www.aljazeera.com/news/2026/3/11/irans-irgc-says-not-one-litre-of-oil-will-get-through-strait-of-hormuz"}] },
    { text: "IRGC threat to target Middle East banks and financial institutions — UAE banks? Saudi SABIC? Systematic financial attack would be new category.", why: "Iran announced it will target regional banks as retaliation for Bank Sepah/Melli strikes. If executed, this would be the first systematic financial infrastructure attack of the war — new escalation category with civilian economic impact.", category: "military", timeframe: "24-48h", sources: [{t:"ToI-D12",u:"https://www.timesofisrael.com/iran-threatens-banks-as-3-commercial-ships-hit-in-gulf-drones-impact-near-dubai-airport/"}] },
    { text: "School strike congressional fallout — preliminary Pentagon finding that US killed 175 children. Does this crack domestic support?", why: "Trump publicly blamed Iran; own Pentagon contradicts him. Congressional Democrats have a documented presidential misstatement on a war crime investigation. This is leverage for hearings, even if War Powers vote failed.", category: "political", timeframe: "this week", sources: [{t:"NPR-School",u:"https://www.npr.org/2026/03/11/nx-s1-5744981/pentagon-iran-missile-school-hegseth"}] },
    { text: "$11.3B in 6 days — $50B supplemental + Congressional authorization fight. When does cost trigger a forced vote?", why: "Congress hasn't authorized or funded this war. At $1.5-2B/day run rate, 100 days = $150-200B. Democrats can force every member to vote on cost before midterms even if they can't stop the war.", category: "political", timeframe: "this week", sources: [{t:"NBC-D12",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-israel-us-lebanon-tehran-oil-prices-hormuz-rcna262889"},{t:"CAP-Cost",u:"https://www.americanprogress.org/article/the-trump-administrations-reckless-war-in-iran-has-already-cost-more-than-5-billion/"}] },
    { text: "Hezbollah ATGM depletion — at 150 rockets/24hr record with active rationing, how many precision strikes remain?", why: "Hezbollah precision strikes (ATGMs, Fateh-110) are the high-value threat; volume rockets are annoyances. When ATGMs run out, Hezbollah shifts to area fire — less dangerous per strike but harder to intercept at volume.", category: "military", timeframe: "open question", sources: [{t:"CTP-ISW-D12M",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-11-2026"}] },
  ],
  watchResolved: [
    ...
    { text: "G7 oil reserves release", resolved: "CONFIRMED: IEA approved 400M bbl release (largest in history). G7 had deferred; IEA overrode. Oil fell to $86 then rebounded to $88 — Hormuz supply side unchanged.", status: "confirmed" },
    { text: "Day 12 BDA — 'most intense day' aftermath", resolved: "CONFIRMED: 5,500+ targets, 60+ ships, Soleimani-class eliminated. Hegseth declares Day 12 most intense day yet.", status: "confirmed" },
    ...
    { text: "Pentagon supplemental", resolved: "$11.3B in first 6 days (Senate briefing). ~$50B supplemental being prepared. Dems demanding hearings.", status: "ongoing" },
    { text: "Houthi silence", resolved: "Day 12 without entry. Pledged allegiance to Mojtaba as 'Imam.' Stimson: weakened Iran makes entry 'detrimental.'", status: "ongoing" },
    { text: "Toronto consulate + synagogue shootings", resolved: "RCMP: 'national security incident.' 2 suspects sought. No Iranian attribution confirmed yet.", status: "ongoing" },
    { text: "Ruwais refinery restart", resolved: "HALTED: Still offline Day 12. Oman fuel silos also struck. Bahrain evacuating aircraft.", status: "ongoing" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 12: MOJTABA WOUNDED BUT LEADING. NYT: Mojtaba wounded in both legs on opening day of war (Feb 28) — unconfirmed single source. 'Death to Mojtaba' chants heard from windows across Iranian cities. BUT Houthis pledged allegiance calling him 'Imam' — suggests even Iran's allies believe regime will survive. Israeli ministers told cabinet: complete regime change could take 'up to a year.' IRGC 'complete obedience' pledge intact. Institutional succession complete; popular acceptance contested but regime controlling narrative under blackout.", sources:[{t:"NYT-Wounded",u:"https://www.timesofisrael.com/liveblog_entry/irans-new-supreme-leader-mojtaba-khamenei-said-injured-in-legs-on-opening-day-of-war-nyt/"},{t:"FP-Houthi",u:"https://foreignpolicy.com/2026/03/11/why-houthis-havent-fired-iran/"},{t:"AJZ-Mojtaba",u:"https://www.aljazeera.com/news/2026/3/9/hezbollah-pledges-allegiance-mojtaba-khamenei"},{t:"AJZ-Named",u:"https://www.aljazeera.com/news/2026/3/8/iran-names-khameneis-son-as-new-supreme-leader-after-fathers-killing-2"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"nav-mines", name:"Prevent/clear mine-laying in Hormuz", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"MINES OPERATIONAL + 3 SHIPS STRUCK: Day 12: Three commercial vessels hit near Strait — Thai-flagged Mayuree Naree (USV struck waterline, fire, crew evacuated), Japanese One Majesty (damaged), third bulk carrier. UKMTO: 17 incidents total since Feb 28. CTP-ISW D12: ~12 mines confirmed deployed in Strait — fewer than expected. Iran retains 5,000-6,000 mines but hesitating: full deployment would trap Chinese tankers and cut Iraqi oil revenue (key political costs Iran is absorbing at minimum). CENTCOM destroyed 16 minelayers, all Soleimani-class — but Iran retains 80-90% of small boat capacity. Mine clearance would take weeks-months after hostilities even if Iran stops now. France pledged 'purely defensive' escort once intense phase ends. Bandar Abbas struck (Day 10-11): 6 precision strikes, 11 warships sunk, Makran base ship ablaze — forward naval base degraded.", sources:[{t:"CNBC-Ships",u:"https://www.cnbc.com/2026/03/11/cargo-ship-struck-strait-of-hormuz-uk-iran-war.html"},{t:"CNBC-Mines",u:"https://www.cnbc.com/2026/03/11/us-strikes-iran-mine-ships-strait-of-hormuz-war-oil.html"},{t:"CENTCOM-Ports",u:"https://www.centcom.mil/MEDIA/PRESS-RELEASES/Press-Release-View/Article/4430855/civilians-warned-to-avoid-ports-used-by-iranian-forces/"},{t:"CNN-Mines",u:"https://www.cnn.com/2026/03/10/politics/iran-begins-laying-mines-in-strait-of-hormuz"}] },
    ]
  },
  {
    ...
    subgoals:[
      ...
      { id:"hor-bypass", name:"Maintain alternative export routes", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Day 12: BYPASS ROUTES UNDER SIMULTANEOUS ATTACK — Oman fuel silos burning after drone strikes on Oman port; 2 Iranian drones hit near Dubai International Airport (4 injured, flights continued); Bahrain evacuating Gulf Air + cargo aircraft out of country (pre-emptive). Ruwais refinery (922K bbl/day) still offline. Day 11: Fujairah port struck (ops halted). Saudi East-West pipeline reaching 7M bbl/day capacity (major bypass option). Iraq southern fields down 70%. Iran systematically targeting every non-Hormuz export route in parallel with Hormuz mining — not rationing effort.", sources:[{t:"Euronews-D11",u:"https://www.euronews.com/2026/03/10/tehran-fires-barrage-of-drones-at-neighbouring-saudi-arabia-and-kuwait-as-iran-war-enters-"},{t:"Argus",u:"https://www.argusmedia.com/en/news-and-insights/latest-market-news/2795400-uae-s-fujairah-storage-tanks-hit-by-drones"},{t:"Bloomberg-Ruwais",u:"https://www.bloomberg.com/news/articles/2026-03-10/uae-says-drone-attack-causes-fire-in-zone-that-houses-refinery"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"hez-ground", name:"Clear southern Lebanon border zone", party:"israel", type:"achieve", importance:4, achievability:3, status:"in progress", outcomeNote:"Day 12: GROUND OPS ADVANCING — IDF moving into Kanouq neighborhood, Aitaroun, Bint Jbeil District (south Lebanon). Senior Israeli security official: 'We are on the eve of a fateful campaign in Lebanon which will determine the future of both countries.' 30+ multi-story buildings destroyed in Dahiyeh since March 2. 750,000+ displaced in Lebanon (up from 667K). IDF struck Hezbollah HQ and weapons storage in Dahiyeh with 30-min evacuation notice. Earlier: IDF ordered 500,000+ to evacuate all of southern Beirut. Smotrich: 'Dahieh will look like Khan Younis.' Gaza operational template being applied to Lebanese capital suburbs. Radwan deployed to block armor. IRGC + Hezbollah announced first 'joint and integrated operation' Day 12 evening.", sources:[{t:"CNN",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-05-26"}] },
      ...
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 12 EVENING: IRGC + HEZBOLLAH DECLARE FIRST 'JOINT AND INTEGRATED OPERATION.' ~150 rockets fired at northern Israel in 24 hours — record volume of war. IRGC announced joint operation with Hezbollah targeting Israel, Jordan, and Saudi Arabia simultaneously. At least six heavy IDF strikes on Dahiyeh (south Beirut). Day 11: 29 distinct attacks in 24 hours; SES civilian satellite station near Beit Shemesh hit — no intercept, no siren (IDF: 'isolated failure'). ATGM stocks depleting — Hezbollah rationing precision strikes while maintaining rocket volume. Appointing 4 deputies per commander (redundancy against decapitation). IDF: Lebanon launched MORE attacks than Iran over past week. Senior Israeli security official Day 12: 'We are on the eve of a fateful campaign in Lebanon which will determine the future of both countries.'", sources:[{t:"Fabian-Satellite",u:"https://x.com/manniefabian/status/2031416252770533883"},{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"},{t:"Haaretz-D12",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-11/ty-article-live/iran-fires-four-barrages-at-israel-idf-launches-wide-scale-attacks-in-tehran/0000019c-daf7-d9b7-a5fd-dfff2a880000"}] },
    ]
  },
  {
  ...
  // ═══ TIER 3: POLITICAL / DIPLOMATIC ═══
  {
    ...
    subgoals:[
      { id:"dom-justify", name:"Maintain 'imminent threat' justification", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 12: FIFTH CONTRADICTION — Pentagon preliminary confirms US Tomahawk killed 175 children at Minab girls school. Trump publicly blamed Iran. Own government's preliminary finding contradicts the president. Day 4: FOUR contradictory war rationales: (1) imminent threat, (2) Israel forced hand (Rubio Mon), (3) diplomacy failed, (4) preemptive intuition (Trump: 'It was my opinion they were going to attack first' — cited no intelligence). Rubio denied own Monday statement on Tuesday. School strike adds: (5) administration's public attribution directly contradicts its own investigation. Each contradiction compounds; opponents now have documented presidential misstatement on a war crime investigation.", sources:[{t:"WaPo",u:"https://www.washingtonpost.com/national-security/2026/03/03/trump-iran-war-rationale-hegseth-rubio/"},{t:"CNN",u:"https://www.cnn.com/2026/03/03/politics/explanation-trump-preemptive-iran-strikes"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 12: IEA 400M BBL RELEASE (LARGEST IN IEA HISTORY) — OIL BELOW $100 BUT REBOUNDING. Oil fell to ~$86 on IEA announcement, then rebounded to ~$88 as 3 more ships struck in Hormuz same day. IEA release addresses demand-side price, not supply-side Hormuz closure. Ruwais still offline. ~12 mines in water. IRGC: 'not one liter of oil' — threatening $200/bbl. 15M bbl/day stranded. Brent peaked at $119.50 (Day 11); IEA release pulled it back but Hormuz fundamentals unchanged — whether it holds depends on shipping, not reserves. Watch: if Hormuz ships resume, $100 won't be tested. If mines spread, IEA release buys weeks, not months.", sources:[{t:"CNBC-IEA",u:"https://www.cnbc.com/2026/03/11/oil-price-today-crude-wti-us-iran-war-strait-hormuz-iea.html"},{t:"AJZ-D12",u:"https://www.aljazeera.com/news/2026/3/11/iran-war-what-is-happening-on-day-12-of-us-israel-attacks"},{t:"ToI-D12",u:"https://www.timesofisrael.com/liveblog-march-11-2026/"}] },
