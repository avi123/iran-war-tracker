...
const HIGHLIGHTS = {
  updatedAt: "2026-03-14T13:59Z",
  keyDevelopments: [
    { text: "KHARG ISLAND STRUCK — 90 MILITARY TARGETS. US executed 'one of the most powerful bombing raids in the history of the Middle East' (Trump) overnight on Iran's #1 oil export hub. Targets: naval mine storage, missile bunkers, airbase runway cratered, air defense, IRGC sites. Oil infrastructure deliberately spared — Trump warned it becomes target if Hormuz stays blocked.", why: "Kharg handles ~90% of Iran's oil exports. Striking military infrastructure ON the island while explicitly sparing oil infrastructure is both a massive show of capability and a coercive threat — 'we can destroy your oil revenue at will.' B-2 bombers used. Sets up an escalation ladder where Iran's economic survival is the next rung.", category: "military", goalIds: ["navy", "hormuz", "en-oil"], sources: [{t:"NPR-Kharg",u:"https://www.npr.org/2026/03/14/nx-s1-5747838/trump-kharg-island-iran-war"},{t:"AJZ-Kharg",u:"https://www.aljazeera.com/news/liveblog/2026/3/14/iran-war-live-pentagon-vows-to-ramp-up-us-military-campaign-against-iran"},{t:"sentdefender-Kharg",u:"https://x.com/sentdefender/status/2032633904331432006"}] },
    { text: "ISRAEL PLANNING LARGEST LEBANON GROUND INVASION SINCE 2006 — seize all territory south of Litani River. 3 armored/infantry divisions on border, reserves mobilizing. 7-8 km buffer zone + 20 outposts planned.", why: "This is the most significant scope expansion of the war. A Litani-line operation would put IDF in control of ~1,000 sq km of southern Lebanon — far beyond the current limited raids. Triggered by Hezbollah's record 200+ rocket barrage. If executed, transforms a multi-front air campaign into a ground occupation on a second front while the Iran air campaign continues.", category: "military", goalIds: ["hez", "hez-ground", "scope"], sources: [{t:"Axios-Invasion",u:"https://www.axios.com/2026/03/14/israel-lebanon-ground-invasion-hezbollah"},{t:"ToI-Invasion",u:"https://www.timesofisrael.com/israel-said-planning-massive-ground-invasion-of-southern-lebanon-to-uproot-hezbollah/"}] },
    { text: "KC-135 — ALL 6 CREW CONFIRMED DEAD. US KIA now 13 total (7 hostile fire + 6 crash). War cost: ~$16.5B in 12 days. $50B supplemental requested. 250+ organizations opposing.", why: "13 US KIA in 15 days with 4 manned aircraft lost. Cost running $1.4B/day. The $50B supplemental forces every member of Congress to vote on war funding — political exposure that War Powers resolutions did not create. 250+ groups opposing gives organized opposition a vehicle. France lost its first KIA (Erbil drone) — coalition casualties now multinational.", category: "military", goalIds: ["cas-us", "cas-zero", "dom-warpow"], sources: [{t:"CENTCOM-KC135",u:"https://x.com/CENTCOM/status/2032460946770202725"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"},{t:"ACLU-250",u:"https://www.aclu.org/press-releases/more-than-250-groups-oppose-additional-spending-on-trumps-illegal-iran-war"}] },
    { text: "IRAN FIRES CLUSTER MUNITIONS AT ISRAEL — BM with cluster bomb warhead hit Shoham + Rishon Lezion. IRGC threatens UAE as 'legitimate targets.' Missile launcher degradation quantified: 160-190 destroyed, ~200 disabled, ~150 remain. Crew desertions reported.", why: "Cluster munitions = weapons escalation even as volume declines (missiles ↓90%, drones ↓95%). Iran adapting rather than exhausting — fewer missiles but more sophisticated payloads. Meanwhile IRGC formally threatening UAE after Kharg strike raises the stakes for Gulf allies hosting US forces. The launcher quantification (160-190 destroyed) is the first precise IDF number — confirming ~60% hardware destruction + crew attrition.", category: "military", goalIds: ["cas-isr", "hez-rocket", "gulf-protect", "missile"], sources: [{t:"manniefabian-Cluster",u:"https://x.com/manniefabian/status/2032523479984030088"},{t:"AmitSegal-Launchers",u:"https://x.com/AmitSegal/status/2032365394451694063"},{t:"TheHill-UAE",u:"https://thehill.com/policy/international/5784080-iran-threatens-uae-cities/"}] },
    { text: "EUROPEAN JEWISH ATTACKS SPREADING — Amsterdam Jewish school bombed, Rotterdam synagogue arson (4 arrested). 'Ashab Al Yamim' claiming attacks. Stryker cyberattack confirmed physical-world disruption. 7 countries outside Middle East now hit.", why: "The geographic spread from Middle East → Oslo → NYC → Toronto → Belgium → Amsterdam → Rotterdam establishes a systematic pattern of anti-Jewish attacks across Europe. Combined with the Stryker cyberattack (first confirmed physical disruption to a US company), Iran's asymmetric reach is now touching 15+ countries. This erodes the 'contained' narrative and makes the war a European domestic security issue.", category: "regime", goalIds: ["terror", "ter-us", "ter-global"], sources: [{t:"ToI-Amsterdam",u:"https://www.timesofisrael.com/liveblog-march-14-2026/"},{t:"CEPA-Europe",u:"https://cepa.org/article/and-so-it-begins-irans-terror-proxies-emerge-from-the-shadows/"},{t:"FDD-Europe",u:"https://www.fdd.org/analysis/2026/03/13/irans-war-across-europe-complacency-must-finally-end/"}] },
    { text: "OIL VOLATILE — peaked $119.50, now ~$97-100. IEA released 400M barrels (largest ever). Gas $3.48-3.63 nationally, CA $5.20. Iran selectively opening Hormuz to Turkey, India, Saudi ships.", why: "Oil swung from $67 pre-war to $119.50 peak to ~$97-100 — extreme volatility reflecting competing forces: supply destruction vs. IEA reserves vs. selective Hormuz opening. Iran maintaining 2.1M bbl/day exports through the Strait it supposedly closed. The selective opening reveals Iran's Hormuz strategy: punish US/allies while maintaining own revenue + keeping non-Western partners cooperative.", category: "economic", goalIds: ["en-oil", "en-pump", "hormuz"], sources: [{t:"Fortune-Peak",u:"https://fortune.com/article/price-of-oil-03-13-2026/"},{t:"IEA-Record",u:"https://www.iea.org/news/iea-member-countries-to-carry-out-largest-ever-oil-stock-release-amid-market-disruptions-from-middle-east-conflict"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/gas-prices-today-us-iran-war-oil-strait-of-hormuz/"}] },
  ],
  watchNext: [
    { text: "Lebanon ground invasion timing — Axios: 'within a week.' 3 divisions on border. Will Israel execute or use as leverage?", why: "If executed, this transforms the war from multi-front air campaign to ground occupation on two fronts simultaneously. 2006 Lebanon War lasted 34 days with significant IDF casualties. A Litani operation while the Iran air campaign continues would stretch Israeli forces and dramatically increase civilian casualties in Lebanon (already 773 dead).", category: "military", timeframe: "this week", sources: [{t:"Axios-Invasion",u:"https://www.axios.com/2026/03/14/israel-lebanon-ground-invasion-hezbollah"},{t:"ToI-Invasion",u:"https://www.timesofisrael.com/israel-said-planning-massive-ground-invasion-of-southern-lebanon-to-uproot-hezbollah/"}] },
    { text: "Kharg oil infrastructure — Trump explicitly warned it becomes a target if Hormuz stays blocked. Iran vowed Hormuz stays closed. Collision course.", why: "If US strikes Kharg oil infrastructure, it removes ~90% of Iran's oil export revenue — potentially regime-ending economically. But it would also spike oil above $119.50 peak and accelerate global energy crisis. This is the most consequential escalation decision remaining.", category: "economic", timeframe: "this week", sources: [{t:"NPR-Kharg",u:"https://www.npr.org/2026/03/14/nx-s1-5747838/trump-kharg-island-iran-war"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/13/trump-iran-oil-prices-military-strait-of-hormuz.html"}] },
    { text: "Goldman $110 threshold — March 21 (7 days). Oil at ~$97-100 after $119.50 peak. IEA release buying time but not solving structural gap.", why: "March 21 remains Goldman's inflection point. IEA 400M bbl release created temporary ceiling but Hormuz still at <10% for Western ships. If selective opening expands, pressure eases. If Kharg oil infrastructure struck, $150+ possible.", category: "economic", timeframe: "this week", sources: [{t:"Goldman-Forecast",u:"https://money.usnews.com/investing/news/articles/2026-03-11/goldman-sachs-raises-q4-brent-wti-crude-price-forecast-amid-longer-hormuz-disruption"}] },
    { text: "School strike March 18 deadline — 4 days. Pentagon formally elevated investigation. Majority of House Dem caucus demanding answers.", why: "Pentagon elevation = institutional acknowledgment of likely US responsibility. March 18 deadline creates a forcing function. 168 children dead. If DOD provides substantive response, it validates the accountability mechanism. If it stonewalls, school strike becomes a Congressional flashpoint for the $50B supplemental debate.", category: "political", timeframe: "this week", sources: [{t:"USNews-Elevated",u:"https://www.usnews.com/news/world/articles/2026-03-13/pentagon-elevates-investigation-into-iran-school-strike"},{t:"Ansari-House",u:"https://ansari.house.gov/media/press-releases/03/12/2026/reps-ansari-jacobs-crow-lead-majority-of-house-democratic-caucus-demanding-answers-on-reported-us-strike-on-iranian-school"}] },
    { text: "IRGC threats to UAE — formal declaration of US facilities as 'legitimate targets.' Will attacks escalate beyond current drone/missile pattern?", why: "IRGC formal threat after Kharg strike is a step-change from opportunistic attacks to declared targeting. If a significant strike hits UAE civilian or US military infrastructure, it could trigger a ground response or Article 5-adjacent scenario. UAE is the US's most critical Gulf basing partner.", category: "military", timeframe: "24-48h", sources: [{t:"TheHill-UAE",u:"https://thehill.com/policy/international/5784080-iran-threatens-uae-cities/"},{t:"AJZ-IRGC",u:"https://www.aljazeera.com/news/liveblog/2026/3/14/iran-war-live-pentagon-vows-to-ramp-up-us-military-campaign-against-iran"}] },
    { text: "Houthi entry — Day 15 without engagement. Leader: 'hands on the trigger.' Restraint holding but Iran's degradation shifting calculus.", why: "Each day of non-entry = strategic win. But if Lebanon ground invasion proceeds + Hormuz stays selectively open, Houthis could calculate that Red Sea disruption is their only remaining leverage for Iran. Entry would create simultaneous closures of Hormuz + Bab el-Mandeb — ~35% of global maritime trade.", category: "military", timeframe: "open question", sources: [{t:"Stimson",u:"https://www.stimson.org/2026/the-houthis-must-decide-join-irans-war-against-the-us-and-israel-or-abandon-iran/"},{t:"Axios-Houthis",u:"https://www.axios.com/2026/03/12/iran-war-houthis-yemen-gulf-red-sea"}] },
  ],
  watchResolved: [
    { text: "KC-135 crash crew status", resolved: "CONFIRMED: All 6 crew dead (CENTCOM March 14). US KIA now 13 total. NOT hostile fire. Resolved.", status: "confirmed" },
    { text: "Oil at $100 — will IEA release hold?", resolved: "CONFIRMED FAILED: Peaked $119.50 before IEA 400M bbl release pulled it back to ~$97-100. IEA buying time but not solving structural gap.", status: "confirmed" },
    { text: "Mojtaba physical appearance", resolved: "STILL UNRESOLVED + WORSENING: Hegseth says 'wounded and likely disfigured.' State Dept $10M reward. Reza Pahlavi claims transitional govt ready. No appearance. Clerical council challenge ongoing.", status: "ongoing" },
    { text: "Belgium + Greece attacks — pattern or opportunistic?", resolved: "CONFIRMED PATTERN: Amsterdam Jewish school bombed + Rotterdam synagogue arson (4 arrested) = systematic European campaign. 'Ashab Al Yamim' claiming. 7 countries outside Middle East now hit.", status: "confirmed" },
    { text: "IDF Lebanon escalation signals", resolved: "CONFIRMED: Axios reports largest ground invasion since 2006 planned — seize south of Litani River. 3 divisions on border. Kept as active watch item with specific timing.", status: "ongoing" },
    { text: "$50B supplemental and Congressional authorization", resolved: "ONGOING: $50B formally requested. $16.5B spent in 12 days. 250+ groups opposing. March 18 school strike deadline approaching.", status: "ongoing" },
    { text: "Houthi silence", resolved: "Day 15 without entry. Leader: 'hands on the trigger' but no action. Kept as active watch item.", status: "ongoing" },
    { text: "BARZIN + second ship", resolved: "ONGOING: BARZIN still anchored off Malaysia. No interdiction reported. Xi-Trump summit March 31 constraining US options.", status: "ongoing" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 15: 15,000+ COMBINED TARGETS — LAUNCHER DEGRADATION QUANTIFIED. Senior IDF official: 160-190 launchers destroyed, ~200 disabled, ~150 remain active. Crew 'desertions and refusals to follow orders.' Hegseth: missile ↓90%, drones ↓95%. Up to 80% of air defenses destroyed (Bloomberg). Hegseth: March 13 = 'highest number of US strikes so far.' 7,600+ IDF strikes in Iran, 1,100+ in Lebanon. BUT: Iran fired cluster BM warhead at Israel (new escalation) + 7 BM barrages Mar 12-13. Adapting as volume declines.", sources:[{t:"AmitSegal-Launchers",u:"https://x.com/AmitSegal/status/2032365394451694063"},{t:"StarsStripes-15K",u:"https://www.stripes.com/theaters/middle_east/2026-03-12/centcom-update-march-12-6000-targets-21042030.html"},{t:"Bloomberg-80pct",u:"https://www.bloomberg.com/news/articles/2026-03-14/iran-repeats-retaliation-threat-as-us-hits-kharg-island-military"},{t:"idfonline",u:"https://x.com/idfonline/status/2032359784830116131"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 15: IRAN SELECTIVELY OPENING HORMUZ — Turkish, Indian, Saudi ships allowed through; closed to US/Western allies. Maritime traffic still down 97%. Iran maintaining 2.1M bbl/day own exports through Strait (CTP-ISW). US Navy escort 'possible by end of month' (Energy Sec Wright). Kharg Island military targets destroyed but oil infrastructure spared — Trump explicit warning. 150+ ships stalled outside. IRGC threatens UAE as 'legitimate targets' after Kharg strike.", sources:[{t:"Bloomberg-Hormuz",u:"https://www.bloomberg.com/news/articles/2026-03-04/hormuz-tracker-traffic-comes-to-a-near-halt-amid-signal-fog"},{t:"AJZ-Kharg",u:"https://www.aljazeera.com/news/liveblog/2026/3/14/iran-war-live-pentagon-vows-to-ramp-up-us-military-campaign-against-iran"},{t:"TheHill-UAE",u:"https://thehill.com/policy/international/5784080-iran-threatens-uae-cities/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 15: LARGEST GROUND INVASION SINCE 2006 PLANNED. Israel planning massive operation to seize all territory south of Litani River — 3 armored/infantry divisions on border, reserves mobilizing, 7-8 km buffer zone + 20 outposts planned (Axios). Triggered by record 200+ rocket barrage March 13. IDF struck Hezbollah financial network — destroyed 30 al Qard al Hassan locations; organization halted ops. Radwan Force Commander Abu Ali Rayyan + IRGC-Hezbollah BM coordinator Abu Dhar Mohammadi killed. Weapons expert Morteza Hussein Sorour killed near Beirut campus. Amal Movement broke with Hezbollah. Lebanon: 773 killed (103 children), 830,000 displaced.", sources:[{t:"Axios-Invasion",u:"https://www.axios.com/2026/03/14/israel-lebanon-ground-invasion-hezbollah"},{t:"ToI-Invasion",u:"https://www.timesofisrael.com/israel-said-planning-massive-ground-invasion-of-southern-lebanon-to-uproot-hezbollah/"},{t:"CTP-ISW-D13PM",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-13-2026"},{t:"AvichayAdraee",u:"https://x.com/AvichayAdraee/status/2032395880410587471"}],
    subgoals:[
      ...
      { id:"hez-ground", name:"Clear southern Lebanon border zone", party:"israel", type:"achieve", importance:4, achievability:3, status:"in progress", outcomeNote:"Day 15: MASSIVE GROUND INVASION PLANNED — LARGEST SINCE 2006. Israel planning to seize all territory south of Litani River (Axios confirmed). 3 armored/infantry divisions on border, reserves mobilizing. 7-8 km buffer zone + 20 outposts planned. Triggered by Hezbollah's record 200+ rocket barrage. Trump admin asked Israel to spare Beirut airport; Israel agreed on airport but not other state infrastructure. 12 medical workers killed in IDF strike on healthcare facility in Burj Qalawiya (March 14). Lebanon: 773 killed (103 children, 26 paramedics), 830,000 displaced.", sources:[{t:"Axios-Invasion",u:"https://www.axios.com/2026/03/14/israel-lebanon-ground-invasion-hezbollah"},{t:"ToI-Invasion",u:"https://www.timesofisrael.com/israel-said-planning-massive-ground-invasion-of-southern-lebanon-to-uproot-hezbollah/"},{t:"ToI-D15",u:"https://www.timesofisrael.com/liveblog-march-14-2026/"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"prx-houthi", name:"Suppress Houthi threats", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", outcomeNote:"DAY 15 SILENCE — LONGEST NON-ENTRY OF ANY PROXY. Zero confirmed Houthi strikes in 15 days. Leader al-Houthi: 'hands on the trigger whenever developments require.' Restraint influenced by 2025 US-Houthi ceasefire + fear of Israeli decapitation strikes. Iran's military degradation makes weapons pipeline less viable. Strategic calculation to preserve position rather than fight for weakening patron.", sources:[{t:"Stimson",u:"https://www.stimson.org/2026/the-houthis-must-decide-join-irans-war-against-the-us-and-israel-or-abandon-iran/"},{t:"Axios-Houthis",u:"https://www.axios.com/2026/03/12/iran-war-houthis-yemen-gulf-red-sea"},{t:"ModernDiplomacy",u:"https://moderndiplomacy.eu/2026/03/13/why-yemens-houthis-have-not-joined-the-iran-war/"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"cas-zero", name:"Maintain zero-casualty posture", party:"us", type:"avoid", importance:5, achievability:1, status:"unachievable", outcomeNote:"Failed Day 2. US KIA now 13: 7 hostile fire + 6 KC-135 crash (all crew confirmed dead March 14). ~140 wounded total, 8 severely, 108 returned to duty. France: 1 KIA. Double-digit threshold crossed Day 14.", sources:[{t:"CENTCOM-KC135",u:"https://x.com/CENTCOM/status/2032460946770202725"},{t:"TIME-KIA",u:"https://time.com/article/2026/03/10/us-service-members-killed-iran-war-casualties/"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 15: CLUSTER MUNITIONS ON ISRAEL — Iran fired BM with cluster bomb warhead; submunitions hit Shoham (building fire) + Rishon Lezion (highway/car damage). New weapons escalation. Fresh wave hit northern Israel March 14 morning — 2 injured, buildings damaged. Missiles targeted Jerusalem + Eilat. 15 Israeli civilians killed, 2,975+ injured cumulative. BM launches down 90% but weapons sophistication increasing — cluster warheads represent adaptation as volume declines.", sources:[{t:"manniefabian-Cluster",u:"https://x.com/manniefabian/status/2032523479984030088"},{t:"Haaretz-D15",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-13/ty-article-live/dozens-wounded-one-moderately-in-iranian-missile-strike-in-northern-israel/0000019c-e502-db58-a9dd-f54eac480000"},{t:"ToI-D15",u:"https://www.timesofisrael.com/liveblog-march-14-2026/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 15: LEBANON GROUND INVASION = MAJOR SCOPE EXPANSION. Israel planning largest ground invasion of Lebanon since 2006 — seize south of Litani River (Axios). Kharg Island struck (90 military targets). Trump: US 'way ahead of schedule,' Iran 'totally defeated' — while announcing Navy escort + threatening oil infrastructure. IRGC threatens UAE directly. European Jewish attacks spreading. 15,000+ combined targets struck. War cost $16.5B in 12 days. Scope now spans Iran + Lebanon + Gulf + Europe + cyber — 5 simultaneous theaters.", sources:[{t:"Axios-Invasion",u:"https://www.axios.com/2026/03/14/israel-lebanon-ground-invasion-hezbollah"},{t:"NPR-Kharg",u:"https://www.npr.org/2026/03/14/nx-s1-5747838/trump-kharg-island-iran-war"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 15: EXTREME VOLATILITY — Oil swung $67 → $119.50 peak → $97-100. IEA released record 400M barrels (US: 172M from SPR). War cutting ~8M bbl/day. Kharg Island military struck but oil infrastructure spared — Trump explicitly linking oil to escalation. Iran selectively opening Hormuz (Turkey, India, Saudi) while blocking Western ships. Gas: $3.48-3.63 nationally, CA $5.20. War cost: $16.5B in 12 days. $50B supplemental. Iran still exporting 2.1M bbl/day through Strait. Trump eased Russian oil sanctions temporarily.", sources:[{t:"Fortune-Peak",u:"https://fortune.com/article/price-of-oil-03-13-2026/"},{t:"IEA-Record",u:"https://www.iea.org/news/iea-member-countries-to-carry-out-largest-ever-oil-stock-release-amid-market-disruptions-from-middle-east-conflict"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/gas-prices-today-us-iran-war-oil-strait-of-hormuz/"},{t:"NPR-Kharg",u:"https://www.npr.org/2026/03/14/nx-s1-5747838/trump-kharg-island-iran-war"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 15: BRENT PEAKED $119.50, NOW ~$97-100. Extreme volatility — swung from $67 pre-war to $119.50 peak, pulled back to ~$97-100 on IEA 400M bbl reserve release (US: 172M from SPR, Canada: 23.6M). IEA: war cutting 8M bbl/day from global supply. Iran STILL exporting 2.1M bbl/day (CTP-ISW) — sanctions failing during active operations. Kharg Island military struck but oil infrastructure explicitly spared — Trump warning oil becomes next target if Hormuz stays blocked. Goldman: $110 if disruption extends past March 21 (7 days). Trump eased Russian oil sanctions temporarily. Dow below 47,000.", sources:[{t:"Fortune-Peak",u:"https://fortune.com/article/price-of-oil-03-13-2026/"},{t:"IEA-Record",u:"https://www.iea.org/news/iea-member-countries-to-carry-out-largest-ever-oil-stock-release-amid-market-disruptions-from-middle-east-conflict"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/13/trump-iran-oil-prices-military-strait-of-hormuz.html"},{t:"NPR-Kharg",u:"https://www.npr.org/2026/03/14/nx-s1-5747838/trump-kharg-island-iran-war"}] },
      ...
      { id:"en-pump", name:"Keep US gas prices manageable", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 15: GAS $3.48-3.63/GAL national avg — up 48-55 cents from $2.98 pre-war (+16-20%). California $5.20, Washington $4.63. Still approaching $4 presidential approval-rating cliff. 56% of Americans oppose the war. War cost: ~$16.5B in first 12 days ($1.4B/day). $50B supplemental requested. 250+ organizations calling on Congress to halt war funding. Summer blend switchover imminent. Indian airlines raising ticket prices on aviation fuel costs.", sources:[{t:"CBS-Gas",u:"https://www.cbsnews.com/news/gas-prices-today-us-iran-war-oil-strait-of-hormuz/"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"},{t:"ACLU-250",u:"https://www.aclu.org/press-releases/more-than-250-groups-oppose-additional-spending-on-trumps-illegal-iran-war"}] },
    ]
  },
  {
