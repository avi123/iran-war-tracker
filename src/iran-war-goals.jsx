...
const HIGHLIGHTS = {
  updatedAt: "2026-03-17T20:00Z",
  keyDevelopments: [
    { text: "ISRAEL CLAIMS LARIJANI KILLED + BASIJ DECAPITATED — IAF says it killed Ali Larijani (SNSC Secretary, Iran's 'de facto leader'). Iran has NOT confirmed — Tasnim posted purported handwritten note from Larijani dated March 17 as possible proof-of-life. Separately, ~300 Basij commanders/officials killed in overnight strikes on command centers. Basij commander Gholamreza Soleimani + deputy killed.", why: "If confirmed, Larijani would be the highest-value target since Khamenei — he was the operational leader managing the war. Basij decapitation is significant: ~300 commanders at once is a systematic elimination of the paramilitary's field leadership. But unconfirmed kills have been wrong before. Tasnim's proof-of-life note is either genuine or fabricated — either way, Iran is signaling Larijani matters.", category: "military", goalIds: ["reg-succession", "reg-irgc-leaders", "reg-repress"], sources: [{t:"ToI-Larijani",u:"https://www.timesofisrael.com/liveblog-march-17-2026/"},{t:"Military.com",u:"https://www.military.com/daily-news/2026/03/17/israel-says-ali-larijani-top-iranian-security-official-killed-israel-strike.html"},{t:"IranIntl-Basij",u:"https://www.iranintl.com/en"}] },
    { text: "LEBANON GROUND OPS EXPANDING — IDF CoS Zamir: will 'deepen' operations until 'all objectives achieved.' Evacuation warnings 40+ km north, beyond Litani River. 886 killed, 1M+ displaced in Lebanon since March 2. 1 Lebanese soldier killed March 17.", why: "This is not a new invasion — IDF entered Khiam March 2. What's new is the expansion beyond initial positions and evacuation orders well past the Litani. If IDF pushes to seize all territory south of Litani, this becomes the largest Israeli ground operation in Lebanon since 2006 and a second full war running simultaneously with the Iran air campaign.", category: "military", goalIds: ["hez", "hez-ground", "sco-theater"], sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"Time-Ground",u:"https://time.com/article/2026/03/16/how-an-israeli-ground-invasion-of-lebanon-could-unfold/"}] },
    { text: "BAGHDAD EMBASSY PENETRATED — most intense attack of war. 5 drones + rockets; C-RAM shot 2, 1 struck inside compound (fire/smoke). Green Zone hotel also hit. 20 PMF killed at al-Qaim + 8 Badr fighters killed.", why: "An Iranian proxy drone penetrating the US embassy compound is a qualitative escalation — even if damage was limited. Iraqi militia capability is increasing despite leadership degradation (al-Askari killed Day 17). CTP-ISW's PMF casualty data (20 at al-Qaim, 8 Badr, 6 at Jurf al-Sakhr) shows US hitting back hard, but volume of attacks keeps rising.", category: "military", goalIds: ["prx-iraq", "cas-us"], sources: [{t:"CNN-Embassy",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-17-26"},{t:"Asharq-Embassy",u:"https://english.aawsat.com/arab-world/5252117-drone-rocket-attack-targets-us-embassy-baghdad"},{t:"CTP-ISW-D16",u:"https://www.criticalthreats.org/analysis/iran-update-march-16-2026"}] },
    { text: "ALL ALLIES REFUSE HORMUZ COALITION — EU: 'no appetite, this is not Europe's war.' Germany explicitly declined. Trump 'greatly disappointed.' First non-Iranian tanker (Aframax Karachi) transited Hormuz with AIS on March 15.", why: "Zero allied buy-in for forcible reopening. The Karachi transit suggests negotiated safe passage for select shipments is the de facto regime, not military escort. Bessent's 'allowing Iranian tankers through' is the real policy; Trump's coalition demand is theater. Gulf exports still down ~60% — partial reopening, not resolution.", category: "political", goalIds: ["alliance", "hormuz", "hor-open"], sources: [{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"MarineTraffic",u:"https://x.com/MarineTraffic/status/2033490585298915497"},{t:"Bloomberg-Allies",u:"https://www.bloomberg.com/news/newsletters/2026-03-17/iran-war-us-allies-reluctant-to-join-trump-in-freeing-hormuz"}] },
    { text: "OIL $102-103 BRENT DESPITE 400M BBL STRATEGIC RELEASE — largest coordinated release in history (30+ countries). Gas $3.72/gal (+25%). Diesel ~$5. Monthly inflation could hit 1% in March.", why: "Strategic reserves are being burned at an unprecedented rate and prices are still above $100. This is a structural supply disruption, not a speculative spike — reserves can slow the rise but can't fix the underlying 60% export reduction. If Hormuz stays partially closed through April, reserves become a depleting asset with no resupply.", category: "economic", goalIds: ["en-oil", "en-pump", "energy"], sources: [{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/17/oil-prices-wti-brent-hormuz-coalition-shipping-trump.html"},{t:"NPR-Gas",u:"https://www.npr.org/2026/03/16/nx-s1-5749333/iran-war-gasoline-prices-day-17"}] },
    { text: "MOJTABA REJECTS CEASEFIRE — 'not the right time for peace until US and Israel are brought to their knees.' Questions about health/location persist. Iran ambassador denied Moscow medical treatment. Nowruz in 3 days.", why: "Maximalist language closes diplomatic off-ramps from the Iranian side, matching Trump's 'unconditional surrender.' Both leaders are now publicly committed to positions that preclude negotiation. Nowruz (March 20) remains the hard deadline for Mojtaba's functionality — if he can't deliver the traditional message, IRGC-by-committee is confirmed.", category: "regime", goalIds: ["reg-endgame", "reg-succession", "sco-exit"], sources: [{t:"Yahoo-Ceasefire",u:"https://www.yahoo.com/news/articles/exclusive-irans-supreme-leader-rejects-095430432.html"},{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"}] },
  ],
  watchNext: [
    { text: "Larijani — will Iran confirm or deny? Tasnim's proof-of-life note vs Israeli claim. If confirmed = highest-value kill since Khamenei.", why: "Iran's silence is the signal. Confirmed death would eliminate the most pragmatic figure in Iranian leadership, leaving Mojtaba + IRGC hardliners with no experienced diplomatic operator. Confirmed alive = Israeli intelligence failure and morale boost for Iran.", category: "military", timeframe: "imminent", sources: [{t:"ToI-Larijani",u:"https://www.timesofisrael.com/liveblog-march-17-2026/"},{t:"Military.com",u:"https://www.military.com/daily-news/2026/03/17/israel-says-ali-larijani-top-iranian-security-official-killed-israel-strike.html"}] },
    { text: "School strike March 18 deadline — TODAY. Amnesty: 'potential war crime.' Republicans blocking hearings. $50B supplemental leverage point.", why: "Amnesty + HRW + Bellingcat + Pentagon's own investigation all confirm US responsibility. If March 18 passes without DOD response while Republicans block hearings, the accountability gap becomes a midterm issue. The $50B supplemental forces every member to take a recorded position.", category: "political", timeframe: "imminent", sources: [{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"},{t:"WaPo-Hearings",u:"https://www.washingtonpost.com/politics/2026/03/16/iran-war-congress-trump-democrats-hearings/fc0d14d2-20ec-11f1-954a-6300919c9854_story.html"}] },
    { text: "Nowruz March 20 — Mojtaba must deliver traditional supreme leader message or signal 'significant shifts in power structure.' Banking system collapsing. Internet at 4%.", why: "First testable deadline for regime functionality. If Mojtaba appears = regime reconstituted under hardline IRGC direction. If not = ruling by committee confirmed, changing every negotiation calculus. Banking failures + internet collapse ahead of biggest Iranian holiday = civilian pressure compounding military pressure.", category: "regime", timeframe: "24-48h", sources: [{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"}] },
    { text: "Lebanon ground scope — will IDF push north of Litani? Evacuation orders 40+ km north. Biggest ground op since 2006. 886 killed.", why: "If IDF seizes all territory south of Litani, casualties accelerate and this becomes a second full war. Hezbollah firing ~100 rockets/day into Israel, coordinated with Iranian barrages. Five-nation statement urging restraint = allies fear this trajectory.", category: "military", timeframe: "24-48h", sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"}] },
    { text: "Houthi escalation — attacked USS Truman, 'banned' US vessels from Red Sea/Arabian Sea. Formal war entry or continued ambiguity?", why: "Combined Hormuz + Bab el-Mandeb = ~35% of global maritime trade under threat. If US retaliates against Yemen = 8th simultaneous theater. Houthi weapons stockpile reportedly low — entry may be symbolic rather than sustained.", category: "military", timeframe: "this week", sources: [{t:"WashInst-Houthis",u:"https://www.washingtoninstitute.org/policy-analysis/lethal-attacks-show-strengthened-houthi-control-over-red-sea-transit"}] },
    { text: "Russian BM resupply — confirmed Shahed drones + MANPADS + missiles. Will Russia provide ballistic missile resupply as Iran's arsenal nears 90% depletion?", why: "Russia has crossed from intelligence to weapons. If BM resupply follows, Iran's 90% decline reverses and the air campaign timeline resets. This is the single most significant external variable for campaign duration.", category: "military", timeframe: "this week", sources: [{t:"United24-Russia",u:"https://united24media.com/latest-news/iran-officially-confirms-military-support-from-russia-and-china-in-war-against-the-us-16882"}] },
  ],
  watchResolved: [
    { text: "Bessent Hormuz policy vs Trump coalition", resolved: "RESOLVED: All allies refused coalition (EU, Germany, Japan, Australia). Bessent's selective passage = real policy. First non-Iranian tanker transited Hormuz with AIS (March 15). But exports still down ~60%.", status: "confirmed" },
    { text: "Oil at $100 — will Bessent statement hold?", resolved: "NO: Brent rebounded to $102-103 despite largest coordinated strategic release in history (400M bbl, 30+ countries). Structural disruption overpowering reserves.", status: "wrong" },
    { text: "Houthi entry", resolved: "ESCALATING: Attacked USS Truman, 'banned' US vessels, sank 2 ships. Still no formal declaration. Upgraded to active watch.", status: "ongoing" },
    { text: "Mojtaba physical appearance", resolved: "ONGOING: Rejected ceasefire publicly but still no physical appearance (19 days). Denied Moscow medical treatment. Nowruz March 20 = 3 days.", status: "ongoing" },
    { text: "$50B supplemental", resolved: "ONGOING: Not voted. March 18 deadline = tomorrow. Republicans blocking hearings.", status: "ongoing" },
    { text: "Lebanon ground invasion execution", resolved: "CONFIRMED + EXPANDING: IDF CoS Zamir: 'deepen' operations. Evacuation orders 40+ km north, beyond Litani. 886 killed, 1M+ displaced.", status: "confirmed" },
    { text: "Belgium + Greece attacks — pattern or opportunistic?", resolved: "CONFIRMED PATTERN: IMCR claimed Belgium + Greece. Rotterdam arson. France arrests. Poland cyberattack. EU designated IRGC. Kuwait: 14 Kuwaitis + 2 Lebanese arrested for Hezbollah sabotage plot.", status: "confirmed" },
    { text: "UAE airspace closure", resolved: "CONFIRMED: Cumulative 314 BMs + 1,672 drones intercepted. Qatar escalation: 14 BMs (up from drones). Dubai airport hit by drone. Shah oil field fire.", status: "confirmed" },
  ],
};
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 16: IAEA HAS NO ACCESS TO ANY OF 4 DECLARED ENRICHMENT FACILITIES SINCE WAR BEGAN — cannot verify stockpile status or enrichment activity. Natanz entrance destroyed but underground FEP survived. 2 buildings near Isfahan site damaged (satellite). Iran stored most highly enriched uranium at underground tunnel complex at Isfahan. SPND chiefs killed Day 1. Netanyahu confirmed nuclear scientists killed. BARZIN (Chinese ship with rocket fuel precursors) still anchored off Malaysia. Iran supertanker pushed through Hormuz for China — supply line active. Ground option (seize 450 kg 60%-enriched uranium) still under discussion.", sources:[{t:"CTP-ISW-D12AM",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-12-2026"},{t:"AJZ-IAEA",u:"https://www.aljazeera.com/news/2026/3/3/iaea-confirms-some-damage-to-irans-natanz-nuclear-facility"},{t:"WaPo-Nuclear",u:"https://www.washingtonpost.com/world/2026/03/02/iran-nuclear-facilities-attack-us-israel/8ce237a0-1623-11f1-aef0-0aac8e8e94db_story.html"},{t:"WaPo-BARZIN",u:"https://www.washingtonpost.com/investigations/2026/03/07/laden-iranian-ships-depart-chinese-port-tied-key-military-chemicals/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 17: IDF — 7,600+ STRIKES IN ~5,000 AERIAL SORTIES. 70%+ missile launchers neutralized. 85%+ air defense/radar destroyed. 700+ missile targets hit. 100+ production/armament + 500+ C2 targets. Original arsenal ~3,000 missiles; ~2,500 remain. 290 of 410-440 launchers disabled. But Iran still firing — 5 BM salvos at Israel on Day 17, cluster munitions + Sejjil (first use). IRGC: 'most weapons intact, using older missiles first.' Russia confirmed supplying Shahed drones + 500 Verbas + 2,500 9M336 missiles. Overnight March 15-16: wide strike wave in Tehran targeting nuclear program hardening sites.", sources:[{t:"Alma-D17",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-16-2026-1800/"},{t:"AJZ-Missiles",u:"https://www.aljazeera.com/news/2026/3/16/us-says-it-has-destroyed-iran-missile-capacity-how-is-iran-still-shooting"},{t:"CBS-Nuclear",u:"https://www.cbsnews.com/live-updates/iran-war-oil-prices-strait-of-hormuz-trump-threat-kharg-island/"},{t:"United24-Russia",u:"https://united24media.com/latest-news/iran-officially-confirms-military-support-from-russia-and-china-in-war-against-the-us-16882"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 17: US INTEL — REGIME 'LIKELY WILL REMAIN IN PLACE, WEAKENED BUT MORE HARD-LINE, IRGC GREATER CONTROL' (WaPo). Both sides reject ceasefire. Mojtaba 'low condition to function' — NOWRUZ MARCH 21 IS HARD DEADLINE for public appearance. Trump: 'some say he's badly disfigured.' Hegseth: 'wounded and likely disfigured.' Banking system failing: Bank Melli + Bank Sepah ATM/online outages ahead of Nowruz. 500 arrests for 'spy' activities. 20 arrested in Urmia for alleged Israeli agents. Mass desertions continuing. Internet blackout 17 days.", sources:[{t:"WaPo-Intel",u:"https://www.washingtonpost.com/national-security/2026/03/16/iran-regime-intelligence-irgc-war/"},{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"},{t:"IranIntl-Ceasefire",u:"https://www.iranintl.com/en/202603166219"},{t:"FDD-Banking",u:"https://www.longwarjournal.org/archives/2026/03/iran-braces-for-internal-unrest-as-us-and-israeli-attacks-persist-march-14-16-updates.php"}],
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 19: LARIJANI ASSASSINATION CLAIM (UNCONFIRMED) — Israel says IAF killed Ali Larijani (SNSC Secretary, 'de facto leader'). Iran has NOT confirmed; Tasnim posted purported handwritten note from Larijani dated March 17 mourning navy members — possible proof-of-life. If true = highest-value kill since Khamenei. Mojtaba formally rejected ceasefire: 'not the right time for peace until US and Israel are brought to their knees.' Denied Moscow medical treatment. Inner circle: hardline IRGC (Taeb, Vahidi, Jafari, Ghalibaf). Nowruz March 20 = 3 days — hard deadline for appearance. Banking system collapsing (Melli/Sepah ATMs offline). Internet at 4%. 500 arrested.", sources:[{t:"ToI-Larijani",u:"https://www.timesofisrael.com/liveblog-march-17-2026/"},{t:"Military.com-Larijani",u:"https://www.military.com/daily-news/2026/03/17/israel-says-ali-larijani-top-iranian-security-official-killed-israel-strike.html"},{t:"Yahoo-Ceasefire",u:"https://www.yahoo.com/news/articles/exclusive-irans-supreme-leader-rejects-095430432.html"},{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"}] },
  ...
  },
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"Day 17: CENTCOM — 100+ IRANIAN NAVAL VESSELS DESTROYED, 6,500+ COMBAT SORTIES, ~7,000 TARGETS. Adm. Cooper: 'we aren't done.' Supreme Leader's aircraft destroyed at Mehrabad Airport. Kharg Island: 90+ military targets struck. All 4 Soleimani-class destroyed. Navy 'combat ineffective.' IRGC retains asymmetric capacity — 19+ commercial ships attacked. ~50,000 US troops deployed.", sources:[{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-16/centcom-update-operation-epic-fury-day-16-21086277.html"},{t:"Janes-Soleimani",u:"https://www.janes.com/osint-insights/defence-news/sea/iran-conflict-2026-centcom-commander-says-all-irgcn-soleimani-class-destroyed"},{t:"CNN-Ineffective",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-13-26"},{t:"Alma-D17",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-16-2026-1800/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 19: SELECTIVE PASSAGE = DE FACTO REGIME. First non-Iranian tanker (Aframax Karachi carrying Abu Dhabi Das crude) transited Hormuz with AIS active March 15 — suggests negotiated safe passage for select shipments. Pre-war 153 transits/day, now ~13/day. All allies refused Hormuz coalition — EU, Germany, Japan, Australia explicitly declined. Trump 'greatly disappointed.' Tanker hit by 'unknown projectile' 23 NM east of Fujairah. Iran maintaining selective blockade: open to China, Turkey, India; closed to Western allies. Gulf exports still down ~60%. Iran halted direct vessel attacks since March 12 (CTP-ISW) but maintaining threat posture.", sources:[{t:"MarineTraffic",u:"https://x.com/MarineTraffic/status/2033490585298915497"},{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"ANI-Fujairah",u:"https://aninews.in/news/world/middle-east/tanker-hit-by-unknown-projectile-near-fujairah-ukmto-confirms-no-injuries20260317091226/"},{t:"AJZ-Passage",u:"https://www.aljazeera.com/economy/2026/3/16/strait-of-hormuz-which-countriess-ships-has-iran-allowed-safe-passage-to"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 19: GROUND OPS EXPANDING — IDF CoS Zamir: will 'deepen' operations until 'all objectives achieved.' Evacuation warnings issued 40+ km north from Israeli border, beyond Litani River. Plan: seize entire area south of Litani, dismantle Hezbollah military infrastructure. Biggest Israeli ground op since 2006. Hezbollah firing ~100 rockets/day, sometimes coordinated with Iranian barrages. Israeli airstrikes hit 3 Beirut neighborhoods (Kafaat, Haret Hreik, Doha Aramoun). 1 Lebanese soldier killed, 4 wounded in Nabatiyeh strikes March 17. Lebanon: 886 killed (111 children), 2,141 wounded, 1M+ displaced. Five-nation statement urged restraint.", sources:[{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"Time-Ground",u:"https://time.com/article/2026/03/16/how-an-israeli-ground-invasion-of-lebanon-could-unfold/"},{t:"WSWS-Lebanon",u:"https://www.wsws.org/en/articles/2026/03/17/yvdv-m17.html"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 17: US KIA 13 (7 hostile fire + 6 KC-135 crash), ~200 WOUNDED ACROSS 7 COUNTRIES (WaPo/CENTCOM) — 10 severe, 180+ returned to duty. France: 1 KIA (CWO Frion). ~50,000 troops deployed (USS Ford, Lincoln, Tripoli + 31st MEU). Most intense Baghdad embassy attack of war: 5 drones + rockets, 1 struck inside compound. Italian drone destroyed at Ali Al Salem (Kuwait). Army banned uniform-wearing off-base as precaution. $50B supplemental pending. 4 manned aircraft lost in 17 days.", sources:[{t:"WaPo-200WIA",u:"https://www.washingtonpost.com/national-security/2026/03/16/us-troops-wounded-iran/"},{t:"USNews-200",u:"https://www.usnews.com/news/world/articles/2026-03-16/number-of-us-troops-wounded-in-war-against-iran-rises-to-about-200"},{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-16/centcom-update-operation-epic-fury-day-16-21086277.html"},{t:"CTP-ISW-D15",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-15-2026"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 19: Iran Health Ministry: 1,444+ killed, 18,551 injured. Hengaw: 4,400+ military killed. Israeli estimate: 3,000-4,000 soldiers/commanders. Amnesty: school strike killed 168 (110 children) — 'potential war crime.' ~300 Basij commanders/officials killed in overnight strikes. Lebanon: 886 killed (111 children), 1M+ displaced. UAE: 16+ killed (foreign nationals). Regional total approaching 2,400+ killed across all countries. 3.2M displaced in Iran.", sources:[{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"},{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 17: 15 KILLED, 3,329 INJURED, 247 WOUNDED BY IRANIAN/HEZBOLLAH FIRE. 245 Iranian attack waves + 485 Hezbollah attack waves since war began. 5 BM salvos on Day 17 alone — cluster munitions + Sejjil (first use). 8 wounded in northern Israel barrage. Iran claims ~700 missiles + 3,600 drones total. Semafor: US officials say Israel 'critically low' on Arrow system — IDF denied, suspects Iranian disinfo. Knesset voting on 5.1% deficit / NIS 32B ($10.2B) additional war spending.", sources:[{t:"Alma-D17",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-16-2026-1800/"},{t:"Haaretz-D17",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-16/ty-article-live/dubai-halts-flights-after-drone-strike-on-fuel-tank-near-airport/0000019c-f4e9-df50-a9de-f6f96e610005"},{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"},{t:"JPost-Deficit",u:"https://www.jpost.com/israel-news/politics-and-diplomacy/article-890019"}],
    subgoals:[
  ...
  // ═══ TIER 3: POLITICAL / DIPLOMATIC ═══
  {
    ...
    importance:5, achievability:2, status:"at risk", outcomeNote:"Day 17: REPUBLICANS BLOCKING WAR HEARINGS — Democrats demanding hearings on war authority; Republicans resisting (WaPo). Congress has not publicly tested Trump's case in 3 weeks. Trump: war ends 'soon' but 'probably not this week.' Delayed China trip ~1 month. Army banned uniform-wearing off-base as precaution. Amnesty: school strike killed 168 (110 children) — calls it potential war crime. FCC threatening broadcaster licenses. Gas $3.72. $50B supplemental pending. March 18 school strike deadline in 2 days.", sources:[{t:"WaPo-Hearings",u:"https://www.washingtonpost.com/politics/2026/03/16/iran-war-congress-trump-democrats-hearings/fc0d14d2-20ec-11f1-954a-6300919c9854_story.html"},{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"},{t:"NPR-FCC",u:"https://www.npr.org/2026/03/16/nx-s1-5748570/fcc-chair-threatens-broadcasters-licenses-over-negative-coverage-of-the-war-in-iran"},{t:"CBS-NotThisWeek",u:"https://www.cbsnews.com/live-updates/iran-war-oil-prices-strait-of-hormuz-trump-threat-kharg-island/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 19: ZERO ALLIED BUY-IN FOR HORMUZ COALITION. EU: 'no appetite — this is not Europe's war.' Germany explicitly refused. Trump 'greatly disappointed' — named China, France, Japan, South Korea, UK as targets but none confirmed. Five-nation statement (Canada, France, Germany, Italy, UK) condemned Hezbollah joining war, urged averting Israeli ground offensive. France, Canada, Germany, Italy, UK jointly condemned Lebanon escalation. Military assets deployed (7+ NATO nations) but political refusal to expand = alliance contracting. Gulf states privately pressing US to 'finish the job' (Al-Monitor).", sources:[{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"Bloomberg-Allies",u:"https://www.bloomberg.com/news/newsletters/2026-03-17/iran-war-us-allies-reluctant-to-join-trump-in-freeing-hormuz"},{t:"AlMonitor-Gulf",u:"https://www.al-monitor.com/originals/2026/03/analysis-gulf-states-press-us-neutralise-iran-good-hormuz-crisis-deepens"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 19: OIL $102-103 BRENT DESPITE LARGEST STRATEGIC RELEASE IN HISTORY — 30+ countries released 400M barrels (IEA coordinated). WTI ~$96. Gas $3.72/gal national avg (+25% from pre-war), diesel ~$5 (+$1.34/month), California $5.20. Monthly inflation could hit 1% in March (highest in 4 years). Gulf exports still down ~60%. Bessent policy (allowing Iranian tankers through) = de facto partial closure acceptance. First non-Iranian tanker transited Hormuz March 15. But structural disruption overpowering reserves — strategic stocks being depleted with no Hormuz resolution in sight.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/17/oil-prices-wti-brent-hormuz-coalition-shipping-trump.html"},{t:"NPR-Gas",u:"https://www.npr.org/2026/03/16/nx-s1-5749333/iran-war-gasoline-prices-day-17"},{t:"AJZ-Release",u:"https://www.aljazeera.com/economy/2026/3/15/strategic-oil-release-may-calm-markets-but-cannot-fix-hormuz-disruption"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 19: BRENT $102-103 DESPITE 400M BBL STRATEGIC RELEASE. WTI ~$96. 30+ countries coordinated largest reserve release in history — and prices are still above $100. Structural disruption (60% export reduction) overpowering reserves. Goldman $110 threshold: March 21 (3 days). Japan began releasing strategic oil reserves per IEA. First non-Iranian tanker transited Hormuz March 15 — selective passage not sufficient to restore flows. Oil up ~50% from pre-war ~$65-70. S&P 500 posted first 3-week losing streak in a year.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/17/oil-prices-wti-brent-hormuz-coalition-shipping-trump.html"},{t:"AJZ-Release",u:"https://www.aljazeera.com/economy/2026/3/15/strategic-oil-release-may-calm-markets-but-cannot-fix-hormuz-disruption"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/gas-prices-today-us-iran-war-oil-strait-of-hormuz/"}] },
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 19: UAE cumulative: 314 BMs + 15 cruise + 1,672 drones intercepted. 10 BMs + 45 drones on Day 17 alone. 1 killed in Abu Dhabi (Palestinian national, missile hit civilian vehicle in Al Bahyah). Dubai airport flights halted after drone hit fuel tank — resumed later. Shah oil field fire from drone attack. Qatar escalation: 14 BMs (13 intercepted) — up from drone-only attacks. Saudi intercepted 7 drones in Eastern Province. Kuwait: 4 hostile drones detected. Bahrain intercepting 'successive waves.' Tanker hit by 'unknown projectile' 23 NM east of Fujairah (UKMTO investigating).", sources:[{t:"modgovae-D19",u:"https://x.com/modgovae/status/2033528372547268715"},{t:"ADMedia-D19",u:"https://x.com/ADMediaOffice/status/2033435203818201551"},{t:"ANI-Fujairah",u:"https://aninews.in/news/world/middle-east/tanker-hit-by-unknown-projectile-near-fujairah-ukmto-confirms-no-injuries20260317091226/"},{t:"AJZ-Dubai",u:"https://www.aljazeera.com/news/2026/3/16/drone-strike-disrupts-dubai-flights-as-iran-continues-gulf-attacks"}],
    subgoals:[
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 19</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>7,600+ IDF strikes. 100+ ships destroyed. 70%+ launchers neutralized. 85%+ air defense destroyed. BMs down 90%. ~300 Basij commanders killed in single night. Larijani (SNSC Secretary) possibly killed — unconfirmed but if true, highest-value target since Khamenei.</span> IRGC supply crisis deepening. Basij command structure decapitated. CENTCOM: 6,500+ sorties, ~50K troops deployed. Houthis still not formally engaged. Kosovo prior: Day 19 of 78 — still early in campaign arc.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Gulf intercept rates holding: UAE 2,001 total projectiles intercepted. Iran's retaliatory capacity declining — BM volume collapsing even as drone surges continue.</span> First non-Iranian tanker transited Hormuz with AIS (March 15) — selective passage emerging. IDF ground ops expanding in Lebanon with stated intent to 'deepen until all objectives achieved.' The military degradation is historically unprecedented in pace.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 19</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>{stats.expanding} goals growing beyond plan</span>. <span style={{color:"#F59E0B",fontWeight:700}}>Lebanon ground ops expanding — IDF pushing beyond initial Khiam positions, evacuation warnings 40+ km north. Baghdad embassy penetrated by drone. Qatar now receiving BMs (escalation from drones). Iran-backed attacks in Belgium + Greece. Kuwait Hezbollah sabotage plot foiled. Brent $102-103, gas $3.72/gal (+25%).</span> This is now a 4-front war: Iran air, Lebanon ground, Iraq militia, Gulf defense — plus European terrorism, cyber, and Houthi maritime threats.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              All allies refused Hormuz coalition. 30+ countries released 400M bbl strategic reserves — largest coordinated release in history — and oil is still above $100. Iran's selective Hormuz regime rewards China while punishing the West. <span style={{color:"#F59E0B",fontWeight:700}}>Both sides publicly maximalist: Mojtaba 'not the right time for peace,' Trump 'terms aren't good enough.' No mediator, no off-ramp, no endgame. The war is militarily succeeding, economically failing, geographically expanding, and diplomatically frozen — all simultaneously true.</span>
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 19</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are genuinely failing</span>. (1) <span style={{color:C.red,fontWeight:700}}>Zero allied buy-in for Hormuz: EU 'not our war,' Germany explicitly refused. US bearing entire cost alone.</span> (2) Mojtaba formally rejected ceasefire with maximalist language. No endgame: NIC says regime stays, Trump demands unconditional surrender, no mediator accepted by both sides. (3) Amnesty: school strike = 'potential war crime' (168 killed). March 18 deadline tomorrow. Republicans blocking hearings. (4) Oil $102-103 despite 400M bbl strategic release. Gas $3.72 approaching $4 cliff. 53-56% oppose war.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              US WIA at ~200 across 7 countries with trajectory increasing. 13 KIA. Baghdad embassy penetrated. Lebanon: 886 dead, 1M+ displaced, ground ops expanding. 1,444+ Iranian civilians killed. Banking collapse ahead of Nowruz (3 days). <span style={{color:C.red,fontWeight:700}}>Everything failing is structurally unchanged or worsening. Destroying Iran's military doesn't fix the Hormuz chokepoint, the interceptor math, the school strike politics, the allied refusal, or the absence of an endgame. Strategic reserves are being depleted at historic rates with no resolution in sight.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
