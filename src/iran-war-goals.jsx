...
const HIGHLIGHTS = {
  updatedAt: "2026-03-19T15:12Z",
  keyDevelopments: [
    { text: "ENERGY WAR ESCALATION SPIRAL — Iran struck Gulf energy infrastructure overnight March 18-19: Saudi SAMREF/Yanbu + Jubail, Qatar Ras Laffan (Pearl GTL extensively damaged — LNG exports offline until June/July), Kuwait refineries. Response to Israel's South Pars strike. Brent surged to $116. Trump threatened to 'blow up' South Pars entirely. US-Israel friction: Trump rebuked strike but WSJ says he approved it in advance.", why: "Mutual energy infrastructure destruction is a new phase. Qatar LNG offline until June/July = structural European gas supply disruption. Both sides now targeting the other's revenue base. $116 oil with strategic reserves depleting = approaching political crisis.", category: "economic", goalIds: ["en-oil", "en-gas", "gulf-infra", "hormuz"], sources: [{t:"AJZ-Gulf",u:"https://www.aljazeera.com/news/2026/3/18/iran-threatens-to-strike-gulf-energy-facilities-after-south-pars-attack"},{t:"NBC-LNG",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"Axios-SouthPars",u:"https://www.axios.com/2026/03/19/iran-war-trump-israel-strike-gas"}] },
    { text: "PENTAGON REQUESTS $200B SUPPLEMENTAL — Hegseth: 'that number could move' higher. Unlikely to pass Congress (needs 60 Senate votes). At Day 21, campaign cost exceeds $1B/day. DNI Gabbard testified Iran was NOT rebuilding enrichment pre-war — directly contradicts war justification. Written testimony omitted from oral statement; Sen. Warner accused her of deliberate omission.", why: "$200B in 3 weeks is extraordinary burn rate (Afghanistan: $300B/year at peak). Gabbard testimony is the most damaging intelligence contradiction since Iraq WMD — the DNI's own written findings undermine the casus belli. Supplemental forces every member to take a recorded position.", category: "political", goalIds: ["dom-warpow", "dom-justify", "sco-exit"], sources: [{t:"Axios-$200B",u:"https://www.axios.com/2026/03/19/200-billion-iran-war-hegseth-penntagon"},{t:"WaPo-$200B",u:"https://www.washingtonpost.com/national-security/2026/03/18/iran-cost-budget-pentagon/"},{t:"AJZ-Gabbard",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"}] },
    { text: "4+ SENIOR OFFICIALS KILLED IN 48 HOURS — Larijani (SNSC Secretary/nuclear negotiator), Khatib (Intelligence Minister), G. Soleimani (Basij commander), Nasirzadeh (military chief). Hezbollah's Hassan Ali Marwan killed in Beirut. Larijani's killing closes primary diplomatic channel — he was the only experienced negotiator.", why: "Decapitation accelerating, not plateauing. But killing the nuclear negotiator while the endstate is undefined creates a structural diplomatic problem: who negotiates the end? IDF's blanket kill authorization signals this is deliberate — destroy negotiating capacity to force unconditional surrender.", category: "military", goalIds: ["reg-irgc-leaders", "reg-succession", "reg-endgame"], sources: [{t:"CNBC-Khatib",u:"https://www.cnbc.com/2026/03/18/iran-war-intelligence-esmail-khatib-israel-middle-east-crisis.html"},{t:"CNN-Larijani",u:"https://www.cnn.com/2026/03/19/politics/trump-israel-iran-war-larijani-analysis"},{t:"WaPo-Khatib",u:"https://www.washingtonpost.com/world/2026/03/18/iran-israel-war-us-esmail-khatib/"}] },
    { text: "IRAN STRIKING BACK — 8+ BM barrages in one night at Israel. Cluster/multiple-warhead missiles hitting central Israel: 2 killed in Ramat Gan, 4 Palestinian women killed in West Bank. Tel Aviv Savidor Central station took direct hits. Israel interceptor crisis: 'critically low' on Arrow (Semafor); NIS 2.6B ($826M) emergency defense transfer approved.", why: "Iran's shift to cluster munitions and sustained barrages shows residual capability is being used for maximum civilian impact. The interceptor crisis is corroborated by the emergency financial transfer — you don't approve $826M if stocks are fine. If Arrow depletes before campaign ends, Israel's population centers are exposed.", category: "military", goalIds: ["cas-isr", "isr-dome", "mis-mobile"], sources: [{t:"Haaretz-WB",u:"https://www.haaretz.com/west-bank/2026-03-19/ty-article/.premium/iranian-barrages-kill-at-least-four-palestinians-in-west-bank-one-man-in-israel/0000019d-02e2-da5c-a3bd-0ee231080000"},{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"},{t:"ToI-D19",u:"https://www.timesofisrael.com/liveblog-march-19-2026/"}] },
    { text: "GULF STATES CHOOSE COALITION — Qatar expelled all Iranian military/security attachés (March 18). Saudi FM: trust with Iran 'completely shattered.' UAE official: attacks 'will drive Gulf into Israeli arms.' Kuwait foiled Hezbollah sabotage plot (14 Kuwaitis + 2 Lebanese arrested). Iran's Gulf strikes are strengthening, not fracturing, the coalition.", why: "Iran's retaliatory strikes on Gulf energy infrastructure backfired diplomatically. Instead of deterring Gulf cooperation, they accelerated alignment with US/Israel. Qatar expelling attachés while under missile fire = choosing sides definitively. Saudi 'trust shattered' language closes the door Iran tried to keep open.", category: "political", goalIds: ["all-gulf", "alliance", "gulf-protect"], sources: [{t:"AJZ-Qatar",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"},{t:"TheNatl-Saudi",u:"https://www.thenationalnews.com/news/gulf/2026/03/19/saudi-arabia-says-trust-with-iran-completely-shattered-by-attacks-on-gulf-states/"}] },
    { text: "NOWRUZ TOMORROW — Mojtaba still invisible (21 days). Trump claims 'not alive.' No contact with President Pezeshkian (IranWire). Iran may not be able to pay government employees this month. Internet blackout 20 days (longest ever). Chaharshanbe Suri defiance — Iranians lit fires despite crackdown.", why: "March 20 is the single most important leading indicator for regime trajectory. Supreme leader's Nowruz message is constitutionally expected. If Mojtaba appears = regime wounded but functional (Kosovo path). If silence = state coherence failing (Libya path). Can't pay employees + 20-day blackout + holiday = maximum civilian pressure on regime.", category: "regime", goalIds: ["reg-succession", "reg-endgame", "reg-popular"], sources: [{t:"IranWire-NoContact",u:"https://iranwire.com/en/news/150201-pezeshkian-has-no-contact-with-mojtaba-khamenei-iranian-government-may-not-be-able-to-pay-employee-this-month/"},{t:"IranIntl-Nowruz",u:"https://www.iranintl.com/en"},{t:"CBS-Mojtaba",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"}] },
  ],
  watchNext: [
    { text: "Nowruz March 20 (TOMORROW) — will Mojtaba deliver traditional supreme leader message? Trump claims 'not alive.' No contact with Pezeshkian. Can't pay government employees.", why: "Single most important leading indicator for regime trajectory. If Mojtaba appears = regime wounded but functional (Kosovo path). If silence = state coherence failing (Libya path). Can't pay employees + 20-day blackout + holiday = maximum civilian pressure.", category: "regime", timeframe: "imminent", sources: [{t:"IranWire",u:"https://iranwire.com/en/news/150201-pezeshkian-has-no-contact-with-mojtaba-khamenei-iranian-government-may-not-be-able-to-pay-employee-this-month/"},{t:"CBS-Mojtaba",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"}] },
    { text: "$200B supplemental — needs 60 Senate votes. Hegseth: 'could move higher.' Will Congress fund a war whose intelligence justification the DNI contradicted?", why: "Gabbard testimony + $200B price tag = the two strongest arguments for opposition. If supplemental fails, war funding becomes the constraint the War Powers vote wasn't. If it passes, Congress has endorsed an open-ended campaign.", category: "political", timeframe: "this week", sources: [{t:"Axios-$200B",u:"https://www.axios.com/2026/03/19/200-billion-iran-war-hegseth-penntagon"},{t:"WaPo-$200B",u:"https://www.washingtonpost.com/national-security/2026/03/18/iran-cost-budget-pentagon/"}] },
    { text: "Israel interceptor sustainability — 'critically low' on Arrow (Semafor). $826M emergency transfer approved. Can stocks hold through Day 78 (Kosovo equivalent)?", why: "Interceptor production rate is fixed. If Arrow depletes before campaign ends, Israeli population centers are exposed to Iranian BMs. The emergency transfer is evidence of crisis, not solution — you can't manufacture interceptors with money alone.", category: "military", timeframe: "this week", sources: [{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"},{t:"ToI-D19",u:"https://www.timesofisrael.com/liveblog-march-19-2026/"}] },
    { text: "School strike House vote March 20 — Senate deadline passed March 18 with no DOD response. Will House force accountability?", why: "If House vote passes, it's the first binding Congressional action constraining the war. If it fails like the Senate, school strike becomes a midterm issue rather than a wartime constraint.", category: "political", timeframe: "24-48h", sources: [{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"}] },
    { text: "Lebanon IDF casualty rates — Hezbollah 'avoiding troops, hiding ammunition' (Haaretz) but still firing ~100 rockets/day. Litani bridges destroyed. Will IDF push north?", why: "2006 lesson: ground operations in Lebanon produce high casualties and ambiguous outcomes. If IDF casualty rate spikes, domestic pressure to halt ground ops mounts. Hezbollah adapting to IDF presence signals potential for protracted insurgency.", category: "military", timeframe: "24-48h", sources: [{t:"Haaretz-Hiding",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-18/ty-article/.premium/idf-officials-hezbollah-avoiding-israeli-troops-in-lebanon-hiding-ammunition/0000019d-000b-d1a7-a5fd-e6af20240000"},{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"}] },
    { text: "Fort McNair drones — unidentified drones over DC where Rubio and Hegseth reside. US 'taking countermeasures.' Attribution pending.", why: "If Iranian-linked = homeland security breach at the highest level. If domestic = war-related radicalization. Either way, drones over senior officials' residences is unprecedented and will drive security posture changes.", category: "military", timeframe: "24-48h", sources: [{t:"ToI-FtMcNair",u:"https://www.timesofisrael.com/liveblog-march-19-2026/"}] },
  ],
  watchResolved: [
    { text: "Iran's Gulf energy retaliation — named targets", resolved: "CONFIRMED: Iran struck all named targets overnight March 18-19 — SAMREF/Yanbu, Jubail, Ras Laffan (Pearl GTL extensively damaged), Kuwait refineries. Qatar LNG offline until June/July.", status: "confirmed" },
    { text: "Fed decision March 19", resolved: "CONFIRMED: Fed held rates. Signaled economic uncertainty from Middle East developments. European gas +24%.", status: "confirmed" },
    { text: "School strike Senate deadline (March 18)", resolved: "PASSED WITH NO DOD RESPONSE: Senate deadline expired. No Pentagon accountability. House vote March 20.", status: "confirmed" },
    { text: "Mojtaba physical appearance", resolved: "ONGOING: 21 days, no appearance. Trump claims 'not alive.' No contact with Pezeshkian. Nowruz tomorrow is the hard test.", status: "ongoing" },
    { text: "$50B supplemental", resolved: "SUPERSEDED: Pentagon now requesting $200B (up from $50B). Hegseth: 'could move higher.' Needs 60 Senate votes.", status: "confirmed" },
    { text: "Russian weapons escalation", resolved: "ONGOING + EXPANDING: Confirmed Shahed components + MANPADS + satellite imagery + targeting data. CENTCOM struck Caspian Sea supply route (Bandar Anzali). Russia warned Israel. BM resupply question still open.", status: "ongoing" },
    { text: "Houthi escalation", resolved: "STRATEGIC PAUSE HOLDING: Zero Red Sea shipping attacks despite 3 weeks of war. Attacked USS Truman but not commercial vessels. Still not attacking.", status: "partial" },
    { text: "Lebanon ground invasion", resolved: "EXPANDING: 968 killed, 1M+ displaced. Litani bridges destroyed. Hezbollah degraded/'hiding ammo.' IDF pre-authorized kills without approval.", status: "confirmed" },
  ],
};
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 21: IAEA REVEALS NEW UNDERGROUND ISFAHAN ENRICHMENT SITE — cannot verify if operational or 'empty hall.' DNI Gabbard testified Iran was NOT rebuilding enrichment pre-war — contradicts war justification (written testimony omitted from oral statement). Fordow assessed 'inoperable' (US official). 7,800+ targets struck incl 5,000-lb penetrators on underground facilities. Ground option to seize 450 kg enriched uranium still under discussion. Previous: SPND chiefs killed Day 1. 440 kg 60%-enriched uranium location unknown. IAEA has zero access to any declared facility.", sources:[{t:"TheNatl-IAEA",u:"https://www.thenationalnews.com/news/mena/2026/03/18/iran-has-new-underground-nuclear-site-iaea-reveals/"},{t:"AJZ-Gabbard",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"},{t:"CBS-Fordow",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"},{t:"AJZ-IAEA",u:"https://www.aljazeera.com/news/2026/3/3/iaea-confirms-some-damage-to-irans-natanz-nuclear-facility"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 21: 7,800+ TARGETS STRUCK, 8,000+ SORTIES. 'Largest strike package yet' on Day 21. 5,000-lb deep penetrators on underground coastal defense missile sites. 120+ Iranian vessels destroyed. ~70% missile launchers destroyed. But Iran sustaining 8+ BM barrages in single night at Israel — cluster/multiple-warhead missiles hitting central Israel (2 killed Ramat Gan, Savidor station). Missile crews experiencing desertions. Russia confirmed supplying Shahed components + MANPADS + satellite imagery. CENTCOM struck Caspian Sea supply route.", sources:[{t:"NBC-D21",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"CENTCOM-D21",u:"https://x.com/CENTCOM/status/2034580622149026102"},{t:"Haaretz-WB",u:"https://www.haaretz.com/west-bank/2026-03-19/ty-article/.premium/iranian-barrages-kill-at-least-four-palestinians-in-west-bank-one-man-in-israel/0000019d-02e2-da5c-a3bd-0ee231080000"},{t:"United24-Russia",u:"https://united24media.com/latest-news/iran-officially-confirms-military-support-from-russia-and-china-in-war-against-the-us-16882"}],
    subgoals:[
      ...
      { id:"mis-mobile", name:"Destroy mobile missile launchers", party:"both", type:"achieve", importance:5, achievability:2, status:"in progress", outcomeNote:"Day 15: FIRST QUANTIFICATION — Senior IDF official: 160-190 launchers destroyed, ~200 disabled, ~150 remain active. Missile crews experiencing 'desertions and refusals to follow orders.' Hegseth: missile volume down 90%, drone volume down 95%. Still hardest target class but combination of strikes + crew attrition degrading capability faster than hardware alone.", sources:[{t:"AmitSegal-IDF",u:"https://x.com/AmitSegal/status/2032365394451694063"},{t:"AviationWk",u:"https://aviationweek.com/defense/missile-defense-weapons/debrief-new-great-scud-hunt-tracking-irans-shahed-launchers"}] },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 21: 4+ SENIOR OFFICIALS KILLED IN 48 HOURS — Larijani (SNSC/nuclear negotiator), Khatib (Intel Minister), G. Soleimani (Basij commander), Nasirzadeh. Closes primary diplomatic channel. Mojtaba: no contact with Pezeshkian (IranWire). Trump claims 'not alive.' Can't pay government employees this month. Internet blackout 20 days (longest ever). Chaharshanbe Suri defiance. ~5,000 security forces killed (IranIntl). 75 arrests, 1 execution. Iran executed 3 for protest-related police deaths. NOWRUZ TOMORROW = hard test.", sources:[{t:"IranWire-NoContact",u:"https://iranwire.com/en/news/150201-pezeshkian-has-no-contact-with-mojtaba-khamenei-iranian-government-may-not-be-able-to-pay-employee-this-month/"},{t:"CNBC-Khatib",u:"https://www.cnbc.com/2026/03/18/iran-war-intelligence-esmail-khatib-israel-middle-east-crisis.html"},{t:"CNN-Larijani",u:"https://www.cnn.com/2026/03/19/politics/trump-israel-iran-war-larijani-analysis"},{t:"IranIntl-D21",u:"https://www.iranintl.com/en"}],
    subgoals:[
      ...
      { id:"reg-irgc-leaders", name:"Kill IRGC senior leadership", party:"both", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"Day 20: Basij commander Soleimani + deputy killed. ~300 Basij field commanders eliminated in overnight strikes. Intelligence Minister Khatib killed. IDF authorized to kill senior Iranians without prior approval. Previous: 50+ senior leaders killed including 7 named generals (CTP-ISW). LEC being decapitated. Israel warned it will target every Khamenei successor.", sources:[{t:"IDF-Soleimani",u:"https://x.com/idfonline/status/2033826032667496787"},{t:"IranIntl-Basij",u:"https://x.com/IranIntl/status/2033955048175145156"},{t:"NPR-Khatib",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"CTP-ISW-D11E",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-10-2026"}] },
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 20: Larijani confirmed killed by Iran. Intelligence Minister Khatib killed overnight March 17-18. Mojtaba 'wounded and disfigured' per Hegseth — still no appearance (20 days). Nowruz March 20 is hard deadline. Banking crisis (Melli/Sepah) + internet blackout Day 18+. Previous: Mojtaba rejected ceasefire. Inner circle: hardline IRGC (Taeb, Vahidi, Jafari, Ghalibaf). 500 arrested.", sources:[{t:"NPR-Khatib",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"WaPo-Khatib",u:"https://www.washingtonpost.com/world/2026/03/18/iran-israel-war-us-esmail-khatib/"},{t:"CBS-Mojtaba",u:"https://www.cbsnews.com/news/iran-mojtaba-khamenei-hegseth-wounded/"},{t:"Euronews-Nowruz",u:"https://www.euronews.com/2026/03/16/still-no-mojtaba-iran-war-enters-third-week-amid-leadership-crisis-as-norwuz-looms"}] },
      ...
      { id:"reg-comms", name:"Destroy regime communications", party:"both", type:"achieve", importance:3, achievability:4, status:"in progress", outcomeNote:"Day 17: 17 DAYS OF NEAR-TOTAL BLACKOUT — connectivity at 1-4% of normal (NetBlocks). Confirmed government-imposed, not bombing damage. Worsened further March 15-16. Iranians have spent roughly one-third of 2026 in digital darkness (includes Jan blackout during protests). Communications Minister: costing economy $35.7M/day. Commercial flights still not operating out of Iran. Regime leadership still communicating — Araghchi on CBS, IRGC issuing statements. Population completely cut off. 500 arrested for sending info to adversaries.", sources:[{t:"JapanTimes-Blackout",u:"https://www.japantimes.co.jp/news/2026/03/16/world/how-iran-internet-blackout/"},{t:"ReportWire-17d",u:"https://reportwire.in/world/irans-17-day-internet-blackout-cuts-off-world-access/"},{t:"CyberSec-Blackout",u:"https://cybersecuritynews.com/iran-internet-blackout/amp/"}] },
      { id:"reg-endgame", name:"Define post-war governance plan", party:"opposing", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 19: BOTH SIDES NOW PUBLICLY MAXIMALIST. Mojtaba: 'not the right time for peace until US and Israel are brought to their knees.' Trump: told NBC Iran is 'totally obliterated' and 'ready to make a deal but terms aren't good enough yet.' Iran flatly denies wanting a deal. All allies refused Hormuz coalition — EU: 'not our war.' No governance plan, no exit criteria, no ceasefire pathway, no mediator accepted by both sides. If Larijani assassination confirmed, the most experienced diplomatic operator is gone. Oman and Egypt mediation rejected by both sides. NPR: 'broad support for the war wavers.'", sources:[{t:"Yahoo-Ceasefire",u:"https://www.yahoo.com/news/articles/exclusive-irans-supreme-leader-rejects-095430432.html"},{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"NPR-Wavers",u:"https://www.npr.org/2026/03/16/nx-s1-5748534/trump-refocuses-his-message-on-winning-as-broad-support-for-the-war-in-iran-wavers"}] },
    ]
  },
  {
    id:"navy", name:"Destroy Iran's Navy & Maritime Threat", party:"us", type:"achieve",
    importance:5, achievability:5, status:"achieved", outcomeNote:"Day 21: 120+ IRANIAN NAVAL VESSELS DESTROYED. 8,000+ sorties. Continuing Hormuz operations. 2 new UKMTO merchant vessel incidents March 18-19. UN IMO started emergency talks on Middle East shipping. 6 coalition members (UK, FR, DE, IT, NL, JP) stated readiness to support Hormuz reopening. Caspian Sea strikes on Iranian navy (5+ vessels) disrupting Russia supply route. Navy 'combat ineffective' but IRGC retains asymmetric capacity — 21+ confirmed merchant ship attacks.", sources:[{t:"CENTCOM-D21",u:"https://x.com/CENTCOM/status/2034580622149026102"},{t:"S&S-CENTCOM",u:"https://www.stripes.com/theaters/middle_east/2026-03-16/centcom-update-operation-epic-fury-day-16-21086277.html"},{t:"Euronews-IMO",u:"https://www.euronews.com/2026/03/18/un-maritime-body-starts-talks-on-middle-east-shipping-with-hormuz-strait-effectively-close"},{t:"Safety4Sea-UKMTO",u:"https://safety4sea.com/ukmto-reports-ships-struck-by-projectiles-in-latest-gulf-escalation/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 21: HORMUZ DOWN ~97% — traffic at ~1/5 normal. UN IMO started emergency talks. 6 coalition members stated readiness to support reopening. 5,000-lb penetrators hitting coastal missile sites. But both sides now hitting energy infrastructure: Israel struck South Pars → Iran struck Saudi/Qatar/Kuwait facilities. Mutual energy destruction escalation. Bessent floated removing sanctions on stranded Iranian oil to ease prices. Previous: All allies refused active coalition. Iran maintaining selective blockade.", sources:[{t:"Euronews-IMO",u:"https://www.euronews.com/2026/03/18/un-maritime-body-starts-talks-on-middle-east-shipping-with-hormuz-strait-effectively-close"},{t:"NBC-D21",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"}],
    subgoals:[
      { id:"hor-open", name:"Keep Hormuz open during operations", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 19: SELECTIVE PASSAGE EMERGING BUT STRAIT STILL EFFECTIVELY CLOSED. Pre-war: 153 transits/day; now ~13/day. First non-Iranian tanker (Aframax Karachi) transited with AIS active March 15 — suggests negotiated safe passage for select shipments. But all allies refused coalition to reopen. EU: 'not our war.' Germany, Japan, Australia explicitly declined. Gulf exports down ~60%. Tanker hit by 'unknown projectile' near Fujairah (UKMTO). Iran halted direct vessel attacks since March 12 but maintaining threat posture. Bessent policy = de facto acceptance of partial closure, not forcible reopening.", sources:[{t:"MarineTraffic",u:"https://x.com/MarineTraffic/status/2033490585298915497"},{t:"NPR-Allies",u:"https://www.npr.org/2026/03/17/nx-s1-5749408/trump-continues-to-plead-with-us-allies-to-join-coalition-to-secure-strait-of-hormuz"},{t:"ANI-Fujairah",u:"https://aninews.in/news/world/middle-east/tanker-hit-by-unknown-projectile-near-fujairah-ukmto-confirms-no-injuries20260317091226/"},{t:"AJZ-Passage",u:"https://www.aljazeera.com/economy/2026/3/16/strait-of-hormuz-which-countriess-ships-has-iran-allowed-safe-passage-to"}] },
      ...
      { id:"hor-energy", name:"Prevent global energy crisis", party:"us", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Day 17: BRENT $104-105, WTI ~$100, GAS $3.70/GAL (+24% since Feb 28). Oil sustained above $100 despite IEA 400M bbl release. Wood Mackenzie: $150/bbl needed for demand destruction with 15M bpd disrupted. Retail investors poured record $211M into oil ETFs (March 12) — 'meme-style' trading. Fujairah hit AGAIN (2nd time in 3 days) — UAE's Hormuz bypass suspended. Dubai airport drone fire. Iran warned oil could hit $200. Goldman $110 threshold: March 21 (5 days). Global stocks down 5.5% since conflict began — worst monthly since 2022. Gas prices could set all-time high by end of March (Yahoo Finance). California $5.34/gal.", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/03/16/cnbc-daily-open-us-iran-trump-war-oil.html"},{t:"Bloomberg-Fujairah2",u:"https://www.bloomberg.com/news/articles/2026-03-16/uae-s-fujairah-port-hit-again-damage-is-being-assessed"},{t:"CNBC-Meme",u:"https://www.cnbc.com/2026/03/16/oil-crude-iran-war-retailers-meme.html"},{t:"Yahoo-Gas",u:"https://finance.yahoo.com/news/gas-prices-could-set-time-232319378.html"}] },
    ]
  },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 21: LEBANON — 968 KILLED, 1M+ DISPLACED. Litani River bridges destroyed cutting south from north. Hezbollah 'avoiding Israeli troops, hiding ammunition' (Haaretz) — degraded combat capability. But still firing ~100 rockets/day. Hassan Ali Marwan (Imam Hussein Division commander) killed in Beirut strike. 14 killed in Beirut strikes. IDF pre-authorized kills of senior figures without prior approval. German Chancellor Merz called ground offensive an 'error.' Macron urged ceasefire. Rafah Crossing reopened between Gaza and Egypt.", sources:[{t:"Haaretz-Hiding",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-18/ty-article/.premium/idf-officials-hezbollah-avoiding-israeli-troops-in-lebanon-hiding-ammunition/0000019d-000b-d1a7-a5fd-e6af20240000"},{t:"JPost-Marwan",u:"https://www.jpost.com/israel-news/defense-news/article-890494"},{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/3/17/israeli-strikes-target-beirut-southern-lebanon-one-million-displaced"},{t:"NPR-Merz",u:"https://www.npr.org/2026/03/17/nx-s1-5749304/israels-lebanon-incursion-raises-pressure-on-west-over-iran-backed-hezbollah"}],
    subgoals:[
      ...
      { id:"hez-ground", name:"Clear southern Lebanon border zone", party:"israel", type:"achieve", importance:4, achievability:3, status:"in progress", outcomeNote:"Day 17: GROUND INVASION LAUNCHED — Katz confirmed 'targeted ground operation against key targets' in southern Lebanon. Stated displaced Lebanese 'will not return home south of the Litani River' until safety guaranteed. IDF conducting overnight airstrikes in southern Beirut suburbs. Zrariyeh bridge across Litani struck (cutting south Lebanon routes). Lebanon: 850+ killed (107 children, 31 health workers), 900,000 displaced. Largest Israeli ground operation since 2006. Israeli FM Saar rejected direct talks with Lebanon while Hezbollah attacks continue. Lebanese President Aoun offered negotiations — Israel has not responded.", sources:[{t:"NPR-GroundOps",u:"https://www.npr.org/2026/03/16/nx-s1-5746805/iran-blocks-vital-oil-route-as-israel-expands-its-ground-operations-in-lebanon"},{t:"AJZ-D17",u:"https://www.aljazeera.com/news/2026/3/16/iran-war-what-is-happening-on-day-17-of-us-israel-attacks"},{t:"NBC-D17",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-reopen-strait-of-hormuz-israel-lebanon-rcna263448"}] },
      ...
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 17: HEZBOLLAH 31 ATTACKS IN 24 HOURS — 7 direct ATGM engagements with Israeli forces (highest single-day count since war began). Claimed precision missile on Palmachim Airbase (~140km from border). Targeted Rafael Advanced Defense Systems complex. Increasingly using rockets since March 12. UNIFIL peacekeepers fired upon 3 times near Bint Jbeil and Tyre. Volume and sophistication increasing even as ground invasion launches. Iran cluster munitions continuing — hit Tel Aviv, Bnei Brak, Rishon LeZion.", sources:[{t:"CTP-ISW-D15",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-15-2026"},{t:"Haaretz-D17",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-16/ty-article-live/dubai-halts-flights-after-drone-strike-on-fuel-tank-near-airport/0000019c-f4e9-df50-a9de-f6f96e610005"},{t:"ToI-D17",u:"https://www.timesofisrael.com/liveblog-march-16-2026/"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"prx-houthi", name:"Suppress Houthi threats", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 17: HOUTHIS ATTACKED USS TRUMAN — 18 missiles + 1 UAV, all failed (11 UAVs shot down, missile fell far from ships). Announced 'ban' on US vessels entering Red Sea/Arabian Sea/Gulf of Aden. Sank 2 commercial vessels. Senior official: 'decision to stand alongside Iran already made.' Weapons stockpile reportedly low after Red Sea campaign. Not formally declaring war to maintain independence appearance. If formal entry = simultaneous Hormuz + Bab el-Mandeb (~35% global maritime trade).", sources:[{t:"WashInst-Houthis",u:"https://www.washingtoninstitute.org/policy-analysis/lethal-attacks-show-strengthened-houthi-control-over-red-sea-transit"},{t:"FP-Houthis",u:"https://foreignpolicy.com/2026/03/11/iran-war-houthis-yemen-military-operations-calculus-ground-force-mobilization/"},{t:"WaPo-Houthis",u:"https://www.washingtonpost.com/world/2026/03/15/yemen-houthis-iran-war-gulf-us-israel/8e1cff82-2056-11f1-954a-6300919c9854_story.html"},{t:"YaLibnan-Trigger",u:"https://yalibnan.com/2026/03/14/yemens-houthis-decided-to-join-iran-in-the-war-our-finger-on-the-trigger-an-official-says/"}] },
      { id:"prx-iraq", name:"Prevent Iraqi militia activation", party:"us", type:"avoid", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 19: EMBASSY PENETRATED — drone struck inside US Embassy Baghdad compound (fire/smoke visible). 5 drones + rockets launched; C-RAM shot 2. Green Zone luxury hotel also hit. 4 killed in Jadiriyah district. CTP-ISW (March 16): 20 PMF killed/wounded at al-Qaim (18th/19th brigades), 8 Badr Organization fighters killed, 6 PMF wounded at Jurf al-Sakhr (KH facility), 3 PMF wounded near Badush Dam. 196+ drone/missile attacks on KRI since Feb 28. Militia tempo still escalating despite leadership kills (al-Askari, Day 17).", sources:[{t:"CNN-Embassy",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-17-26"},{t:"Asharq-Embassy",u:"https://english.aawsat.com/arab-world/5252117-drone-rocket-attack-targets-us-embassy-baghdad"},{t:"CTP-ISW-D16",u:"https://www.criticalthreats.org/analysis/iran-update-march-16-2026"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 21: 6 KC-135 crew members killed (Hegseth honored at Dover AFB). Total: ~19 KIA, ~200+ wounded across 7 countries. Pentagon requesting $200B supplemental. Military presented Trump daily 'escalate or exit' options — hasn't taken exit ramp. Previous: USS Ford to Crete for repairs. Embassy Baghdad struck. ~50,000 troops deployed. 4 manned aircraft lost.", sources:[{t:"NBC-KC135",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"NBC-ExitRamp",u:"https://www.nbcnews.com/politics/national-security/trump-presented-daily-options-end-war-iran-hasnt-taken-far-rcna263399"},{t:"WaPo-200WIA",u:"https://www.washingtonpost.com/national-security/2026/03/16/us-troops-wounded-iran/"},{t:"Axios-$200B",u:"https://www.axios.com/2026/03/19/200-billion-iran-war-hegseth-penntagon"}],
    subgoals:[
      { id:"cas-zero", name:"Maintain zero-casualty posture", party:"us", type:"avoid", importance:5, achievability:1, status:"unachievable", outcomeNote:"Failed Day 2. US KIA: 13 (7 hostile fire + 6 KC-135 crash). ~200 wounded across 7 countries, 10 severe, 180+ returned to duty. France: 1 KIA (drone strike, Kurdish Iraq). Coalition casualties multinational.", sources:[{t:"WaPo-200WIA",u:"https://www.washingtonpost.com/national-security/2026/03/16/us-troops-wounded-iran/"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"},{t:"USNews-200",u:"https://www.usnews.com/news/world/articles/2026-03-16/number-of-us-troops-wounded-in-war-against-iran-rises-to-about-200"}] },
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 20: Amnesty: school strike killed 170+ (mostly schoolgirls). AI targeting identified as cause (WaPo). Senate deadline March 18. Iran toll: 1,444+ (health ministry) / 5,300 (Hengaw NGO). 3.2M displaced. 18 hospitals struck (WHO). 'Black rain' from oil facility strikes. Previous: Lebanon 922+ killed, 1M+ displaced. UAE 16+ killed. Regional total approaching 2,500+ killed across all countries.", sources:[{t:"Amnesty-School",u:"https://www.amnesty.org/en/latest/news/2026/03/usa-iran-those-responsible-for-deadly-and-unlawful-us-strike-on-school-that-killed-over-100-children-must-be-held-accountable/"},{t:"WaPo-AI",u:"https://www.washingtonpost.com/national-security/2026/03/17/iran-school-strike-ai-targeting/"},{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 21: CLUSTER MISSILES HITTING CENTRAL ISRAEL — elderly couple killed in Ramat Gan, 30-year-old foreign worker killed at Moshav Adanim, 4 Palestinian women killed in West Bank by Iranian missiles. Tel Aviv Savidor Central station took direct hits — 'extensive structural damage.' INTERCEPTOR CRISIS: NIS 2.6B ($826M) emergency defense transfer approved. Semafor: 'critically low' on Arrow. IDF denied. 8+ BM barrages in single night. Iran's shift to cluster/multiple-warhead munitions maximizing civilian impact.", sources:[{t:"Haaretz-WB",u:"https://www.haaretz.com/west-bank/2026-03-19/ty-article/.premium/iranian-barrages-kill-at-least-four-palestinians-in-west-bank-one-man-in-israel/0000019d-02e2-da5c-a3bd-0ee231080000"},{t:"ToI-D21",u:"https://www.timesofisrael.com/liveblog-march-19-2026/"},{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"}],
    subgoals:[
  ...
  // ═══ TIER 3: POLITICAL / DIPLOMATIC ═══
  {
    ...
    importance:5, achievability:2, status:"at risk", outcomeNote:"Day 21: DNI GABBARD CONTRADICTS WAR JUSTIFICATION — written testimony says Iran was NOT rebuilding enrichment pre-war. Sen. Warner accused her of deliberately omitting this from oral statement. Pentagon requesting $200B supplemental. Kent resignation. Senate school strike deadline passed with no DOD response. House vote March 20. 53-56% oppose war. Antisemitic posts up 95%. 3 domestic terrorism incidents. Gas $3.25+ (national avg). Macron urged ceasefire, called escalation 'reckless.'", sources:[{t:"AJZ-Gabbard",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"},{t:"Axios-$200B",u:"https://www.axios.com/2026/03/19/200-billion-iran-war-hegseth-penntagon"},{t:"CNN-Kent",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-18-26"},{t:"NBC-ExitRamp",u:"https://www.nbcnews.com/politics/national-security/trump-presented-daily-options-end-war-iran-hasnt-taken-far-rcna263399"}],
    subgoals:[
      ...
      { id:"dom-warpow", name:"Avoid War Powers Act confrontation", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 21: PENTAGON REQUESTS $200B — up from $50B. Hegseth: 'that number could move' higher. Needs 60 Senate votes — unlikely to pass. At $1B+/day, this is Afghanistan-peak burn rate compressed into weeks. 60-day War Powers clock expires ~April 29. DNI Gabbard testimony undermines justification. School strike Senate deadline passed with no response; House vote March 20. Every member now forced to take a position on both the cost AND the intelligence contradiction.", sources:[{t:"Axios-$200B",u:"https://www.axios.com/2026/03/19/200-billion-iran-war-hegseth-penntagon"},{t:"WaPo-$200B",u:"https://www.washingtonpost.com/national-security/2026/03/18/iran-cost-budget-pentagon/"},{t:"AJZ-Gabbard",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"}] },
  ...
  },
  {
    ...
    importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 20: Kent resigns (NCTC Director) — first senior Trump official to quit. Trump threatens NATO withdrawal. All allies refused Hormuz coalition. 5 NATO allies oppose Lebanon ground ops. EU: 'not our war.' Previous: Military assets deployed (7+ NATO nations) but political refusal to expand = alliance contracting. Gulf states privately pressing US to 'finish the job.'", sources:[{t:"CNN-Kent",u:"https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-18-26"},{t:"NPR-Kent",u:"https://www.npr.org/2026/03/18/nx-s1-5751694/iran-retaliates-israel-kills-two-top-iranian-officials"},{t:"Euronews-NATO",u:"https://www.euronews.com/2026/03/18/trump-threatens-nato-exit-allies-refuse-hormuz"},{t:"AlMonitor-Gulf",u:"https://www.al-monitor.com/originals/2026/03/analysis-gulf-states-press-us-neutralise-iran-good-hormuz-crisis-deepens"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 17: LEBANON GROUND INVASION LAUNCHED — 7TH THEATER. IDF confirmed 'targeted ground operation' in southern Lebanon. War now: Iran air campaign + Lebanon ground war + Gulf maritime + Yemen/Red Sea (Houthis sank 2 ships) + Iraq (Baghdad airport struck) + European attacks + cyber = 7 simultaneous theaters across 15+ countries. IDF: 'thousands of targets remaining,' 3+ more weeks. Both sides reject ceasefire. Trump demands Hormuz coalition — allies refuse (Japan, Australia, Germany, Greece, Italy). FCC threatens broadcaster licenses. Russia confirmed supplying weapons to Iran. War cost $16.5B+ in 17 days.", sources:[{t:"NPR-GroundOps",u:"https://www.npr.org/2026/03/16/nx-s1-5746805/iran-blocks-vital-oil-route-as-israel-expands-its-ground-operations-in-lebanon"},{t:"AJZ-D17",u:"https://www.aljazeera.com/news/2026/3/16/iran-war-what-is-happening-on-day-17-of-us-israel-attacks"},{t:"NPR-Wavers",u:"https://www.npr.org/2026/03/16/nx-s1-5748534/trump-refocuses-his-message-on-winning-as-broad-support-for-the-war-in-iran-wavers"}],
    subgoals:[
      { id:"sco-time", name:"Complete operations within 4-5 weeks", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 17: TRUMP — WAR ENDS 'SOON' BUT 'PROBABLY NOT THIS WEEK.' Delayed China trip ~1 month to stay present during conflict. IDF: 'at least 3 more weeks' through Passover + contingency beyond. CENTCOM planning 100+ days. Ground invasion of Lebanon launched = new open-ended commitment. Gap between political rhetoric ('soon') and operational reality (100+ days, Lebanon ground ops) widening. $50B supplemental pending.", sources:[{t:"CBS-NotThisWeek",u:"https://www.cbsnews.com/live-updates/iran-war-oil-prices-strait-of-hormuz-trump-threat-kharg-island/"},{t:"NBC-ChinaTrip",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-reopen-strait-of-hormuz-israel-lebanon-rcna263448"},{t:"ToI-D16",u:"https://www.timesofisrael.com/liveblog-march-15-2026/"}] },
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 21: MUTUAL ENERGY INFRASTRUCTURE DESTRUCTION — Israel struck South Pars → Iran struck Saudi SAMREF/Yanbu, Jubail, Qatar Ras Laffan (Pearl GTL extensively damaged, LNG offline until June/July), Kuwait refineries. Brent $116 (+10%). European gas +24%. US diesel $5+. S&P -1%, Nasdaq -1.3%. Fed held rates, signaled uncertainty. Trump threatened to 'blow up' entire South Pars. Bessent floated removing sanctions on stranded Iranian oil. $200/bbl not ruled out. Both sides now destroying the energy infrastructure the global economy depends on.", sources:[{t:"NBC-D21",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"AJZ-Gulf",u:"https://www.aljazeera.com/news/2026/3/18/iran-threatens-to-strike-gulf-energy-facilities-after-south-pars-attack"},{t:"CBS-Diesel",u:"https://www.cbsnews.com/live-updates/iran-war-israel-strike-south-pars-gas-field-trump-threat-oil-gas-prices/"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 21: BRENT $116 (+10%), WTI ~$99. European gas +24%. US diesel above $5 for first time since 2022. Mutual energy infrastructure destruction: Israel struck South Pars → Iran struck Saudi SAMREF/Yanbu + Jubail + Qatar Ras Laffan (Pearl GTL extensively damaged, LNG exports offline until June/July) + Kuwait refineries. Qatar expelled Iranian attachés. Bessent floated removing sanctions on stranded Iranian oil. Fed held rates, signaled uncertainty. $200/bbl not ruled out. S&P -1%, Nasdaq -1.3%.", sources:[{t:"NBC-D21",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"},{t:"AJZ-Gulf",u:"https://www.aljazeera.com/news/2026/3/18/iran-threatens-to-strike-gulf-energy-facilities-after-south-pars-attack"},{t:"CBS-Diesel",u:"https://www.cbsnews.com/live-updates/iran-war-israel-strike-south-pars-gas-field-trump-threat-oil-gas-prices/"}] },
      ...
      { id:"en-pump", name:"Keep US gas prices manageable", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 17: GAS $3.72/GAL national avg (AAA), DIESEL NEAR $5 (+$1.34/MONTH). California $5.53, Kansas $3.15. Up ~80 cents from a month ago. Highest since Oct 2023. Summer formulation switch may push higher. Approaching $4 presidential approval-rating cliff. 53-56% oppose war. Rising fuel costs driving up food prices. War cost: ~$16.5B+ in 17 days. $50B supplemental pending. 250+ organizations calling on Congress to halt war funding.", sources:[{t:"AAA-Gas",u:"https://gasprices.aaa.com/"},{t:"NPR-Gas",u:"https://www.npr.org/2026/03/16/nx-s1-5749333/iran-war-gasoline-prices-day-17"},{t:"NPR-Cost",u:"https://www.npr.org/2026/03/14/nx-s1-5746623/iran-war-cost-deaths"},{t:"ACLU-250",u:"https://www.aclu.org/press-releases/more-than-250-groups-oppose-additional-spending-on-trumps-illegal-iran-war"}] },
    ]
  },
  {
    id:"gulf-protect", name:"Protect Gulf Allies From Iranian Retaliation", party:"us", type:"achieve",
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 21: IRAN STRUCK GULF ENERGY INFRASTRUCTURE — Saudi SAMREF/Yanbu (Red Sea) + Jubail Petrochemical, Qatar Ras Laffan (Pearl GTL extensively damaged — LNG offline until June/July), Kuwait refineries, UAE Shah oil field + Fujairah. Qatar expelled all Iranian military/security attachés (March 18). Saudi FM: trust 'completely shattered.' UAE: attacks 'will drive Gulf into Israeli arms.' Kuwait foiled Hezbollah sabotage plot (14 Kuwaitis + 2 Lebanese). British Airways suspended Doha flights through April 30. Iran's retaliation BACKFIRED diplomatically — strengthened coalition instead of fracturing it.", sources:[{t:"AJZ-Gulf",u:"https://www.aljazeera.com/news/2026/3/18/iran-threatens-to-strike-gulf-energy-facilities-after-south-pars-attack"},{t:"TheNatl-Saudi",u:"https://www.thenationalnews.com/news/gulf/2026/03/19/saudi-arabia-says-trust-with-iran-completely-shattered-by-attacks-on-gulf-states/"},{t:"AJZ-Qatar",u:"https://www.aljazeera.com/news/liveblog/2026/3/19/iran-war-live-qatar-saudi-energy-sites-attacked-riyadh-says-trust-gone"},{t:"NBC-LNG",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-energy-prices-trump-gas-field-israel-qatar-rcna264010"}],
    subgoals:[
      { id:"gulf-ad", name:"Maintain Gulf air defense effectiveness", party:"us", type:"achieve", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 19: UAE CUMULATIVE — 314 BMs + 15 CRUISE + 1,672 DRONES INTERCEPTED (2,001 total projectiles). Rates holding but volume enormous. Qatar: 14 BMs on March 17 (13 intercepted, 1 uninhabited) — escalation from drone-only. Saudi: 7 drones intercepted Eastern Province. Kuwait: 4 hostile drones detected, 1 destroyed. Bahrain: Neutralized 129 missiles + 221 drones cumulative. CENTCOM denied Iran's false-flag claim (US attacking Gulf states) — called it a 'LIE.' Interceptor sustainability remains the critical question — 'years of production shot in days.'", sources:[{t:"modgovae-D19",u:"https://x.com/modgovae/status/2033528372547268715"},{t:"BDF-Bahrain",u:"https://x.com/BDF_Bahrain/status/2033463468607639728"},{t:"KuwaitArmy",u:"https://x.com/KuwaitArmyGHQ/status/2033569001658319282"},{t:"CENTCOM-LIE",u:"https://x.com/CENTCOM/status/2033190759654981777"}] },
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:mobile?8:12 }}>
          <div>
            ...
            <div style={{ fontSize:mobile?10:11, color:C.textDim, marginTop:4 }}>
              ...
              <span style={{color:C.oppose}}>■</span> Opposing {!mobile && <>&nbsp;|&nbsp; Day 20 — March 18, 2026 — Evening Update</>}
            </div>
            {mobile && <div style={{ fontSize:9, color:C.textDim, marginTop:2 }}>Day 20 — March 18, 2026 — Evening Update</div>}
          </div>
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 21</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Decapitation accelerating: 4+ senior officials killed in 48 hours (Larijani/SNSC, Khatib/Intel, Soleimani/Basij, Nasirzadeh) + Hezbollah's Marwan in Beirut. 7,800+ targets struck. 8,000+ sorties. 120+ vessels destroyed. ~70% missile launchers destroyed. 'Largest strike package yet' on Day 21 with 5,000-lb penetrators on underground facilities.</span> Iran reduced to asymmetric responses — cluster munitions on civilians and Gulf energy strikes — precisely because conventional capacity is gone. Missile crews deserting.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Iran's Gulf retaliation backfired: Qatar expelled Iranian attachés AFTER being attacked — chose coalition over neutrality. Saudi FM: trust 'completely shattered.' UAE: attacks 'will drive Gulf into Israeli arms.'</span> Iran can't pay government employees. No contact between Mojtaba and Pezeshkian. ~5,000 security forces killed. Houthis still NOT attacking Red Sea shipping. Kosovo prior: Day 21 of 78 — NATO hadn't achieved air superiority. This campaign has total air/naval dominance and is in Phase 2 underground targeting. Militarily ahead of every modern analogue.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 21</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>{stats.expanding} goals growing beyond plan</span>. <span style={{color:"#F59E0B",fontWeight:700}}>5 active theaters (was 2 on Day 1): Iran air campaign, Lebanon ground war (968 killed, 1M+ displaced, Litani bridges destroyed), Gulf energy infrastructure war (MUTUAL — both sides hitting each other's facilities), Caspian Sea supply route strikes, Fort McNair drones over DC. Pentagon $200B supplemental — 'could move higher.' Brent $116. Qatar LNG offline until June/July.</span>
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              Kent resignation + Gabbard testimony = political foundations cracking. Trump threatening to 'blow up' South Pars entirely. Iraqi militia claimed 28 drone strikes across Saudi/Kuwait/Jordan. <span style={{color:"#F59E0B",fontWeight:700}}>The core question: is expansion a sign of winning so thoroughly that Iran is desperate (Gulf energy strikes = asymmetric because conventional forces destroyed) or uncontrolled escalation (both sides now destroying the revenue each needs to sustain operations)? The answer may be both, in different theaters.</span>
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 21</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are genuinely failing</span>. (1) <span style={{color:C.red,fontWeight:700}}>Nuclear: IAEA reveals NEW underground Isfahan enrichment site — target set growing, not shrinking. DNI Gabbard testified Iran was NOT rebuilding enrichment — the intelligence contradicts the casus belli.</span> (2) Force protection: Israel 'critically low' on Arrow interceptors ($826M emergency transfer). Iran firing 8+ BM barrages per night with cluster munitions. 2 killed Ramat Gan, Savidor station hit. ~19 US KIA, 200+ wounded. (3) Diplomatic coherence: killing Larijani (nuclear negotiator) closes the primary diplomatic channel while no endstate is defined.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              Brent $116 despite strategic releases. $200B supplemental request. Qatar LNG offline until June/July. School strike Senate deadline passed with no response. <span style={{color:C.red,fontWeight:700}}>The structural failing: military success at Layer 1 without political endstate at Layer 3. Can decapitation + air superiority produce capitulation? Kosovo says yes (78 days). Iraq 2003 says no. Nowruz tomorrow is the leading indicator — if Mojtaba delivers a coherent message, regime is wounded but functional. If silence, state coherence is failing and the Libya analogue rises.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
