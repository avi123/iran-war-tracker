...
const HIGHLIGHTS = {
  updatedAt: "2026-04-09T16:37Z",
  keyDevelopments: [
    { text: "CEASEFIRE CRACKING — Iran accuses US of 3 violations (Lebanon strikes, drone incursions, enrichment refusal). Re-closed Hormuz citing Lebanon. But UAE reported ZERO incoming threats April 9 — first clean day since war began, confirming ceasefire orders reaching IRGC units. Hezbollah fired rockets at northern Israel April 9 (first since ceasefire). Trump: 'if agreement not reached then the shootin starts bigger and better and stronger.' Soufan Center: ceasefire 'hovers on verge of collapse.'", why: "The ceasefire is bifurcating: Iran-US direct hostilities paused (UAE zero-attack day confirms), but Lebanon exclusion is unraveling the framework. Iran using Hormuz re-closure as leverage for Lebanon inclusion. Pakistan's mediation is the only thing preventing full collapse before Islamabad talks.", category: "political", goalIds: ["sco-exit", "hor-open", "hez-rocket"], sources: [{t:"CBS-Violations",u:"https://www.cbsnews.com/live-updates/iran-trump-ceasefire-strait-hormuz-israel-war-hezbollah-continues/"},{t:"NBC-Verge",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-ceasefire-trump-hormuz-israel-lebanon-rcna267390"},{t:"KhaleejTimes-UAE",u:"https://www.khaleejtimes.com/uae/uae-detects-no-missiles-confirms-airspace-free-of-threats-on-april-9"}] },
    { text: "ISLAMABAD TALKS TOMORROW — Highest-level US-Iran contact since 1979. US: VP Vance (lead), Witkoff, Kushner. Iran: Ghalibaf + Araghchi. Pakistan PM Sharif mediating via shuttle diplomacy. Iran's 3-step nuclear proposal: lower enrichment to 3.67% (JCPOA level), permanently halt HEU, restore IAEA inspections + Additional Protocol. Most concrete offer yet — but meets Trump's 'zero enrichment' red line.", why: "The enrichment impasse is the likely deal-breaker. Iran's 3-step proposal shows genuine movement from 'enrichment is a right, full stop' but still retains enrichment capability. Trump/Hegseth: 'we'll take it if we have to.' If talks produce a verification framework, war potentially ends. If they fail, resumption at Day 54 with Iran partially recovered and War Powers at ~7 days.", category: "political", goalIds: ["nuke", "sco-exit", "all-oman"], sources: [{t:"Axios-Vance",u:"https://www.axios.com/2026/04/08/us-iran-peace-talks-vance-pakistan-saturday"},{t:"Bloomberg-Iran",u:"https://www.bloomberg.com/news/articles/2026-04-08/pakistan-says-iran-confirms-to-attend-talks-with-us-in-islamabad"},{t:"Time-Nuclear",u:"https://time.com/article/2026/04/08/iran-us-ceasefire-proposal-talks/"}] },
    { text: "OPERATION ETERNAL DARKNESS — Israel's largest coordinated strike of the war. 254 killed April 8, 100+ Hezbollah targets in 10 minutes across Beirut, southern Lebanon, Bekaa Valley. National mourning declared. 6 IDF divisions now committed (98th Paratrooper newly deployed). Key kills: Qassem's nephew/secretary Ali Yusuf Harshi + Hezbollah cleric Sadiq al Nabulsi (Sidon). Trump asked Netanyahu to 'scale back' — first visible US-Israel disagreement on theater management.", why: "Lebanon is now the active war while Iran pauses. The Trump-Netanyahu tension over scale-back is a significant dynamic shift — Washington sees Lebanon escalation as risk to Islamabad talks. Iran's Point 10 demands all-fronts cessation. 8 European leaders say ceasefire should cover Lebanon. If Lebanon torpedoes talks, Israel's theater decoupling will have traded tactical Hezbollah gains for strategic failure on Iran.", category: "military", goalIds: ["hez", "hez-rocket", "hez-ground", "sco-theater"], sources: [{t:"NBC-Lebanon",u:"https://www.nbcnews.com/world/lebanon/lebanon-israel-attack-iran-ceasefire-hezbollah-rcna267260"},{t:"AJZ-254",u:"https://www.aljazeera.com/news/liveblog/2026/4/9/iran-war-live-israel-kills-254-in-lebanon-shaking-trump-tehran-ceasefire"},{t:"ToI-Harshi",u:"https://www.timesofisrael.com/liveblog-april-09-2026/"}] },
    { text: "CASUALTIES REVISED SHARPLY UPWARD — HRANA (independent): 3,636 killed in Iran (1,701 civilian, 1,221 military, 714 unclassified, 216+ children). 26,500+ wounded. Lebanon: 1,784 killed, 5,977 wounded, 1M+ displaced. Israel: 40 killed (27 civilian), 7,367 wounded. US: 13 KIA, 381 WIA. Total all fronts: ~5,600-5,700 killed, ~41,000+ wounded.", why: "Iran figure jumped from 1,332 (Red Crescent, government-adjacent) to 3,636 (HRANA, independent methodology). This is primarily a source change reflecting better accounting, not a sudden spike — HRANA tracks military casualties that Red Crescent omits. Combined death toll across all fronts now approaching 6,000. IMF warns 45M additional people pushed into food insecurity globally.", category: "humanitarian", goalIds: ["cas-civ", "cas-us", "cas-isr", "civ-total"], sources: [{t:"HRANA",u:"https://www.hrana.org"},{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"},{t:"Wikipedia-Cas",u:"https://en.wikipedia.org/wiki/Casualties_of_the_2026_Iran_war"}] },
    { text: "HORMUZ TOLL SYSTEM — Iran collecting ~$2M/vessel in bitcoin/yuan. Free transit for China, Russia, India, Iraq, Pakistan. Cap at 15 vessels/day. IMO: 'dangerous and unacceptable precedent.' UK rejected scheme. Only 3-4 ships/day transiting vs 135 normal. 800+ vessels trapped. Oil bounced back above $100 after Iran re-closed Strait citing Lebanon strikes.", why: "Iran is creating a permanent revenue/control mechanism regardless of ceasefire outcome. The two-tier system (allies free, others pay) restructures global shipping around Iranian sovereignty claims. Even if ceasefire holds, normalization timeline is weeks to months. The gap between 'safe opening' promise and 3% throughput is the ceasefire's central credibility failure.", category: "economic", goalIds: ["hor-open", "en-oil", "hor-insurance"], sources: [{t:"Bloomberg-Tolls",u:"https://www.bloomberg.com/news/articles/2026-04-09/iran-s-hormuz-tolls-would-set-a-dangerous-precedent-imo-says"},{t:"CoinDesk-Crypto",u:"https://www.coindesk.com/policy/2026/04/09/crypto-payments-to-pass-strait-of-hormuz-is-the-next-logical-step-for-iran-s-sanctions-skirting-trade-network"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/04/09/oil-prices-today-wti-brent-iran-accuse-us-of-ceasefire-breach.html"}] },
    { text: "PEZESHKIAN vs IRGC — President publicly accused IRGC commanders Vahidi, Abdollahi, and Taeb of 'unilateral actions that wrecked ceasefire prospects.' Unprecedented internal split. Ghalibaf (unsanctioned) leading diplomatic track for Islamabad. Iran's SNSC says talks could continue up to 15 days.", why: "Most significant regime fracture since war began. The reformist/pragmatist camp (Pezeshkian/Araghchi/Ghalibaf) is openly challenging the IRGC hardliners (Vahidi) over war policy — no longer behind closed doors. If the negotiating team doesn't control the military actors, ceasefire compliance is structurally unreliable. Washington Institute assessment: strikes paradoxically strengthening IRGC domestic authority even as political authority fractures.", category: "regime", goalIds: ["regime", "reg-succession", "reg-irgc-cohesion"], sources: [{t:"IranIntl-Split",u:"https://www.iranintl.com/en/202604097799"},{t:"WashInst-IRGC",u:"https://www.washingtoninstitute.org/policy-analysis/countering-threats-irans-proxies-and-partners-during-wartime"}] },
  ],
  watchNext: [
    { text: "ISLAMABAD TALKS APRIL 10-11 — Can enrichment impasse be bridged? Iran's 3-step proposal (3.67%, halt HEU, restore IAEA) vs Trump's 'zero enrichment.' Indirect/shuttle format. Iran's SNSC: talks could continue 15 days.", why: "The single most important event since the war began. If talks produce a verification framework on enrichment, the war potentially ends. If they fail on enrichment (the most likely outcome given structurally irreconcilable positions), resumption at Day 54 with Iran partially recovered and War Powers at ~7 days. Watch for: process agreement to extend ceasefire vs substance on nuclear terms.", category: "political", timeframe: "24-48h", sources: [{t:"Axios-Vance",u:"https://www.axios.com/2026/04/08/us-iran-peace-talks-vance-pakistan-saturday"},{t:"Bloomberg-Iran",u:"https://www.bloomberg.com/news/articles/2026-04-08/pakistan-says-iran-confirms-to-attend-talks-with-us-in-islamabad"}] },
    { text: "LEBANON AS CEASEFIRE-KILLER — Iran's Point 10 demands all-fronts cessation. 8 European leaders agree. Trump asked Netanyahu to 'scale back.' But Israel launched largest strike wave of war (254 killed April 8). Does Lebanon torpedo Islamabad talks?", why: "If Iran walks out of Islamabad citing Lebanon, Israel's theater decoupling strategy will have traded tactical Hezbollah gains for strategic failure on Iran. The Trump-Netanyahu tension over scale-back is the first visible coalition fracture on theater management. Hezbollah fired rockets at Israel April 9 — escalation spiral during ceasefire.", category: "military", timeframe: "24-48h", sources: [{t:"AJZ-254",u:"https://www.aljazeera.com/news/liveblog/2026/4/9/iran-war-live-israel-kills-254-in-lebanon-shaking-trump-tehran-ceasefire"},{t:"PBS-Lebanon",u:"https://www.pbs.org/newshour/world/israel-says-iran-ceasefire-doesnt-apply-to-lebanon-and-strikes-central-beirut-without-warning"}] },
    { text: "HORMUZ RE-CLOSURE — Iran shut Strait again after initially allowing tankers, citing Lebanon strikes. 3-4 ships/day vs 135 normal. Iran collecting $2M/vessel in crypto/yuan. When does throughput meaningfully resume?", why: "Hormuz is Iran's strongest remaining leverage and the ceasefire's operational credibility test. The toll system creates a permanent two-tier regime that could persist even with a deal. Until throughput exceeds 50 ships/day, the ceasefire's economic deliverable has failed. Oil back above $100 — markets re-pricing after initial ceasefire euphoria.", category: "economic", timeframe: "this week", sources: [{t:"Bloomberg-Tolls",u:"https://www.bloomberg.com/news/articles/2026-04-09/iran-s-hormuz-tolls-would-set-a-dangerous-precedent-imo-says"},{t:"WaPo-Reclosed",u:"https://www.washingtonpost.com/national/2026/04/08/iran-israel-us-lebanon-latest-april-8-2026/5b988e08-3304-11f1-b85b-2cd751275c1d_story.html"}] },
    { text: "CEASEFIRE EXPIRY ~APRIL 21 + WAR POWERS ~APRIL 28 — 7-day gap. If talks fail and war resumes at Day 54, legal authority contested within a week. House Democrats tried unanimous consent on War Powers April 9 — GOP blocked. Senate vote when Congress returns next week.", why: "The ceasefire may be running out the War Powers clock by design. If talks succeed, both clocks become moot. If talks fail: ceasefire expires April 21, Congress returns from recess, War Powers expires April 28. Only 7 days of fighting before authorization required. $200B supplemental still dead.", category: "political", timeframe: "this week", sources: [{t:"Axios-WP",u:"https://www.axios.com/2026/03/26/iran-trump-war-powers-vote-house-democrats"},{t:"CommonDreams-WP",u:"https://www.commondreams.org/news/congress-iran-war-powers"}] },
    { text: "IRAN USING CEASEFIRE TO RECONSTITUTE — 14 days to harden Fordow, relocate HEU, reconstitute command. CSIS: Iran may be 'redoubling efforts' on nuclear program given conventional imbalance. Russia provided 55 Israeli energy infrastructure targets (single-source Ukrainian intel, Russia denies).", why: "The ceasefire freezes the only leverage (military pressure) while Iran recovers. If Islamabad fails, resumed war faces a partially reconstituted adversary with better targeting data (Russian intel). Satellite imagery during ceasefire will reveal whether Iran is hardening or negotiating in good faith.", category: "military", timeframe: "this week", sources: [{t:"CSIS-Nuclear",u:"https://www.csis.org/analysis/fragile-us-iran-ceasefire-issues-watch"},{t:"JPost-Russia55",u:"https://www.jpost.com/middle-east/iran-news/article-892256"}] },
  ],
  watchResolved: [
    { text: "Gulf ceasefire attacks April 8", resolved: "PRE-PROGRAMMED: UAE reported ZERO incoming threats April 9 — first clean day since war began. April 8 attacks were pre-programmed launches clearing the system, not deliberate violations. Ceasefire orders confirmed reaching IRGC operational units with ~24hr delay.", status: "confirmed" },
    { text: "Trump's 8PM deadline April 7", resolved: "CEASEFIRE INSTEAD: Did NOT follow through on 'civilization will die tonight' threat. Announced Pakistan-brokered 14-day ceasefire ~90 min before deadline. Third ultimatum → diplomacy.", status: "confirmed" },
    { text: "Passover attack", resolved: "CONFIRMED: Iran fired ~20+ BMs with cluster munitions during Seder night. Coordinated with Hezbollah (100+ rockets) + Houthis (drones at Eilat). 4 killed Haifa, 11-year-old critically hurt.", status: "confirmed" },
    { text: "Iran's 10-point proposal", resolved: "BECAME CEASEFIRE BASIS + ISLAMABAD FRAMEWORK: US says published version 'not the one approved.' Iran's 3-step nuclear proposal (3.67%, halt HEU, IAEA) is most concrete offer. Talks begin April 10.", status: "confirmed" },
    { text: "Interceptor crisis", resolved: "CEASEFIRE PROVIDES RESPITE: Arrow 2/3 ~80% depleted. Ceasefire pauses depletion clock but replacement is 2-3 years. If war resumes, crisis returns immediately.", status: "confirmed" },
    { text: "$200B supplemental", resolved: "STILL DEAD: House Democrats tried War Powers unanimous consent April 9 — GOP blocked. No supplemental votes, no timeline. War at $38B+ spent.", status: "ongoing" },
    { text: "Bab el-Mandeb threat", resolved: "HOUTHIS MIRRORING CEASEFIRE: Iraq's Islamic Resistance declared parallel 2-week halt. Houthis participated in pre-ceasefire strikes but have NOT resumed Red Sea shipping attacks. Status uncertain.", status: "partial" },
    { text: "Pezeshkian vs IRGC", resolved: "SPLIT CONFIRMED: President publicly accused Vahidi, Abdollahi, Taeb of sabotaging ceasefire. Most significant regime fracture — but unclear if negotiating team controls military compliance.", status: "ongoing" },
  ],
};
...
const AXES = [
  {
    ...
    summary: "Ceasefire at Day 40 stabilizes the regime more than 40 days of bombardment weakened it. Mojtaba Khamenei instructed all military units to stop firing ~2 hours after ceasefire announcement — still reported 'wounded and likely disfigured' but governing. Both sides claimed victory: Iran's SNSC portrayed deal as win, state media frames ceasefire as 'Iran's power forced Trump into agreement.' Protesters chanting 'Death to Mojtaba' in residential neighborhoods. IRGC intel chief Khademi (#2) + Quds Force commander Bagheri killed April 6 — but leadership reconstituting faster than being killed. Ghalibaf (unsanctioned) leading diplomatic track toward Islamabad talks. Deep regime split persists: negotiate vs fight on. 6+ political prisoners executed. Washington Institute: strikes strengthening IRGC domestic authority.",
    keyIndicators: [
      ...
      { label: "Regime split", value: "Deepening", detail: "Pezeshkian/Araghchi/Zarif (negotiate) vs IRGC/Vahidi (fight on). Zarif branded 'traitor.' Both factions can claim ceasefire validates their position. Islamabad talks will force resolution of internal debate.", color: "#EF4444" },
      { label: "Mojtaba status", value: "Governing but wounded", detail: "Instructed ceasefire compliance. 'Wounded and likely disfigured' from earlier strike. No video/audio in 30+ days. Protesters chanting 'Death to Mojtaba.' Russia medical treatment unverified.", color: "#EF4444" },
      { label: "IRGC paradox", value: "Ceasefire reinforces", detail: "Washington Institute: strikes strengthening IRGC domestic authority. Ceasefire further consolidates — regime survived 40 days of bombardment and extracted a deal. State media framing as victory.", color: "#F59E0B" },
    ],
    watching: [
      { text: "Islamabad talks — does regime send Ghalibaf or Araghchi? Choice signals which faction controls diplomacy.", timeframe: "24-48h" },
      { text: "Mojtaba Khamenei's whereabouts — no video/audio in 30+ days. Ceasefire removes immediate survival pressure but governance demands visibility.", timeframe: "open question" },
      { text: "Internal debate resolution — ceasefire forces regime to choose: negotiate seriously or use pause to rearm. Both factions claiming vindication.", timeframe: "this week" },
    ],
  ...
  },
  {
    ...
    summary: "Ceasefire freezes military pressure but enrichment impasse is the likely deal-breaker. Trump: 'no enrichment — we will dig up and remove all deeply buried nuclear dust.' Iran Point 3: enrichment is a right. These are structurally incompatible. Fordow — primary 60% enrichment site — undamaged and operational. 440 kg of 60% HEU unverifiable. New underground facility at Isfahan (June 2025) never inspected. Khondab Heavy Water Plant no longer operational. Natanz aboveground destroyed but underground status unclear. Bushehr struck 4 times (1 worker killed, 75m from perimeter). IAEA: zero access since Day 1. Grossi: cannot certify program as 'exclusively peaceful.' Iran now has 14 days to harden, relocate, or advance its program with reduced risk of strikes.",
    keyIndicators: [
      ...
      { label: "Enrichment impasse", value: "Structural", detail: "Trump: 'no enrichment.' Iran Point 3: 'enrichment is a right.' No visible compromise formula. This is the most likely failure point for Islamabad talks.", color: "#EF4444" },
      { label: "IAEA access", value: "Zero since Day 1", detail: "No inspectors at any facility. Grossi: cannot certify peaceful. Any inspection during ceasefire would transform intelligence picture — but Iran has no incentive to allow it.", color: "#EF4444" },
    ],
    watching: [
      { text: "Enrichment at Islamabad — can any compromise formula bridge 'no enrichment' vs 'enrichment is a right'? This is the deal-breaker.", timeframe: "24-48h" },
      { text: "Iran using ceasefire to harden/relocate — 14 days to move HEU, reinforce Fordow, reconstitute Natanz. Satellite imagery will reveal.", timeframe: "this week" },
      { text: "IAEA access during ceasefire — Grossi seeking inspection. If granted, transforms intelligence picture. If denied, confirms worst-case assumptions.", timeframe: "this week" },
    ],
    goalIds: ["nuke", "hormuz"],
  ...
  },
  {
    ...
    summary: "Ceasefire pauses Iran-US attrition but Lebanon is actively depleting both sides. Arrow 2/3 ~80% depleted — ceasefire provides respite but replacement is 2-3 years. Soufan Center: Iran's arsenal 'only partially depleted.' UAE reported ZERO incoming threats April 9 — confirming ceasefire compliance reaching IRGC units. But Hezbollah fired rockets at Israel April 9 (first since ceasefire) and Israel launched largest strike wave of the war (254 killed April 8). Oil whipsawed: crashed 16% on ceasefire, bounced back above $100 after Iran re-closed Hormuz. Both sides in a 14-day race: Iran to reconstitute/harden/relocate HEU, US/Israel to replenish interceptors. Russia providing Iran with 55 Israeli target list (single-source) — if war resumes, Iran will have better targeting data. CSIS: Iran may be 'redoubling nuclear efforts' given conventional imbalance.",
    keyIndicators: [
      { label: "Iran arsenal", value: "Partially depleted", detail: "Soufan: 'only partially depleted.' Pentagon claims 'completely destroyed' DI base — asymmetric skepticism flag. 14-day ceasefire = reconstitution window. CSIS: Iran may be redoubling nuclear efforts.", color: "#F59E0B" },
      { label: "Israel interceptors", value: "~80% depleted", detail: "Arrow 2/3 ~80% expended. Ceasefire pauses depletion but replacement 2-3 years. Hezbollah sustaining 200 daily launches — can maintain 5 more months per Israeli admission.", color: "#EF4444" },
      { label: "Casualties all fronts", value: "~5,700 killed", detail: "Iran: 3,636 (HRANA). Lebanon: 1,784. Israel: 40. US: 13 KIA, 381 WIA. Gulf: ~23. Total wounded: ~41,000+. Ceasefire pauses Iran-US but Lebanon escalating.", color: "#EF4444" },
      { label: "Oil/economic", value: "Back above $100", detail: "Crashed 16% on ceasefire (WTI $94.41), bounced back above $100 after Iran re-closed Hormuz. 800+ vessels trapped. Iran toll system: $2M/vessel in bitcoin/yuan.", color: "#F59E0B" },
      { label: "Ceasefire clock", value: "~12 days left", detail: "Expires ~April 21. War Powers ~April 28 (7-day gap). Islamabad talks tomorrow — enrichment impasse is the likely failure point. If talks fail, resumption with Iran partially recovered.", color: "#F59E0B" },
    ],
    watching: [
      { text: "Islamabad talks — enrichment deal-breaker. Iran's 3-step proposal vs Trump's zero enrichment. Most important event since war began.", timeframe: "24-48h" },
      { text: "Lebanon ceasefire-killer — does Israel's 254-killed strike wave torpedo Islamabad talks? Trump asked Netanyahu to 'scale back.'", timeframe: "24-48h" },
      { text: "Iran reconstitution — satellite imagery of Fordow, Natanz, missile sites. Is Iran hardening or negotiating?", timeframe: "this week" },
    ],
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 42: ENRICHMENT IS THE DEAL-BREAKER — Iran proposed 3-step plan: lower to 3.67% (JCPOA level), permanently halt HEU production, restore IAEA inspections + Additional Protocol. Most concrete offer yet. BUT: Trump 'zero enrichment,' Hegseth 'we'll take it if we have to,' Netanyahu demands all enriched material leave Iran. CSIS: facilities 'buried beneath tons of rubble' but issue 'fundamentally unresolved' — Iran may be 'redoubling efforts' given conventional imbalance. IAEA chief Grossi visited Tehran, met Araghchi: 'very crucial stage.' Fordow undamaged and operational. ~440 kg 60% HEU unverifiable (~972 lbs). Ceasefire gives Iran 14 days to harden/relocate. Islamabad talks tomorrow will test whether any compromise formula exists.", sources:[{t:"Time-Nuclear",u:"https://time.com/article/2026/04/08/iran-us-ceasefire-proposal-talks/"},{t:"CSIS-Nuclear",u:"https://www.csis.org/analysis/fragile-us-iran-ceasefire-issues-watch"},{t:"PBS-Enrichment",u:"https://www.pbs.org/newshour/world/iran-nuclear-enrichment-ceasefire-2026"},{t:"Newsweek-Dust",u:"https://www.newsweek.com/donald-trump-iran-bombers-nuclear-dust-uranium-11798842"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 42: OPERATION EPIC FURY CUMULATIVE — 13,000+ targets struck, 80% air defenses destroyed, 450+ BM storage facilities hit, 801 drone storage facilities struck, 155+ vessels destroyed, 13,000+ combat flights. Hegseth: defense-industrial base 'completely destroyed.' 'Hundreds' of US drones integrated into operations — air, sea, subsea, ground. LUCAS (Low-cost Uncrewed Combat Attack Systems) deployed. BUT Soufan Center: Iran's arsenal 'only partially depleted' — asymmetric skepticism flag. Pentagon claims lack independent baseline verification. Gen. Caine: 'ceasefire's a pause — joint force remains ready to resume.' 50,000+ US troops remain in region.", sources:[{t:"DefenseScoop-Drones",u:"https://defensescoop.com/2026/04/07/us-launches-more-attack-drones-iran-epic-fury-adm-cooper-centcom/"},{t:"Soufan-Arsenal",u:"https://thesoufancenter.org/intelbrief-2026-april-6/"},{t:"Euronews-DI",u:"https://www.euronews.com/2026/04/08/us-and-iran-agree-to-two-week-truce-after-trump-pulls-back-on-threats"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"hor-open", name:"Keep Hormuz open during operations", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 42: HORMUZ RE-CLOSED — Iran shut Strait again citing Lebanon strikes, hours after initial tanker transit. 3-4 ships/day vs 135 normal. Iran toll system: $2M/vessel in bitcoin/yuan, free for China/Russia/India/Iraq/Pakistan. Cap at 15 vessels/day. IMO: 'dangerous and unacceptable precedent.' UK rejected. UKMTO: 'critical' — 27 incidents since March 1. Possible sea mines (AP chart). White House claims open — 'contradicted by marine tracking data.' Trump demands open 'without limitation, including tolls.' Macron: ~15 countries on 'strictly defensive mission.' China confirmed 3 ships transited (free-passage). Maersk/Hapag-Lloyd: normalization weeks to months.", sources:[{t:"Bloomberg-Tolls",u:"https://www.bloomberg.com/news/articles/2026-04-09/iran-s-hormuz-tolls-would-set-a-dangerous-precedent-imo-says"},{t:"InsJournal-Ships",u:"https://www.insurancejournal.com/news/international/2026/04/09/865095.htm"},{t:"WashTimes-UK",u:"https://www.washingtontimes.com/news/2026/apr/9/british-officials-openly-reject-proposed-toll-system-strait-hormuz/"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"sco-exit", name:"Define clear exit criteria", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 42: ISLAMABAD TALKS BEGIN TOMORROW — Highest-level US-Iran contact since 1979. VP Vance leading US delegation with Witkoff + Kushner. Iran: Ghalibaf + Araghchi. Shuttle diplomacy via Pakistani mediators. Iran's SNSC: talks could continue 15 days. Competing frameworks irreconcilable at face value: US demands zero enrichment + Hormuz open without tolls; Iran demands enrichment rights + sanctions lifting + US withdrawal + reparations + all-fronts cessation including Lebanon. Iran's 3-step nuclear proposal (3.67%, halt HEU, restore IAEA) is most concrete offer. But Trump: 'if agreement not reached then the shootin starts bigger and better and stronger.' War Powers ~19 days. $200B supplemental dead. Ceasefire expires ~April 21. If talks fail, resumption at Day 54 with Iran partially recovered.", sources:[{t:"Axios-Vance",u:"https://www.axios.com/2026/04/08/us-iran-peace-talks-vance-pakistan-saturday"},{t:"Bloomberg-Iran",u:"https://www.bloomberg.com/news/articles/2026-04-08/pakistan-says-iran-confirms-to-attend-talks-with-us-in-islamabad"},{t:"CNN-Pakistan",u:"https://edition.cnn.com/2026/04/09/asia/pakistan-islamabad-talks-us-iran-ceasefire-intl-hnk"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 42: OIL WHIPSAWED — Crashed ~16% on ceasefire announcement (WTI to $94.41, largest one-day decline since 2020), then bounced back above $100 after Iran re-closed Hormuz. Brent $98.26, Dated Brent spot $124.68 (near-record). Markets re-pricing as ceasefire's economic deliverable fails. Stocks surged initially (S&P +2.5%, Dow +1,325 pts, Nikkei +5.4%, DAX +5.1%) then reversed by April 9. Analysts: fuel prices 'go up like rockets, down like feathers' — retail relief 1-2 months away even in best case. Dollar weakened vs EUR ($1.17) and GBP ($1.34).", sources:[{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/04/09/oil-prices-today-wti-brent-iran-accuse-us-of-ceasefire-breach.html"},{t:"NBC-Crash",u:"https://www.nbcnews.com/business/markets/iran-war-ceasefire-oil-prices-stocks-trump-rcna267229"},{t:"Time-Gas",u:"https://time.com/article/2026/04/09/oil-gas-commodity-prices-iran-war/"}] },
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 42</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Ceasefire holding for US-Iran direct hostilities. Islamabad talks begin tomorrow — highest-level US-Iran contact since 1979.</span> Military campaign destroyed 80%+ air defenses, 90% weapons factories, 85% petrochemical exports across 13,000+ targets. IRGC intel chief Khademi + Quds Force commander Bagheri killed. UAE reported ZERO incoming threats April 9 — first clean day since war began, confirming ceasefire compliance reaching IRGC operational units. Iraq's Islamic Resistance declared parallel halt.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Iran's 3-step nuclear proposal is the most concrete offer yet</span> — lower enrichment to 3.67% (JCPOA level), permanently halt HEU production, restore IAEA access + Additional Protocol. This represents genuine movement from 'enrichment is a right, full stop.' Oil stabilized. Markets pricing credible deescalation. The compellence theory — air campaign pressure producing diplomatic concessions — is being tested in real time with early positive signals. CAUTION: ceasefire at Day 40 is a negotiating pause, not Kosovo's Day 78 capitulation. These are fundamentally different outcomes at different timeline points.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 42</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Lebanon is now the active war while Iran is paused — the two conflicts pull in opposite directions.</span> 'Operation Eternal Darkness' — 254 killed April 8, 100+ targets in 10 minutes, worst single day of the 2026 Lebanon conflict. 6 IDF divisions committed. Cumulative: 1,784 killed, 1M+ displaced. Hezbollah fired rockets at Israel April 9 — first since ceasefire. <span style={{color:"#F59E0B",fontWeight:700}}>Trump asked Netanyahu to 'scale back'</span> — first visible US-Israel disagreement on theater management. 8 European leaders say ceasefire should cover Lebanon. Iran's Point 10 demands all-fronts cessation. Hezbollah 2006 parallel now at 7.5/10 fit — overtaking Kosovo as primary analogue.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Hormuz remains effectively closed — the ceasefire's centerpiece economic deliverable is failing.</span> Iran re-closed Strait citing Lebanon strikes. 3-4 ships/day vs 135 normal. 800+ vessels trapped. Iran collecting $2M/vessel tolls in bitcoin/yuan — creating permanent two-tier transit regime (allies free, others pay). Oil bounced back above $100. IMO called tolls 'dangerous and unacceptable precedent.' The war's center of gravity may have shifted from Iran to Lebanon without anyone declaring it. The ceasefire didn't resolve expansion — it shifted it from 'war expanding to new theaters' to 'diplomacy unable to contain what the war started.'
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 42</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are demonstrably failing.</span> (1) <span style={{color:C.red,fontWeight:700}}>Nuclear disarmament at structural impasse the ceasefire worsens.</span> Fordow undamaged. 440 kg 60% HEU unverifiable. CSIS: facilities 'buried beneath tons of rubble' but issue 'fundamentally unresolved.' Iran may be 'redoubling efforts' given conventional imbalance. Iran's 3-step proposal (3.67%, halt HEU, IAEA) shows movement but doesn't accept zero enrichment. 14 days to harden, relocate, reconstitute. Osirak lesson directly applicable: strikes delayed but didn't prevent program. (2) <span style={{color:C.red,fontWeight:700}}>Hormuz reopening failing its operational test.</span> Iran re-closed Strait citing Lebanon. 3-4 ships/day vs 135 normal. 800+ trapped. Toll system creating permanent revenue mechanism.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              (3) <span style={{color:C.red,fontWeight:700}}>Pezeshkian publicly accused IRGC of sabotaging ceasefire</span> — revealing regime split that could prevent coherent negotiating at Islamabad. If negotiating team doesn't control military compliance, ceasefire is structurally unreliable. (4) Russia provided Iran 55 Israeli energy infrastructure targets (single-source, contested) — intelligence sharing escalating during ceasefire. (5) War Powers ~19 days, $200B supplemental dead, House Democrats blocked on unanimous consent. (6) Trump's own framing undercuts diplomacy: 'if agreement not reached then the shootin starts bigger and better and stronger' — positioning ceasefire as ultimatum, not opening. <span style={{color:C.red,fontWeight:700}}>If talks fail and war resumes at Day 54: Iran partially recovered with Russian targeting data, US War Powers at ~7 days, interceptors still depleted, Lebanon in full escalation. There is no Plan B.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
