...
const HIGHLIGHTS = {
  updatedAt: "2026-04-06T05:00Z",
  keyDevelopments: [
    { text: "FIRST US AIRCRAFT LOSSES — F-15E Strike Eagle shot down over southwestern Iran (April 3), first US fixed-wing loss to enemy fire since 2003. Both crew rescued by April 5 in joint military/CIA operation from Iranian mountains. A-10 also downed near Strait same day. Rescue cost 2 C-130s + 2 MH-6Ms destroyed to prevent capture. Iran offered $60K bounty for crew.", why: "Came <48hrs after Trump claimed Iran was 'beaten and decimated.' Demonstrates Iran retains lethal air defense capability despite 80%+ AD destruction. Rescue operation losses (4 additional aircraft) show high operational cost. Politically significant: first named US aircraft shootdown shifts domestic narrative.", category: "military", goalIds: ["airsup", "cas-us", "sco-time"], sources: [{t:"WaPo-F15",u:"https://www.washingtonpost.com/national-security/2026/04/03/f15-iran-shootdown"},{t:"NBC-Rescue",u:"https://www.nbcnews.com/news/world/us-f-15-shot-down-iran-crew-rescued-rcna148723"},{t:"CBS-A10",u:"https://www.cbsnews.com/news/us-a10-iran-war-persian-gulf/"}] },
    { text: "HOUTHIS ENTERED THE WAR (March 28) — BM launched at Beersheba (intercepted). 5+ attacks on Israel through April 2. Claiming 'joint coordination' with Iran, Hezbollah, Iraqi PMF. Threatening Bab el-Mandeb naval blockade. Axis of resistance now fully activated across 4 fronts simultaneously.", why: "Ends the war's biggest strategic surprise (28 days of restraint). Now two maritime chokepoints threatened simultaneously: Hormuz + Bab el-Mandeb = ~35% of global maritime trade. Entry came as 5-day pause expired — torpedoed diplomatic momentum. But also exposes Houthis to direct US strikes, potentially overextending the resistance axis.", category: "military", goalIds: ["prx-houthi", "sco-theater", "hor-open"], sources: [{t:"CNN-Houthi",u:"https://www.cnn.com/2026/03/28/world/live-news/iran-war-us-israel-trump"},{t:"AJZ-Houthi",u:"https://www.aljazeera.com/news/2026/3/28/yemens-houthis-claim-responsibility-for-a-missile-attack-on-israel-2"},{t:"FDD-Houthi",u:"https://www.fdd.org/analysis/2026/03/31/renewed-threat-from-houthis-in-yemen-as-iran-war-reaches-decisive-stage/"}] },
    { text: "12,300+ TARGETS, 155 VESSELS DESTROYED — CENTCOM April 2 update. 13,000+ combat flights. 70% of Iran's defense industrial base struck. Target sets expanded into economic warfare: steel factories, pharma plants, bridges, petrochemical zones. Trump threatening 'Power Plant Day' on Tuesday. Netanyahu claims 70% of Iran's steel production destroyed.", why: "Campaign has crossed from military to economic targeting. Steel, pharma, bridges = civilian economic infrastructure. 'Power Plant Day' threat = collective punishment of civilian population. Scale unprecedented: 155 vessels = Iran's navy no longer exists as a fighting force. But expanded targeting raises humanitarian law questions and strengthens Iran's narrative internationally.", category: "military", goalIds: ["navy", "mis-fixed", "mis-prod", "sco-time"], sources: [{t:"MEE-12300",u:"https://www.middleeasteye.net/live-blog/live-blog-update/centcom-says-it-struck-12300-targets-iran-february"},{t:"AJZ-Video",u:"https://www.aljazeera.com/video/newsfeed/2026/4/2/centcom-releases-video-of-air-strikes-in-fifth-week-of-war-on-iran"},{t:"DefNews-Adapt",u:"https://www.defensenews.com/global/mideast-africa/2026/04/01/iranian-strikes-target-the-infrastructure-behind-us-airpower/"}] },
    { text: "DIPLOMACY AT DEAD END — 5-day pause expired, energy strike pause extended to April 6. US 15-point plan rejected as 'maximalist.' Iran's 5 conditions rejected. 48-hour ceasefire rejected. Pakistan mediation failed. Mediators told WSJ: 'dead end.' China-Pakistan ceasefire proposal emerged (new track). Trump: 'deal possible by Monday' while also 'no deal needed.'", why: "No diplomatic pathway visible at Day 38. Every proposal rejected by one side or the other. Trump's 48-hour Hormuz ultimatum expires April 6 (today). If he follows through on power plant strikes, this is a major escalation phase. China-Pakistan initiative is the only new diplomatic track — but no US engagement with it. Without diplomacy, only exit is military exhaustion of one side.", category: "political", goalIds: ["sco-exit", "all-oman", "hor-open"], sources: [{t:"CNBC-48hr",u:"https://www.cnbc.com/2026/04/05/crude-oil-prices-iran-war-strait-hormuz.html"},{t:"Axios-ChinaPak",u:"https://www.axios.com/2026/03/31/china-pakistan-iran-peace-deal-strait-ceasefire"},{t:"ACA-NukeTalks",u:"https://www.armscontrol.org/act/2026-04/features/analysis-us-negotiators-were-ill-prepared-serious-nuclear-talks-iran"}] },
    { text: "CASUALTY SURGE — Iran: 2,076+ killed (Health Ministry) to 3,519 (Al Monitor), 244+ children, 26,500+ wounded. US: 13 KIA, 365 WIA. Israel: 19 civilians + 10 IDF in Lebanon dead, 6,833 hospital evacuations. Lebanon: 1,001+ killed, 1M+ displaced (20% of population). 195 cities across 27 provinces struck. 6 political prisoners executed.", why: "Massive divergence in Iranian casualty figures (2,076 vs 3,519 vs 7,300 Hengaw) reflects information blackout. US WIA jumped from ~200 to 365 in two weeks. Pentagon accused of undercounting (Intercept: 75% of WIA classified as TBI, returned to duty). Lebanon toll now exceeding 1,000 — 20% of population displaced. Humanitarian pressure intensifying on all sides.", category: "humanitarian", goalIds: ["cas-civ", "cas-us", "cas-isr", "civ-total"], sources: [{t:"NPR-Casualties",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"},{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"},{t:"Hengaw",u:"https://hengaw.net/en/reports-and-statistics-1/2026/04/article-1"}] },
    { text: "HEZBOLLAH AT 600 ATTACKS/DAY — Double the 2023-24 peak. 5,000+ projectiles at Israel since March 2. Deploying fiber-optic FPV drones (jam-proof). Killed IDF battalion commander + 3 officers in Beit Lif ambush. Israel occupied to Litani River (March 24). 900+ Hezbollah fighters killed, 2,500+ targets struck. Qatar shot down 2 Iranian Su-24s after Doha airport targeted.", why: "Hezbollah fire rate exceeding 2006 war peak despite massive IDF strikes on Lebanon. Fiber-optic FPV drones represent a new class of threat — immune to electronic warfare. 2006 lesson being re-learned: air power alone cannot suppress distributed rocket/drone forces. Qatar's direct engagement against Iran is a major coalition development — first Gulf state to shoot down Iranian aircraft.", category: "military", goalIds: ["prx-hzb", "sco-theater", "gulf-protect"], sources: [{t:"JPost-Hzb",u:"https://www.jpost.com/middle-east/article-891265"},{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/4/1/israeli-strikes-on-beirut-kill-7-hezbollah-fights-back-in-southern-lebanon"}] },
  ],
  watchNext: [
    { text: "TRUMP'S APRIL 6 HORMUZ ULTIMATUM — '48 hours before all Hell will reign down.' Energy strike pause expires today. 'Power Plant Day' + 'Bridge Day' threatened for Tuesday. Iran called it 'helpless, nervous, unbalanced and stupid.' Does Trump follow through or extend again?", why: "Third ultimatum of the war. First two expired with extensions, eroding credibility. If he follows through, power plant strikes = collective punishment of 85M civilians. If he extends again, deterrent credibility further eroded. Markets pricing in escalation — Brent at $110+.", category: "political", timeframe: "imminent", sources: [{t:"CNBC-48hr",u:"https://www.cnbc.com/2026/04/05/crude-oil-prices-iran-war-strait-hormuz.html"}] },
    { text: "War Powers 60-day clock — Expires ~April 28-29 (22 days). House vote delayed to mid-April after recess. Sen. Curtis (R-UT) won't support beyond 60 days without authorization. 5-6 GOP lawmakers on fence. Prior vote failed 212-219.", why: "If War Powers resolution passes post-recess, it's the binding domestic constraint on campaign continuation. Even if vetoed, bipartisan opposition signals growing. Curtis defection from GOP ranks is new. Combined with stalled $200B supplemental, the domestic political runway is shortening.", category: "political", timeframe: "this week", sources: [{t:"Axios-WP",u:"https://www.axios.com/2026/03/26/iran-trump-war-powers-vote-house-democrats"},{t:"DemNow-Delay",u:"https://www.democracynow.org/2026/3/27/headlines/house_democratic_leaders_delay_vote_on_iran_war_powers_resolution_until_at_least_mid_april"}] },
    { text: "Interceptor crisis deepening — RUSI estimates ~80% of Arrow stocks depleted. Haifa BM intercept FAILED April 5. Replacement: 2-3 years even with accelerated production. $826M emergency transfer approved but production rate fixed. Iran adapting to cluster munitions.", why: "Haifa intercept failure is the first confirmed urban BM penetration since Dimona/Arad. If Arrow depletes entirely, Israeli population centers are defenseless against Iran's remaining ~1,000 missiles. Iran's quality-over-quantity shift (fewer launches, better targeting of US enabler infrastructure) may be more dangerous than volume.", category: "military", timeframe: "this week", sources: [{t:"Semafor-Intercept",u:"https://www.semafor.com/article/03/14/2026/israel-is-running-critically-low-on-interceptors-us-officials-say"},{t:"Haaretz-Arrow",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-26/ty-article/.premium/israel-u-s-running-low-on-interceptors-as-iran-war-drains-stocks-study-finds/0000019d-2b24-dac5-a99d-6b7ccebd0000"}] },
    { text: "Nuclear incomplete — Only 1 of 3 sites fully destroyed (NBC). 440 kg of 60% HEU unverifiable (IAEA access denied). CSIS sees 'possible signs of renewed nuclear activity.' Bushehr struck 4th time — 198 Rosatom staff evacuated.", why: "If enrichment can resume in months at Natanz/Isfahan, the stated war objective of eliminating nuclear capability fails. The HEU stockpile is the critical unknown — enough for ~11 weapons at 90% enrichment. Bushehr strikes risk radiation incident that would transform the conflict's character. IAEA has had zero access since war started.", category: "military", timeframe: "open question", sources: [{t:"UN-Bushehr",u:"https://news.un.org/en/story/2026/04/1167250"},{t:"AJZ-Bushehr",u:"https://www.aljazeera.com/news/2026/4/4/iaea-says-projectile-hits-near-irans-bushehr-nuclear-plant-killing-one"}] },
    { text: "Bab el-Mandeb threat — Houthis threatening naval blockade of 'aggressor country' vessels. Combined with Hormuz = ~35% of global maritime trade at risk. 40-nation UK-led Hormuz coalition forming but not operational.", why: "If Houthis operationalize Bab el-Mandeb blockade alongside Hormuz closure, global shipping faces simultaneous dual-chokepoint disruption unprecedented in modern history. Oil could spike above $150 (all-time high). IEA already calling this 'largest supply disruption in history.'", category: "economic", timeframe: "this week", sources: [{t:"FDD-Houthi",u:"https://www.fdd.org/analysis/2026/03/31/renewed-threat-from-houthis-in-yemen-as-iran-war-reaches-decisive-stage/"}] },
    { text: "Zamir 'halfway' timeline being tested — IDF Chief said 'halfway' at Day 22, implying mid-April conclusion. We're now at Day 38. Trump says '2-3 more weeks.' CENTCOM planning 100+ days. Three contradictory timelines persist.", why: "Mid-April is days away. If campaign doesn't show signs of concluding, Zamir's assessment was wrong and the war has no defined endpoint. Trump's '2-3 weeks' maps to mid-to-late April — roughly aligned. But CENTCOM's 100-day planning contradicts both. The timeline question determines whether this is Kosovo (78 days) or something longer.", category: "military", timeframe: "this week", sources: [{t:"NPR-Updates",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"}] },
  ],
  watchResolved: [
    { text: "5-day pause clock", resolved: "EXPIRED → EXTENDED ON ENERGY ONLY: Pause expired ~March 28. Military strikes never paused — expanded to economic targets (steel, pharma, bridges). Energy infrastructure strikes deferred to April 6 as confidence-building measure. Oil rebounded from $94 to $110+. No diplomatic framework produced.", status: "confirmed" },
    { text: "Houthi entry", resolved: "CONFIRMED: Houthis entered March 28 — BM at Beersheba (intercepted). 5+ attacks on Israel by April 2. Claiming joint coordination with IRGC + Hezbollah + Iraqi PMF. Threatening Bab el-Mandeb blockade. 28 days of restraint ended.", status: "confirmed" },
    { text: "Oil price whipsaw", resolved: "CONFIRMED: Brent rebounded from ~$94 dip to $109-112. Peaked $119-126 during conflict. March saw 55-60% monthly gain — record since 1988. Gas >$4/gal. Goldman forecast of $110 avg was correct.", status: "confirmed" },
    { text: "IRGC troika durability", resolved: "CONFIRMED + FORMALIZED: IRGC formed military council controlling core decision-making. Vahidi/Ghalibaf/Taeb running Iran. Pezeshkian effectively sidelined. Mojtaba still invisible — no video/audio since named Supreme Leader. Junta is the government now.", status: "confirmed" },
    { text: "$200B supplemental", resolved: "ONGOING: Still dead. GOP fractured. Reconciliation explored but near-unanimous House GOP needed — 'a tall task.' No votes, no timeline. War at $38B+ spent without authorization.", status: "ongoing" },
    { text: "Interceptor depletion", resolved: "ONGOING + WORSENING: RUSI estimates ~80% of Arrow depleted. Haifa intercept failed April 5. Replacement: 2-3 years. IDF denied shortfall but approved NIS 2.6B ($826M) emergency procurement. Iran adapting to cluster munitions.", status: "ongoing" },
    { text: "Zamir 'halfway' timeline", resolved: "ONGOING: Mid-April conclusion approaching. Trump says '2-3 more weeks' (April 1). Campaign clearly not winding down — 272 IDF strikes on April 5 alone. Three contradictory signals persist.", status: "ongoing" },
    { text: "Russian weapons escalation", resolved: "ONGOING: Russia providing satellite imagery of US bases (Diego Garcia, Incirlik, Al Udeid, Shaybah). Chinese AI firms exposing US force movements. De facto co-belligerence deepening.", status: "ongoing" },
  ],
};
...
const AXES = [
  {
    ...
    statusColor: "#F59E0B",
    keyMetric: "38+ days",
    keyMetricLabel: "Mojtaba invisible",
    summary: "The IRGC has formalized control. A military council (Vahidi/Ghalibaf/Taeb) has 'assumed control over the regime's core decision-making apparatus,' restricting access to the Supreme Leader. President Pezeshkian is effectively sidelined — deepening rift with IRGC Commander Vahidi over war's economic costs. Mojtaba Khamenei has NOT appeared in public since being named Supreme Leader; his first statement was read by a TV anchor over a still photograph. No video or audio released. 2,345 arrested on national security charges (UN Human Rights Office). IRGC lowered recruitment age to 12. SecDef Hegseth reports 'widespread desertions, key personnel shortages.' Iran military withdrawing from formal bases to civilian locations (schools, mosques). Institutional regime holding but degrading — the question is whether degradation propagates to collapse or stabilizes into a new equilibrium.",
    keyIndicators: [
      { label: "IRGC military council", value: "Running Iran", detail: "Vahidi/Ghalibaf/Taeb controlling decisions daily. Pezeshkian sidelined. Functioning as 'temporary ruling body.' Restricted access to Supreme Leader.", color: "#F59E0B" },
      { label: "Mojtaba Khamenei", value: "Invisible", detail: "No public appearance, video, or audio since named Supreme Leader. First statement read by TV anchor over still photo. Described as 'more hardline than father.' Guarded by elite 'kill squad.'", color: "#EF4444" },
      { label: "Internal security", value: "Degrading", detail: "2,345 arrested. 6 political prisoners executed. IRGC recruiting age 12+. Military moving to civilian sites. 'Widespread desertions' per Hegseth. But Basij still enforcing in provinces.", color: "#EF4444" },
      { label: "Institutional continuity", value: "Strained", detail: "Assembly of Experts met virtually. Regime adapting around strikes. But PMF fighters being mobilized to control protest hotspots — external forces needed for internal security.", color: "#F59E0B" },
    ],
    watching: [
  ...
  },
  {
    ...
    summary: "Critical US assessment (NBC): only 1 of 3 major nuclear sites fully destroyed. Natanz and Isfahan 'not as badly damaged' — enrichment could resume in months. 440 kg of 60%-enriched uranium remains unverifiable (IAEA has lost continuity of knowledge due to inspector access denial since war started). CSIS satellite imagery shows 'possible signs of renewed nuclear activity.' Bushehr nuclear plant struck for 4th time (April 4) — 1 killed (physical protection staff), 198 Russian Rosatom staff evacuated. IAEA 'deeply concerned.' Iran FM warned: 'radioactive fallout will end life in Gulf.' Both SPND chiefs confirmed killed but ISIS (Institute for Science) says centrifuge enrichment 'effectively destroyed' — the gap between optimistic and pessimistic assessments is the central nuclear uncertainty.",
    keyIndicators: [
  ...
  },
  {
    ...
    summary: "The attrition picture has shifted dramatically since Day 24. Iran retains ~50% of missile launchers and ~1,000 missiles (CNN/Haaretz) — far more than 'near-exhaustion' previously assessed. Missile volume is down 90%+ but Iran has shifted to quality over quantity: fewer launches, better targeting of US enabler infrastructure (AWACS, radar, SATCOM, tankers). Israel believes Iran 'can keep firing indefinitely.' Meanwhile, Israel's Arrow stocks are ~80% depleted (RUSI estimate: ~122 of ~150 expended). Haifa BM intercept failed April 5. Replacement: 2-3 years even with accelerated production. The F-15E + A-10 losses (April 3) demonstrate Iran retains lethal air defense capability despite 80%+ AD destruction. The attrition equation has become more dangerous: Iran is adapting faster than it's depleting.",
    keyIndicators: [
      { label: "Iran launchers", value: "~50% intact", detail: "~1,000 missiles remaining. Launches down 90% but targeting improving — hitting US enabler infra. Israel: Iran 'can keep firing indefinitely.'", color: "#F59E0B" },
      { label: "Israel interceptors", value: "~80% depleted", detail: "RUSI: ~122 of ~150 Arrow expended. Haifa intercept failed April 5. Replacement: 2-3 years. $826M emergency procurement approved.", color: "#EF4444" },
      { label: "US aircraft losses", value: "F-15E + A-10 down", detail: "First US fixed-wing losses since 2003. Both crews rescued but cost 2 C-130s + 2 MH-6Ms. Iran retains lethal AD capability.", color: "#EF4444" },
      { label: "US casualties", value: "13 KIA, 365 WIA", detail: "Pentagon accused of undercounting (Intercept: 75% WIA classified as TBI). Across 9 countries. Politically visible.", color: "#EF4444" },
      { label: "Multi-front drain", value: "4 active fronts", detail: "Iran + Hezbollah (600/day) + Houthis (entered Mar 28) + Iraqi PMF (1,000+ in Iran). Axis of resistance fully activated. Coalition stretched.", color: "#EF4444" },
    ],
    watching: [
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    importance:5, achievability:3, status:"in progress", outcomeNote:"Day 38: NUCLEAR OBJECTIVE INCOMPLETE — NBC assessment: only 1 of 3 major sites fully destroyed. Natanz and Isfahan 'not as badly damaged' — enrichment could resume in months. 440 kg of 60%-enriched uranium unverifiable (IAEA access denied since Day 1). CSIS satellite imagery: 'possible signs of renewed nuclear activity.' Bushehr struck 4th time (April 4) — 1 killed, 198 Rosatom staff evacuated. IAEA 'deeply concerned.' Iran FM: 'radioactive fallout will end life in Gulf.' ISIS: centrifuge enrichment 'effectively destroyed' (optimistic assessment). Parchin warhead casting factory struck. Khojir BM engine production damaged. Both SPND chiefs dead. Gap between optimistic/pessimistic assessments is the central nuclear uncertainty.", sources:[{t:"UN-Bushehr",u:"https://news.un.org/en/story/2026/04/1167250"},{t:"AJZ-Bushehr",u:"https://www.aljazeera.com/news/2026/4/4/iaea-says-projectile-hits-near-irans-bushehr-nuclear-plant-killing-one"},{t:"TheWeek-FM",u:"https://www.theweek.in/news/middle-east/2026/04/05/iran-fm-warns-of-radioactive-fallout-after-fourth-strike-on-bushehr-nuclear-plant.html"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 38: 12,300+ TARGETS, 155 VESSELS, 70% DI BASE HIT — CENTCOM April 2 update. 13,000+ combat flights. Head of Iranian missile forces killed in Kermanshah. Khojir Complex: 88+ structures, 4 BM production facilities halted. BUT: ~50% of missile launchers intact, ~1,000 missiles remaining (CNN/Haaretz). Iran fires 1-10 missiles per salvo (down from larger salvos) but accuracy INCREASING — targeting US enabler infrastructure (AWACS, radar, SATCOM). Iran shift to quality-over-quantity 'deliberate, not opportunistic' (Defense News). Cluster munitions in at least 2 Israel strikes. Petah Tikva hit. Haifa BM intercept FAILED April 5. Previous: missile production at zero, Diego Garcia 4,000km IRBM demonstrated.", sources:[{t:"MEE-12300",u:"https://www.middleeasteye.net/live-blog/live-blog-update/centcom-says-it-struck-12300-targets-iran-february"},{t:"DefNews-Adapt",u:"https://www.defensenews.com/global/mideast-africa/2026/04/01/iranian-strikes-target-the-infrastructure-behind-us-airpower/"},{t:"AJZ-Video",u:"https://www.aljazeera.com/video/newsfeed/2026/4/2/centcom-releases-video-of-air-strikes-in-fifth-week-of-war-on-iran"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 38: IRGC MILITARY COUNCIL RUNNING IRAN — Formalized junta (Vahidi/Ghalibaf/Taeb) 'assumed control over core decision-making.' Restricted access to Supreme Leader. Pezeshkian effectively sidelined — rift with Vahidi over war's economic costs. Mojtaba still invisible — no video/audio since named Supreme Leader. 2,345 arrested on national security charges (UN Human Rights). 6 political prisoners executed. IRGC lowered recruitment age to 12. 'Widespread desertions, key personnel shortages' (Hegseth). Military withdrawing from formal bases to civilian locations (schools, mosques). Kamal Kharrazi (Strategic Council) severely injured. But: institutional regime holding. 1,000+ Iraqi PMF entering Iran to assist. Regime adapting, not collapsing — question is whether degradation stabilizes or propagates.", sources:[{t:"JPost-IRGC",u:"https://www.jpost.com/israel-news/article-890716"},{t:"NPR-Updates",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"}],
    subgoals:[
      ...
      { id:"reg-irgc-leaders", name:"Kill IRGC senior leadership", party:"both", type:"achieve", importance:5, achievability:5, status:"achieved", outcomeNote:"Day 24: BG AGHA JANI KILLED — IRGC drone unit commander who oversaw drone provision to Russia ($10M US bounty). Also: Naeini (IRGC spokesman, March 20), Ahmadi-Moghaddam (Basij intelligence chief), Ghorishi (IRGC Aerospace Force, Esfahan). Previous: Larijani, Khatib, Soleimani, Nasirzadeh. ~300 Basij commanders eliminated. 50+ senior leaders killed total. IDF authorized kills without prior approval. CTP-ISW: strikes caused 'shock and confusion' — personnel operating from tents and under bridges. But replacements consolidating: Vahidi/Ghalibaf/Jafari troika.", sources:[{t:"Euronews-AghaJani",u:"https://www.euronews.com/2026/03/20/iran-irgc-drone-commander-killed"},{t:"CTP-ISW-D21",u:"https://www.criticalthreats.org/analysis/iran-update-evening-special-report-march-21-2026"},{t:"JPost-IRGC",u:"https://www.jpost.com/israel-news/article-890716"}] },
      ...
      { id:"reg-endgame", name:"Define post-war governance plan", party:"opposing", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 38: ENDGAME ABSENT — Every diplomatic proposal rejected. 15-point plan: 'maximalist.' 48-hour ceasefire: rejected. Pakistan mediation: failed. Mediators to WSJ: 'dead end.' Trump contradictions: 'deal possible by Monday' + 'no deal needed' + 'unconditional surrender.' No exit strategy articulated. $200B supplemental dead — $38B+ spent without authorization. War Powers 60-day clock 22 days from expiry. RAND: 'dilemma, not debacle.' Trump floated asking Arab states to pay. China-Pakistan ceasefire proposal = only new diplomatic track. IRGC military council IS the government now — no interlocutor, no governance plan, no exit criteria. Iraq 2003 parallel at its tightest.", sources:[{t:"CNBC-48hr",u:"https://www.cnbc.com/2026/04/05/crude-oil-prices-iran-war-strait-hormuz.html"},{t:"Axios-ChinaPak",u:"https://www.axios.com/2026/03/31/china-pakistan-iran-peace-deal-strait-ceasefire"},{t:"NatDef-200B",u:"https://www.nationaldefensemagazine.org/articles/2026/3/25/congress-lacks-clarity-on-pentagons-200-billion-iran-war-request"}] },
    ]
  },
  {
  ...
  // ═══ TIER 2: OPERATIONAL ═══
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"Day 38: AIR SUPERIORITY MAINTAINED BUT NOT ABSOLUTE — 13,000+ combat flights. 272 IDF strikes across 14 provinces on April 5 alone. 80%+ of Iranian air defense destroyed. A-10s/Apaches still operating (= permissive environment). BUT: F-15E shot down over Iran April 3 (first US fixed-wing loss since 2003). A-10 also downed same day. Both crews rescued but cost 2 C-130s + 2 MH-6Ms destroyed. Iran offered $60K bounty. Iran retains residual AD capability — lethal if not suppressed. Status remains 'achieved' (functional superiority) but losses demonstrate it's not immunity. Artesh Joint Staff HQ struck in Tehran (April 2). 70% of defense industrial base hit.", sources:[{t:"WaPo-F15",u:"https://www.washingtonpost.com/national-security/2026/04/03/f15-iran-shootdown"},{t:"NBC-Rescue",u:"https://www.nbcnews.com/news/world/us-f-15-shot-down-iran-crew-rescued-rcna148723"},{t:"MEE-12300",u:"https://www.middleeasteye.net/live-blog/live-blog-update/centcom-says-it-struck-12300-targets-iran-february"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 38: HEZBOLLAH AT 600 ATTACKS/DAY — double the 2023-24 peak. 5,000+ projectiles at Israel since March 2. 71 attacks in single 24hr period (March 31-April 1). Deploying fiber-optic FPV drones (jam-proof) against IDF armor. Killed IDF 934th Infantry Brigade battalion commander + 3 officers in Beit Lif ambush. IDF struck 2,500+ Hezbollah targets; 900+ Hezbollah fighters killed. Israel occupied to Litani River (March 24). 1,001+ killed in Lebanon, 1M displaced (20% of population). Lebanese government demanded Hezbollah disarm (unprecedented). 2006 lesson being re-learned: air power alone cannot suppress distributed rocket/drone forces.", sources:[{t:"JPost-Hzb",u:"https://www.jpost.com/middle-east/article-891265"},{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/4/1/israeli-strikes-on-beirut-kill-7-hezbollah-fights-back-in-southern-lebanon"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"prx-houthi", name:"Suppress Houthi threats", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 38: HOUTHIS ENTERED THE WAR (March 28) — BM launched at Beersheba (intercepted). 5+ attacks on Israel by April 2. Claiming 'joint coordination' with IRGC, Hezbollah, Iraqi PMF. Threatening Bab el-Mandeb naval blockade targeting 'aggressor country' vessels. Ben Gurion targeted with cluster munitions (April 5). Ended 28 days of restraint — axis of resistance now fully activated. Entry came as 5-day pause expired, torpedoing diplomatic momentum. Houthi non-entry was the war's biggest strategic surprise; its end opens second maritime chokepoint. Previous: attacked USS Truman (all failed), sank 2 commercial vessels, declared 'ban' on US Red Sea passage.", sources:[{t:"CNN-Houthi",u:"https://www.cnn.com/2026/03/28/world/live-news/iran-war-us-israel-trump"},{t:"AJZ-Houthi",u:"https://www.aljazeera.com/news/2026/3/28/yemens-houthis-claim-responsibility-for-a-missile-attack-on-israel-2"},{t:"FDD-Houthi",u:"https://www.fdd.org/analysis/2026/03/31/renewed-threat-from-houthis-in-yemen-as-iran-war-reaches-decisive-stage/"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 38: 13 KIA, 365 WIA — Pentagon accused of undercounting (Intercept: 75% of WIA classified as TBI, 273/365 returned to duty). F-15E shot down over Iran April 3 — first US fixed-wing loss since 2003. A-10 also downed same day. Rescue operation cost 2 C-130s + 2 MH-6Ms destroyed. Iran offered $60K bounty for crew. 41 Iraqi PMF drone attacks on US bases claimed April 1 alone. Kataib Hezbollah kidnapped US journalist in Baghdad. State Dept warned of attacks on Americans in central Baghdad. Hegseth fired Army Chief of Staff during active war (April 2). Trump's lowest approval ratings of second term. Previous: Diego Garcia IRBM, F-35 investigation still open.", sources:[{t:"NPR-Casualties",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"},{t:"WaPo-F15",u:"https://www.washingtonpost.com/national-security/2026/04/03/f15-iran-shootdown"},{t:"CBS-A10",u:"https://www.cbsnews.com/news/us-a10-iran-war-persian-gulf/"}],
    subgoals:[
      { id:"cas-zero", name:"Maintain zero-casualty posture", party:"us", type:"avoid", importance:5, achievability:1, status:"unachievable", outcomeNote:"Day 38: 13 KIA, 365 WIA. F-15E + A-10 shot down April 3. Rescue cost 2 C-130s + 2 MH-6Ms destroyed. Pentagon accused of undercounting (Intercept: 75% WIA classified as TBI). Across 9 countries. France: 1 KIA. Failed Day 2, irreversible.", sources:[{t:"NPR-Casualties",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"},{t:"WaPo-F15",u:"https://www.washingtonpost.com/national-security/2026/04/03/f15-iran-shootdown"}] },
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 38: CASUALTY FIGURES SURGING — Iran Health Ministry: 2,076+ killed. Al Monitor: 3,519. Hengaw (34 days): 7,300 (890 civilian / 6,410 military). HRANA: 3,531 (1,607 civilian inc. 244 children). IFRC: 1,900+ killed, 20,000 injured. 195 cities across 27 provinces struck. 113,000+ civilian sites damaged. 30+ universities targeted. 6 political prisoners executed (MEK-affiliated, April 3-4). Mahshahr petrochemical zone: 5 killed, 170 injured (April 4). B1 Bridge Tehran-Karaj: 13 killed, 90+ wounded (April 2). Lebanon: 1,001+ killed, 1M+ displaced (20% of population). Target expansion to economic infrastructure (steel, pharma, bridges) increasing civilian toll. The massive variance in Iranian figures (2,076-7,300) reflects information blackout.", sources:[{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"},{t:"Hengaw",u:"https://hengaw.net/en/reports-and-statistics-1/2026/04/article-1"},{t:"NPR-Casualties",u:"https://www.npr.org/2026/04/04/nx-s1-5773436/iran-war-updates"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"all-nato", name:"Maintain NATO unity", party:"us", type:"achieve", importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 24: 22-NATION HORMUZ COALITION — UK, France, Germany, Italy, Netherlands, Japan, Canada, South Korea, UAE, Bahrain, Australia + 11 others condemning Iran's attacks on shipping. Referenced UNSC Resolution 2817. NATO intercepted BM over Turkish airspace (Gaziantep). Trump called NATO allies 'cowards' for refusing Hormuz military support. NATO pulled all remaining personnel from Iraq. UK approved US use of British bases + deployed 'more combat aircraft than any point in 15 years.' Diego Garcia IRBM (4,000km) changes European security calculus — IDF: 'Berlin, Paris, Rome all within range.' Military commitment deepening while political fractures persist.", sources:[{t:"TheNatl-Coalition",u:"https://www.thenationalnews.com/news/uae/2026/03/21/joint-statement-on-strait-of-hormuz-says-freedom-of-navigation-is-enshrined-in-international-law/"},{t:"CBS-NATO",u:"https://www.cbsnews.com/news/nato-turkey-missile-iran-intercepted"},{t:"USNews-NATO",u:"https://www.usnews.com/news/world/articles/2026-03-22/trump-calls-nato-cowards-hormuz"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"sco-exit", name:"Define clear exit criteria", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 38: DIPLOMACY AT DEAD END — Every proposal rejected. US 15-point plan: 'maximalist, unreasonable.' Iran 5 conditions: rejected. 48-hour ceasefire: rejected. Pakistan mediation: failed. Mediators told WSJ: 'dead end.' Trump contradictions: 'deal possible by Monday' + 'no deal needed' + 'unconditional surrender' + '2-3 more weeks.' China-Pakistan ceasefire proposal = only new diplomatic track. Arms Control Association: US negotiators 'ill-prepared for serious nuclear talks.' Iran FM: 'zero trust' and 'no negotiations.' $200B supplemental dead — no congressional buy-in. War Powers 60-day clock: 22 days. RAND: 'dilemma, not debacle.' Without exit criteria, campaign continues on inertia.", sources:[{t:"CNBC-48hr",u:"https://www.cnbc.com/2026/04/05/crude-oil-prices-iran-war-strait-hormuz.html"},{t:"Axios-ChinaPak",u:"https://www.axios.com/2026/03/31/china-pakistan-iran-peace-deal-strait-ceasefire"},{t:"ACA-NukeTalks",u:"https://www.armscontrol.org/act/2026-04/features/analysis-us-negotiators-were-ill-prepared-serious-nuclear-talks-iran"}] },
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 24: SAUDI EXPELS IRANIAN DIPLOMATS — military attaché + 4 diplomats given 24-hour departure. Kuwait Mina al-Ahmadi refinery struck by drone waves (730,000 bpd, several units shut down). UAE drone interceptions at 1,740 cumulative (surging). 22-nation coalition condemning Iranian attacks on commercial shipping. Iran counter-threatened 'irreversible' destruction of regional energy/IT/desalination if power plants targeted. Qatar/UAE dismantled Iranian operative cells. Gen. Shekarchi: tourist destinations 'anywhere in the world will no longer be safe.' Gulf cooperation deepening in response to attacks — Iran's retaliation continues to backfire diplomatically.", sources:[{t:"AJZ-SaudiExpel",u:"https://www.aljazeera.com/news/2026/3/22/saudi-arabia-expels-iranian-diplomats"},{t:"AJZ-Kuwait",u:"https://www.aljazeera.com/news/2026/3/20/kuwait-oil-refinery-hit-again-as-iran-targets-gulf-energy-infrastructure"},{t:"TheNatl-Coalition",u:"https://www.thenationalnews.com/news/uae/2026/03/21/joint-statement-on-strait-of-hormuz-says-freedom-of-navigation-is-enshrined-in-international-law/"},{t:"Euronews-Terror",u:"https://www.euronews.com/2026/03/20/iran-general-threatens-global-tourist-sites"}],
    subgoals:[
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 38</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>12,300+ targets struck, 155 vessels destroyed ('largest elimination of a navy since WWII'), 80%+ of air defense destroyed, 70% of defense industrial base hit.</span> Both SPND nuclear chiefs dead. Head of Iranian missile forces killed in Kermanshah. 272 IDF strikes across 14 provinces on April 5 alone. Iran's conventional military effectively destroyed. Missile production at zero. A-10/Apache deployment = functional air superiority confirmed. Kamal Kharrazi (Strategic Council chair) severely injured.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Axis of resistance overextending.</span> Houthi entry opens them to US strikes. Hezbollah burning through multi-year reserves at 600/day — unsustainable. Iraqi PMF crossing INTO Iran = proxy doctrine collapse (proxies defending homeland, not projecting power). 40-nation Hormuz coalition forming. Gulf states now fighting back — Qatar shot down 2 Iranian Su-24s. Lebanon government banned Hezbollah. Kosovo parallel: Day 38 of 78 = exactly halfway. If pattern holds, decisive diplomatic pressure intensifies in weeks 6-8.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 38</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>{stats.expanding} goals growing beyond plan.</span> Every axis expanded since Day 24. Geographically: Houthis entered (2nd chokepoint), Hezbollah at 600/day (double peak), 1,000+ Iraqi PMF in Iran, all 6 GCC states targeted. Economically: Brent $110+ (was $67 pre-war), gas {'>'}$4/gal, $200B supplemental dead, $1B+/day burn rate. Target sets: steel factories, pharma plants, bridges, petrochemicals. Trump threatening 'Power Plant Day' = civilian infrastructure.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>The expansion is analytically ambiguous — read BOTH ways.</span> Bullish: each new front is an adversary asset that can be degraded. 40-nation coalition = expansion in coalition's favor. Hezbollah exhausting itself. Bearish: campaign framed as targeted nuclear strikes now hitting steel plants. 'Power Plant Day' = collective punishment. $200B unfunded. Trump's escalating ultimatums (each followed by extensions) erode credibility. The 40-nation coalition is needed because the original plan was insufficient. Critical question for weeks 7-8: does expansion decelerate (bullish) or accelerate further (bearish)? War Powers 60-day clock expires April 29. If still expanding then, domestic constraint becomes binding.
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 38</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are demonstrably failing.</span> (1) <span style={{color:C.red,fontWeight:700}}>Diplomacy is dead.</span> 15-point plan rejected. 48-hour ceasefire rejected. Pakistan mediation failed. Mediators: 'dead end.' Trump's 'unconditional surrender' demand eliminates off-ramps by design. (2) <span style={{color:C.red,fontWeight:700}}>Nuclear incomplete:</span> only 1 of 3 sites fully destroyed. 440 kg HEU unverifiable. CSIS sees 'renewed activity.' (3) <span style={{color:C.red,fontWeight:700}}>Hormuz still closed</span> after 38 days — the primary stated objective. Oil $110+. IEA: 'largest supply disruption in history.'
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              (4) First US aircraft losses — F-15E + A-10 in same day. (5) Interceptor crisis: ~80% Arrow depleted, Haifa intercept failed. (6) $200B supplemental dead — $38B+ spent without authorization. (7) 13 US KIA, 365 WIA (Pentagon accused of undercounting). (8) Iran retains ~50% of launchers + 1,000 missiles — 'can keep firing indefinitely.' (9) Iran adapting: fewer missiles but better targeting of US enabler infrastructure. <span style={{color:C.red,fontWeight:700}}>The central failure: no exit strategy articulated. Without diplomacy, without congressional funding, without a defined end state, the campaign continues on inertia. You don't threaten 'Power Plant Day' if the existing approach is working.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
