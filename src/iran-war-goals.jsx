...
const HIGHLIGHTS = {
  updatedAt: "2026-03-08T09:00Z",
  keyDevelopments: [
    { text: "Khamenei's underground bunker destroyed — ~50 IAF jets, ~100 bombs on Tehran leadership compound. B-2 Spirits confirmed engaged.", why: "Combined B-2/IAF deep-strike on leadership infrastructure shows capability to destroy any hardened target in Iran — changes regime's calculus on survivability.", category: "military", goalIds: ["airsup"], sources: [{t:"ToI",u:"https://www.timesofisrael.com/idf-destroys-key-tehran-bunker-used-by-top-brass-trump-vows-no-deal-until-iran-surrenders/"},{t:"TWZ",u:"https://www.twz.com/air/b-2-spirits-join-iran-air-war-pummel-underground-missile-caves"}] },
    { text: "Quds Force Lebanon Corps decapitated — commander Zadeh killed in Tehran, CoS Khazaei killed in Beirut. Dozens of IRGC officers fleeing Lebanon.", why: "IRGC's entire Hezbollah liaison chain destroyed in 48 hours — Hezbollah now operationally severed from Iranian command.", category: "military", goalIds: ["hez", "reg-irgc-cohesion"], sources: [{t:"ToI",u:"https://www.timesofisrael.com/liveblog_entry/top-member-of-irans-quds-force-killed-in-navy-strike-in-beirut-yesterday-idf-says/"},{t:"Axios",u:"https://www.axios.com/2026/03/06/lebanon-israel-iran-irgc-hezbollah"}] },
    { text: "School strike attribution shifting: NBC says 'increasingly likely' US munition responsible. HRW demands war crimes investigation.", why: "If confirmed, transforms the narrative from 'fog of war' to potential US legal liability — the single biggest political vulnerability of the campaign.", category: "political", goalIds: ["nar-school", "civ-school"], sources: [{t:"NBC",u:"https://www.nbcnews.com/world/iran/iran-school-strike-us-military-targeted-area-rcna261888"},{t:"HRW",u:"https://www.hrw.org/news/2026/03/07/us/israel-investigate-iran-school-attack-as-a-war-crime"}] },
    { text: "Gulf interceptor crisis: US 'stonewalling' replenishment. 'Several years of production shot in days.' Rates holding but stocks depleting.", why: "Interception rates are 90%+ but mathematically unsustainable — when stocks run out, Gulf allies face undefended cities or demand US assets.", category: "military", goalIds: ["gulf-ad"], sources: [{t:"MEE",u:"https://www.middleeasteye.net/news/us-stonewalling-requests-gulf-states-replenish-interceptors-sources-say"},{t:"Fortune",u:"https://fortune.com/2026/03/07/trump-munitions-iran-war-ukraine-interceptors-patriot-thaad-low-supply/"}] },
    { text: "Chinese military supply line exposed — IRIAF 747 cargo from China destroyed at Mehrabad. IRISL ships carrying missile components departed Chinese ports.", why: "Evidence of Chinese material support crosses a threshold — transforms the conflict from US-Iran bilateral to potential great power confrontation.", category: "political", goalIds: ["gp-china", "mis-supply"], sources: [{t:"Aviationist",u:"https://theaviationist.com/2026/03/07/b-1b-bombers-deploy-to-raf-fairford/"},{t:"NBC",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-dignified-transfer-us-soldiers-rcna262207"}] },
    { text: "Trump rejected UK HMS Prince of Wales carrier: 'We don't need them any longer.' Using UK bases while insulting UK contribution.", why: "Antagonizing your closest ally while depending on their bases is a contradiction that could unravel European basing access.", category: "political", goalIds: ["all-base", "all-nato"], sources: [{t:"Hill",u:"https://thehill.com/policy/international/5773460-trump-rejects-uk-aircraft-carriers/"},{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/8/trump-says-us-does-not-need-united-kingdom-aircraft-carriers-for-iran-war"}] },
  ],
  watchNext: [
    { text: "First B-1B sortie from Fairford — UK armed forces chief said 'within days,' aircraft now positioned", why: "Fairford-origin missions mean sustained heavy bombardment without CONUS-to-target transit — dramatically increases sortie rate.", category: "military", timeframe: "imminent", sources: [{t:"Aviationist",u:"https://theaviationist.com/2026/03/07/b-1b-bombers-deploy-to-raf-fairford/"},{t:"ITV",u:"https://www.itv.com/news/westcountry/2026-03-07/us-bomber-lands-in-gloucestershire-as-iran-war-enters-eighth-day"}] },
    { text: "Oil crosses $100/bbl — WTI $90.90, Bloomberg: traders say '$100 imminent if war keeps raging'", why: "$100 oil triggers $4+ gas, which historically erodes presidential approval — becomes a domestic political crisis, not just economic.", category: "economic", timeframe: "24-48h", sources: [{t:"Bloomberg",u:"https://www.bloomberg.com/news/articles/2026-03-06/traders-warn-100-oil-is-imminent-if-iran-war-keeps-raging"},{t:"CNBC",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"}] },
    { text: "Mojtaba investiture — Assembly of Experts vs. Expediency Council power struggle. Both claim authority over succession.", why: "If Iran's constitutional institutions fracture over succession under bombardment, it's the first crack in regime cohesion that matters.", category: "regime", timeframe: "24-48h", sources: [{t:"Wiki-SL",u:"https://en.wikipedia.org/wiki/2026_Iranian_Supreme_Leader_election"},{t:"IranIntl",u:"https://www.iranintl.com/en/202603030390"}] },
    { text: "Houthi decision point — 'hands on trigger' but no military action yet. Stimson: weakened Iran makes joining 'detrimental'", why: "Houthi entry reopens Red Sea/Bab al-Mandab chokepoint and doubles the shipping crisis. Their non-entry is a major strategic win for the US.", category: "military", timeframe: "this week", sources: [{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/7/why-yemens-houthis-are-staying-out-of-israel-us-fight-with-iran-for-now"},{t:"Stimson",u:"https://www.stimson.org/2026/the-houthis-must-decide-join-irans-war-against-the-us-and-israel-or-abandon-iran/"}] },
    { text: "Does China respond to evidence of supply line destruction? 747 cargo + IRISL ships = exposed material support.", why: "China's choice: escalate support (weapons, not just components) or cut losses. Either path reshapes the conflict's great power dynamics.", category: "political", timeframe: "this week", sources: [{t:"NBC",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-dignified-transfer-us-soldiers-rcna262207"}] },
    { text: "Does the school strike investigation trigger congressional or international legal action?", why: "If 'increasingly likely' becomes 'confirmed,' it creates a legal obligation to investigate under IHL — and a political weapon for war opponents.", category: "political", timeframe: "open question", sources: [{t:"HRW",u:"https://www.hrw.org/news/2026/03/07/us/israel-investigate-iran-school-attack-as-a-war-crime"}] },
  ],
  watchResolved: [
    { text: "B-1B sorties from Fairford — UK armed forces chief expects missions 'within days'", resolved: "4 B-1Bs at Fairford — 3 arrived after completing missions from CONUS. No Fairford-originating sorties yet. 'Within days' per UK chief.", status: "partial" },
    { text: "Assembly of Experts formal announcement of Mojtaba — delayed by 8/88 refusal", resolved: "Complicated by Expediency Council intervention to suspend Assembly. Power struggle between institutions. Formal investiture still incomplete.", status: "ongoing" },
    { text: "Oil approaching $100/bbl — WTI at $90.90", resolved: "Still $90.90. Bloomberg: traders warn '$100 imminent.' Not crossed yet but trajectory unchanged.", status: "ongoing" },
    { text: "Gulf interceptor depletion — at least one ally running low", resolved: "MEE confirms US 'stonewalling' replenishment. 'Years of production shot in days.' Rates holding but stocks unsustainable.", status: "confirmed" },
    { text: "Iran missile redirect to Israel — IDF assessment", resolved: "Confirmed: 12 separate missile salvos at Israel on March 7. IRGC claims Haifa refinery hit in retaliation for Tehran oil depot strikes.", status: "confirmed" },
    { text: "Do NCRI 'organized uprising' reports reflect ground reality?", resolved: "Cannot assess — internet at 1% of normal for 8+ days. No independent verification possible through blackout.", status: "ongoing" },
  ],
};
...
const GOALS = [
  // ═══ TIER 1: EXISTENTIAL / STRATEGIC ═══
  {
    ...
    subgoals:[
      ...
      { id:"nuke-breakout", name:"Prevent future breakout capability", party:"both", type:"avoid", importance:5, achievability:2, status:"tbd", outcomeNote:"Even if facilities destroyed, Iran retains technical knowledge + can rebuild. Oman deal would have achieved this diplomatically.", sources:[{t:"AJZ-Oman",u:"https://www.aljazeera.com/news/2026/2/28/peace-within-reach-as-iran-agrees-no-nuclear-material-stockpile-oman-fm"},{t:"ArmCtrl",u:"https://www.armscontrol.org/issue-briefs/2026-03/did-irans-nuclear-and-missile-programs-pose-imminent-threat-no"}] },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"BIFURCATED: Missiles down 90%, drones down 83% (CENTCOM Cooper). BUT drone volume SURGING — UAE D8: 121 drones (119 intercepted). IDF: ~3,400 strikes, ~7,500 munitions. CENTCOM: 3,000+ targets. 100-200 missile launchers estimated remaining. 6 defense industrial sites struck D8 (DIO, Shiraz Electronics). Phase 2 targeting underground BM bunkers + defense industrial base. First combat use of PrSM confirmed. Oil infrastructure now targeted (3 Tehran depots). Campaign succeeding against missiles, struggling against drones.", sources:[{t:"CBS",u:"https://www.cbsnews.com/live-updates/us-iran-war-spreads-azerbaijan-israel-strikes-tehran-lebanon/"},{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/04/why-irans-ballistic-missile-launches-are-declining/"},{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"}],
    subgoals:[
      { id:"mis-fixed", name:"Destroy fixed missile launch sites", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Day 8 evening: IDF ~3,400 strikes, ~7,500 munitions total. 6 defense industrial sites struck D8 (DIO, Shiraz Electronics Industries). 2 Artesh airbases in Esfahan Province struck. 16 IRGC aircraft destroyed at Isfahan. Heydar Karrar missile base (Absard) struck — satellite confirmed. BM production at Shahrud hit. Ali Asghar Hejazi (Khamenei deputy CoS) targeted. 100-200 launchers estimated remaining. UAE BM data: D1:137, D2:28, D3:9, D4:12, D5:3, D6:7, D7:9. B-2s dropping 2,000lb penetrators. First combat use of PrSM confirmed by CENTCOM.", sources:[{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"FDD",u:"https://www.fdd.org/analysis/2026/03/04/why-irans-ballistic-missile-launches-are-declining/"},{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"},{t:"BreakDef",u:"https://breakingdefense.com/2026/03/centcom-confirms-first-combat-use-of-prsm-in-iran/"}] },
      ...
      { id:"mis-drone", name:"Destroy drone production & launch sites", party:"both", type:"achieve", importance:4, achievability:3, status:"in progress", outcomeNote:"DRONE SURGE CONTINUING: UAE D8: 121 drones detected (119 intercepted, 98.3%). Drones down 83% (CENTCOM Cooper) but volume still high. Shokouhiyeh Industrial Zone (Qom) drone production struck. INSS total: 1,600+ drones across all theaters. IRGC called 230-drone attack 'first powerful steps.' First combat use of PrSM confirmed. Dubai airport Concourse A hit by drone — within 1 hour of Pezeshkian's apology to neighbors. Drone factories distributed + harder to eliminate. Kamikaze drone boats attacking shipping.", sources:[{t:"CBS",u:"https://www.cbsnews.com/live-updates/us-iran-war-spreads-azerbaijan-israel-strikes-tehran-lebanon/"},{t:"Euronews-DXB",u:"https://www.euronews.com/2026/03/07/iranian-drone-attack-suspends-flights-at-dubai-international-airport"},{t:"BreakDef",u:"https://breakingdefense.com/2026/03/centcom-confirms-first-combat-use-of-prsm-in-iran/"}] },
      { id:"mis-c2", name:"Destroy missile command & control", party:"both", type:"achieve", importance:4, achievability:4, status:"in progress", outcomeNote:"Day 8 evening: IRGC Air Force central air defense command center struck in central Tehran plus air defense systems, HQs, warehouses. 12 BM salvos in 24 hours = staggered strategy (every 1-2 hours) to strain interception + keep millions in shelters. IDF: reflects degraded capability to coordinate large barrages. Ali Asghar Hejazi (Khamenei's most powerful intel official) targeted in Tehran. C2 fragmented but functioning — Iran adapting to distributed, small-salvo attacks.", sources:[{t:"France24-D8",u:"https://www.france24.com/en/middle-east/20260307-live-israel-launches-broader-attacks-on-tehran-as-war-goes-into-eighth-day"},{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"},{t:"IDF-Hejazi",u:"https://x.com/idfonline/status/2029922050576413074"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", outcomeNote:"INSTITUTIONAL POWER STRUGGLE: Assembly of Experts elected Mojtaba under IRGC pressure (8/88 boycotted). BUT Expediency Discernment Council moved to SUSPEND Assembly of Experts and shift authority to Interim Leadership Council — creating parallel power struggle between Iran's constitutional institutions. Formal investiture still not complete. Two candidates remain, both reportedly 'reluctant to accept position.' Israel declared Mojtaba 'unequivocal target for elimination.' Trump: Mojtaba 'unacceptable.' Ali Asghar Hejazi (deputy CoS) targeted. Succession legally contested AND physically threatened.", sources:[{t:"JPost-AoE",u:"https://www.jpost.com/middle-east/iran-news/article-888965"},{t:"IranIntl-AoE",u:"https://www.iranintl.com/en/202603052337"},{t:"Wiki-SL",u:"https://en.wikipedia.org/wiki/2026_Iranian_Supreme_Leader_election"},{t:"IDF-Hejazi",u:"https://x.com/idfonline/status/2029922050576413074"}] },
      { id:"reg-irgc-cohesion", name:"Break IRGC institutional cohesion", party:"both", type:"achieve", importance:4, achievability:2, status:"at risk", outcomeNote:"QUDS FORCE COMMAND CHAIN SHATTERED OUTSIDE IRAN: Daoud Ali Zadeh (Quds Force Lebanon Corps commander) killed in Tehran strike. Reza Khazaei (CoS, Lebanon Corps) + deputy killed in Beirut hotel strike. Several dozen IRGC officers fleeing Lebanon within 48 hours (Axios). IRGC institutional cohesion holding INSIDE Iran — zero defections, claims '6-month readiness.' 9/23 Basij bases hit. IRGC compensating with escalated repression. Pattern: IRGC fracturing abroad (Lebanon flight) while consolidating at home (shoot-to-kill orders). Expediency Council vs Assembly of Experts power struggle may create new internal fissures.", sources:[{t:"ToI-Zadeh",u:"https://www.timesofisrael.com/liveblog_entry/top-member-of-irans-quds-force-killed-in-navy-strike-in-beirut-yesterday-idf-says/"},{t:"Axios-Flee",u:"https://www.axios.com/2026/03/06/lebanon-israel-iran-irgc-hezbollah"},{t:"Bloomberg-IRGC",u:"https://www.bloomberg.com/news/live-blog/2026-03-07/iran-latest"},{t:"AJZ-5thCol",u:"https://www.aljazeera.com/news/2026/3/7/iranian-authorities-warn-against-fifth-column-as-no-signs-of-war-abating"}] },
      ...
      { id:"reg-repress", name:"Degrade regime's internal repression capability", party:"israel", type:"achieve", importance:3, achievability:4, status:"in progress", outcomeNote:"Day 8: SYSTEMATIC DEGRADATION of internal security. 9 of 23 Basij regional bases in Tehran now targeted (9th, 10th, 11th hit D8). LEC provincial HQs struck in Kermanshah, West Azerbaijan, Kurdistan, Ilam. Kamyaran police station destroyed. IRGC intelligence + Sepah buildings struck in Ilam. Law Enforcement + Criminal Investigation destroyed in Urmia. BUT regime compensating with escalated violence: IRGC commander Velayatmadar: 'anyone who lets a sound out... order to shoot issued.' Police chief Radan: shoot 'thieves' on sight. NCRI reports 'organized uprising across most cities' — images of bodies in warehouses. Infrastructure degrading but repression intensifying.", sources:[{t:"CTP-ISW-D8",u:"https://www.criticalthreats.org/analysis/iran-update-morning-special-report-march-7-2026"},{t:"AJZ-5thCol",u:"https://www.aljazeera.com/news/2026/3/7/iranian-authorities-warn-against-fifth-column-as-no-signs-of-war-abating"},{t:"NCRI",u:"https://www.ncr-iran.org/en/news/iran-news-in-brief-news/iran-news-in-brief-march-7-2026/"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"hor-open", name:"Keep Hormuz open during operations", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Day 8: IRGC struck oil tanker Prima + US tanker Louise P in Strait. Tugboat Safeen Prestige struck by 2 missiles — 8 crew killed (Mar 6). CENTCOM: ZERO Iranian ships in Persian Gulf, Hormuz, or Gulf of Oman. But IRGC still claims 'complete control' of Strait despite naval losses — using drones, mines, fast boats. 8+ commercial vessels attacked since war began. Tanker traffic effectively near zero. Insurance withdrawal = primary closure mechanism. 150+ ships anchored outside. Severe GPS/AIS interference. Iran testing own shipping (2 cargo ships transited, 4 tankers at Kharg).", sources:[{t:"Wiki-Hormuz",u:"https://en.wikipedia.org/wiki/2026_Strait_of_Hormuz_crisis"},{t:"UKMTO",u:"https://x.com/UK_MTO/status/2029974855471227056"},{t:"CENTCOM",u:"https://x.com/CENTCOM/status/2029725370371424476"}] },
      ...
      { id:"hor-bypass", name:"Maintain alternative export routes", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"failing", outcomeNote:"Fujairah port (UAE Hormuz bypass) struck by Iranian drones, operations halted. Bypass infrastructure being systematically degraded.", sources:[{t:"Argus",u:"https://www.argusmedia.com/en/news-and-insights/latest-market-news/2795400-uae-s-fujairah-storage-tanks-hit-by-drones"},{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/4/hundreds-of-drones-target-kuwait-iraq-saudi-arabia-uae-amid-iran-war"}] },
      { id:"hor-energy", name:"Prevent global energy crisis", party:"us", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"failing", outcomeNote:"CRISIS MATERIALIZING: Brent $92.69, WTI $90.90. WTI +35.63% weekly = largest weekly gain in history. ~9M bbl/day off market from strikes + precautionary shutdowns. Kuwait cutting 100K bbl/day (storage full in ~12 days). Qatar Energy Minister to FT: exports could halt 'within weeks,' oil to $150. EU TTF gas +60% to EUR 50/MWh — sharpest energy shock since 2022. KOSPI worst day ever. Gold $5,100+. Supertanker rates $423K/day (record). QatarEnergy LNG halt continues. Iraq Rumaila shutting. First oil infrastructure strikes on Iran (3 Tehran depots) = ESCALATION of energy war.", sources:[{t:"CNBC-Kuwait",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"},{t:"Euronews-TTF",u:"https://www.euronews.com/business/2026/03/05/iran-war-how-exposed-are-european-economies"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"}] },
    ]
  },
  ...
  // ═══ TIER 2: OPERATIONAL ═══
  {
    ...
    importance:5, achievability:5, status:"achieved", outcomeNote:"FULL-SPECTRUM AIR DOMINANCE: ~50 IAF jets dropped ~100 bombs destroying Khamenei's underground bunker complex in Tehran (used by successors post-death). B-2 Spirits confirmed engaged (callsigns PETRO41-44) striking underground missile caves — collapsed tunnel entrances at Tabriz North Missile Base confirmed by satellite. Mehrabad airport hit: 12+ aircraft destroyed including rare IRIAF 747 cargo delivering military supplies from China. 150+ Iranian air defense systems disabled/destroyed. B-1B Lancers at RAF Fairford (4 aircraft — 3 arrived after completing missions over Iran from CONUS). Air superiority over Tehran + western Iran. Campaign entering sustained heavy bombardment phase.", sources:[{t:"ToI-Bunker",u:"https://www.timesofisrael.com/idf-destroys-key-tehran-bunker-used-by-top-brass-trump-vows-no-deal-until-iran-surrenders/"},{t:"TWZ-B2",u:"https://www.twz.com/air/b-2-spirits-join-iran-air-war-pummel-underground-missile-caves"},{t:"Aviationist",u:"https://theaviationist.com/2026/03/07/b-1b-bombers-deploy-to-raf-fairford/"},{t:"MEE-B1B",u:"https://www.middleeasteye.net/news/us-bombers-land-britain-pentagon-prepares-surge-iran-strikes"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"QUDS FORCE LEBANON CORPS DECAPITATED: Commander Daoud Ali Zadeh killed in Tehran; CoS Reza Khazaei + deputy killed in Beirut Ramada Hotel strike. 70+ Hezbollah operatives killed since Mar 1. 500 Israeli targets struck in Lebanon. Infrastructure destroyed: Shura Council HQ, Unit 7900 naval unit, Radwan Force command center, drone storage, financial unit HQ, IRGC Aerospace Force HQ in southern suburbs. Lebanese gov banned IRGC activity + ordered deportation. Lebanon: 294 dead, 300K+ displaced. Nabi Chit: 41 killed. 3 UNIFIL peacekeepers wounded. Hezbollah issuing Hebrew evacuation warnings to northern Israel. IRGC command structure in Lebanon collapsing.", sources:[{t:"ToI-QF",u:"https://www.timesofisrael.com/liveblog_entry/top-member-of-irans-quds-force-killed-in-navy-strike-in-beirut-yesterday-idf-says/"},{t:"INN-QF",u:"https://www.israelnationalnews.com/news/423538"},{t:"AJZ-Bekaa",u:"https://www.aljazeera.com/news/2026/3/7/hezbollah-israeli-troops-clash-on-the-ground-in-eastern-lebanons-bekaa"},{t:"NRC",u:"https://www.nrc.no/news/2026/lebanon-300000-already-displaced-as-israel-issues-mass-evacuation-orders"}],
    subgoals:[
      ...
      { id:"hez-rocket", name:"Stop rocket fire on northern Israel", party:"israel", type:"avoid", importance:5, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"TEL AVIV NOW IN RANGE: Hezbollah expanded attacks to Tel Aviv area — 2 launches toward central Israel. 38 attacks in 24hrs using drones, ATGMs, missiles. Attacks on Galilee, Haifa, Golan Heights continuing. Range expansion = strategic escalation, not just border harassment.", sources:[{t:"MEMO",u:"https://www.middleeastmonitor.com/20260304-hezbollah-fires-rockets-towards-tel-aviv-and-haifa-as-fighting-intensifies/"},{t:"Alma",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-4-2026/"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"prx-houthi", name:"Suppress Houthi threats", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", outcomeNote:"HOUTHIS STILL NOT MILITARILY ENGAGED: Despite Abdul-Malik al-Houthi saying 'our hands are on the trigger' (Mar 5), NO confirmed retaliatory strikes launched. Stimson Center analysis: weakened Iran 'detrimental' to Houthis as weapons smuggling pipeline shrinks. Internal debate ongoing — cost-benefit calculation shifting as Iran's military degrades. Called for mass demonstrations but no military action. Key question: do Houthis join a losing fight or preserve their own position?", sources:[{t:"AJZ-Houthi",u:"https://www.aljazeera.com/news/2026/3/7/why-yemens-houthis-are-staying-out-of-israel-us-fight-with-iran-for-now"},{t:"Stimson",u:"https://www.stimson.org/2026/the-houthis-must-decide-join-irans-war-against-the-us-and-israel-or-abandon-iran/"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"6 KIA, 18 seriously wounded. Drone hit Kuwait command center with 'little overhead protection.' Murphy: Pentagon admitted 'more Americans are going to die, they can't stop the drones.' Force protection failing.", sources:[{t:"PBS",u:"https://www.pbs.org/newshour/nation/pentagon-identifies-4-of-6-u-s-soldiers-killed-in-iran-war-by-drone-strike-in-kuwait"},{t:"CNN",u:"https://www.cnn.com/2026/03/02/politics/six-soldiers-killed-in-iranian-strike-kuwait"}],
    subgoals:[
      { id:"cas-zero", name:"Maintain zero-casualty posture", party:"us", type:"avoid", importance:5, achievability:1, status:"unachievable", outcomeNote:"Failed Day 2. First 3 KIA confirmed. Now at 6 KIA. Pentagon had pre-positioned for casualties by drawing down personnel.", sources:[{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/1/at-least-three-us-service-members-killed-during-iran-operation-centcom"},{t:"NPR",u:"https://www.npr.org/2026/03/01/nx-s1-5731365/us-israeli-strikes-region"}] },
  ...
  },
  {
    ...
    importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"Day 8 evening: Iran 1,332+ dead, 181 children (UNICEF), 6,668 civilian units targeted (Red Crescent). Lebanon: 294 dead (up from 217), 1,023 wounded, 300,000+ displaced (NRC). 330,000+ displaced across Middle East (UN total). 28,000+ American citizens evacuated. Nabi Chit: 41 killed (incl. 3 Lebanese soldiers). Dubai airport struck. First oil infrastructure strikes in Tehran = civilian energy infrastructure now targeted. 3 UNIFIL peacekeepers wounded. Toll documented by UNICEF, OHCHR, WHO, Red Crescent — permanent accountability record.", sources:[{t:"NRC",u:"https://www.nrc.no/news/2026/lebanon-300000-already-displaced-as-israel-issues-mass-evacuation-orders"},{t:"AJZ-Bekaa",u:"https://www.aljazeera.com/news/2026/3/7/hezbollah-israeli-troops-clash-on-the-ground-in-eastern-lebanons-bekaa"},{t:"PBS-D8",u:"https://www.pbs.org/newshour/world/new-wave-of-strikes-hit-tehran-as-netanyahu-vows-many-surprises-for-next-phase-of-iran-war"},{t:"AJZ-D8",u:"https://www.aljazeera.com/news/2026/3/7/iran-war-what-is-happening-on-day-eight-of-us-israel-attacks"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 9: 12 BM salvos on March 7 — Iran shifting to staggered strategy (every 1-2 hours). IRGC claims hitting Haifa refinery in retaliation for Tehran oil depot strikes (unverified — no independent BDA). 11-12 civilians dead, 1,600+ injured. IDF assessment: Iran redirecting from Gulf to concentrate on Israel. Energy infrastructure now targeted both ways — bilateral escalation. No new Israeli casualties from latest salvos. Defense systems holding but IRGC adapting tactics.", sources:[{t:"ToI-D8",u:"https://www.timesofisrael.com/liveblog-march-07-2026/"},{t:"ToI-Salvos",u:"https://www.timesofisrael.com/smaller-volleys-more-alerts-attacking-israel-anew-iran-shifts-tack-on-missile-barrages/"},{t:"AJZ-D9",u:"https://www.aljazeera.com/news/liveblog/2026/3/8/iran-live-israel-bombs-tehran-oil-depots-attacks-on-gulf-states-continue"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"gp-china", name:"Prevent Chinese military support to Iran", party:"both", type:"avoid", importance:5, achievability:3, status:"at risk", outcomeNote:"SUPPLY LINE EXPOSED: IRIAF Boeing 747 cargo aircraft at Mehrabad airport was delivering military supplies from China (Gaolan chemical storage port) before being destroyed in strikes. Two IRISL-sanctioned cargo ships departed Chinese ports bound for Iran carrying ballistic missile program components. US intel suggests China may provide financial assistance + missile components (sodium perchlorate for propellant). Wang Yi: conflict 'should not have happened,' 'law of the jungle must not return.' China in talks with Iran for safe Hormuz passage. HQ-9B humiliation + 1 Chinese citizen killed. Moving from rhetorical concern to material support evidence.", sources:[{t:"Aviationist-747",u:"https://theaviationist.com/2026/03/07/b-1b-bombers-deploy-to-raf-fairford/"},{t:"JPost-Hormuz",u:"https://www.jpost.com/middle-east/iran-news/article-889028"},{t:"NBC",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-dignified-transfer-us-soldiers-rcna262207"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"nar-school", name:"Control Minab school narrative", party:"us", type:"achieve", importance:4, achievability:1, status:"at risk", trend:"failing", outcomeNote:"ATTRIBUTION SHIFTING TO US: NBC reports preliminary US investigation finds it 'increasingly likely' a US munition caused the Minab school strike (170+ killed, mostly girls 7-12). HRW: 'unlawful attack that should be investigated as a war crime.' Trump claimed Iran bombed the school — contradicted by own government's preliminary findings. CBS satellite: strike targeted IRGC barracks 60m away, school suffered collateral. Second school hit (Tehran Niloufar Square). Pattern now established. Narrative has moved from 'fog of war' to potential war crimes liability.", sources:[{t:"NBC-School",u:"https://www.nbcnews.com/world/iran/iran-school-strike-us-military-targeted-area-rcna261888"},{t:"HRW",u:"https://www.hrw.org/news/2026/03/07/us/israel-investigate-iran-school-attack-as-a-war-crime"},{t:"CBS-Satellite",u:"https://www.cbsnews.com/live-updates/us-iran-war-spreads-azerbaijan-israel-strikes-tehran-lebanon/"}] },
      { id:"nar-araghchi", name:"Counter Araghchi's information campaign", party:"us", type:"achieve", importance:3, achievability:1, status:"at risk", trend:"failing", outcomeNote:"Araghchi weaponizing every US admission. 'Mr. Rubio admitted war of choice.' Calling on Americans to 'take back their country.' Outperforming US messaging.", sources:[{t:"JPost",u:"https://www.jpost.com/middle-east/iran-news/article-888615"},{t:"CNBC",u:"https://www.cnbc.com/2026/03/05/iran-us-war-invasion-abbas-araghchi.html"}] },
      { id:"nar-iran", name:"Control narrative inside Iran", party:"both", type:"achieve", importance:3, achievability:3, status:"in progress", outcomeNote:"Internet at 1%. State broadcaster struck but still operating. Regime still communicating. Cyber ops hacking Iranian news sites.", sources:[{t:"Wiki",u:"https://en.wikipedia.org/wiki/2026_Internet_blackout_in_Iran"},{t:"CNBC",u:"https://www.cnbc.com/2026/03/02/irans-internet-down-amid-reports-of-us-israel-cyberattacks.html"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"sco-time", name:"Complete operations within 4-5 weeks", party:"us", type:"achieve", importance:4, achievability:2, status:"at risk", trend:"expanding", outcomeNote:"SEVEN TIMELINES: Israel 2 weeks. Trump 4-5 weeks. Hegseth 8 weeks. CENTCOM 100 days. Trump 'no time limits.' White House projects 4-6 weeks. IRGC claims '6-month readiness.' Haaretz/IDF: 'several more weeks unless Trump abruptly halts.' CSIS: $891M/day ($3.7B-$5.8B first 100 hours). Operation Epic Fury cost virtually none budgeted. Netanyahu announcing 'second stage' = extending not concluding. B-1B deployment to UK = preparing for sustained campaign.", sources:[{t:"Bloomberg-IRGC",u:"https://www.bloomberg.com/news/live-blog/2026-03-07/iran-latest"},{t:"Haaretz-IDF",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-07/ty-article/.premium/idf-officials-israel-bracing-for-iran-to-ramp-up-missile-launches/0000019c-c8fb-d3fb-a1fe-dffb592b0000"},{t:"CSIS",u:"https://www.csis.org/analysis/37-billion-estimated-cost-epic-furys-first-100-hours"}] },
      { id:"sco-theater", name:"Limit conflict to Iran bilateral", party:"us", type:"achieve", importance:4, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"WAR NOW TOUCHING EUROPE: Oslo — explosion at US embassy compound (~1am Mar 7), minor damage, no injuries. First physical attack on US diplomatic facility outside Middle East. Oil infrastructure strikes both ways (Tehran depots + IRGC claims Haifa refinery). B-1Bs operating from UK after completing missions over Iran from CONUS. Iran threatened European basing nations as 'legitimate targets.' Iran-Azerbaijan ultimatum. 10+ theaters active. Iran attacked 12 countries. Chinese military supply flights exposed. War scope expanding on every axis — target categories, geographic theaters, and participating nations all growing.", sources:[{t:"BNO-Oslo",u:"https://bnonews.com/index.php/2026/03/loud-bang-reported-near-u-s-embassy-in-oslo-norway/"},{t:"ToI-Oil",u:"https://www.timesofisrael.com/liveblog_entry/air-force-striking-iranian-oil-infrastructure-in-tehran-in-apparent-first/"},{t:"MEE-B1B",u:"https://www.middleeasteye.net/news/us-bombers-land-britain-pentagon-prepares-surge-iran-strikes"},{t:"France24-Threat",u:"https://www.france24.com/en/tv-shows/t%C3%AAte-%C3%A0-t%C3%AAte/20260306-europeans-will-be-legitimate-targets-if-they-join-war-iran-s-deputy-fm-warns"}] },
      { id:"sco-exit", name:"Define clear exit criteria", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"failing", outcomeNote:"UNDEFINED — BUT DEFINABLE: Hegseth stated 4 objectives (missiles, navy, nuclear, terror funding). Those are operationalizable with measurable thresholds — someone just hasn't done it. 60-day War Powers clock creates institutional forcing function. Phase 2 underground targeting implies military planners DO have internal metrics. The public framing is vague but internal planning may be more specific. Politically neglected ≠ structurally impossible.", sources:[{t:"FoxNews",u:"https://www.foxnews.com/politics/hegseth-lays-out-clear-3-part-mission-against-iran-says-war-not-endless"},{t:"NPR",u:"https://www.npr.org/2026/03/02/nx-s1-5732258/us-iran-hegseth-caine"}] },
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"TRIPLE ENERGY SHOCK: (1) First oil infrastructure strikes on Iran (3 Tehran depots). (2) Kuwait cutting 100K bbl/day (storage overflow). (3) Qatar: exports could halt 'within weeks,' oil to $150. ~9M bbl/day off market. WTI $90.90 (+35.63% weekly = history's largest). US gas $3.41 (+14% weekly). European TTF +60%. CSIS: $3.7B-$5.8B first 100 hours. $151.8M emergency arms sale. B-1B deployment = sustained campaign costs escalating. India granted 30-day Russian oil waiver. Russia profiting. Saudi's largest refinery suspended. Every metric worsening.", sources:[{t:"CNBC-Kuwait",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"},{t:"WaPo-Gas",u:"https://www.washingtonpost.com/business/2026/03/07/gas-prices-increasing-iran-war/"},{t:"CSIS",u:"https://www.csis.org/analysis/37-billion-estimated-cost-epic-furys-first-100-hours"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"FIRST OIL INFRASTRUCTURE STRIKES + $100 THRESHOLD APPROACHING: IDF struck 3 oil depots in western Tehran (Kuhak, Shahran, Karaj) — ~30 storage tanks targeted. First civil/energy infrastructure hit of war. Refinery undamaged. Brent $92.69, WTI $90.90. WTI +35.63% weekly = largest weekly gain in history. Kuwait cutting 100K bbl/day (storage full ~12 days). Qatar Energy Minister: oil could hit $150 if Gulf exports halt. ~9M bbl/day off market. Goldman Sachs: $100/bbl if Hormuz disrupted 5 weeks. Bloomberg: traders warn '$100 oil is imminent if Iran war keeps raging.' India granted 30-day Russian oil waiver. Russia 'significant increase in demand.' $100 threshold = political crisis — approaching fast.", sources:[{t:"Bloomberg-100",u:"https://www.bloomberg.com/news/articles/2026-03-06/traders-warn-100-oil-is-imminent-if-iran-war-keeps-raging"},{t:"ToI-Oil",u:"https://www.timesofisrael.com/liveblog_entry/air-force-striking-iranian-oil-infrastructure-in-tehran-in-apparent-first/"},{t:"CNBC-Kuwait",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"}] },
      ...
      { id:"en-iraq", name:"Prevent Iraqi oil shutdown", party:"us", type:"avoid", importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Iraq shutting Rumaila field. Could shutter 3M bpd total if Hormuz crisis continues. Iraq has no export route except via Gulf.", sources:[{t:"TheNational",u:"https://www.thenationalnews.com/business/energy/2026/03/03/iranian-attacks-force-iraq-to-shut-largest-oil-field-and-halt-exports/"},{t:"Bloomberg",u:"https://www.bloomberg.com/news/articles/2026-03-03/iraq-starts-shutting-oil-output-at-rumaila-as-storage-fills-up"}] },
      { id:"en-pump", name:"Keep US gas prices manageable", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"$3.41 NATIONAL AVG (+14% WEEKLY): Up from $3.00 pre-war. Highest since September 2024. If Strait stays closed, analysts project $100+ oil and $4+ gas. Trump won't tap SPR. DFC insurance 6-9 months away. First oil infrastructure strikes on Iran = could push prices higher. Summer blend switchover adds pressure. CA already $5+. If 100-day war at current trajectory: approaching politically toxic $4/gal threshold.", sources:[{t:"WaPo-Gas",u:"https://www.washingtonpost.com/business/2026/03/07/gas-prices-increasing-iran-war/"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/why-gas-prices-are-going-up-iran-war-chart/"}] },
    ]
  },
  {
    ...
    subgoals:[
      { id:"gulf-ad", name:"Maintain Gulf air defense effectiveness", party:"us", type:"achieve", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"INTERCEPTOR DEPLETION CRISIS: MEE reports US 'stonewalling' Gulf replenishment requests. Western official: 'several years' worth of production shot in days.' UAE/Qatar officially deny running low. THAAD radar sites damaged at Al Dhafra + Ruwais + Sader. UAE D8: 121 drones (119 intercepted, 98.3%). Saudi: BM hit uninhabited area near Prince Sultan AB + 16 drones at Shaybah (all intercepted). Qatar: 10 drones (9 intercepted). Bahrain cumulative: 86 missiles + 148 drones. Interception RATES holding 90%+ but STOCKS depleting — the math is unsustainable. This is now the critical near-term vulnerability.", sources:[{t:"MEE-Stonewall",u:"https://www.middleeasteye.net/news/us-stonewalling-requests-gulf-states-replenish-interceptors-sources-say"},{t:"CBS-Intercept",u:"https://www.cbsnews.com/news/arab-states-running-low-interceptors-iranian-fired-missiles/"},{t:"Fortune-Supply",u:"https://fortune.com/2026/03/07/trump-munitions-iran-war-ukraine-interceptors-patriot-thaad-low-supply/"},{t:"modgovae",u:"https://x.com/modgovae/status/2030240557491278272"}] },
      { id:"gulf-infra", name:"Protect Gulf energy infrastructure", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 8 ESCALATING BOTH WAYS: Iranian drone hit Dubai airport Concourse A — narrowly missed terminal/parked aircraft, operations suspended. Occurred <1 hour after Pezeshkian's apology to neighbors. Pezeshkian pledge contradicted by IRGC hitting Al Dhafra AFTER statement. Saudi's largest refinery suspended production. Kuwait cutting 100K bbl/day (storage overflow). BAPCO refinery (Bahrain) struck D7. AND: IDF struck 3 oil depots in Tehran (first oil infrastructure strikes) = energy war now bilateral. Saudi defense minister warned Iran against 'miscalculation.' ~9M bbl/day off market. AWS data centers UAE/Bahrain still affected.", sources:[{t:"Euronews-DXB",u:"https://www.euronews.com/2026/03/07/iranian-drone-attack-suspends-flights-at-dubai-international-airport"},{t:"CNBC-Kuwait",u:"https://www.cnbc.com/2026/03/07/kuwait-oil-cut-iran-war-strait-hormuz.html"},{t:"ToI-Oil",u:"https://www.timesofisrael.com/liveblog_entry/air-force-striking-iranian-oil-infrastructure-in-tehran-in-apparent-first/"},{t:"AlMonitor",u:"https://www.al-monitor.com/originals/2026/03/war-middle-east-latest-developments-2"}] },
  ...
  },
  {
    ...
    subgoals:[
      { id:"ter-us", name:"Prevent attacks on US homeland", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"FIRST PHYSICAL ATTACKS ON US/ALLIED FACILITIES IN EUROPE: Oslo — explosion at US embassy compound (~1am Mar 7), hit consular section entry point, minor damage, no injuries. NYC — incendiary device near Gracie Mansion during anti-Muslim protest (2 arrested). Previous: Texas shooting (man with Iran flag), Asif Merchant conviction (pre-war IRGC assassination plot). DHS Noem: terrorism risk 'elevated.' Threat now materializing outside Middle East — Oslo attack represents geographic expansion of anti-US violence. No mass-casualty event yet but pattern escalating.", sources:[{t:"BNO-Oslo",u:"https://bnonews.com/index.php/2026/03/loud-bang-reported-near-u-s-embassy-in-oslo-norway/"},{t:"NPR",u:"https://www.npr.org/2026/03/02/nx-s1-5732326/u-s-states-take-steps-to-guard-against-any-potential-threat-from-iran"},{t:"CBS",u:"https://www.cbsnews.com/live-updates/us-iran-war-israel-strikes-regime-targets/"}] },
      ...
      <div style={{ background:`linear-gradient(135deg, ${C.navy} 0%, #0E1A30 100%)`, padding:mobile?"14px 12px 10px":"20px 24px 16px", borderBottom:`2px solid ${C.blue}` }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", flexWrap:"wrap", gap:mobile?8:12 }}>
          <div>
            ...
            <h1 style={{ color:C.white, fontSize:mobile?16:20, fontWeight:800, margin:0, letterSpacing:-0.5 }}>Iran War Goals Assessment</h1>
            <div style={{ fontSize:mobile?10:11, color:C.textDim, marginTop:4 }}>
              ...
              <span style={{color:C.oppose}}>■</span> Opposing {!mobile && <>&nbsp;|&nbsp; Day 9 — Hour 216+ — March 8, 2026 — Morning Update</>}
            </div>
            {mobile && <div style={{ fontSize:9, color:C.textDim, marginTop:2 }}>Day 8 — March 7, 2026 — Evening Update</div>}
          </div>
      ...
      <div style={{ padding:"24px", maxWidth:1400, margin:"0 auto" }}>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))", gap:12 }}>
          {[
            ...
            { title:"Civilian Casualties", us:"Iran: 1,332+ dead (Red Crescent), 181 children (UNICEF). Second school hit (Tehran Niloufar Square). 160+ dead in girls school strike. CBS satellite: Minab school 60m from IRGC barracks. US: 'wouldn't deliberately target.' 100,000 fled Tehran in first 2 days (UNHCR). 20,000 Americans evacuated from region.", israel:"IDF ordered 500,000+ Dahiyeh evacuation. Lebanon: 123 dead, 600+ wounded, 95,000+ displaced. Smotrich: 'Dahieh = Khan Younis.' 26th strike wave on Beirut. Phase 2 underground targeting proceeding.", risk:"Multi-theater toll now 1,500+ across 9+ countries. Tug crew killed in Hormuz (8 dead). Azerbaijan airport hit. Italy defense minister: strikes 'violated international law.' UNICEF documentation creating permanent accountability record. The gap between 'precision campaign' messaging and 1,332+ dead (181 children) is now unbridgeable." },
