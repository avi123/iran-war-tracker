...
const HIGHLIGHTS = {
  updatedAt: "2026-03-08T22:48Z",
  keyDevelopments: [
    { text: "Mojtaba Khamenei formally named Supreme Leader — Assembly of Experts 'decisive vote,' IRGC pledged 'complete obedience.' First hereditary succession since 1979.", why: "Regime demonstrating it can regenerate leadership under bombardment. IDF immediately threatened to 'pursue every successor' — creating a targeting vs. legitimacy race.", category: "regime", goalIds: ["reg-succession", "reg-irgc-cohesion"], sources: [{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/8/iran-names-khameneis-son-as-new-supreme-leader-after-fathers-killing-2"},{t:"JPost",u:"https://www.jpost.com/middle-east/iran-news/article-889215"},{t:"RFE/RL",u:"https://www.rferl.org/a/iran-names-khamenei-supreme-leader-us-israel/33698945.html"}] },
    { text: "WTI crosses $100 — opens at $103.93/bbl (+14.33%). Brent $103-104. Weekly gain 35.63% = largest in WTI futures history since 1983.", why: "$100 oil is the political crisis threshold — $4+ gas erodes presidential approval. Bilateral oil strikes + Hormuz shutdown make this structural, not a spike.", category: "economic", goalIds: ["en-oil", "en-price"], sources: [{t:"CNBC",u:"https://www.cnbc.com/2026/03/08/crude-oil-prices-today-iran-war.html"},{t:"OilPriceAPI",u:"https://www.oilpriceapi.com/live/wti-crude-oil-price"}] },
    { text: "Axios: US/Israel weighing special forces to seize Iran's 450 kg of 60% HEU — enough for 11 bombs. Two options: remove or dilute on-site.", why: "Ground troops inside Iran crosses a fundamental escalation threshold. If executed, it would be the first US ground operation in Iran and the most consequential nuclear nonproliferation action since Iraq.", category: "military", goalIds: ["nuke", "nuke-breakout", "reg-endgame"], sources: [{t:"Axios",u:"https://www.axios.com/2026/03/08/iran-ground-troops-special-forces-nuclear"},{t:"Bloomberg",u:"https://www.bloomberg.com/news/articles/2026-03-08/iran-war-us-mulls-idea-of-special-operation-to-seize-tehran-s-uranium"}] },
    { text: "US orders diplomatic evacuation from Saudi Arabia — first since war began. Iranian drones struck Riyadh embassy.", why: "Mandatory evacuation signals the Gulf is no longer safe for US personnel — undermines the 'limited, contained' framing of the conflict.", category: "political", goalIds: ["cas-us", "gulf-infra"], sources: [{t:"Bloomberg",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"},{t:"USEmb",u:"https://sa.usembassy.gov/security-alert-security-alert-u-s-embassy-riyadh-saudi-arabia-march-8-2026-update-1/"}] },
    { text: "7th US service member killed — died from March 1 injuries in Saudi attack. 2 IDF soldiers killed in southern Lebanon by Hezbollah anti-tank fire.", why: "US KIA rising despite 'standoff' campaign framing. IDF ground casualties in Lebanon show Hezbollah retains lethal capability despite decapitation campaign.", category: "humanitarian", goalIds: ["cas-us", "cas-isr", "hez"], sources: [{t:"NPR",u:"https://www.npr.org/2026/03/08/nx-s1-5741654/israel-iran-oil-ayatollah-successor"},{t:"Haaretz",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-08/ty-article/.premium/two-israeli-soldiers-killed-by-anti-tank-fire-in-southern-lebanon/0000019c-cdd6-dcff-a3ff-fdfeec9e0000"}] },
    { text: "Bahrain desalination plant struck by Iranian drone — first water infrastructure hit in Gulf. Iran FM: US struck Qeshm water supply to 30 villages.", why: "Water infrastructure targeting crosses a new threshold. Tit-for-tat water attacks could become a pattern that outlasts the military campaign.", category: "economic", goalIds: ["gulf-infra"], sources: [{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/8/bahrain-says-water-desalination-plant-damaged-in-iranian-drone-attack"},{t:"Fortune",u:"https://fortune.com/2026/03/08/mideast-water-supply-bahrain-iran-desalination-plants-attacks-us-israel-war/"}] },
  ],
  watchNext: [
    { text: "Will Israel target Mojtaba? IDF explicitly threatened to 'pursue every successor and every Assembly member who voted'", why: "If Israel strikes the new Supreme Leader, it confirms decapitation-as-strategy and forces Iran into another succession crisis — or proves the threat was a bluff.", category: "military", timeframe: "imminent", sources: [{t:"JPost",u:"https://www.jpost.com/middle-east/iran-news/article-889215"}] },
    { text: "Oil approaching $110? Gas approaching $4? Sunday open at $103.93 may trigger Monday institutional panic", why: "Each $10 above $100 = ~$0.25/gal at the pump. $4 gas is historically the approval-rating cliff for US presidents.", category: "economic", timeframe: "24-48h", sources: [{t:"CNBC",u:"https://www.cnbc.com/2026/03/08/crude-oil-prices-today-iran-war.html"}] },
    { text: "Does special forces uranium seizure plan advance? Axios reports active US-Israel discussions for 'later stage' ground op", why: "Ground troops in Iran = fundamentally different war. If this leaks further or advances, it reshapes both the military and political calculus entirely.", category: "military", timeframe: "this week", sources: [{t:"Axios",u:"https://www.axios.com/2026/03/08/iran-ground-troops-special-forces-nuclear"}] },
    { text: "Does China escalate material support? IRISL ships carrying sodium perchlorate (rocket fuel) from China toward Iran", why: "China crossing from diplomatic support to material military supply would be the most consequential great-power escalation since the war began.", category: "political", timeframe: "this week", sources: [{t:"Windward",u:"https://windward.ai/blog/march-8-maritime-intelligence-daily/"}] },
    { text: "Houthi decision point — Day 9 without entry. Vowed to resume attacks but still not firing", why: "Houthi entry reopens Red Sea/Bab al-Mandab and doubles the shipping crisis. Their continued non-entry is the most underreported positive for the coalition.", category: "military", timeframe: "this week", sources: [{t:"LWJ",u:"https://www.longwarjournal.org/archives/2026/03/houthis-express-solidarity-with-iran-but-do-not-launch-retaliatory-attacks-yet.php"}] },
    { text: "Does school strike trigger formal legal proceedings? OHCHR + HRW + UNICEF + UNESCO all demanding investigation", why: "Institutional momentum building — if ICC or national courts open proceedings, it creates legal constraints on US targeting decisions for the remainder of the campaign.", category: "political", timeframe: "open question", sources: [{t:"OHCHR",u:"https://www.ohchr.org/en/press-releases/2026/03/un-experts-strongly-condemn-deadly-missile-strike-girls-school-iran-call"},{t:"HRW",u:"https://www.hrw.org/news/2026/03/07/us/israel-investigate-iran-school-attack-as-a-war-crime"}] },
    { text: "Iraq oil collapse deepening — southern production down 70% to 1.3M bpd. No export route via Hormuz", why: "Iraq becoming a secondary economic casualty of the war. If Iraqi government faces revenue crisis, it changes their calculus on allowing US basing.", category: "economic", timeframe: "this week", sources: [{t:"CNBC",u:"https://www.cnbc.com/2026/03/08/crude-oil-prices-today-iran-war.html"}] },
  ],
  watchResolved: [
    { text: "B-1B Fairford sorties", resolved: "CONFIRMED: 3 B-1Bs arrived at Fairford after completing combat missions over Iran. Forward basing now operational.", status: "confirmed" },
    { text: "Oil crosses $100/bbl", resolved: "CONFIRMED: WTI $103.93 on Sunday open (+14.33%). Brent $103-104. Weekly gain 35.63% = all-time record.", status: "confirmed" },
    { text: "Mojtaba investiture", resolved: "CONFIRMED: Assembly of Experts formally named Mojtaba as 3rd Supreme Leader. IRGC pledged allegiance.", status: "confirmed" },
    { text: "Houthi decision point", resolved: "Day 9 without entry. Vowed to resume attacks but no confirmed strikes. Each day = strategic win for coalition.", status: "ongoing" },
    { text: "China material support", resolved: "Escalating: IRISL ships carrying sodium perchlorate from China toward Iran. Wang Yi declared support. Supply line active.", status: "ongoing" },
    { text: "School strike legal action", resolved: "Momentum building: OHCHR, HRW, UNICEF, UNESCO all demanding investigation. No formal proceedings yet.", status: "ongoing" },
    { text: "Gulf interceptor depletion", resolved: "Confirmed crisis. Ukraine drone expertise agreed in principle but weapons export ban complicates.", status: "confirmed" },
    { text: "Pezeshkian-IRGC split", resolved: "Split visible but contained: IRGC overruled Pezeshkian, pledged loyalty to Mojtaba. Civilian government marginalized.", status: "ongoing" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"reg-succession", name:"Prevent regime reconstitution", party:"israel", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 9 Evening: MOJTABA KHAMENEI FORMALLY NAMED 3RD SUPREME LEADER — Assembly of Experts announced 'decisive vote.' IRGC pledged 'complete obedience and self-sacrifice.' First hereditary succession since 1979 revolution. His wife and one son reportedly killed in Feb 28 strikes. IRGC applied 'psychological and political pressure' on Assembly from Mar 3. Assembly met mostly online under bombardment — announcement delayed over fears he'd be targeted. IDF immediately warned: 'The hand of the State of Israel will continue to pursue every successor and every Assembly member who voted.' Trump: 'a lightweight' who 'won't last long.' Regime has reconstituted its apex leadership under fire — the most significant test of institutional resilience passed.", sources:[{t:"AJZ-Named",u:"https://www.aljazeera.com/news/2026/3/8/iran-names-khameneis-son-as-new-supreme-leader-after-fathers-killing-2"},{t:"JPost",u:"https://www.jpost.com/middle-east/iran-news/article-889215"},{t:"RFE/RL",u:"https://www.rferl.org/a/iran-names-khamenei-supreme-leader-us-israel/33698945.html"},{t:"Axios-Profile",u:"https://www.axios.com/2026/03/08/mojtaba-khamenei-iran-supreme-leader"},{t:"Wiki-Election",u:"https://en.wikipedia.org/wiki/2026_Iranian_Supreme_Leader_election"}] },
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 9 Evening: 5 IRGC QUDS FORCE COMMANDERS KILLED in Ramada Hotel strike — named: Majed Husseini, Ali Baazazar, Ahmad Rasouli, Hossein Ahmadlou + one more. ~200 operatives killed in Lebanon since Monday (80 Radwan, 70 artillery). 600+ strikes, 820+ munitions across Lebanon. 2 IDF SOLDIERS KILLED in southern Lebanon by anti-tank fire (first ground casualties since fighting restarted). 192 Hezbollah attack waves since Mar 2 (89 over weekend alone). Quds Force Lebanon Corps fully decapitated. 150+ Iranians/diplomats departed Lebanon. Lebanese gov banned IRGC. Lebanon: ~394 dead (83 children, 42 women), 500K+ displaced. UK partially withdrew embassy staff. Hezbollah retains lethal ground capability despite leadership losses.", sources:[{t:"AJZ-Ramada",u:"https://www.aljazeera.com/news/2026/3/8/israeli-strike-on-hotel-in-lebanons-beirut-kills-four-people"},{t:"Alma-D9",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-8-2026-1800/"},{t:"Haaretz-IDF",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-08/ty-article/.premium/two-israeli-soldiers-killed-by-anti-tank-fire-in-southern-lebanon/0000019c-cdd6-dcff-a3ff-fdfeec9e0000"},{t:"NPR-Hez",u:"https://www.npr.org/2026/03/08/nx-s1-5737540/under-attack-from-israel-some-in-lebanon-are-distancing-themselves-from-hezbollah"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"7 KIA (7th died Mar 8 from Mar 1 Saudi attack injuries), 18+ seriously wounded. US ordered diplomatic evacuation from Saudi Arabia — first since war began — after Iranian drones struck Riyadh embassy. CIA station inside embassy previously hit. Pentagon admitted 'more Americans are going to die, they can't stop the drones.' Force protection failing across the theater.", sources:[{t:"NPR-7th",u:"https://www.npr.org/2026/03/08/nx-s1-5741654/israel-iran-oil-ayatollah-successor"},{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"},{t:"PBS",u:"https://www.pbs.org/newshour/nation/pentagon-identifies-4-of-6-u-s-soldiers-killed-in-iran-war-by-drone-strike-in-kuwait"}],
    subgoals:[
      { id:"cas-zero", name:"Maintain zero-casualty posture", party:"us", type:"avoid", importance:5, achievability:1, status:"unachievable", outcomeNote:"Failed Day 2. Now at 7 KIA (7th died Mar 8 from Mar 1 Saudi injuries). Pentagon had pre-positioned for casualties by drawing down personnel.", sources:[{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/1/at-least-three-us-service-members-killed-during-iran-operation-centcom"},{t:"NPR-7th",u:"https://www.npr.org/2026/03/08/nx-s1-5741654/israel-iran-oil-ayatollah-successor"}] },
  ...
  },
  {
    ...
    importance:5, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 9 Evening: 12 civilians dead, 1,900+ injured total. 2 IDF soldiers killed in southern Lebanon by Hezbollah anti-tank fire (Sgt. First Class Maher Khatar, 38, near Manara — first IDF ground casualties since fighting restarted). 8 Iranian attack waves on Day 9 (down from peak 55 on Day 1). Cluster bomb warhead struck Tel Aviv/Petah Tikva — 6 wounded (1 serious). 165 total attack waves since Feb 28. IDF extended remote schooling nationally, restricted gatherings of 50+. Iran has fired 6+ cluster missiles total. Attack wave frequency declining but weapons sophistication increasing — quality over quantity.", sources:[{t:"Haaretz-IDF",u:"https://www.haaretz.com/israel-news/israel-security/2026-03-08/ty-article/.premium/two-israeli-soldiers-killed-by-anti-tank-fire-in-southern-lebanon/0000019c-cdd6-dcff-a3ff-fdfeec9e0000"},{t:"ToI-D9",u:"https://www.timesofisrael.com/liveblog-march-08-2026/"},{t:"Alma-D9",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-8-2026-1800/"},{t:"JPost-Cluster",u:"https://www.jpost.com/israel-news/defense-news/article-889185"}],
    subgoals:[
  ...
  },
  {
    ...
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"$100 THRESHOLD BREACHED: WTI $103.93/bbl on Sunday evening open (+14.33% from Friday close of $90.90). Brent $103-104. Weekly gain 35.63% = LARGEST IN WTI FUTURES HISTORY (since 1983). Gas $3.41/gal national avg (+$0.43/+14% weekly). European gasoil $1,158/tonne (up 54% weekly). Bilateral oil strikes + Hormuz at 3 transits/day = structural, not a spike. Kuwait cutting production (storage full). Iraq southern production collapsed 70% to 1.3M bpd. ~9M bbl/day off market. Qatar Energy Minister: oil could hit $150 if Gulf exports halt. $100 oil = political crisis threshold — $4+ gas erodes presidential approval historically. Monday institutional trading likely to amplify.", sources:[{t:"CNBC-$100",u:"https://www.cnbc.com/2026/03/08/crude-oil-prices-today-iran-war.html"},{t:"Bloomberg-100",u:"https://www.bloomberg.com/news/articles/2026-03-06/traders-warn-100-oil-is-imminent-if-iran-war-keeps-raging"},{t:"CNBC-Weekly",u:"https://www.cnbc.com/2026/03/06/iran-us-war-oil-prices-brent-wti-barrel-futures.html"},{t:"AJZ-Qatar150",u:"https://www.aljazeera.com/news/2026/3/6/qatar-warns-iran-war-could-halt-gulf-energy-exports-within-weeks"},{t:"AJZ-OilFirst",u:"https://www.aljazeera.com/news/2026/3/8/israel-strikes-irans-oil-facilities-for-first-time-as-war-enters-ninth-day"}] },
  ...
  },
  {
    ...
    subgoals:[
      ...
      { id:"gulf-infra", name:"Protect Gulf energy infrastructure", party:"us", type:"achieve", importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 9 Evening: WATER INFRASTRUCTURE NOW TARGETED — Bahrain desalination plant damaged by Iranian drone (first water infrastructure hit in Gulf). 3 injured at Sitra island. Iran FM: US struck Qeshm Island water supply to 30 villages (tit-for-tat). US ORDERED DIPLOMATIC EVACUATION from Saudi Arabia — first since war began — after Iranian drones struck Riyadh embassy. Kuwait airport fuel tanks struck, 2 border officers killed. Saudi: 3 BMs intercepted at Prince Sultan Base + Al-Kharj residential area hit (2 foreign nationals killed). UAE: airports, residential, hotels struck. Energy war BILATERAL: Israel struck 5 oil facilities in Tehran. ~9M bbl/day off market. ~4,000 DXB flight cancellations, 21,300 across region.", sources:[{t:"AJZ-Desal",u:"https://www.aljazeera.com/news/2026/3/8/bahrain-says-water-desalination-plant-damaged-in-iranian-drone-attack"},{t:"Fortune-Water",u:"https://fortune.com/2026/03/08/mideast-water-supply-bahrain-iran-desalination-plants-attacks-us-israel-war/"},{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"},{t:"France24-Kuwait",u:"https://www.france24.com/en/live-news/20260308-kuwait-airport-saudi-arabia-targeted-as-iran-presses-gulf-attacks"}] },
      { id:"gulf-civ", name:"Protect Gulf civilian populations", party:"us", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 9 Evening: GULF CASUALTIES MOUNTING ACROSS 6 COUNTRIES. UAE: 4 dead, 112+ injured (airports + residential struck). Saudi: 2 foreign nationals killed (Indian, Bangladeshi) at Al-Kharj, 12 injured. Kuwait: 2 border officers killed, airport fuel tanks struck. Bahrain: desalination plant damaged, Sitra island drone strikes, civilians injured. Qatar: 1 Pakistani killed. Jordan: 60 missiles + 59 UAVs since war start. US ORDERED DEPARTURE from Saudi embassy. 32,000+ US citizens repatriated from Middle East. ~4,000 DXB cancellations, 21,300 across region. 52,000+ Indians evacuated. War affecting daily life in 9+ countries.", sources:[{t:"Alma-D9",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-8-2026-1800/"},{t:"CBS",u:"https://www.cbsnews.com/live-updates/us-iran-war-israel-strikes-regime-targets/"},{t:"AJZ-D9",u:"https://www.aljazeera.com/news/2026/3/8/iran-war-what-is-happening-on-day-nine-of-us-israel-attacks"},{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"}] },
    ]
  },
  {
