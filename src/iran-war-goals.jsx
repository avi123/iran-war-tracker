...
const HIGHLIGHTS = {
  updatedAt: "2026-04-08T14:18Z",
  keyDevelopments: [
    { text: "TWO-WEEK CEASEFIRE AGREED — Pakistan-brokered deal announced ~90 minutes before Trump's 8PM deadline April 7. Iran's SNSC accepted. China provided 'last-minute nudge.' US/Israel suspend all strikes on Iran for 14 days. Iran agrees to 'complete, immediate, safe opening' of Hormuz. Iran + Oman collect transit tolls. Islamabad talks begin Friday April 10 (Witkoff, Kushner, Vance). Iraq's Islamic Resistance declared parallel halt.", why: "Most significant inflection since war began. Ceasefire at Day 40 is ahead of Kosovo's Day 78 resolution — but resolution quality is far behind (negotiating pause vs capitulation). Iran's 10-point demands (sanctions lifting, enrichment rights, US withdrawal, reparations) are structurally incompatible with Trump's 'no enrichment' position. Both sides claimed victory. The 14-day window determines whether this is a pathway to settlement or a tactical pause before resumption.", category: "political", goalIds: ["sco-exit", "all-oman", "hor-open"], sources: [{t:"NBC-Ceasefire",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-deadline-hormuz-infrastructure-ceasefire-rcna267039"},{t:"AJZ-Day41",u:"https://www.aljazeera.com/news/2026/4/8/iran-war-ceasefire-day-41"},{t:"Bloomberg-Hormuz",u:"https://www.bloomberg.com/news/articles/2026-04-08/hormuz-stays-blocked-for-now-as-hundreds-of-ships-seek-escape"}] },
    { text: "HEGSETH: 'DECISIVE MILITARY VICTORY' — 13,000+ targets struck in 38 days of 'Operation Epic Fury.' Iran lost 80% air defenses, 90% weapons factories, 90%+ conventional naval forces, 85% petrochemical exports. US used 'less than 10%' of capabilities. Iran 'begged' for ceasefire. But Soufan Center (US intel): Iran's arsenal 'only partially depleted' — can fight war of attrition.", why: "Pentagon framing echoes 'Mission Accomplished' structurally — declaring victory while political endgame undefined. Military metrics (80%/90%/85%) independently corroborated by OSINT satellite BDA. But percentage claims lack baselines, and 13K target count contradicts earlier 15K+ figure (methodology unclear). Soufan assessment directly challenges the victory narrative. Key test: does military degradation translate to political concessions at Islamabad?", category: "military", goalIds: ["missile", "airsup", "reg-irgc-leaders", "sco-time"], sources: [{t:"JPost-Hegseth",u:"https://www.jpost.com/international/article-892371"},{t:"Soufan-Arsenal",u:"https://thesoufancenter.org/intelbrief-2026-april-6/"},{t:"ABC-Victory",u:"https://abcnews.go.com/International/hegseth-iran-decisive-military-victory/story?id=127384956"}] },
    { text: "LEBANON EXCLUDED FROM CEASEFIRE — Netanyahu explicitly stated ceasefire does NOT cover Lebanon. Israel launched massive strikes across Lebanon hours after ceasefire. IDF deployed 6th Division (elite 98th Commando) to southern Lebanon. 1,100+ Hezbollah fighters killed since March 2. But Haaretz intel: Hezbollah maintains 'solid military hold' south of Litani. IDF: disarming Hezbollah 'unrealistic, not a goal.'", why: "Israel is using the Iran ceasefire as cover to intensify against Hezbollah — deliberate theater decoupling. This is strategically coherent (maintain leverage, exploit pause) but carries real costs: 1,497+ killed, 1.2M displaced (20% of Lebanon's population). Iran's Point 10 demands all-fronts cessation. If Islamabad talks require Lebanon inclusion and Israel refuses, talks collapse on this point. Hezbollah 2006 parallel now at 7/10 fit — Israel committed elite units while Hezbollah maintains position.", category: "military", goalIds: ["prx-hzb", "hez-rocket", "sco-theater"], sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/4/8/netanyahu-says-us-iran-ceasefire-does-not-include-lebanon"},{t:"Haaretz-Hzb",u:"https://www.haaretz.com/israel-news/israel-security/2026-04-06/ty-article/.premium/hezbollah-solid-hold-south-lebanon"},{t:"ToI-6thDiv",u:"https://www.timesofisrael.com/idf-deploys-6th-division-southern-lebanon"}] },
    { text: "PASSOVER ATTACK CONFIRMED + OIL CRASHED — Iran fired largest missile salvo in weeks during Seder night: ~20+ BMs including cluster munitions. Coordinated with Hezbollah (100+ rockets) + Houthis (drones at Eilat). 4 killed Haifa, 11-year-old critically hurt. Post-ceasefire: oil crashed ~16% (WTI to $94.55, Brent to $94.13) — still 30% above pre-war. Markets surged (S&P +2.7%, Nikkei +5.4%).", why: "Passover attack demonstrated continued Iranian strike capability and axis coordination even as ceasefire was being finalized — Iran negotiated from a position of active military capability, not exhaustion. Oil crash signals markets believe deescalation is credible but 30% premium above pre-war shows structural uncertainty remains. Ceasefire's economic impact is immediate and significant — pressure on both sides to sustain it.", category: "economic", goalIds: ["cas-isr", "isr-dome", "en-oil"], sources: [{t:"ToI-Passover",u:"https://www.timesofisrael.com/idf-passover-iran-attack-assessment"},{t:"CNBC-Oil",u:"https://www.cnbc.com/2026/04/07/oil-prices-iran-war-trump-deadline-strait-hormuz.html"},{t:"IsraelHayom-Seder",u:"https://www.israelhayom.com/2026/04/07/iran-strikes-during-passover-seder/"}] },
    { text: "UNSC HORMUZ VOTE FAILED — 11-2-2 (Russia/China vetoed). France voted YES after forcing removal of offensive language. Hormuz reopening theoretical only: ~800 vessels trapped, little immediate change in traffic vs 135/day normal. Hapag-Lloyd: 6-8 weeks to normalize even with stable ceasefire. Iran collecting transit tolls in yuan.", why: "Russia/China veto eliminates multilateral framework for Hormuz enforcement — US must rely on ceasefire terms or act unilaterally. France voting YES (after earlier opposition) shows NATO fracture partially healed on this issue. But operational reality unchanged: Iran retains de facto chokepoint control. The gap between 'safe opening' announcement and actual throughput is the key credibility test for the ceasefire.", category: "political", goalIds: ["hor-open", "all-nato", "en-oil"], sources: [{t:"PBS-UNSC",u:"https://www.pbs.org/newshour/world/russia-and-china-veto-watered-down-un-resolution-aimed-at-reopening-the-strait-of-hormuz"},{t:"Bloomberg-Ships",u:"https://www.bloomberg.com/news/articles/2026-04-08/hormuz-stays-blocked-for-now-as-hundreds-of-ships-seek-escape"},{t:"InsJournal-Hapag",u:"https://www.insurancejournal.com/news/international/2026/04/08/864956.htm"}] },
    { text: "CASUALTIES UPDATED — Iran: 3,597 killed per HRANA (most methodical: 1,665 civilians, 1,221 military, 711 unclassified). Lebanon: 1,497-1,530 killed, 1.2M displaced (20% of population). Israel: 23 civilians + 12 soldiers killed, 7,183 civ + 411 mil wounded. US: 15 KIA, 538 WIA. Gulf: 28 dead. Post-ceasefire Gulf attacks April 8: UAE, Kuwait (28 drones intercepted), Bahrain, Saudi pipeline all hit.", why: "Casualty figures now methodically tracked by HRANA (independent Iranian HR org). Post-ceasefire Gulf attacks raise immediate questions about ceasefire compliance — either pre-programmed launches arriving after announcement, or deliberate violations by proxy forces. Gulf state attacks could shift regional alignment and undermine ceasefire durability.", category: "humanitarian", goalIds: ["cas-civ", "cas-us", "cas-isr", "gulf-protect"], sources: [{t:"AJZ-Tracker",u:"https://www.aljazeera.com/news/2026/3/1/us-israel-attacks-on-iran-death-toll-and-injuries-live-tracker"},{t:"HRANA",u:"https://www.hrana.org"},{t:"JPost-Gulf",u:"https://www.jpost.com/middle-east/iran-news/article-892349"}] },
  ],
  watchNext: [
    { text: "CEASEFIRE DURABILITY — Gulf states attacked April 8 (UAE, Kuwait 28 drones, Bahrain, Saudi pipeline) hours after ceasefire. Pre-programmed or deliberate violations? Does the ceasefire hold 48 hours?", why: "If post-ceasefire attacks continue, the deal unravels before Islamabad talks begin. If they stop (pre-programmed launches clearing the system), ceasefire gains credibility. Gulf state reactions will determine whether regional alignment shifts against the deal.", category: "military", timeframe: "24-48h", sources: [{t:"JPost-Gulf",u:"https://www.jpost.com/middle-east/iran-news/article-892349"},{t:"AJZ-Day41",u:"https://www.aljazeera.com/news/2026/4/8/iran-war-ceasefire-day-41"}] },
    { text: "ISLAMABAD TALKS FRIDAY APRIL 10 — Witkoff, Kushner, Vance attending. Deal-breaker: enrichment (Trump 'no enrichment' vs Iran Point 3 'enrichment is a right'). US sent 15-point counter-proposal. Can they bridge structural incompatibility in positions?", why: "The gap between opening positions is canyon-wide but both sides have incentives to deal: Iran's infrastructure is 85% destroyed, US faces War Powers clock + $38B+ costs. Pakistan brokered the ceasefire but lacks leverage to bridge nuclear positions. If talks produce framework agreement, war potentially ends. If they fail, resumption after Day 54 with Iran partially recovered.", category: "political", timeframe: "24-48h", sources: [{t:"NBC-Ceasefire",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-deadline-hormuz-infrastructure-ceasefire-rcna267039"},{t:"Axios-Deal",u:"https://www.axios.com/2026/04/05/trump-iran-deal-power-plants"}] },
    { text: "LEBANON ESCALATION — Israel intensifying with 6 divisions committed while Iran ceasefire holds. Does Iran re-enter the war for Hezbollah? Does Lebanon derail Islamabad talks (Iran Point 10: all-fronts cessation)?", why: "Israel's deliberate theater decoupling is a calculated bet that Iran won't break the ceasefire for Hezbollah. If correct, Israel gets a free window to degrade Hezbollah. If wrong, ceasefire collapses. Hezbollah 2006 parallel: Israel committed elite units but Hezbollah maintained position and claimed victory. IDF itself says disarmament is 'unrealistic.'", category: "military", timeframe: "this week", sources: [{t:"AJZ-Lebanon",u:"https://www.aljazeera.com/news/2026/4/8/netanyahu-says-us-iran-ceasefire-does-not-include-lebanon"},{t:"Haaretz-Hzb",u:"https://www.haaretz.com/israel-news/israel-security/2026-04-06/ty-article/.premium/hezbollah-solid-hold-south-lebanon"}] },
    { text: "HORMUZ THROUGHPUT — ~800 vessels trapped. Ceasefire promises 'safe opening' but little immediate change. When does throughput reach 50/day? Insurance terms undefined. Hapag-Lloyd: 6-8 weeks to normalize.", why: "Hormuz is the ceasefire's operational credibility test. Diplomatic promise vs physical reality: Iran retains de facto control and is collecting tolls. Until throughput exceeds 50 ships/day, this is theater. Maersk cautious, insurers undefined. If shipping doesn't resume meaningfully within 5-7 days, ceasefire's economic value evaporates.", category: "economic", timeframe: "this week", sources: [{t:"Bloomberg-Ships",u:"https://www.bloomberg.com/news/articles/2026-04-08/hormuz-stays-blocked-for-now-as-hundreds-of-ships-seek-escape"},{t:"InsJournal-Hapag",u:"https://www.insurancejournal.com/news/international/2026/04/08/864956.htm"}] },
    { text: "War Powers 60-day clock — ~19 days remain (expires ~April 28-29). Ceasefire may effectively run out the clock. $200B supplemental still dead. If ceasefire collapses after April 28, legal authority for resumption is contested.", why: "The ceasefire aligns almost perfectly with the War Powers window: 14-day ceasefire expires ~April 21, War Powers ~April 28. If talks succeed, War Powers becomes moot. If talks fail and war resumes, Congress returns from recess into an active debate about authorization. The domestic political constraint hasn't disappeared — it's been deferred.", category: "political", timeframe: "this week", sources: [{t:"Axios-WP",u:"https://www.axios.com/2026/03/26/iran-trump-war-powers-vote-house-democrats"}] },
    { text: "CEASEFIRE EXPIRY ~APRIL 21 — Extendable 'by mutual agreement.' Aligns with Zamir's mid-April framing (now 'strategic crossroads'). If no deal by Day 54, war resumes with Iran partially recovered and US War Powers clock at ~7 days.", why: "The 14-day window creates artificial urgency without creating real pressure to compromise. If both sides use the pause to rearm/reposition rather than negotiate, the resumption will be more violent. Iran has 14 days to harden nuclear facilities, relocate HEU, reconstitute command. US/Israel have 14 days to replenish interceptors, reposition forces. The clock is the strategy.", category: "political", timeframe: "this week", sources: [{t:"NBC-Ceasefire",u:"https://www.nbcnews.com/world/iran/live-blog/live-updates-iran-war-trump-deadline-hormuz-infrastructure-ceasefire-rcna267039"},{t:"Euronews-Lapid",u:"https://www.euronews.com/2026/04/08/lapid-diplomatic-disaster-israel-not-at-table"}] },
  ],
  watchResolved: [
    { text: "Trump's 8PM deadline April 7", resolved: "CEASEFIRE INSTEAD: Did NOT follow through on 'civilization will die tonight' threat. Announced Pakistan-brokered 14-day ceasefire ~90 min before deadline. Third ultimatum → diplomacy. Power plants not struck.", status: "confirmed" },
    { text: "Passover attack", resolved: "CONFIRMED: Iran fired ~20+ BMs with cluster munitions during Seder night. Coordinated with Hezbollah (100+ rockets) + Houthis (drones at Eilat). 4 killed Haifa, 11-year-old critically hurt, infants injured Bnei Brak.", status: "confirmed" },
    { text: "UNSC Hormuz vote", resolved: "FAILED: 11-2-2. Russia/China vetoed. France voted YES (reversed earlier opposition after offensive language removed). No multilateral framework for Hormuz enforcement.", status: "confirmed" },
    { text: "Zamir 'halfway' timeline", resolved: "SHIFTED: Now says 'approaching strategic crossroads' — no longer 'halfway.' Ceasefire at Day 40 roughly validates mid-April framing but as pause, not conclusion.", status: "confirmed" },
    { text: "Iran's 10-point proposal", resolved: "BECAME CEASEFIRE BASIS: Trump called it 'workable basis to negotiate.' Full text now public (sanctions lifting, enrichment rights, reparations, US withdrawal, all-fronts cessation). US sent 15-point counter-proposal. Gap remains enormous but both sides at table.", status: "confirmed" },
    { text: "Interceptor crisis", resolved: "CONFIRMED + CEASEFIRE PROVIDES RESPITE: Arrow 2/3 ~80% depleted. 4 killed Haifa. Ceasefire pauses the depletion clock but replacement is 2-3 years. If war resumes, crisis returns immediately.", status: "confirmed" },
    { text: "$200B supplemental", resolved: "STILL DEAD: No votes, no timeline. War at $38B+ spent without authorization. Ceasefire may defer but doesn't resolve.", status: "ongoing" },
    { text: "Bab el-Mandeb threat", resolved: "DECLARED BUT NOT OPERATIONALIZED: Velayati declared Bab el-Mandeb 'same as Hormuz.' Houthis participated in coordinated strikes on Israel but have NOT resumed Red Sea shipping attacks. Ceasefire status for Houthis unclear.", status: "partial" },
  ],
};
...
const AXES = [
  ...
  },
  {
    ...
    summary: "Ceasefire pauses the attrition clock but doesn't reset it. Arrow 2/3 ~80% depleted — ceasefire provides respite but replacement is 2-3 years (THAAD production <20/year). Soufan Center: Iran's arsenal 'only partially depleted' — can fight war of attrition if ceasefire collapses. Iran demonstrated continued capability with Passover salvo (~20+ BMs + cluster munitions, coordinated with Hezbollah + Houthis). 4 killed Haifa, 11-year-old critically hurt. Oil crashed ~16% on ceasefire (WTI $94.55, Brent $94.13) but 30% above pre-war. Both sides now in a 14-day race: Iran to reconstitute/harden, US/Israel to replenish interceptors and reposition. If war resumes at Day 54, the attrition balance will have shifted — question is which direction.",
    keyIndicators: [
      { label: "Iran arsenal", value: "Partially depleted", detail: "Soufan Center: 'only partially depleted.' Passover salvo demonstrated continued multi-front capability. 14-day ceasefire = reconstitution window. 90% weapons factories destroyed limits recovery.", color: "#F59E0B" },
      { label: "Israel interceptors", value: "~80% depleted", detail: "Arrow 2/3 ~80% expended. Ceasefire pauses depletion but replacement is 2-3 years. $826M emergency transfer approved but production rate fixed. If war resumes, crisis returns immediately.", color: "#EF4444" },
      { label: "US casualties", value: "15 KIA, 538 WIA", detail: "Across 9 countries. Ceasefire pauses but Lebanon excluded — US forces supporting IDF operations there remain at risk.", color: "#EF4444" },
      { label: "Oil/economic", value: "Crashed but elevated", detail: "WTI $94.55 (-16%), Brent $94.13. Still 30% above pre-war. S&P +2.7%, Nikkei +5.4%. Markets pricing credible deescalation but hedging. ~800 vessels still trapped in Hormuz.", color: "#F59E0B" },
      { label: "Ceasefire clock", value: "14 days", detail: "Both sides racing: Iran to harden nuclear sites + reconstitute command. US/Israel to replenish interceptors + reposition. If talks fail at Day 54, resumption more violent than pause.", color: "#F59E0B" },
    ],
    watching: [
      { text: "Interceptor replenishment — can US/Israel meaningfully improve Arrow/THAAD stocks in 14 days? Production rate is the binding constraint.", timeframe: "this week" },
      { text: "Iran reconstitution — satellite imagery of Natanz, Fordow, missile production sites. Is Iran using ceasefire to rebuild or negotiate?", timeframe: "this week" },
      { text: "Hezbollah attrition — Lebanon excluded from ceasefire. 1,100+ fighters killed. Can Hezbollah sustain 200/day without Iranian resupply during ceasefire?", timeframe: "this week" },
    ],
      ...
      <CollapsibleSection title="Three Readings — Succeeding / Expanding / Failing" id="verdicts" mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"12px 24px 12px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.green}`, marginBottom:12 }}>
            <h3 style={{ color:C.green, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Succeeding — Day 41</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Ceasefire at Day 40 — ahead of Kosovo's Day 78 resolution.</span> Military campaign delivered results exceeding expectations: 13,000+ targets, 80% air defenses destroyed, 90% weapons factories, 85% petrochemical exports, 90%+ conventional naval forces. IRGC intel chief Khademi + Quds Force Unit 840 commander Bagheri killed. Independent OSINT/satellite BDA confirms damage at South Pars, Damavand, Mahshahr, Shiraz Electronics, and dozens more. Hegseth: US used 'less than 10%' of capabilities.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:C.green,fontWeight:700}}>Iran accepted ceasefire and negotiations — the compellence theory is being validated.</span> Iran's SNSC accepted terms including Hormuz reopening. Trump called Iran's 10-point plan a 'workable basis.' Islamabad talks Friday with Witkoff/Kushner/Vance. Oil crashed 16% — markets pricing credible deescalation. Global equities surged. Iraq's Islamic Resistance declared parallel halt. The economic pressure campaign — 85% petrochemical destruction + Hormuz disruption — created leverage that didn't exist before the war. If Islamabad produces a framework, this is the fastest air-campaign-to-diplomacy conversion since Kosovo.
            </p>
          </div>
          ...
          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid #F59E0B`, marginBottom:12 }}>
            <h3 style={{ color:"#F59E0B", fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Expanding — Day 41</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Lebanon excluded from ceasefire — Israel intensifying with 6 divisions while Iran pauses.</span> Netanyahu explicitly decoupled theaters: ceasefire covers Iran but NOT Lebanon. Massive strikes across Lebanon hours after ceasefire. 6th Division (elite 98th Commando) deployed. 1,497+ killed, 1.2M displaced (20% of Lebanon). IDF says disarming Hezbollah is 'unrealistic, not a goal.' Haaretz intel: Hezbollah maintains 'solid military hold' south of Litani. Hezbollah 2006 parallel now at 7/10 fit — Israel committed elite units while adversary maintains position.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              <span style={{color:"#F59E0B",fontWeight:700}}>Gulf attacks AFTER ceasefire reveal the conflict has metastasized.</span> UAE, Kuwait (28 drones), Bahrain (Sitra Island), Saudi pipeline all hit on April 8 — hours after ceasefire announcement. Pre-programmed or deliberate violations? Iran warned 'restraint in targeting oil infrastructure in the region would no longer apply.' Ceasefire's scope is ambiguous: Israel wasn't at the table, Hezbollah/Houthi compliance unclear, Gulf states still being attacked. The central amber question has shifted from 'will the deadline produce concessions?' (it did) to 'is the ceasefire a genuine inflection toward resolution or a tactical pause before escalation?' Islamabad talks Friday will determine which.
            </p>
          </div>

          <div style={{ background:C.card, borderRadius:8, padding:18, border:`1px solid ${C.border}`, borderLeft:`4px solid ${C.red}` }}>
            <h3 style={{ color:C.red, fontSize:14, fontWeight:700, marginBottom:8 }}>The Case That This Is Failing — Day 41</h3>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, marginBottom:8, fontFamily:SANS }}>
              <span style={{color:C.red,fontWeight:700}}>{stats.failing} goals are demonstrably failing.</span> (1) <span style={{color:C.red,fontWeight:700}}>Nuclear disarmament has hit a structural impasse the ceasefire worsens.</span> Fordow undamaged and operational. 440 kg 60% HEU unverifiable. Trump: 'no enrichment.' Iran Point 3: 'enrichment is a right.' No visible compromise formula. Ceasefire freezes military pressure — the only leverage driving nuclear concessions — while giving Iran 14 days to harden/relocate. (2) <span style={{color:C.red,fontWeight:700}}>Hormuz reopening is failing the operational test.</span> Iran promised 'complete, immediate, safe opening' but little immediate change in traffic vs 135/day normal. ~800 vessels trapped. Insurance undefined. Hapag-Lloyd: 6-8 weeks to normalize. Iran retains de facto chokepoint control.
            </p>
            <p style={{ color:C.text, fontSize:13, lineHeight:1.65, margin:0, fontFamily:SANS }}>
              (3) <span style={{color:C.red,fontWeight:700}}>War termination has no visible pathway within the ceasefire window.</span> Iran's 10 points (sanctions, reparations, US withdrawal, enrichment) are structurally incompatible with Trump's demands. Pakistan brokered the ceasefire but can't bridge these positions. Israel wasn't at the table and is actively escalating in Lebanon. 14-day clock creates artificial urgency without real pressure to compromise. (4) UNSC Hormuz resolution vetoed by Russia/China — no multilateral framework. (5) $200B supplemental dead, War Powers ~19 days. (6) Lapid: 'never such a diplomatic disaster' — Israel excluded from its own ceasefire. <span style={{color:C.red,fontWeight:700}}>If talks fail and war resumes at Day 54: Iran partially recovered, Gulf states rattled by post-ceasefire attacks, US War Powers authority expiring, interceptors still depleted. There is no Plan B visible in the public record.</span>
            </p>
          </div>
        </div>
      </CollapsibleSection>
      ...
      <CollapsibleSection title="Historical Analogues" id="analogues" defaultOpen={false} mobile={mobile} borderColor={C.blueLt}>
        <div style={{ padding:"24px", maxWidth:1400, margin:"0 auto" }}>
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fit, minmax(280px, 1fr))", gap:12 }}>
            {[
              { name:"Kosovo 1999", fit:"HIGH (7.5)", fitColor:C.green, note:"Ceasefire at Day 40 vs Kosovo's Day 78 resolution — ahead of schedule but resolution quality far behind. Both: sustained air campaign, no ground troops, infrastructure escalation → diplomatic engagement. Kosovo's Rambouillet → Islamabad. Key difference: Milosevic capitulated fully; Iran is negotiating from 'we survived.' Kosovo Day 78 = Serbian withdrawal; Iran Day 40 = 'we'll talk about it.' If pattern holds, resolution window Day 54-78. Still the best single analogue." },
              { name:"Israel-Hezbollah 2006", fit:"HIGH (7.0)", fitColor:C.green, note:"UPGRADING. Lebanon exclusion from ceasefire makes this the second most relevant analogue. Israel committing 6 divisions (2006: Golani, 2026: 98th Commando). Haaretz: Hezbollah maintaining 'solid military hold' despite claims. IDF: disarmament 'unrealistic.' 1,497+ killed, 1.2M displaced. 2006 lesson: Israel declared objectives met but Hezbollah emerged claiming victory. Same framing emerging — or have they internalized 2006's lesson?" },
              { name:"Desert Storm 1991", fit:"MEDIUM (6.5)", fitColor:C.amber, note:"38-day air campaign → ceasefire (no ground phase) mirrors timeline. Desert Storm's ceasefire was on coalition terms with Iraq accepting UNSC resolutions. Iran's ceasefire is a negotiating pause, not capitulation. Desert Storm's lesson: ceasefire held but political objectives (Saddam's removal) NOT achieved. Hegseth's 'decisive victory' echoes Schwarzkopf's briefing. Directly relevant to military success ≠ political resolution risk." },
              { name:"Libya 2011", fit:"MEDIUM (5.0)", fitColor:C.amber, note:"NATO air campaign lasting months, degrade without invading. Libya's lesson: military success without political follow-through → state collapse. Relevant if ceasefire collapses and Iran fragments — but Iran's institutions far stronger. Ceasefire actually reduces this risk by providing a diplomatic pathway. Petrochemical destruction (85%) parallels Libya's infrastructure degradation." },
              { name:"Iraq 2003", fit:"LOW-MED (3.0)", fitColor:C.red, note:"Demoting. No occupation, no governance burden. 'Mission Accomplished' parallel to Hegseth's press conference is thematic but not structural. Iraq 2003's failure mode (insurgency, sectarian collapse) has no pathway here. The ceasefire further diverges — Bush declared mission accomplished unilaterally; Iran's ceasefire is bilateral. Only premature victory theme remains useful." },
              { name:"June 2025 12-Day War", fit:"LOW (4.0)", fitColor:C.red, note:"Scale divergence now overwhelming. 41-day war with ceasefire negotiated by Pakistan/China has nothing structurally in common with contained 12-day operation. Retained only as counterfactual — what 'limited' looked like." },
              { name:"Panama 1989", fit:"LOW (3.0)", fitColor:C.red, note:"Terminal. No ground troops, no regime change, ceasefire rather than overthrow. Quick-swap model completely inapplicable." },
              { name:"Osirak 1981", fit:"LOW (4.0)", fitColor:C.red, note:"Only nuclear dimension relevant. Fordow intact + 440 kg HEU unverifiable confirms Osirak-style surgical outcome not achieved. Osirak's lesson — strikes delayed but didn't prevent program — directly relevant to enrichment impasse at Islamabad." },
            ].map(a => (
