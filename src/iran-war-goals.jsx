...
const HIGHLIGHTS = {
  updatedAt: "2026-03-09T13:39Z",
  keyDevelopments: [
    { text: "Oil spiked ~$119/bbl intraday Monday, settled ~$109.30 — institutional panic on first full trading day since $100 breach.", why: "Monday confirmed $100 wasn't a ceiling — it was a floor. $109 settle means $4+ gas is imminent. Markets pricing in sustained disruption, not a spike.", category: "economic", goalIds: ["en-oil", "en-pump"], sources: [{t:"Reuters",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"},{t:"CNBC",u:"https://www.cnbc.com/2026/03/09/oil-prices-spike-above-119-on-iran-war-fears.html"}] },
    { text: "Iran formally rejects ceasefire — Araghchi: 'We need to continue fighting for the sake of our people.' Demands 'permanent end to war,' not temporary halt.", why: "Closes the diplomatic off-ramp. Combined with US demanding 'unconditional surrender,' both sides have now publicly rejected compromise — war has no visible exit.", category: "political", goalIds: ["sco-exit", "reg-endgame"], sources: [{t:"NBC-Araghchi",u:"https://www.nbcnews.com/world/iran/irans-foreign-minister-rejects-calls-ceasefire-continue-fighting-rcna262291"}] },
    { text: "Turkey intercepted Iranian ballistic missile over eastern Mediterranean — deployed F-16s to Northern Cyprus after Shahed drone struck RAF Akrotiri.", why: "NATO member actively intercepting Iranian weapons = geographic and alliance expansion. Turkey went from neutral to shooting down Iranian ordnance in 10 days.", category: "military", goalIds: ["all-nato", "sco-theater"], sources: [{t:"Reuters-Turkey",u:"https://www.reuters.com/world/middle-east/turkey-intercepts-iranian-missile-eastern-mediterranean-2026-03-09/"},{t:"AJZ-Cyprus",u:"https://www.aljazeera.com/news/2026/3/9/macron-visits-cyprus-after-iranian-drone-strikes-british-airbase"}] },
    { text: "Bahrain Bapco refinery declares force majeure — 32 injured at Sitra including 2-month-old. Gulf civilian toll deepening.", why: "Force majeure = Bahrain's oil exports halted indefinitely. Infant casualty underscores that Gulf 'protection' goal is failing for civilian populations.", category: "economic", goalIds: ["gulf-infra", "gulf-civ"], sources: [{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"AJZ-Sitra",u:"https://www.aljazeera.com/news/2026/3/9/bahrain-sitra-drone-strikes-injure-dozens"}] },
    { text: "Global markets crash — Kospi -8% (worst since 2020), Nikkei -7%, TA-125 -3.4%. US-Israel friction over oil strikes: US 'dismayed' Israel hit 30 depots exceeding agreement.", why: "Market crash signals economic contagion spreading beyond oil. US-Israel disagreement over targeting = first public crack in bilateral war management.", category: "economic", goalIds: ["en-oil", "alliance"], sources: [{t:"Bloomberg-Markets",u:"https://www.bloomberg.com/news/articles/2026-03-09/global-markets-crash-iran-war-oil-spike"},{t:"Axios-Friction",u:"https://www.axios.com/2026/03/09/us-israel-friction-oil-depot-strikes"}] },
    { text: "13th Israeli civilian killed by cluster munition. 2 more IDF soldiers killed in Lebanon (4 IDF KIA total). Hezbollah pledged allegiance to Mojtaba.", why: "Cluster munitions killing Israeli civilians while Hezbollah consolidates under new Supreme Leader — the two-front war is intensifying, not winding down.", category: "humanitarian", goalIds: ["cas-isr", "hez"], sources: [{t:"ToI-Cluster",u:"https://www.timesofisrael.com/liveblog-march-09-2026/"},{t:"Haaretz-IDF",u:"https://www.haaretz.com/israel-news/2026-03-09/ty-article/two-more-idf-soldiers-killed-in-lebanon"}] },
  ],
  watchNext: [
    { text: "8th US death reported (AJZ) — not yet CENTCOM-confirmed. If confirmed, doubles the political cost of 'standoff' framing", why: "Each confirmed KIA erodes the 'limited/precision' narrative. 8 KIA in 10 days approaching Iraq War Week 1 pace.", category: "humanitarian", timeframe: "imminent", sources: [{t:"AJZ",u:"https://www.aljazeera.com/news/2026/3/9/us-soldier-dies-iran-war"}] },
    { text: "'Death to Mojtaba' protests in Tehran — unverified by AFP. If confirmed, regime reconstitution narrative collapses", why: "Anti-Supreme-Leader protests under bombardment would be unprecedented — suggests IRGC control weaker than unity narrative implies.", category: "regime", timeframe: "24-48h", sources: [{t:"IranIntl",u:"https://www.iranintl.com/en/liveblog/202602288143"}] },
    { text: "Houthi silence Day 10 — still not attacking. Each day of non-entry = strategic win for coalition", why: "If Houthis enter now with oil at $109, Red Sea closure doubles the shipping crisis. Their continued restraint is the most underreported positive.", category: "military", timeframe: "this week", sources: [{t:"LWJ",u:"https://www.longwarjournal.org/archives/2026/03/houthis-express-solidarity-with-iran-but-do-not-launch-retaliatory-attacks-yet.php"}] },
    { text: "Oil sustaining above $100? Monday settled $109 — does it hold or was it panic overshoot?", why: "If $109 holds through Tuesday, $4 gas is locked in. If it retreats to $100-105, market sees it as panic spike. Structural vs. speculative.", category: "economic", timeframe: "24-48h", sources: [{t:"Reuters",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"}] },
    { text: "Turkey NATO Article 5 implications — intercepted Iranian BM, F-16s to Cyprus. Erdogan weighing options", why: "If Turkey invokes Article 5 after intercepting Iranian missiles in its airspace, it transforms a regional war into a formal NATO conflict.", category: "political", timeframe: "this week", sources: [{t:"Reuters-Turkey",u:"https://www.reuters.com/world/middle-east/turkey-intercepts-iranian-missile-eastern-mediterranean-2026-03-09/"}] },
    { text: "Macron in Cyprus post-Akrotiri drone strike — building European Strait protection coalition", why: "France taking operational lead in Mediterranean/Strait suggests NATO-minus-US framework emerging — strategic autonomy tested in real time.", category: "political", timeframe: "this week", sources: [{t:"AJZ-Cyprus",u:"https://www.aljazeera.com/news/2026/3/9/macron-visits-cyprus-after-iranian-drone-strikes-british-airbase"}] },
    { text: "Does special forces uranium seizure plan advance? Still under active US-Israel discussion", why: "Ground troops in Iran = fundamentally different war. With ceasefire rejected on both sides, the window for this operation may be opening.", category: "military", timeframe: "this week", sources: [{t:"Axios",u:"https://www.axios.com/2026/03/08/iran-ground-troops-special-forces-nuclear"}] },
  ],
  watchResolved: [
    { text: "Oil crosses $110", resolved: "CONFIRMED: WTI spiked ~$119 intraday Monday, settled ~$109.30. Far exceeded $110 threshold.", status: "confirmed" },
    { text: "Iran ceasefire response", resolved: "REJECTED: Araghchi on NBC: 'continue fighting.' Demands permanent end, not temporary halt.", status: "confirmed" },
    { text: "Mojtaba investiture", resolved: "CONFIRMED + CONSOLIDATING: Hezbollah pledged allegiance. But 'Death to Mojtaba' protests reported (unverified).", status: "confirmed" },
    { text: "Houthi decision point", resolved: "Day 10 without entry. Still no confirmed strikes. Each day = strategic win for coalition.", status: "ongoing" },
    { text: "China material support", resolved: "Escalating: IRISL ships with sodium perchlorate from China. Wang Yi declared support. Supply line active.", status: "ongoing" },
    ...
    { text: "Gulf interceptor depletion", resolved: "Confirmed crisis. Ukraine drone experts deploying next week. Stocks unsustainable.", status: "confirmed" },
    { text: "B-1B Fairford sorties", resolved: "CONFIRMED: 3 B-1Bs at Fairford. Forward basing operational.", status: "confirmed" },
    { text: "Oil crosses $100/bbl", resolved: "CONFIRMED: Breached Sunday at $103.93, Monday spike to $119, settle $109.30.", status: "confirmed" },
  ],
};
...
const GOALS = [
  ...
  },
  {
    ...
    importance:5, achievability:2, status:"in progress", outcomeNote:"Day 10: HEZBOLLAH PLEDGED ALLEGIANCE TO MOJTABA — consolidating under new Supreme Leader, not fracturing. 2 more IDF soldiers killed in Lebanon (Staff Sgt. Or Demry, 20) — 4 IDF KIA total since fighting restarted. Previous: 5 IRGC Quds commanders killed in Ramada Hotel, ~200 operatives killed, 600+ strikes. Quds Force Lebanon Corps decapitated but Hezbollah ground forces still lethal. Lebanon: ~394+ dead, 500K+ displaced. Hezbollah retaining combat capability despite massive leadership losses — institutional loyalty transferring to Mojtaba.", sources:[{t:"Haaretz-IDF-D10",u:"https://www.haaretz.com/israel-news/2026-03-09/ty-article/two-more-idf-soldiers-killed-in-lebanon"},{t:"AJZ-Mojtaba",u:"https://www.aljazeera.com/news/2026/3/9/hezbollah-pledges-allegiance-mojtaba-khamenei"},{t:"AJZ-Ramada",u:"https://www.aljazeera.com/news/2026/3/8/israeli-strike-on-hotel-in-lebanons-beirut-kills-four-people"},{t:"Alma-D9",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-8-2026-1800/"}],
    subgoals:[
  ...
  },
  {
    ...
    importance:5, achievability:1, status:"at risk", trend:"expanding", outcomeNote:"Day 10: GLOBAL MARKET CRASH — WTI spiked ~$119 intraday, settled ~$109.30. Kospi -8% (worst since 2020), Nikkei -7%, TA-125 -3.4%. Bahrain Bapco declared force majeure. US-Israel friction over 30 oil depot strikes exceeding agreement. ~9M bbl/day off market. Qatar $150 warning. $4 gas now imminent. Every metric worsening — oil, equities, shipping, insurance all signaling sustained crisis, not a spike.", sources:[{t:"Reuters-Oil",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"},{t:"Bloomberg-Markets",u:"https://www.bloomberg.com/news/articles/2026-03-09/global-markets-crash-iran-war-oil-spike"},{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"CSIS",u:"https://www.csis.org/analysis/37-billion-estimated-cost-epic-furys-first-100-hours"}],
    subgoals:[
      { id:"en-oil", name:"Keep oil below $100/barrel", party:"us", type:"avoid", importance:5, achievability:3, status:"at risk", trend:"failing", outcomeNote:"Day 10: MONDAY PANIC — WTI spiked ~$119/bbl intraday (first full trading day since $100 breach), settled ~$109.30. Brent tracking similar. Sunday open was $103.93; Monday institutional trading amplified as predicted. US 'dismayed' Israel struck 30 oil depots exceeding bilateral agreement — first public crack in targeting coordination. Bahrain Bapco declared force majeure = another Gulf producer offline. Global markets crashed: Kospi -8% (worst since 2020), Nikkei -7%, TA-125 -3.4%. $4 gas now imminent at $109 oil. Qatar $150 warning looking less extreme by the day.", sources:[{t:"Reuters-Oil",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"},{t:"CNBC-$119",u:"https://www.cnbc.com/2026/03/09/oil-prices-spike-above-119-on-iran-war-fears.html"},{t:"Axios-Friction",u:"https://www.axios.com/2026/03/09/us-israel-friction-oil-depot-strikes"},{t:"Bloomberg-Markets",u:"https://www.bloomberg.com/news/articles/2026-03-09/global-markets-crash-iran-war-oil-spike"},{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"}] },
      ...
      { id:"en-pump", name:"Keep US gas prices manageable", party:"us", type:"avoid", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10: $4 GAS NOW IMMINENT — oil at $109 settle (~$119 intraday) = gas above $3.75 within days. Previous $3.41 at $90 oil. Each $10 above $100 ≈ $0.25/gal. CA already $5+. Summer blend switchover adds pressure. Trump still won't tap SPR. DFC insurance fiction (6-9 months). $4 gas is historically the approval-rating cliff for US presidents.", sources:[{t:"Reuters-Oil",u:"https://www.reuters.com/business/energy/oil-prices-surge-iran-war-escalation-2026-03-09/"},{t:"WaPo-Gas",u:"https://www.washingtonpost.com/business/2026/03/07/gas-prices-increasing-iran-war/"},{t:"CBS-Gas",u:"https://www.cbsnews.com/news/why-gas-prices-are-going-up-iran-war-chart/"}] },
    ]
  },
  {
    ...
    subgoals:[
      ...
      { id:"gulf-civ", name:"Protect Gulf civilian populations", party:"us", type:"achieve", importance:4, achievability:3, status:"at risk", trend:"expanding", outcomeNote:"Day 10: BAHRAIN SITRA STRIKES — 32 injured including 2-month-old baby. Gulf casualties mounting across 6+ countries. UAE: 4 dead, 112+ injured. Saudi: 2 foreign nationals killed. Kuwait: 2 border officers killed. Bahrain: desalination plant + Bapco refinery + Sitra residential. Qatar: 1 Pakistani killed. Jordan: 60 missiles + 59 UAVs since war start. War affecting daily life in 9+ countries. 52,000+ Indians evacuated. Infant casualty underscores protection failure.", sources:[{t:"AJZ-Sitra",u:"https://www.aljazeera.com/news/2026/3/9/bahrain-sitra-drone-strikes-injure-dozens"},{t:"Reuters-Bapco",u:"https://www.reuters.com/business/energy/bahrain-bapco-declares-force-majeure-after-iranian-strikes-2026-03-09/"},{t:"Alma-D9",u:"https://israel-alma.org/daily-report-the-second-iran-war-march-8-2026-1800/"},{t:"Bloomberg-Saudi",u:"https://www.bloomberg.com/news/articles/2026-03-08/us-said-to-order-us-diplomats-in-saudi-arabia-to-leave-nyt-says"}] },
    ]
  },
  {
